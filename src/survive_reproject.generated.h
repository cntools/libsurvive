...
#include <linmath.h>
#include <math.h>
static inline double __safe_asin(double x) { return asin(linmath_max(-1., linmath_min(1., x))); }
#define asin __safe_asin
#ifndef WIN32
static inline double __safe_pow(double x, double y) { return x == 0 ? 0 : creal(cpow(x, y)); }

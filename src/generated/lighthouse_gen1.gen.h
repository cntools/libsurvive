...
// clang-format off
static inline void reproject_xy(CnMat *out, const BaseStationCal *cal0, const BaseStationCal *cal1,
								const FLT *sensor_pt) {
	const FLT x0 = sensor_pt[2] * sensor_pt[2];
	const FLT x1 = -1 * sensor_pt[2];
	const FLT x2 = atan2(sensor_pt[0], x1);
	const FLT x3 = (-1 * (*cal0).phase) +
				   (-1 * asin((*cal0).tilt * sensor_pt[1] * (1. / sqrt((sensor_pt[0] * sensor_pt[0]) + x0)))) +
				   (-1 * x2);
	const FLT x4 = (-1 * (*cal1).phase) +
				   (-1 * asin((*cal1).tilt * sensor_pt[0] * (1. / sqrt((sensor_pt[1] * sensor_pt[1]) + x0)))) +
				   (-1 * atan2(-1 * sensor_pt[1], x1));
	cnMatrixOptionalSet(out, 0, 0,
						x3 + (-1 * (*cal0).gibmag * cos(1.5707963267949 + x3 + (*cal0).gibpha)) +
							((atan2(sensor_pt[1], x1) * atan2(sensor_pt[1], x1)) * (*cal0).curve));
	cnMatrixOptionalSet(out, 1, 0,
						x4 + ((x2 * x2) * (*cal1).curve) +
							(-1 * (*cal1).gibmag * cos(1.5707963267949 + x4 + (*cal1).gibpha)));
}

// Jacobian of reproject_xy wrt [<cnkalman.codegen.WrapMember object at 0x7f746dea0b50>, <cnkalman.codegen.WrapMember
// object at 0x7f746dea0a60>, <cnkalman.codegen.WrapMember object at 0x7f746dea06a0>, <cnkalman.codegen.WrapMember
// object at 0x7f746df11700>, <cnkalman.codegen.WrapMember object at 0x7f746df11910>, <cnkalman.codegen.WrapMember
// object at 0x7f74f58a6d30>, <cnkalman.codegen.WrapMember object at 0x7f746dea0be0>]
static inline void reproject_xy_jac_cal0(CnMat *Hx, const BaseStationCal *cal0, const BaseStationCal *cal1,
										 const FLT *sensor_pt) {
	const FLT x0 = -1 * sensor_pt[2];
	const FLT x1 = (sensor_pt[0] * sensor_pt[0]) + (sensor_pt[2] * sensor_pt[2]);
	const FLT x2 = (1. / sqrt(x1)) * sensor_pt[1];
	const FLT x3 = 1.5707963267949 + (-1 * (*cal0).phase) + (-1 * atan2(sensor_pt[0], x0)) + (*cal0).gibpha +
				   (-1 * asin(x2 * (*cal0).tilt));
	const FLT x4 = sin(x3) * (*cal0).gibmag;
	const FLT x5 =
		x2 * (1. / sqrt(1 + (-1 * (1. / x1) * ((*cal0).tilt * (*cal0).tilt) * (sensor_pt[1] * sensor_pt[1]))));
	cnSetZero(Hx);
	cnMatrixOptionalSet(Hx, 0, offsetof(BaseStationCal, curve) / sizeof(FLT),
						atan2(sensor_pt[1], x0) * atan2(sensor_pt[1], x0));
...
// Full version Jacobian of reproject_xy wrt [<cnkalman.codegen.WrapMember object at 0x7f746dea0b50>,
// <cnkalman.codegen.WrapMember object at 0x7f746dea0a60>, <cnkalman.codegen.WrapMember object at 0x7f746dea06a0>,
// <cnkalman.codegen.WrapMember object at 0x7f746df11700>, <cnkalman.codegen.WrapMember object at 0x7f746df11910>,
// <cnkalman.codegen.WrapMember object at 0x7f74f58a6d30>, <cnkalman.codegen.WrapMember object at 0x7f746dea0be0>]

static inline void reproject_xy_jac_cal0_with_hx(CnMat *Hx, CnMat *hx, const BaseStationCal *cal0,
												 const BaseStationCal *cal1, const FLT *sensor_pt) {
	if (hx != 0) {
...
// Jacobian of reproject_xy wrt [<cnkalman.codegen.WrapMember object at 0x7f746df116d0>, <cnkalman.codegen.WrapMember
// object at 0x7f746df112b0>, <cnkalman.codegen.WrapMember object at 0x7f746df11a00>, <cnkalman.codegen.WrapMember
// object at 0x7f746df11790>, <cnkalman.codegen.WrapMember object at 0x7f746df11190>, <cnkalman.codegen.WrapMember
// object at 0x7f746df115b0>, <cnkalman.codegen.WrapMember object at 0x7f746df118b0>]
static inline void reproject_xy_jac_cal1(CnMat *Hx, const BaseStationCal *cal0, const BaseStationCal *cal1,
										 const FLT *sensor_pt) {
	const FLT x0 = -1 * sensor_pt[2];
	const FLT x1 = (sensor_pt[1] * sensor_pt[1]) + (sensor_pt[2] * sensor_pt[2]);
	const FLT x2 = (1. / sqrt(x1)) * sensor_pt[0];
	const FLT x3 = 1.5707963267949 + (-1 * (*cal1).phase) + (*cal1).gibpha + (-1 * asin(x2 * (*cal1).tilt)) +
				   (-1 * atan2(-1 * sensor_pt[1], x0));
	const FLT x4 = sin(x3) * (*cal1).gibmag;
	const FLT x5 =
		x2 * (1. / sqrt(1 + (-1 * (1. / x1) * ((*cal1).tilt * (*cal1).tilt) * (sensor_pt[0] * sensor_pt[0]))));
	cnSetZero(Hx);
	cnMatrixOptionalSet(Hx, 1, offsetof(BaseStationCal, curve) / sizeof(FLT),
						atan2(sensor_pt[0], x0) * atan2(sensor_pt[0], x0));
...
// Full version Jacobian of reproject_xy wrt [<cnkalman.codegen.WrapMember object at 0x7f746df116d0>,
// <cnkalman.codegen.WrapMember object at 0x7f746df112b0>, <cnkalman.codegen.WrapMember object at 0x7f746df11a00>,
// <cnkalman.codegen.WrapMember object at 0x7f746df11790>, <cnkalman.codegen.WrapMember object at 0x7f746df11190>,
// <cnkalman.codegen.WrapMember object at 0x7f746df115b0>, <cnkalman.codegen.WrapMember object at 0x7f746df118b0>]

static inline void reproject_xy_jac_cal1_with_hx(CnMat *Hx, CnMat *hx, const BaseStationCal *cal0,
												 const BaseStationCal *cal1, const FLT *sensor_pt) {
	if (hx != 0) {
		reproject_xy(hx, cal0, cal1, sensor_pt);
	}
...
static inline void reproject_xy_jac_sensor_pt(CnMat *Hx, const BaseStationCal *cal0, const BaseStationCal *cal1,
											  const FLT *sensor_pt) {
	...
	const FLT x13 = (*cal0).gibmag * sin(1.5707963267949 + (-1 * (*cal0).phase) + (-1 * x12) + (*cal0).gibpha +
										 (-1 * asin(x10 * sensor_pt[1])));
	...
	const FLT x23 = sin(1.5707963267949 + (-1 * (*cal1).phase) + (*cal1).gibpha + (-1 * asin(x22 * sensor_pt[0])) +
						(-1 * atan2(-1 * sensor_pt[1], x11))) *
					(*cal1).gibmag;
...
static inline void reproject_xy_jac_sensor_pt_with_hx(CnMat *Hx, CnMat *hx, const BaseStationCal *cal0,
													  const BaseStationCal *cal1, const FLT *sensor_pt) {
	if (hx != 0) {
		reproject_xy(hx, cal0, cal1, sensor_pt);
	}
...
static inline FLT reproject_axis_x(const SurvivePose *obj_p, const FLT *sensor_pt, const SurvivePose *lh_p,
								   const BaseStationCal *bsc0) {
	const FLT x0 =
		(-1 * sensor_pt[1] * (*obj_p).Rot[3]) + (sensor_pt[0] * (*obj_p).Rot[0]) + (sensor_pt[2] * (*obj_p).Rot[2]);
	const FLT x1 =
		(sensor_pt[0] * (*obj_p).Rot[3]) + (-1 * sensor_pt[2] * (*obj_p).Rot[1]) + (sensor_pt[1] * (*obj_p).Rot[0]);
	const FLT x2 = sensor_pt[2] + (2 * ((x1 * (*obj_p).Rot[1]) + (-1 * x0 * (*obj_p).Rot[2]))) + (*obj_p).Pos[2];
	const FLT x3 =
		(sensor_pt[1] * (*obj_p).Rot[1]) + (-1 * sensor_pt[0] * (*obj_p).Rot[2]) + (sensor_pt[2] * (*obj_p).Rot[0]);
	...
	const FLT x13 = (-1 * (*bsc0).phase) + (-1 * asin((1. / sqrt((x12 * x12) + (x10 * x10))) * x8 * (*bsc0).tilt)) +
					(-1 * atan2(x12, x11));
	return x13 + ((atan2(x8, x11) * atan2(x8, x11)) * (*bsc0).curve) +
		   (-1 * cos(1.5707963267949 + x13 + (*bsc0).gibpha) * (*bsc0).gibmag);
}

// Jacobian of reproject_axis_x wrt [(*obj_p).Pos[0], (*obj_p).Pos[1], (*obj_p).Pos[2], (*obj_p).Rot[0],
// (*obj_p).Rot[1], (*obj_p).Rot[2], (*obj_p).Rot[3]]
static inline void reproject_axis_x_jac_obj_p(CnMat *Hx, const SurvivePose *obj_p, const FLT *sensor_pt,
	...
	const FLT x46 = (-1 * x37 * ((-1 * x45 * ((x4 * x44) + (x43 * x30))) + (x41 * x42))) +
					(-1 * x34 * ((-1 * x30 * x31) + (x4 * x27)));
	const FLT x47 = -1 * x24;
	const FLT x48 = (*bsc0).gibmag * sin(1.5707963267949 + (-1 * (*bsc0).phase) + (*bsc0).gibpha +
										 (-1 * asin(x42 * x35)) + (-1 * atan2(x22, x47)));
	...
	const FLT x57 = (-1 * x37 * ((-1 * ((x55 * x44) + (x56 * x43)) * x45) + (x52 * x42))) +
					(-1 * ((-1 * x56 * x31) + (x55 * x27)) * x34);
	const FLT x58 = 1 + x51 + x28;
	const FLT x59 = x1 + x3;
	const FLT x60 = x53 + (-1 * x54);
	const FLT x61 = (-1 * x37 * ((-1 * ((x58 * x44) + (x59 * x43)) * x45) + (x60 * x42))) +
					(-1 * ((-1 * x59 * x31) + (x58 * x27)) * x34);
	const FLT x62 = 2 * x11;
	const FLT x63 = 2 * x9;
	...
	const FLT x77 = (-1 * x37 * ((-1 * ((x73 * x44) + (x75 * x43)) * x45) + (x76 * x42))) +
					(-1 * ((-1 * x75 * x31) + (x73 * x27)) * x34);
	...
	const FLT x91 = (-1 * x37 * ((-1 * ((x87 * x44) + (x89 * x43)) * x45) + (x90 * x42))) +
					(-1 * ((-1 * x89 * x31) + (x87 * x27)) * x34);
	const FLT x92 = 2 * x14;
	...
	const FLT x103 = (-1 * x37 * ((-1 * x45 * ((x99 * x44) + (x43 * x101))) + (x42 * x102))) +
					 (-1 * x34 * ((-1 * x31 * x101) + (x99 * x27)));
	...
	const FLT x113 = (-1 * x37 * ((-1 * ((x44 * x109) + (x43 * x111)) * x45) + (x42 * x112))) +
					 (-1 * ((-1 * x31 * x111) + (x27 * x109)) * x34);
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[0]) / sizeof(FLT),
						x46 + (x46 * x48) + (x50 * ((x4 * x49) + (-1 * x41 * x31))));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[1]) / sizeof(FLT),
						x57 + (((x55 * x49) + (-1 * x52 * x31)) * x50) + (x57 * x48));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[2]) / sizeof(FLT),
						x61 + (x61 * x48) + (((x58 * x49) + (-1 * x60 * x31)) * x50));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[0]) / sizeof(FLT),
						x77 + (x77 * x48) + (((x73 * x49) + (-1 * x76 * x31)) * x50));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[1]) / sizeof(FLT),
						(x91 * x48) + x91 + (((x87 * x49) + (-1 * x90 * x31)) * x50));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[2]) / sizeof(FLT),
						x103 + (x48 * x103) + (x50 * ((x99 * x49) + (-1 * x31 * x102))));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[3]) / sizeof(FLT),
						x113 + (x48 * x113) + (((x49 * x109) + (-1 * x31 * x112)) * x50));
}

// Full version Jacobian of reproject_axis_x wrt [(*obj_p).Pos[0], (*obj_p).Pos[1], (*obj_p).Pos[2], (*obj_p).Rot[0],
// (*obj_p).Rot[1], (*obj_p).Rot[2], (*obj_p).Rot[3]]

static inline void reproject_axis_x_jac_obj_p_with_hx(CnMat *Hx, CnMat *hx, const SurvivePose *obj_p,
...
static inline void reproject_axis_x_jac_sensor_pt(CnMat *Hx, const SurvivePose *obj_p, const FLT *sensor_pt,
												  const SurvivePose *lh_p, const BaseStationCal *bsc0) {
	...
	const FLT x45 = (-1 * x39 * ((-1 * ((x43 * x15) + (x42 * x32)) * x44) + (x40 * x41))) +
					(-1 * ((-1 * x32 * x33) + (x29 * x15)) * x36);
	const FLT x46 = -1 * x24;
	const FLT x47 = (*bsc0).gibmag * sin(1.5707963267949 + (-1 * (*bsc0).phase) + (*bsc0).gibpha +
										 (-1 * asin(x41 * x37)) + (-1 * atan2(x28, x46)));
	...
	const FLT x62 = (-1 * x39 * ((-1 * ((x60 * x43) + (x61 * x42)) * x44) + (x58 * x41))) +
					(-1 * ((-1 * x61 * x33) + (x60 * x29)) * x36);
	...
	const FLT x72 = (-1 * x39 * ((-1 * ((x68 * x43) + (x70 * x42)) * x44) + (x71 * x41))) +
					(-1 * ((-1 * x70 * x33) + (x68 * x29)) * x36);
...
static inline void reproject_axis_x_jac_sensor_pt_with_hx(CnMat *Hx, CnMat *hx, const SurvivePose *obj_p,
														  const FLT *sensor_pt, const SurvivePose *lh_p,
														  const BaseStationCal *bsc0) {
	if (hx != 0) {
		hx->data[0] = reproject_axis_x(obj_p, sensor_pt, lh_p, bsc0);
...
// Jacobian of reproject_axis_x wrt [(*lh_p).Pos[0], (*lh_p).Pos[1], (*lh_p).Pos[2], (*lh_p).Rot[0], (*lh_p).Rot[1],
// (*lh_p).Rot[2], (*lh_p).Rot[3]]
static inline void reproject_axis_x_jac_lh_p(CnMat *Hx, const SurvivePose *obj_p, const FLT *sensor_pt,
											 const SurvivePose *lh_p, const BaseStationCal *bsc0) {
	const FLT x0 =
		(sensor_pt[0] * (*obj_p).Rot[3]) + (-1 * sensor_pt[2] * (*obj_p).Rot[1]) + (sensor_pt[1] * (*obj_p).Rot[0]);
	const FLT x1 =
	...
	const FLT x33 = -1 * x22;
	const FLT x34 = (*bsc0).gibmag * sin(1.5707963267949 + (-1 * (*bsc0).phase) + (*bsc0).gibpha +
										 (-1 * asin(x32 * x26)) + (-1 * atan2(x17, x33)));
	...
	const FLT x52 = (-1 * x28 * ((-1 * ((x41 * x36) + (x50 * x46)) * x51) + (x49 * x32))) +
					(-1 * ((-1 * x44 * x46) + (x41 * x43)) * x47);
	...
	const FLT x65 = (-1 * x28 * ((-1 * ((x58 * x36) + (x62 * x50)) * x51) + (x64 * x32))) +
					(-1 * ((-1 * x62 * x44) + (x59 * x17)) * x47);
	...
	const FLT x71 = (-1 * x28 * ((-1 * ((x69 * x36) + (x70 * x50)) * x51) + (x67 * x32))) +
					(-1 * ((-1 * x70 * x44) + (x69 * x43)) * x47);
	...
	const FLT x76 = (-1 * x28 * ((-1 * ((x73 * x36) + (x74 * x50)) * x51) + (x75 * x32))) +
					(-1 * ((-1 * x74 * x44) + (x73 * x43)) * x47);
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[0]) / sizeof(FLT), x31 + (x31 * x34));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[1]) / sizeof(FLT),
						(-1 * x36 * x37) + (-1 * x34 * x35) + (-1 * x35));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[2]) / sizeof(FLT), x38 + (x34 * x38) + (x39 * x26));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[0]) / sizeof(FLT),
						x52 + (x52 * x34) + (((x53 * x41) + (-1 * x44 * x49)) * x54));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[1]) / sizeof(FLT),
						x65 + (x65 * x34) + (((x59 * x26) + (-1 * x64 * x44)) * x54));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[2]) / sizeof(FLT),
						x71 + (((x69 * x53) + (-1 * x67 * x44)) * x54) + (x71 * x34));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[3]) / sizeof(FLT),
						x76 + (x76 * x34) + (((x73 * x53) + (-1 * x75 * x44)) * x54));
}

// Full version Jacobian of reproject_axis_x wrt [(*lh_p).Pos[0], (*lh_p).Pos[1], (*lh_p).Pos[2], (*lh_p).Rot[0],
// (*lh_p).Rot[1], (*lh_p).Rot[2], (*lh_p).Rot[3]]

static inline void reproject_axis_x_jac_lh_p_with_hx(CnMat *Hx, CnMat *hx, const SurvivePose *obj_p,
													 const FLT *sensor_pt, const SurvivePose *lh_p,
													 const BaseStationCal *bsc0) {
	if (hx != 0) {
		hx->data[0] = reproject_axis_x(obj_p, sensor_pt, lh_p, bsc0);
...
// Jacobian of reproject_axis_x wrt [<cnkalman.codegen.WrapMember object at 0x7f746deb4070>,
// <cnkalman.codegen.WrapMember object at 0x7f746deb4130>, <cnkalman.codegen.WrapMember object at 0x7f746deb40d0>,
// <cnkalman.codegen.WrapMember object at 0x7f746deb41f0>, <cnkalman.codegen.WrapMember object at 0x7f746deb4190>,
// <cnkalman.codegen.WrapMember object at 0x7f746deb1e20>, <cnkalman.codegen.WrapMember object at 0x7f746deb1fd0>]
static inline void reproject_axis_x_jac_bsc0(CnMat *Hx, const SurvivePose *obj_p, const FLT *sensor_pt,
											 const SurvivePose *lh_p, const BaseStationCal *bsc0) {
	const FLT x0 =
		(-1 * sensor_pt[1] * (*obj_p).Rot[3]) + (sensor_pt[0] * (*obj_p).Rot[0]) + (sensor_pt[2] * (*obj_p).Rot[2]);
	const FLT x1 =
	...
	const FLT x15 = 1.5707963267949 + (-1 * (*bsc0).phase) + (*bsc0).gibpha + (-1 * asin(x14 * (*bsc0).tilt)) +
					(-1 * atan2(x12, x11));
...
// Full version Jacobian of reproject_axis_x wrt [<cnkalman.codegen.WrapMember object at 0x7f746deb4070>,
// <cnkalman.codegen.WrapMember object at 0x7f746deb4130>, <cnkalman.codegen.WrapMember object at 0x7f746deb40d0>,
// <cnkalman.codegen.WrapMember object at 0x7f746deb41f0>, <cnkalman.codegen.WrapMember object at 0x7f746deb4190>,
// <cnkalman.codegen.WrapMember object at 0x7f746deb1e20>, <cnkalman.codegen.WrapMember object at 0x7f746deb1fd0>]

static inline void reproject_axis_x_jac_bsc0_with_hx(CnMat *Hx, CnMat *hx, const SurvivePose *obj_p,
													 const FLT *sensor_pt, const SurvivePose *lh_p,
													 const BaseStationCal *bsc0) {
	if (hx != 0) {
		hx->data[0] = reproject_axis_x(obj_p, sensor_pt, lh_p, bsc0);
...
static inline FLT reproject_axis_y(const SurvivePose *obj_p, const FLT *sensor_pt, const SurvivePose *lh_p,
	...
	const FLT x13 = (-1 * atan2(-1 * x12, x11)) + (-1 * (*bsc1).phase) +
					(-1 * asin((1. / sqrt((x12 * x12) + (x10 * x10))) * x8 * (*bsc1).tilt));
	return x13 + ((atan2(x8, x11) * atan2(x8, x11)) * (*bsc1).curve) +
		   (-1 * cos(1.5707963267949 + x13 + (*bsc1).gibpha) * (*bsc1).gibmag);
}

// Jacobian of reproject_axis_y wrt [(*obj_p).Pos[0], (*obj_p).Pos[1], (*obj_p).Pos[2], (*obj_p).Rot[0],
// (*obj_p).Rot[1], (*obj_p).Rot[2], (*obj_p).Rot[3]]
static inline void reproject_axis_y_jac_obj_p(CnMat *Hx, const SurvivePose *obj_p, const FLT *sensor_pt,
	...
	const FLT x48 = (-1 * x47 * ((-1 * x4 * x46) + (x41 * x31))) +
					(-1 * x38 * ((x45 * x30) + (-1 * x44 * ((x4 * x43) + (x41 * x42)))));
	const FLT x49 = sin(1.5707963267949 + (-1 * (*bsc1).phase) + (-1 * asin(x45 * x22)) + (*bsc1).gibpha +
						(-1 * atan2(-1 * x35, x32))) *
					(*bsc1).gibmag;
	...
	const FLT x58 = (-1 * ((-1 * x54 * x35) + (x57 * x31)) * x47) +
					(-1 * x38 * ((x55 * x45) + (-1 * ((x53 * x43) + (x57 * x42)) * x44)));
	const FLT x59 = 1 + x56 + x28;
	const FLT x60 = x1 + x3;
	const FLT x61 = x50 + (-1 * x52);
	const FLT x62 = (-1 * ((-1 * x59 * x46) + (x61 * x31)) * x47) +
					(-1 * x38 * ((x60 * x45) + (-1 * ((x59 * x43) + (x61 * x42)) * x44)));
	const FLT x63 = 2 * x11;
	const FLT x64 = 2 * x9;
	...
	const FLT x78 = (-1 * ((-1 * x74 * x46) + (x77 * x31)) * x47) +
					(-1 * x38 * ((x76 * x45) + (-1 * ((x74 * x43) + (x77 * x42)) * x44)));
	...
	const FLT x92 = (-1 * ((-1 * x88 * x46) + (x91 * x31)) * x47) +
					(-1 * x38 * ((x90 * x45) + (-1 * ((x88 * x43) + (x91 * x42)) * x44)));
	const FLT x93 = 2 * x14;
	...
	const FLT x104 = (-1 * ((-1 * x46 * x100) + (x31 * x103)) * x47) +
					 (-1 * x38 * ((x45 * x102) + (-1 * ((x43 * x100) + (x42 * x103)) * x44)));
	...
	const FLT x114 = (-1 * ((-1 * x46 * x110) + (x31 * x113)) * x47) +
					 (-1 * x38 * ((x45 * x112) + (-1 * ((x43 * x110) + (x42 * x113)) * x44)));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[0]) / sizeof(FLT),
						x48 + (x34 * ((-1 * x30 * x31) + (x4 * x27))) + (x48 * x49));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[1]) / sizeof(FLT),
						x58 + (((-1 * x55 * x31) + (x54 * x22)) * x34) + (x58 * x49));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[2]) / sizeof(FLT),
						x62 + (((-1 * x60 * x31) + (x59 * x27)) * x34) + (x62 * x49));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[0]) / sizeof(FLT),
						(((-1 * x76 * x31) + (x74 * x27)) * x34) + x78 + (x78 * x49));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[1]) / sizeof(FLT),
						x92 + (((-1 * x90 * x31) + (x88 * x27)) * x34) + (x92 * x49));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[2]) / sizeof(FLT),
						x104 + (((-1 * x31 * x102) + (x27 * x100)) * x34) + (x49 * x104));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[3]) / sizeof(FLT),
						x114 + (((-1 * x31 * x112) + (x27 * x110)) * x34) + (x49 * x114));
}

// Full version Jacobian of reproject_axis_y wrt [(*obj_p).Pos[0], (*obj_p).Pos[1], (*obj_p).Pos[2], (*obj_p).Rot[0],
// (*obj_p).Rot[1], (*obj_p).Rot[2], (*obj_p).Rot[3]]

static inline void reproject_axis_y_jac_obj_p_with_hx(CnMat *Hx, CnMat *hx, const SurvivePose *obj_p,
													  const FLT *sensor_pt, const SurvivePose *lh_p,
													  const BaseStationCal *bsc1) {
	if (hx != 0) {
...
static inline void reproject_axis_y_jac_sensor_pt(CnMat *Hx, const SurvivePose *obj_p, const FLT *sensor_pt,
												  const SurvivePose *lh_p, const BaseStationCal *bsc1) {
	const FLT x0 = 2 * (*obj_p).Rot[2];
	const FLT x1 = x0 * (*obj_p).Rot[0];
	const FLT x2 = 2 * (*obj_p).Rot[3];
	...
	const FLT x48 = (-1 * ((-1 * x46 * x15) + (x41 * x33)) * x47) +
					(-1 * x40 * ((x45 * x32) + (-1 * ((x43 * x15) + (x41 * x42)) * x44)));
	const FLT x49 = sin(1.5707963267949 + (-1 * asin(x45 * x24)) + (*bsc1).gibpha + (-1 * (*bsc1).phase) +
						(-1 * atan2(-1 * x37, x34))) *
					(*bsc1).gibmag;
	...
	const FLT x62 = (-1 * ((-1 * x58 * x46) + (x61 * x33)) * x47) +
					(-1 * x40 * ((x60 * x45) + (-1 * ((x58 * x43) + (x61 * x42)) * x44)));
	...
	const FLT x73 = (-1 * ((-1 * x69 * x37) + (x72 * x33)) * x47) +
					(-1 * x40 * ((x71 * x45) + (-1 * ((x68 * x43) + (x72 * x42)) * x44)));
...
static inline void reproject_axis_y_jac_sensor_pt_with_hx(CnMat *Hx, CnMat *hx, const SurvivePose *obj_p,
														  const FLT *sensor_pt, const SurvivePose *lh_p,
														  const BaseStationCal *bsc1) {
	if (hx != 0) {
		hx->data[0] = reproject_axis_y(obj_p, sensor_pt, lh_p, bsc1);
...
// Jacobian of reproject_axis_y wrt [(*lh_p).Pos[0], (*lh_p).Pos[1], (*lh_p).Pos[2], (*lh_p).Rot[0], (*lh_p).Rot[1],
// (*lh_p).Rot[2], (*lh_p).Rot[3]]
static inline void reproject_axis_y_jac_lh_p(CnMat *Hx, const SurvivePose *obj_p, const FLT *sensor_pt,
											 const SurvivePose *lh_p, const BaseStationCal *bsc1) {
	const FLT x0 =
		(sensor_pt[0] * (*obj_p).Rot[3]) + (-1 * sensor_pt[2] * (*obj_p).Rot[1]) + (sensor_pt[1] * (*obj_p).Rot[0]);
	const FLT x1 =
	...
	const FLT x34 = sin(1.5707963267949 + (-1 * asin(x29 * x17)) + (*bsc1).gibpha + (-1 * (*bsc1).phase) +
						(-1 * atan2(-1 * x25, x32))) *
					(*bsc1).gibmag;
	...
	const FLT x53 = (-1 * ((-1 * x43 * x25) + (x44 * x49)) * x52) +
					(-1 * x28 * ((x46 * x29) + (-1 * ((x42 * x31) + (x50 * x49)) * x51)));
	...
	const FLT x64 = (-1 * ((-1 * x58 * x25) + (x63 * x44)) * x52) +
					(-1 * x28 * ((x61 * x29) + (-1 * ((x57 * x31) + (x63 * x50)) * x51)));
	const FLT x65 = 2 * x19;
	...
	const FLT x71 = (-1 * ((-1 * x67 * x25) + (x70 * x44)) * x52) +
					(-1 * x28 * ((x69 * x29) + (-1 * ((x66 * x31) + (x70 * x50)) * x51)));
	const FLT x72 = (-1 * (*obj_p).Pos[1]) + (-1 * sensor_pt[1]) + (-1 * x6);
	const FLT x73 = (x3 * x55) + (-1 * x72 * x60);
	const FLT x74 = x73 * x40;
	const FLT x75 = (-1 * x56) + (-4 * x4) + x48;
	const FLT x76 = x46 + (x72 * x59) + x65;
	const FLT x77 = (-1 * ((-1 * x74 * x25) + (x76 * x44)) * x52) +
					(-1 * x28 * ((x75 * x29) + (-1 * ((x73 * x31) + (x76 * x50)) * x51)));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[0]) / sizeof(FLT),
						(-1 * x30 * x34) + (-1 * x30) + (-1 * x31 * x33));
	...
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[0]) / sizeof(FLT),
						x53 + (((-1 * x44 * x46) + (x43 * x17)) * x47) + (x53 * x34));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[1]) / sizeof(FLT),
						x64 + (((-1 * x61 * x44) + (x58 * x17)) * x47) + (x64 * x34));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[2]) / sizeof(FLT),
						x71 + (((-1 * x69 * x44) + (x67 * x17)) * x47) + (x71 * x34));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[3]) / sizeof(FLT),
						x77 + (((-1 * x75 * x44) + (x74 * x17)) * x47) + (x77 * x34));
}

// Full version Jacobian of reproject_axis_y wrt [(*lh_p).Pos[0], (*lh_p).Pos[1], (*lh_p).Pos[2], (*lh_p).Rot[0],
// (*lh_p).Rot[1], (*lh_p).Rot[2], (*lh_p).Rot[3]]

static inline void reproject_axis_y_jac_lh_p_with_hx(CnMat *Hx, CnMat *hx, const SurvivePose *obj_p,
													 const FLT *sensor_pt, const SurvivePose *lh_p,
													 const BaseStationCal *bsc1) {
	if (hx != 0) {
		hx->data[0] = reproject_axis_y(obj_p, sensor_pt, lh_p, bsc1);
...
// Jacobian of reproject_axis_y wrt [<cnkalman.codegen.WrapMember object at 0x7f746dea03d0>,
// <cnkalman.codegen.WrapMember object at 0x7f746dea0e20>, <cnkalman.codegen.WrapMember object at 0x7f746dea0e80>,
// <cnkalman.codegen.WrapMember object at 0x7f746dea0940>, <cnkalman.codegen.WrapMember object at 0x7f746dea0c10>,
// <cnkalman.codegen.WrapMember object at 0x7f746dea0310>, <cnkalman.codegen.WrapMember object at 0x7f746dea01c0>]
static inline void reproject_axis_y_jac_bsc1(CnMat *Hx, const SurvivePose *obj_p, const FLT *sensor_pt,
											 const SurvivePose *lh_p, const BaseStationCal *bsc1) {
	const FLT x0 =
		(sensor_pt[0] * (*obj_p).Rot[3]) + (-1 * sensor_pt[2] * (*obj_p).Rot[1]) + (sensor_pt[1] * (*obj_p).Rot[0]);
	const FLT x1 =
	...
	const FLT x13 = (x12 * x12) + (x10 * x10);
	const FLT x14 = x8 * (1. / sqrt(x13));
	const FLT x15 = 1.5707963267949 + (-1 * (*bsc1).phase) + (*bsc1).gibpha + (-1 * asin(x14 * (*bsc1).tilt)) +
					(-1 * atan2(-1 * x12, x11));
...
// Full version Jacobian of reproject_axis_y wrt [<cnkalman.codegen.WrapMember object at 0x7f746dea03d0>,
// <cnkalman.codegen.WrapMember object at 0x7f746dea0e20>, <cnkalman.codegen.WrapMember object at 0x7f746dea0e80>,
// <cnkalman.codegen.WrapMember object at 0x7f746dea0940>, <cnkalman.codegen.WrapMember object at 0x7f746dea0c10>,
// <cnkalman.codegen.WrapMember object at 0x7f746dea0310>, <cnkalman.codegen.WrapMember object at 0x7f746dea01c0>]

static inline void reproject_axis_y_jac_bsc1_with_hx(CnMat *Hx, CnMat *hx, const SurvivePose *obj_p,
													 const FLT *sensor_pt, const SurvivePose *lh_p,
													 const BaseStationCal *bsc1) {
	if (hx != 0) {
		hx->data[0] = reproject_axis_y(obj_p, sensor_pt, lh_p, bsc1);

...
static inline void GenerateQuatModelApprox(CnMat* out, const FLT* _x0, const FLT* error_state) {
	...
	cnMatrixOptionalSet(out, 0, 0, (-1 * x2 * error_state0) + (-1 * x1 * error_state2) + (-1 * x0 * error_state1) + _x00);
...
// Jacobian of SurviveKalmanModelToErrorModel wrt [(*_x1).AccBias[0], (*_x1).AccBias[1], (*_x1).AccBias[2], (*_x1).Acc[0], (*_x1).Acc[1], (*_x1).Acc[2], (*_x1).GyroBias[0], (*_x1).GyroBias[1], (*_x1).GyroBias[2], (*_x1).IMUCorrection[0], (*_x1).IMUCorrection[1], (*_x1).IMUCorrection[2], (*_x1).IMUCorrection[3], (*_x1).Pose.Pos[0], (*_x1).Pose.Pos[1], (*_x1).Pose.Pos[2], (*_x1).Pose.Rot[0], (*_x1).Pose.Rot[1], (*_x1).Pose.Rot[2], (*_x1).Pose.Rot[3], (*_x1).Velocity.AxisAngleRot[0], (*_x1).Velocity.AxisAngleRot[1], (*_x1).Velocity.AxisAngleRot[2], (*_x1).Velocity.Pos[0], (*_x1).Velocity.Pos[1], (*_x1).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ea7220>]
...
// Full version Jacobian of SurviveKalmanModelToErrorModel wrt [(*_x1).AccBias[0], (*_x1).AccBias[1], (*_x1).AccBias[2], (*_x1).Acc[0], (*_x1).Acc[1], (*_x1).Acc[2], (*_x1).GyroBias[0], (*_x1).GyroBias[1], (*_x1).GyroBias[2], (*_x1).IMUCorrection[0], (*_x1).IMUCorrection[1], (*_x1).IMUCorrection[2], (*_x1).IMUCorrection[3], (*_x1).Pose.Pos[0], (*_x1).Pose.Pos[1], (*_x1).Pose.Pos[2], (*_x1).Pose.Rot[0], (*_x1).Pose.Rot[1], (*_x1).Pose.Rot[2], (*_x1).Pose.Rot[3], (*_x1).Velocity.AxisAngleRot[0], (*_x1).Velocity.AxisAngleRot[1], (*_x1).Velocity.AxisAngleRot[2], (*_x1).Velocity.Pos[0], (*_x1).Velocity.Pos[1], (*_x1).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ea7220>]
// Jacobian of SurviveKalmanModelToErrorModel wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ea7fd0>]
...
// Full version Jacobian of SurviveKalmanModelToErrorModel wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ea7fd0>]
static inline void SurviveKalmanModelAddErrorModel(SurviveKalmanModel* out, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_state) {
	...
	out->Pose.Rot[0]=(-1 * x0 * (*_x0).Pose.Rot[3]) + (-1 * x2 * (*_x0).Pose.Rot[1]) + (-1 * x1 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0];
	out->Pose.Rot[1]=(*_x0).Pose.Rot[1] + (x2 * (*_x0).Pose.Rot[0]) + (-1 * x1 * (*_x0).Pose.Rot[3]) + (x0 * (*_x0).Pose.Rot[2]);
	out->Pose.Rot[2]=(-1 * x0 * (*_x0).Pose.Rot[1]) + (x1 * (*_x0).Pose.Rot[0]) + (x2 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	out->Pose.Rot[3]=(x1 * (*_x0).Pose.Rot[1]) + (x0 * (*_x0).Pose.Rot[0]) + (*_x0).Pose.Rot[3] + (-1 * x2 * (*_x0).Pose.Rot[2]);
...
// Jacobian of SurviveKalmanModelAddErrorModel wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec26a0>]
static inline void SurviveKalmanModelAddErrorModel_jac_x0(CnMat* Hx, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_state) {
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), 1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), x1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), x3);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x5);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x0);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), 1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), x4);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x3);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x2);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), x5);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), 1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x0);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x4);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), x2);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), x1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), 1);
...
// Full version Jacobian of SurviveKalmanModelAddErrorModel wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec26a0>]
// Jacobian of SurviveKalmanModelAddErrorModel wrt [(*error_state).AccBias[0], (*error_state).AccBias[1], (*error_state).AccBias[2], (*error_state).Acc[0], (*error_state).Acc[1], (*error_state).Acc[2], (*error_state).GyroBias[0], (*error_state).GyroBias[1], (*error_state).GyroBias[2], (*error_state).IMUCorrection[0], (*error_state).IMUCorrection[1], (*error_state).IMUCorrection[2], (*error_state).IMUCorrection[3], (*error_state).Pose.AxisAngleRot[0], (*error_state).Pose.AxisAngleRot[1], (*error_state).Pose.AxisAngleRot[2], (*error_state).Pose.Pos[0], (*error_state).Pose.Pos[1], (*error_state).Pose.Pos[2], (*error_state).Velocity.AxisAngleRot[0], (*error_state).Velocity.AxisAngleRot[1], (*error_state).Velocity.AxisAngleRot[2], (*error_state).Velocity.Pos[0], (*error_state).Velocity.Pos[1], (*error_state).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0eba4c0>]
static inline void SurviveKalmanModelAddErrorModel_jac_error_state(CnMat* Hx, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_state) {
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x3);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x5);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x6);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x5);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x2);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x4);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x6);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x3);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x0);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x6);
...
// Full version Jacobian of SurviveKalmanModelAddErrorModel wrt [(*error_state).AccBias[0], (*error_state).AccBias[1], (*error_state).AccBias[2], (*error_state).Acc[0], (*error_state).Acc[1], (*error_state).Acc[2], (*error_state).GyroBias[0], (*error_state).GyroBias[1], (*error_state).GyroBias[2], (*error_state).IMUCorrection[0], (*error_state).IMUCorrection[1], (*error_state).IMUCorrection[2], (*error_state).IMUCorrection[3], (*error_state).Pose.AxisAngleRot[0], (*error_state).Pose.AxisAngleRot[1], (*error_state).Pose.AxisAngleRot[2], (*error_state).Pose.Pos[0], (*error_state).Pose.Pos[1], (*error_state).Pose.Pos[2], (*error_state).Velocity.AxisAngleRot[0], (*error_state).Velocity.AxisAngleRot[1], (*error_state).Velocity.AxisAngleRot[2], (*error_state).Velocity.Pos[0], (*error_state).Velocity.Pos[1], (*error_state).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0eba4c0>]
...
// Jacobian of SurviveKalmanModelPredict wrt [(*kalman_model).AccBias[0], (*kalman_model).AccBias[1], (*kalman_model).AccBias[2], (*kalman_model).Acc[0], (*kalman_model).Acc[1], (*kalman_model).Acc[2], (*kalman_model).GyroBias[0], (*kalman_model).GyroBias[1], (*kalman_model).GyroBias[2], (*kalman_model).IMUCorrection[0], (*kalman_model).IMUCorrection[1], (*kalman_model).IMUCorrection[2], (*kalman_model).IMUCorrection[3], (*kalman_model).Pose.Pos[0], (*kalman_model).Pose.Pos[1], (*kalman_model).Pose.Pos[2], (*kalman_model).Pose.Rot[0], (*kalman_model).Pose.Rot[1], (*kalman_model).Pose.Rot[2], (*kalman_model).Pose.Rot[3], (*kalman_model).Velocity.AxisAngleRot[0], (*kalman_model).Velocity.AxisAngleRot[1], (*kalman_model).Velocity.AxisAngleRot[2], (*kalman_model).Velocity.Pos[0], (*kalman_model).Velocity.Pos[1], (*kalman_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec7910>]
...
static inline void SurviveKalmanModelErrorPredict(SurviveKalmanErrorModel* out, const FLT t, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model) {
	...
	const FLT x24 = (*_x0).Pose.Rot[1] + (x5 * (*_x0).Pose.Rot[0]) + (-1 * x7 * (*_x0).Pose.Rot[3]) + (x6 * (*_x0).Pose.Rot[2]);
	const FLT x25 = x20 * x21;
	const FLT x26 = (-1 * x6 * (*_x0).Pose.Rot[1]) + (x7 * (*_x0).Pose.Rot[0]) + (x5 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x27 = x22 * x10;
	const FLT x28 = (-1 * x7 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x5 * (*_x0).Pose.Rot[1]) + (-1 * x6 * (*_x0).Pose.Rot[3]);
	...
	const FLT x36 = (-1 * x35 * (*_x0).Pose.Rot[1]) + (-1 * x34 * (*_x0).Pose.Rot[3]) + (x30 * (*_x0).Pose.Rot[2]) + (x33 * (*_x0).Pose.Rot[0]);
	const FLT x37 = (x33 * (*_x0).Pose.Rot[1]) + (x35 * (*_x0).Pose.Rot[0]) + (-1 * x30 * (*_x0).Pose.Rot[3]) + (-1 * x34 * (*_x0).Pose.Rot[2]);
	const FLT x38 = (x35 * (*_x0).Pose.Rot[3]) + (-1 * x34 * (*_x0).Pose.Rot[1]) + (x30 * (*_x0).Pose.Rot[0]) + (-1 * x33 * (*_x0).Pose.Rot[2]);
	const FLT x39 = (x34 * (*_x0).Pose.Rot[0]) + (x30 * (*_x0).Pose.Rot[1]) + (x33 * (*_x0).Pose.Rot[3]) + (x35 * (*_x0).Pose.Rot[2]);
...
static inline void SurviveKalmanModelErrorPredict_jac_t(CnMat* Hx, const FLT t, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model) {
	...
	const FLT x10 = (x9 * (*error_model).Pose.AxisAngleRot[1]) + (*_x0).Pose.Rot[3] + (-1 * x7 * (*_x0).Pose.Rot[2]) + (x8 * (*_x0).Pose.Rot[0]);
	...
	const FLT x36 = (*_x0).Pose.Rot[1] + (x7 * (*_x0).Pose.Rot[0]) + (-1 * x35 * (*_x0).Pose.Rot[3]) + (x8 * (*_x0).Pose.Rot[2]);
	const FLT x37 = x30 * x28;
	const FLT x38 = x36 * x37;
	const FLT x39 = (x35 * (*_x0).Pose.Rot[0]) + (x7 * (*_x0).Pose.Rot[3]) + (-1 * x9 * (*error_model).Pose.AxisAngleRot[2]) + (*_x0).Pose.Rot[2];
	const FLT x40 = x32 * x13;
	const FLT x41 = x40 * x39;
	const FLT x42 = (-1 * x9 * (*error_model).Pose.AxisAngleRot[0]) + (-1 * x35 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x8 * (*_x0).Pose.Rot[3]);
	...
	const FLT x61 = (x60 * (*_x0).Pose.Rot[1]) + (x55 * (*_x0).Pose.Rot[0]) + (-1 * x45 * (*_x0).Pose.Rot[3]) + (-1 * x50 * (*_x0).Pose.Rot[2]);
	const FLT x62 = x61 * x61;
	const FLT x63 = (-1 * x50 * (*_x0).Pose.Rot[1]) + (x45 * (*_x0).Pose.Rot[0]) + (x55 * (*_x0).Pose.Rot[3]) + (-1 * x60 * (*_x0).Pose.Rot[2]);
	const FLT x64 = 1 + (-2 * ((x63 * x63) + x62));
	const FLT x65 = x64 * x64;
	const FLT x66 = (-1 * x55 * (*_x0).Pose.Rot[1]) + (-1 * x50 * (*_x0).Pose.Rot[3]) + (x45 * (*_x0).Pose.Rot[2]) + (x60 * (*_x0).Pose.Rot[0]);
	const FLT x67 = (x45 * (*_x0).Pose.Rot[1]) + (x50 * (*_x0).Pose.Rot[0]) + (x60 * (*_x0).Pose.Rot[3]) + (x55 * (*_x0).Pose.Rot[2]);
	...
	const FLT x84 = ((x83 * x15) + (-1 * x82 * x20) + (x83 * x18) + (x73 * x27) + (-1 * x82 * x15) + (x83 * x20) + (x71 * x27) + (-1 * x81 * x31) + (-1 * x82 * x18) + (x72 * x27)) * (1. / (x29 * sqrt(x29)));
	...
	const FLT x97 = (-1 * x85 * x86) + (-1 * x95 * x38) + (-1 * x46) + (-1 * x53 * x93) + (x91 * x96) + (-1 * x80 * x57) + (-1 * x49) + (-1 * x94 * x42) + (x88 * x76) + (x88 * x89) + (x77 * x69) + (x69 * x90) + (x92 * x91) + (-1 * x47);
	const FLT x98 = x84 * x86;
	const FLT x99 = x85 * x31;
	const FLT x100 = x79 * x57;
	const FLT x101 = x76 * x42;
	const FLT x102 = (-1 * x94 * x36) + (x69 * x92) + (-1 * x87 * x99) + (x95 * x48) + (-1 * x41) + (-1 * x91 * x90) + (-1 * x98 * x36) + x44 + (x11 * x100) + (-1 * x80 * x53) + x34 + (x69 * x96) + (-1 * x87 * x101) + (-1 * x77 * x91);
	const FLT x103 = x69 * x36;
	const FLT x104 = (x87 * x77) + (-1 * x98 * x39) + (-1 * x76 * x103) + x52 + (-1 * x94 * x39) + x51 + (-1 * x16 * x100) + (-1 * x91 * x99) + (-1 * x91 * x101) + (x87 * x90) + (x80 * x38) + (-1 * x54) + (x93 * x48) + (-1 * x89 * x103);
	const FLT x105 = x91 * x36;
	const FLT x106 = (-1 * x93 * x38) + (x76 * x105) + (-1 * x58) + (x80 * x48) + (x53 * x95) + (-1 * x94 * x10) + (-1 * x87 * x92) + (x89 * x105) + (-1 * x69 * x99) + (-1 * x87 * x96) + (-1 * x98 * x10) + x59 + x56 + (-1 * x69 * x101);
	const FLT x107 = (-1 * x106 * (*_x0).Pose.Rot[2]) + (x104 * (*_x0).Pose.Rot[3]) + (-1 * x97 * (*_x0).Pose.Rot[1]) + (x102 * (*_x0).Pose.Rot[0]);
	const FLT x108 = (x97 * (*_x0).Pose.Rot[0]) + (x104 * (*_x0).Pose.Rot[2]) + (x102 * (*_x0).Pose.Rot[1]) + (x106 * (*_x0).Pose.Rot[3]);
	const FLT x109 = (-1 * x97 * (*_x0).Pose.Rot[2]) + (-1 * x102 * (*_x0).Pose.Rot[3]) + (x106 * (*_x0).Pose.Rot[1]) + (x104 * (*_x0).Pose.Rot[0]);
	const FLT x110 = (x106 * (*_x0).Pose.Rot[0]) + (x102 * (*_x0).Pose.Rot[2]) + (-1 * x104 * (*_x0).Pose.Rot[1]) + (-1 * x97 * (*_x0).Pose.Rot[3]);
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), 0, x65 * (1. / (x65 + (4 * (x68 * x68)))) * ((-2 * x68 * (1. / x65) * ((-4 * x63 * x107) + x111)) + (2 * ((x67 * x107) + (x61 * x110) + (x66 * x109) + (x63 * x108)) * (1. / x64))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), 0, 2 * ((-1 * x63 * x110) + (-1 * x66 * x107) + (x61 * x108) + (x67 * x109)) * (1. / sqrt(1 + (-4 * (((x61 * x67) + (-1 * x63 * x66)) * ((x61 * x67) + (-1 * x63 * x66)))))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), 0, x113 * (1. / (x113 + (4 * (x114 * x114)))) * ((-2 * (1. / x113) * x114 * (x111 + (-4 * x66 * x110))) + (2 * ((x61 * x107) + (x63 * x109) + (x67 * x110) + (x66 * x108)) * (1. / x112))));
...
// Jacobian of SurviveKalmanModelErrorPredict wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec94c0>]
static inline void SurviveKalmanModelErrorPredict_jac_x0(CnMat* Hx, const FLT t, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model) {
	...
	const FLT x56 = (x32 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x30 * (*_x0).Pose.Rot[2]) + (x2 * (*_x0).Pose.Rot[0]);
	const FLT x57 = x56 * x34;
	const FLT x58 = (-1 * x2 * (*_x0).Pose.Rot[1]) + (x32 * (*_x0).Pose.Rot[0]) + (x30 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x59 = x58 * x27;
	const FLT x60 = (-1 * x30 * (*_x0).Pose.Rot[1]) + (-1 * x32 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x2 * (*_x0).Pose.Rot[3]);
	const FLT x61 = x60 * x29;
	const FLT x62 = (*_x0).Pose.Rot[1] + (x30 * (*_x0).Pose.Rot[0]) + (-1 * x32 * (*_x0).Pose.Rot[3]) + (x2 * (*_x0).Pose.Rot[2]);
	const FLT x63 = x62 * x36;
	const FLT x64 = x61 + (-1 * x63) + (-1 * x57) + (-1 * x59);
	const FLT x65 = (x55 * (*_x0).Pose.Rot[3]) + (x50 * (*_x0).Pose.Rot[0]) + x64 + (x38 * (*_x0).Pose.Rot[1]) + (x43 * (*_x0).Pose.Rot[2]);
	...
	const FLT x81 = (-1 * x64 * (*_x0).Pose.Rot[1]) + (x80 * (*_x0).Pose.Rot[0]) + (x70 * (*_x0).Pose.Rot[3]) + (-1 * x75 * (*_x0).Pose.Rot[2]);
	const FLT x82 = (x80 * (*_x0).Pose.Rot[1]) + (x64 * (*_x0).Pose.Rot[0]) + (x75 * (*_x0).Pose.Rot[3]) + (x70 * (*_x0).Pose.Rot[2]);
	const FLT x83 = x80 + (x38 * (*_x0).Pose.Rot[0]) + (x43 * (*_x0).Pose.Rot[3]) + (-1 * x50 * (*_x0).Pose.Rot[1]) + (-1 * x55 * (*_x0).Pose.Rot[2]);
	const FLT x84 = (-1 * x38 * (*_x0).Pose.Rot[3]) + (x55 * (*_x0).Pose.Rot[1]) + x70 + (x43 * (*_x0).Pose.Rot[0]) + (-1 * x50 * (*_x0).Pose.Rot[2]);
	const FLT x85 = (-1 * x70 * (*_x0).Pose.Rot[1]) + (-1 * x64 * (*_x0).Pose.Rot[3]) + (x80 * (*_x0).Pose.Rot[2]) + (x75 * (*_x0).Pose.Rot[0]);
	const FLT x86 = (x70 * (*_x0).Pose.Rot[0]) + (-1 * x80 * (*_x0).Pose.Rot[3]) + (x75 * (*_x0).Pose.Rot[1]) + (-1 * x64 * (*_x0).Pose.Rot[2]);
	const FLT x87 = x75 + (-1 * x50 * (*_x0).Pose.Rot[3]) + (x55 * (*_x0).Pose.Rot[0]) + (-1 * x43 * (*_x0).Pose.Rot[1]) + (x38 * (*_x0).Pose.Rot[2]);
	...
	const FLT x109 = x108 + (x104 * (*_x0).Pose.Rot[0]) + (-1 * x100 * (*_x0).Pose.Rot[2]) + (-1 * x107 * (*_x0).Pose.Rot[1]) + (x103 * (*_x0).Pose.Rot[3]);
	const FLT x110 = (x107 * (*_x0).Pose.Rot[0]) + x80 + (x100 * (*_x0).Pose.Rot[3]) + (x104 * (*_x0).Pose.Rot[1]) + (x103 * (*_x0).Pose.Rot[2]);
	const FLT x111 = x75 + (-1 * x107 * (*_x0).Pose.Rot[2]) + (x103 * (*_x0).Pose.Rot[0]) + (x100 * (*_x0).Pose.Rot[1]) + (-1 * x104 * (*_x0).Pose.Rot[3]);
	const FLT x112 = x69 + (x104 * (*_x0).Pose.Rot[2]) + (x100 * (*_x0).Pose.Rot[0]) + (-1 * x67) + (-1 * x103 * (*_x0).Pose.Rot[1]) + (-1 * x68) + (-1 * x66) + (-1 * x107 * (*_x0).Pose.Rot[3]);
	...
	const FLT x122 = (-1 * x72) + (-1 * x121 * (*_x0).Pose.Rot[2]) + (-1 * x71) + (-1 * x117 * (*_x0).Pose.Rot[1]) + (x115 * (*_x0).Pose.Rot[0]) + (x119 * (*_x0).Pose.Rot[3]) + (-1 * x74) + x73;
	const FLT x123 = x70 + (x119 * (*_x0).Pose.Rot[2]) + (x117 * (*_x0).Pose.Rot[0]) + (x115 * (*_x0).Pose.Rot[1]) + (x121 * (*_x0).Pose.Rot[3]);
	const FLT x124 = (-1 * x115 * (*_x0).Pose.Rot[3]) + (x119 * (*_x0).Pose.Rot[0]) + (x121 * (*_x0).Pose.Rot[1]) + x108 + (-1 * x117 * (*_x0).Pose.Rot[2]);
	const FLT x125 = x80 + (x115 * (*_x0).Pose.Rot[2]) + (-1 * x119 * (*_x0).Pose.Rot[1]) + (-1 * x117 * (*_x0).Pose.Rot[3]) + (x121 * (*_x0).Pose.Rot[0]);
	...
	const FLT x131 = x70 + (-1 * x130 * (*_x0).Pose.Rot[1]) + (x127 * (*_x0).Pose.Rot[0]) + (x129 * (*_x0).Pose.Rot[3]) + (-1 * x128 * (*_x0).Pose.Rot[2]);
	const FLT x132 = (-1 * x76) + (-1 * x77) + (-1 * x127 * (*_x0).Pose.Rot[3]) + (x128 * (*_x0).Pose.Rot[1]) + (-1 * x79) + x78 + (-1 * x130 * (*_x0).Pose.Rot[2]) + (x129 * (*_x0).Pose.Rot[0]);
	const FLT x133 = (x127 * (*_x0).Pose.Rot[1]) + x75 + (x128 * (*_x0).Pose.Rot[3]) + (x130 * (*_x0).Pose.Rot[0]) + (x129 * (*_x0).Pose.Rot[2]);
	const FLT x134 = x108 + (-1 * x130 * (*_x0).Pose.Rot[3]) + (x128 * (*_x0).Pose.Rot[0]) + (-1 * x129 * (*_x0).Pose.Rot[1]) + (x127 * (*_x0).Pose.Rot[2]);
	...
	const FLT x155 = (-1 * x152 * x153) + (-1 * x147 * x153) + (-1 * x138 * x146) + (-1 * x148 * x154) + (x147 * x149) + (x150 * x151) + (x138 * x143) + (x149 * x152);
	...
	const FLT x192 = (-1 * x181 * x186) + x191 + (x176 * x185) + (x181 * x183) + (-1 * x179 * x180) + x137 + (x177 * x175) + (-1 * x164 * x155) + (x161 * x158) + (-1 * x170) + x174;
	...
	const FLT x204 = (x181 * x187) + (x184 * x158) + (-1 * x8 * x200) + (-1 * x199 * x155) + (-1 * x176 * x194) + (-1 * x181 * x190) + (-1 * x193) + x195 + x203 + x197 + (-1 * x175 * x198);
	...
	const FLT x212 = (x201 * x181) + (-1 * x208) + (-1 * x202 * x181) + x210 + x206 + (x161 * x177) + (-1 * x205 * x179) + x209 + (-1 * x175 * x158) + (-1 * x207 * x155) + (-1 * x184 * x198) + (-1 * x211);
	...
	const FLT x220 = x218 + (x166 * x181) + (-1 * x9 * x173) + (-1 * x177 * x184) + x214 + (-1 * x213 * x179) + (-1 * x215 * x176) + x219 + (-1 * x217 * x155) + (x216 * x176);
	const FLT x221 = (x212 * (*_x0).Pose.Rot[0]) + (-1 * x192 * (*_x0).Pose.Rot[1]) + (-1 * x220 * (*_x0).Pose.Rot[2]) + (x204 * (*_x0).Pose.Rot[3]);
	const FLT x222 = (x204 * (*_x0).Pose.Rot[2]) + (x220 * (*_x0).Pose.Rot[3]) + (x212 * (*_x0).Pose.Rot[1]) + (x192 * (*_x0).Pose.Rot[0]);
	const FLT x223 = (-1 * x192 * (*_x0).Pose.Rot[2]) + (x220 * (*_x0).Pose.Rot[1]) + (-1 * x212 * (*_x0).Pose.Rot[3]) + (x204 * (*_x0).Pose.Rot[0]);
	const FLT x224 = (x220 * (*_x0).Pose.Rot[0]) + (-1 * x204 * (*_x0).Pose.Rot[1]) + (-1 * x192 * (*_x0).Pose.Rot[3]) + (x212 * (*_x0).Pose.Rot[2]);
	const FLT x225 = -1 * x91 * x223;
	const FLT x226 = x4 * x16;
	const FLT x227 = x3 * x146;
	const FLT x228 = 2 * x151;
	const FLT x229 = (x3 * x3 * x3) * x139;
	const FLT x230 = (-1 * x229 * x145) + (-1 * x226 * x141) + (x229 * x142) + (x3 * x9 * x143) + (-1 * x9 * x227) + (x3 * x142 * x147) + (-1 * x6 * x227) + (x3 * x228);
	...
	const FLT x240 = x239 + x203 + (-1 * x236 * x175) + (-1 * x235 * x187) + (x235 * x190) + (-1 * x230 * x207) + (x233 * x161) + (-1 * x232 * x184) + x196 + (-1 * x234 * x205);
	const FLT x241 = (x238 * x201) + (-1 * x238 * x202);
	const FLT x242 = x241 + (x235 * x183) + (-1 * x174) + x170 + x137 + (-1 * x217 * x230) + (-1 * x215 * x231) + (-1 * x235 * x186) + (x216 * x231) + (-1 * x233 * x184) + (-1 * x213 * x234);
	const FLT x243 = x238 * x187;
	const FLT x244 = x238 * x190;
	const FLT x245 = -1 * x214;
	const FLT x246 = x218 + (-1 * x234 * x180) + (-1 * x230 * x164) + x245 + (-1 * x235 * x166) + (x11 * x173) + (-1 * x244) + (x231 * x185) + x243 + (x233 * x175) + (x236 * x161);
	const FLT x247 = x238 * x183;
	const FLT x248 = x238 * x186;
	const FLT x249 = (-1 * x247) + (-1 * x206) + (x235 * x201) + (x236 * x184) + x248 + (-1 * x231 * x194) + (-1 * x235 * x202) + (-1 * x230 * x199) + (-1 * x232 * x175) + x208 + x209 + (-1 * x234 * x171);
	const FLT x250 = (x249 * (*_x0).Pose.Rot[2]) + (x240 * (*_x0).Pose.Rot[1]) + (x246 * (*_x0).Pose.Rot[0]) + (x242 * (*_x0).Pose.Rot[3]);
	const FLT x251 = (-1 * x246 * (*_x0).Pose.Rot[2]) + (-1 * x240 * (*_x0).Pose.Rot[3]) + (x242 * (*_x0).Pose.Rot[1]) + (x249 * (*_x0).Pose.Rot[0]);
	const FLT x252 = (-1 * x242 * (*_x0).Pose.Rot[2]) + (-1 * x246 * (*_x0).Pose.Rot[1]) + (x249 * (*_x0).Pose.Rot[3]) + (x240 * (*_x0).Pose.Rot[0]);
	const FLT x253 = (x242 * (*_x0).Pose.Rot[0]) + (-1 * x249 * (*_x0).Pose.Rot[1]) + (x240 * (*_x0).Pose.Rot[2]) + (-1 * x246 * (*_x0).Pose.Rot[3]);
	const FLT x254 = -1 * x91 * x251;
	const FLT x255 = x5 * x141;
	const FLT x256 = x255 * x140;
	const FLT x257 = x5 * x5 * x5;
	const FLT x258 = x5 * x146;
	const FLT x259 = (-1 * x11 * x258) + (x256 * x152) + (x5 * x228) + (-1 * x255 * x154) + (x9 * x256 * x139) + (x257 * x143) + (-1 * x9 * x258) + (-1 * x257 * x146);
	...
	const FLT x266 = x239 + (-1 * x264 * x180) + (-1 * x263 * x190) + (x263 * x187) + (x265 * x184) + (x261 * x175) + (-1 * x259 * x164) + x193 + x197 + (x262 * x161) + (-1 * x195);
	const FLT x267 = x60 * x260;
	const FLT x268 = x191 + (-1 * x5 * x200) + x241 + (-1 * x267 * x175) + (x262 * x184) + (-1 * x263 * x183) + x136 + (-1 * x259 * x199) + (x263 * x186) + (-1 * x265 * x161);
	const FLT x269 = (-1 * x263 * x166) + x244 + (-1 * x243) + x219 + (-1 * x207 * x259) + (-1 * x205 * x264) + (-1 * x267 * x184) + (x261 * x161) + (-1 * x262 * x175) + x245 + (x263 * x172);
	const FLT x270 = x211 + (-1 * x267 * x161) + (-1 * x213 * x264) + (x201 * x263) + x209 + (-1 * x202 * x263) + x247 + (-1 * x262 * x162) + (x265 * x175) + (-1 * x248) + (-1 * x261 * x184) + (-1 * x210);
	const FLT x271 = (-1 * x270 * (*_x0).Pose.Rot[2]) + (-1 * x266 * (*_x0).Pose.Rot[1]) + (x269 * (*_x0).Pose.Rot[0]) + (x268 * (*_x0).Pose.Rot[3]);
	const FLT x272 = (x270 * (*_x0).Pose.Rot[3]) + (x266 * (*_x0).Pose.Rot[0]) + (x268 * (*_x0).Pose.Rot[2]) + (x269 * (*_x0).Pose.Rot[1]);
	const FLT x273 = (-1 * x266 * (*_x0).Pose.Rot[2]) + (-1 * x269 * (*_x0).Pose.Rot[3]) + (x270 * (*_x0).Pose.Rot[1]) + (x268 * (*_x0).Pose.Rot[0]);
	const FLT x274 = (x269 * (*_x0).Pose.Rot[2]) + (x270 * (*_x0).Pose.Rot[0]) + (-1 * x268 * (*_x0).Pose.Rot[1]) + (-1 * x266 * (*_x0).Pose.Rot[3]);
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x97 * ((-1 * x96 * ((-1 * x83 * x93) + x92)) + (((x84 * x85) + (x86 * x87) + (x81 * x65) + (x82 * x83)) * x90)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), x97 * ((-1 * x96 * ((-1 * x93 * x109) + x113)) + (((x85 * x111) + (x86 * x112) + (x82 * x109) + (x81 * x110)) * x90)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), x97 * ((-1 * x96 * ((-1 * x93 * x122) + x126)) + (((x86 * x125) + (x82 * x122) + (x85 * x124) + (x81 * x123)) * x90)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x97 * ((-1 * x96 * ((-1 * x93 * x131) + x135)) + (((x86 * x134) + (x82 * x131) + (x81 * x133) + (x85 * x132)) * x90)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x97 * ((-1 * x96 * ((-1 * x93 * x221) + x225)) + (((x86 * x224) + (x85 * x223) + (x82 * x221) + (x81 * x222)) * x90)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x97 * ((-1 * x96 * ((-1 * x93 * x252) + x254)) + (((x82 * x252) + (x86 * x253) + (x81 * x250) + (x85 * x251)) * x90)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x97 * ((-1 * x96 * ((-1 * x93 * x271) + x275)) + (((x86 * x274) + (x85 * x273) + (x82 * x271) + (x81 * x272)) * x90)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), ((-1 * x83 * x85) + (x82 * x84) + (-1 * x81 * x87) + (x86 * x65)) * x276);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), ((-1 * x85 * x109) + (x82 * x111) + (x86 * x110) + (-1 * x81 * x112)) * x276);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), ((-1 * x81 * x125) + (x82 * x124) + (-1 * x85 * x122) + (x86 * x123)) * x276);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), ((-1 * x85 * x131) + (-1 * x81 * x134) + (x86 * x133) + (x82 * x132)) * x276);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[0])/sizeof(FLT), ((-1 * x81 * x224) + (-1 * x85 * x221) + (x82 * x223) + (x86 * x222)) * x276);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[1])/sizeof(FLT), ((-1 * x85 * x252) + (-1 * x81 * x253) + (x82 * x251) + (x86 * x250)) * x276);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[2])/sizeof(FLT), ((-1 * x85 * x271) + (x86 * x272) + (-1 * x81 * x274) + (x82 * x273)) * x276);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x283 * ((-1 * x282 * (x92 + (-1 * x87 * x279))) + (((x83 * x86) + (x81 * x84) + (x82 * x87) + (x85 * x65)) * x278)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), x283 * ((-1 * x282 * (x113 + (-1 * x279 * x112))) + (((x86 * x109) + (x81 * x111) + (x82 * x112) + (x85 * x110)) * x278)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), x283 * ((-1 * x282 * (x126 + (-1 * x279 * x125))) + (((x86 * x122) + (x82 * x125) + (x81 * x124) + (x85 * x123)) * x278)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x283 * ((-1 * x282 * (x135 + (-1 * x279 * x134))) + (((x86 * x131) + (x85 * x133) + (x82 * x134) + (x81 * x132)) * x278)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x283 * ((-1 * x282 * (x225 + (-1 * x279 * x224))) + (((x86 * x221) + (x81 * x223) + (x82 * x224) + (x85 * x222)) * x278)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x283 * ((-1 * x282 * (x254 + (-1 * x279 * x253))) + (((x86 * x252) + (x85 * x250) + (x81 * x251) + (x82 * x253)) * x278)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x283 * ((-1 * x282 * (x275 + (-1 * x279 * x274))) + (((x86 * x271) + (x82 * x274) + (x85 * x272) + (x81 * x273)) * x278)));
...
// Full version Jacobian of SurviveKalmanModelErrorPredict wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec94c0>]
// Jacobian of SurviveKalmanModelErrorPredict wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ed1250>]
static inline void SurviveKalmanModelErrorPredict_jac_error_model(CnMat* Hx, const FLT t, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model) {
	...
	const FLT x6 = (x5 * (*error_model).Pose.AxisAngleRot[0]) + (*_x0).Pose.Rot[1] + (-1 * x3 * (*error_model).Pose.AxisAngleRot[1]) + (x4 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x7 = t * t;
	const FLT x8 = x2 * x2;
	const FLT x9 = x8 * x7;
	...
	const FLT x32 = (*_x0).Pose.Rot[0] + (-1 * x31 * (*error_model).Pose.AxisAngleRot[0]) + (-1 * x4 * (*error_model).Pose.AxisAngleRot[1]) + (-1 * x3 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x33 = x32 * x29;
	const FLT x34 = 0.5 * (*error_model).Pose.AxisAngleRot[2];
	const FLT x35 = (-1 * x34 * (*_x0).Pose.Rot[1]) + (x5 * (*error_model).Pose.AxisAngleRot[1]) + (x3 * (*error_model).Pose.AxisAngleRot[0]) + (*_x0).Pose.Rot[2];
	const FLT x36 = x25 * x23;
	const FLT x37 = x36 * x35;
	const FLT x38 = (x31 * (*error_model).Pose.AxisAngleRot[1]) + (*_x0).Pose.Rot[3] + (-1 * x4 * (*error_model).Pose.AxisAngleRot[0]) + (x34 * (*_x0).Pose.Rot[0]);
	const FLT x39 = x38 * x29;
	...
	const FLT x49 = (-1 * x48 * (*_x0).Pose.Rot[1]) + (x46 * (*_x0).Pose.Rot[0]) + (x40 * (*_x0).Pose.Rot[3]) + (-1 * x44 * (*_x0).Pose.Rot[2]);
	...
	const FLT x74 = (x46 * (*_x0).Pose.Rot[1]) + (x44 * (*_x0).Pose.Rot[3]) + (x48 * (*_x0).Pose.Rot[0]) + (x40 * (*_x0).Pose.Rot[2]);
	...
	const FLT x79 = (-1 * x40 * (*_x0).Pose.Rot[1]) + (x46 * (*_x0).Pose.Rot[2]) + (-1 * x48 * (*_x0).Pose.Rot[3]) + (x44 * (*_x0).Pose.Rot[0]);
	...
	const FLT x84 = (x44 * (*_x0).Pose.Rot[1]) + (x40 * (*_x0).Pose.Rot[0]) + (-1 * x46 * (*_x0).Pose.Rot[3]) + (-1 * x48 * (*_x0).Pose.Rot[2]);
	...
	const FLT x130 = (-1 * x119 * x129) + (-1 * x10 * x128) + (-1 * x116 * x123) + (x10 * x124) + (-1 * x123 * x127) + (x126 * x125) + (x116 * x121) + (x121 * x127);
	...
	const FLT x164 = x163 + (-1 * x45 * x157) + (-1 * x129 * x152) + (x153 * x154) + x147 + x136 + (-1 * x32 * x139) + (x155 * x156) + (x149 * x150) + (x2 * x135) + (-1 * x144);
	...
	const FLT x172 = (x10 * x135) + (x154 * x158) + (-1 * x129 * x169) + x171 + (-1 * x166) + (-1 * x35 * x139) + x165 + (-1 * x41 * x157) + (-1 * x167 * x155) + (-1 * x32 * x130 * x149) + x168;
	...
	const FLT x183 = x174 + (-1 * x175 * x130) + (-1 * x176) + (x167 * x150) + (-1 * x151 * x154) + (x47 * x157) + x33 + (-1 * x129 * x173) + (-1 * x13 * x135) + (-1 * x10 * x180) + x178 + (-1 * x182);
	const FLT x184 = 0.5 * x158;
	const FLT x185 = (x47 * x162) + (-1 * x160 * x151);
	const FLT x186 = (-1 * x45 * x170) + (x146 * x153);
	const FLT x187 = x185 + (x11 * x142) + (-1 * x150 * x156) + (-1 * x133 * x137) + (-1 * x129 * x184) + x43 + (x149 * x155) + x186 + (-1 * x42 * x154) + (-1 * x2 * x180);
	const FLT x188 = (-1 * x187 * (*_x0).Pose.Rot[2]) + (-1 * x164 * (*_x0).Pose.Rot[1]) + (x183 * (*_x0).Pose.Rot[0]) + (x172 * (*_x0).Pose.Rot[3]);
	const FLT x189 = (x172 * (*_x0).Pose.Rot[2]) + (x187 * (*_x0).Pose.Rot[3]) + (x183 * (*_x0).Pose.Rot[1]) + (x164 * (*_x0).Pose.Rot[0]);
	const FLT x190 = (-1 * x183 * (*_x0).Pose.Rot[3]) + (-1 * x164 * (*_x0).Pose.Rot[2]) + (x187 * (*_x0).Pose.Rot[1]) + (x172 * (*_x0).Pose.Rot[0]);
	const FLT x191 = (x187 * (*_x0).Pose.Rot[0]) + (-1 * x172 * (*_x0).Pose.Rot[1]) + (-1 * x164 * (*_x0).Pose.Rot[3]) + (x183 * (*_x0).Pose.Rot[2]);
	...
	const FLT x198 = (x121 * x197) + (-1 * x123 * x197) + (-1 * x123 * x193) + (-1 * x119 * x195) + (x13 * x124) + (x121 * x193) + (-1 * x13 * x128) + (x13 * x196);
	...
	const FLT x205 = (-1 * x13 * x203 * x198) + (-1 * x175 * x198) + (-1 * x173 * x195) + x204 + (-1 * x179 * x199) + (-1 * x202 * x158) + (x41 * x201) + (x200 * x198) + x171 + x39;
	...
	const FLT x213 = (-1 * x45 * x201) + x212 + x144 + (x209 * x149) + (x202 * x153) + (-1 * x207 * x198) + x136 + (-1 * x208 * x179) + (-1 * x147) + (-1 * x206 * x199) + (-1 * x184 * x195);
	const FLT x214 = -1 * x43;
	const FLT x215 = x211 * x158;
	const FLT x216 = x198 * x149;
	const FLT x217 = x41 * x210;
	const FLT x218 = x198 * x138;
	const FLT x219 = (-1 * x195 * x152) + (-1 * x32 * x218) + (-1 * x14 * x142) + (-1 * x217) + (x209 * x156) + x215 + x214 + (x203 * x208) + (x42 * x202) + x186 + (x35 * x216);
	const FLT x220 = x211 * x153;
	const FLT x221 = x45 * x210;
	const FLT x222 = (-1 * x174) + (-1 * x202 * x151) + (x47 * x201) + (-1 * x35 * x218) + (x203 * x199) + (-1 * x32 * x216) + (-1 * x220) + x176 + (-1 * x209 * x167) + x221 + x33 + (-1 * x169 * x195);
	const FLT x223 = (x222 * (*_x0).Pose.Rot[2]) + (x219 * (*_x0).Pose.Rot[0]) + (x205 * (*_x0).Pose.Rot[1]) + (x213 * (*_x0).Pose.Rot[3]);
	const FLT x224 = (-1 * x205 * (*_x0).Pose.Rot[3]) + (-1 * x219 * (*_x0).Pose.Rot[2]) + (x213 * (*_x0).Pose.Rot[1]) + (x222 * (*_x0).Pose.Rot[0]);
	const FLT x225 = (-1 * x213 * (*_x0).Pose.Rot[2]) + (-1 * x219 * (*_x0).Pose.Rot[1]) + (x222 * (*_x0).Pose.Rot[3]) + (x205 * (*_x0).Pose.Rot[0]);
	const FLT x226 = (x205 * (*_x0).Pose.Rot[2]) + (-1 * x222 * (*_x0).Pose.Rot[1]) + (x213 * (*_x0).Pose.Rot[0]) + (-1 * x219 * (*_x0).Pose.Rot[3]);
	const FLT x227 = -1 * x92 * x224;
	const FLT x228 = x2 * x121;
	const FLT x229 = x2 * x194;
	const FLT x230 = (x2 * x2 * x2) * x117;
	const FLT x231 = x2 * x123;
	const FLT x232 = (-1 * x14 * x231) + (x2 * x196) + (x14 * x228) + (x11 * x228) + (x230 * x120) + (-1 * x11 * x231) + (-1 * x229 * x119) + (-1 * x230 * x122);
	...
	const FLT x239 = x204 + (-1 * x41 * x237) + (-1 * x32 * x236) + (x35 * x233) + (-1 * x229 * x152) + x165 + (x2 * x234) + (x235 * x158) + x166 + (x6 * x238 * x148) + (-1 * x168);
	const FLT x240 = x32 * x232;
	const FLT x241 = x163 + (-1 * x229 * x169) + (x45 * x237) + x30 + x212 + (x238 * x203) + (-1 * x235 * x153) + (-1 * x35 * x236) + (-1 * x240 * x149) + (-1 * x6 * x232 * x167);
	const FLT x242 = x185 + (-1 * x229 * x173) + x217 + (-1 * x238 * x179) + x214 + (-1 * x13 * x234) + (x232 * x200) + (-1 * x8 * x142) + (-1 * x215) + (-1 * x232 * x175) + (x42 * x235);
	const FLT x243 = (-1 * x229 * x184) + x182 + (-1 * x178) + x33 + (-1 * x240 * x167) + x220 + (-1 * x232 * x207) + (-1 * x235 * x151) + (x6 * x233) + (x47 * x237) + (-1 * x238 * x206) + (-1 * x221);
	const FLT x244 = (x242 * (*_x0).Pose.Rot[0]) + (-1 * x243 * (*_x0).Pose.Rot[2]) + (-1 * x239 * (*_x0).Pose.Rot[1]) + (x241 * (*_x0).Pose.Rot[3]);
	const FLT x245 = (x241 * (*_x0).Pose.Rot[2]) + (x239 * (*_x0).Pose.Rot[0]) + (x243 * (*_x0).Pose.Rot[3]) + (x242 * (*_x0).Pose.Rot[1]);
	const FLT x246 = (-1 * x239 * (*_x0).Pose.Rot[2]) + (-1 * x242 * (*_x0).Pose.Rot[3]) + (x243 * (*_x0).Pose.Rot[1]) + (x241 * (*_x0).Pose.Rot[0]);
	const FLT x247 = (x243 * (*_x0).Pose.Rot[0]) + (x242 * (*_x0).Pose.Rot[2]) + (-1 * x241 * (*_x0).Pose.Rot[1]) + (-1 * x239 * (*_x0).Pose.Rot[3]);
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x98 * ((-1 * x97 * ((-1 * x78 * x94) + x93)) + (((x88 * x84) + (x83 * x79) + (x73 * x49) + (x78 * x74)) * x91)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x98 * ((-1 * x97 * ((-1 * x94 * x102) + x109)) + (((x79 * x106) + (x74 * x102) + (x84 * x108) + (x49 * x104)) * x91)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x98 * ((-1 * x97 * ((-1 * x94 * x113) + x115)) + (((x84 * x114) + (x74 * x113) + (x49 * x111) + (x79 * x112)) * x91)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x98 * ((-1 * x97 * ((-1 * x94 * x188) + x192)) + (((x79 * x190) + (x74 * x188) + (x84 * x191) + (x49 * x189)) * x91)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x98 * ((-1 * x97 * ((-1 * x94 * x225) + x227)) + (((x74 * x225) + (x84 * x226) + (x49 * x223) + (x79 * x224)) * x91)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x98 * ((-1 * x97 * ((-1 * x94 * x244) + x248)) + (((x79 * x246) + (x84 * x247) + (x74 * x244) + (x49 * x245)) * x91)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), ((-1 * x88 * x49) + (x84 * x73) + (-1 * x79 * x78) + (x83 * x74)) * x249);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), ((-1 * x79 * x102) + (-1 * x49 * x108) + (x74 * x106) + (x84 * x104)) * x249);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), ((-1 * x79 * x113) + (-1 * x49 * x114) + (x84 * x111) + (x74 * x112)) * x249);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[0])/sizeof(FLT), ((-1 * x79 * x188) + (x74 * x190) + (-1 * x49 * x191) + (x84 * x189)) * x249);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[1])/sizeof(FLT), ((-1 * x79 * x225) + (-1 * x49 * x226) + (x74 * x224) + (x84 * x223)) * x249);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[2])/sizeof(FLT), ((x84 * x245) + (-1 * x79 * x244) + (-1 * x49 * x247) + (x74 * x246)) * x249);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x256 * ((-1 * x255 * (x93 + (-1 * x88 * x252))) + (((x88 * x74) + (x84 * x78) + (x73 * x79) + (x83 * x49)) * x251)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x256 * ((-1 * x255 * (x109 + (-1 * x252 * x108))) + (((x49 * x106) + (x79 * x104) + (x84 * x102) + (x74 * x108)) * x251)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x256 * ((-1 * x255 * (x115 + (-1 * x252 * x114))) + (((x49 * x112) + (x84 * x113) + (x74 * x114) + (x79 * x111)) * x251)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x256 * ((-1 * x255 * (x192 + (-1 * x252 * x191))) + (((x49 * x190) + (x84 * x188) + (x74 * x191) + (x79 * x189)) * x251)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x256 * ((-1 * x255 * (x227 + (-1 * x252 * x226))) + (((x84 * x225) + (x49 * x224) + (x79 * x223) + (x74 * x226)) * x251)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x256 * ((-1 * x255 * (x248 + (-1 * x252 * x247))) + (((x84 * x244) + (x74 * x247) + (x79 * x245) + (x49 * x246)) * x251)));
...
// Full version Jacobian of SurviveKalmanModelErrorPredict wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ed1250>]
...
// Jacobian of SurviveObsErrorModelNoFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec5790>]
...
// Full version Jacobian of SurviveObsErrorModelNoFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec5790>]
...
// Jacobian of SurviveObsErrorModelFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ed8310>]
...
// Full version Jacobian of SurviveObsErrorModelFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ed8310>]
...
static inline void SurviveObsErrorStateErrorModelNoFlip(SurviveAxisAnglePose* out, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* err, const SurviveAxisAnglePose* Z) {
	...
	const FLT x3 = (*_x0).Pose.Rot[1] + (x2 * (*_x0).Pose.Rot[0]) + (-1 * x0 * (*err).Pose.AxisAngleRot[1]) + (x1 * (*_x0).Pose.Rot[2]);
	const FLT x4 = 0.5 * (*err).Pose.AxisAngleRot[1];
	const FLT x5 = (x4 * (*_x0).Pose.Rot[1]) + (-1 * x2 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[3] + (x1 * (*_x0).Pose.Rot[0]);
	const FLT x6 = (-1 * x1 * (*_x0).Pose.Rot[1]) + (x4 * (*_x0).Pose.Rot[0]) + (x0 * (*err).Pose.AxisAngleRot[0]) + (*_x0).Pose.Rot[2];
	const FLT x7 = sqrt(1e-10 + (x6 * x6) + (x5 * x5) + (x3 * x3));
	const FLT x8 = 2 * (1. / x7) * atan2(x7, (-1 * x0 * (*err).Pose.AxisAngleRot[2]) + (-1 * x2 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[0] + (-1 * x4 * (*_x0).Pose.Rot[2]));
...
// Jacobian of SurviveObsErrorStateErrorModelNoFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ea9400>]
static inline void SurviveObsErrorStateErrorModelNoFlip_jac_x0(CnMat* Hx, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* err, const SurviveAxisAnglePose* Z) {
	...
	const FLT x2 = 0.5 * (*err).Pose.AxisAngleRot[0];
	const FLT x3 = (*_x0).Pose.Rot[1] + (x2 * (*_x0).Pose.Rot[0]) + (-1 * x0 * (*_x0).Pose.Rot[3]) + (x1 * (*err).Pose.AxisAngleRot[2]);
	const FLT x4 = 2 * x3;
	const FLT x5 = 0.5 * (*err).Pose.AxisAngleRot[2];
	const FLT x6 = (-1 * x5 * (*_x0).Pose.Rot[1]) + (x0 * (*_x0).Pose.Rot[0]) + (x2 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x7 = 1.0 * (*err).Pose.AxisAngleRot[1];
	const FLT x8 = (x0 * (*_x0).Pose.Rot[1]) + (-1 * x1 * (*err).Pose.AxisAngleRot[0]) + (*_x0).Pose.Rot[3] + (x5 * (*_x0).Pose.Rot[0]);
	const FLT x9 = 1.0 * x8;
	...
	const FLT x14 = 1. / x13;
	const FLT x15 = (-1 * x2 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[0] + (-1 * x5 * (*_x0).Pose.Rot[3]) + (-1 * x1 * (*err).Pose.AxisAngleRot[1]);
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, Pos[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Pos[1])/sizeof(FLT), 1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, Pos[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Pos[2])/sizeof(FLT), 1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x26 + (x4 * x20) + (-1 * x23 * x11));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), (-1 * x23 * x29) + x27 + (x4 * x30));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), (x4 * x33) + x35 + (-1 * x3 * x34));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), (-1 * x39) + (x4 * x38) + (-1 * x37 * x23));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x39 + (x31 * x20) + (-1 * x40 * x11));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), (-1 * x35) + (x30 * x31) + (-1 * x40 * x29));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), x27 + (x31 * x33) + (-1 * x6 * x34));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x26 + (x31 * x38) + (-1 * x40 * x37));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x35 + (-1 * x41 * x11) + (x36 * x20));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), x39 + (-1 * x41 * x29) + (x30 * x36));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), (-1 * x26) + (x33 * x36) + (-1 * x8 * x34));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x27 + (x36 * x38) + (-1 * x41 * x37));
}

// Full version Jacobian of SurviveObsErrorStateErrorModelNoFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ea9400>]
// Jacobian of SurviveObsErrorStateErrorModelNoFlip wrt [(*err).AccBias[0], (*err).AccBias[1], (*err).AccBias[2], (*err).Acc[0], (*err).Acc[1], (*err).Acc[2], (*err).GyroBias[0], (*err).GyroBias[1], (*err).GyroBias[2], (*err).IMUCorrection[0], (*err).IMUCorrection[1], (*err).IMUCorrection[2], (*err).IMUCorrection[3], (*err).Pose.AxisAngleRot[0], (*err).Pose.AxisAngleRot[1], (*err).Pose.AxisAngleRot[2], (*err).Pose.Pos[0], (*err).Pose.Pos[1], (*err).Pose.Pos[2], (*err).Velocity.AxisAngleRot[0], (*err).Velocity.AxisAngleRot[1], (*err).Velocity.AxisAngleRot[2], (*err).Velocity.Pos[0], (*err).Velocity.Pos[1], (*err).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec9220>]
static inline void SurviveObsErrorStateErrorModelNoFlip_jac_err(CnMat* Hx, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* err, const SurviveAxisAnglePose* Z) {
	...
	const FLT x3 = (-1 * x1 * (*err).Pose.AxisAngleRot[0]) + (x2 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (x0 * (*_x0).Pose.Rot[0]);
	const FLT x4 = 1.0 * x3;
	const FLT x5 = 0.5 * (*err).Pose.AxisAngleRot[0];
	const FLT x6 = (-1 * x0 * (*_x0).Pose.Rot[1]) + (x5 * (*_x0).Pose.Rot[3]) + (x2 * (*_x0).Pose.Rot[0]) + (*_x0).Pose.Rot[2];
	const FLT x7 = 1.0 * x6;
	const FLT x8 = (*_x0).Pose.Rot[1] + (x5 * (*_x0).Pose.Rot[0]) + (-1 * x2 * (*_x0).Pose.Rot[3]) + (x1 * (*err).Pose.AxisAngleRot[2]);
	const FLT x9 = 1.0 * x8;
	...
	const FLT x13 = 1. / x12;
	const FLT x14 = (*_x0).Pose.Rot[0] + (-1 * x0 * (*_x0).Pose.Rot[3]) + (-1 * x5 * (*_x0).Pose.Rot[1]) + (-1 * x1 * (*err).Pose.AxisAngleRot[1]);
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x26 + (x21 * x19) + (-1 * x8 * x24));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), (-1 * x30) + (x21 * x28) + (-1 * x8 * x29));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x34 + (x32 * x21) + (-1 * x8 * x33));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), (-1 * x6 * x24) + x30 + (x35 * x19));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x26 + (x35 * x28) + (-1 * x6 * x29));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), (-1 * x36) + (x32 * x35) + (-1 * x6 * x33));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), (-1 * x34) + (-1 * x3 * x24) + (x37 * x19));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x36 + (x37 * x28) + (-1 * x3 * x29));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), (x32 * x37) + x26 + (-1 * x3 * x33));
}
...
static inline void SurviveObsErrorStateErrorModelFlip(SurviveAxisAnglePose* out, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* err, const SurviveAxisAnglePose* Z) {
	...
	const FLT x5 = (*_x0).Pose.Rot[3] + (x0 * (*_x0).Pose.Rot[1]) + (-1 * x1 * (*err).Pose.AxisAngleRot[0]) + (x4 * (*_x0).Pose.Rot[0]);
	const FLT x6 = (-1 * x4 * (*_x0).Pose.Rot[1]) + (x0 * (*_x0).Pose.Rot[0]) + (x2 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x7 = sqrt(1e-10 + (x6 * x6) + (x5 * x5) + (x3 * x3));
	const FLT x8 = 2 * (1. / x7) * atan2(x7, (-1 * x2 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[0] + (-1 * x4 * (*_x0).Pose.Rot[3]) + (-1 * x1 * (*err).Pose.AxisAngleRot[1]));
...
// Jacobian of SurviveObsErrorStateErrorModelFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0eba640>]
static inline void SurviveObsErrorStateErrorModelFlip_jac_x0(CnMat* Hx, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* err, const SurviveAxisAnglePose* Z) {
	...
	const FLT x4 = 1.0 * x3;
	const FLT x5 = (x1 * (*_x0).Pose.Rot[1]) + (-1 * x0 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[3] + (x2 * (*_x0).Pose.Rot[0]);
	const FLT x6 = 1.0 * (*err).Pose.AxisAngleRot[2];
	const FLT x7 = (*_x0).Pose.Rot[1] + (x0 * (*_x0).Pose.Rot[0]) + (-1 * x1 * (*_x0).Pose.Rot[3]) + (x2 * (*_x0).Pose.Rot[2]);
	const FLT x8 = 1.0 * x7;
	...
	const FLT x12 = 1. / x11;
	const FLT x13 = (-1 * x0 * (*_x0).Pose.Rot[1]) + (-1 * x2 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[0] + (-1 * x1 * (*_x0).Pose.Rot[2]);
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, Pos[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Pos[1])/sizeof(FLT), 1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, Pos[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Pos[2])/sizeof(FLT), 1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), (-1 * x52 * x30) + (x36 * x27) + (x50 * x30));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), (x57 * x36) + (-1 * x62 * x30) + (x61 * x30));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), (-1 * x70 * x30) + (x65 * x36) + (x69 * x30));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), (-1 * x78 * x30) + (x73 * x36) + (x77 * x30));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), (-1 * x52 * x32) + (x40 * x36) + (x50 * x32));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), (-1 * x62 * x32) + (x58 * x36) + (x61 * x32));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), (-1 * x70 * x32) + (x66 * x36) + (x69 * x32));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), (x74 * x36) + (-1 * x78 * x32) + (x77 * x32));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), (-1 * x79 * x48) + (x45 * x36) + (x50 * x29));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), (-1 * x79 * x60) + (x59 * x36) + (x61 * x29));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), (x67 * x36) + (-1 * x79 * x68) + (x69 * x29));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), (-1 * x79 * x76) + (x77 * x29) + (x75 * x36));
}

// Full version Jacobian of SurviveObsErrorStateErrorModelFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0eba640>]
// Jacobian of SurviveObsErrorStateErrorModelFlip wrt [(*err).AccBias[0], (*err).AccBias[1], (*err).AccBias[2], (*err).Acc[0], (*err).Acc[1], (*err).Acc[2], (*err).GyroBias[0], (*err).GyroBias[1], (*err).GyroBias[2], (*err).IMUCorrection[0], (*err).IMUCorrection[1], (*err).IMUCorrection[2], (*err).IMUCorrection[3], (*err).Pose.AxisAngleRot[0], (*err).Pose.AxisAngleRot[1], (*err).Pose.AxisAngleRot[2], (*err).Pose.Pos[0], (*err).Pose.Pos[1], (*err).Pose.Pos[2], (*err).Velocity.AxisAngleRot[0], (*err).Velocity.AxisAngleRot[1], (*err).Velocity.AxisAngleRot[2], (*err).Velocity.Pos[0], (*err).Velocity.Pos[1], (*err).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec5670>]
static inline void SurviveObsErrorStateErrorModelFlip_jac_err(CnMat* Hx, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* err, const SurviveAxisAnglePose* Z) {
	...
	const FLT x10 = (-1 * x2 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[0] + (-1 * x1 * (*_x0).Pose.Rot[3]) + (-1 * x0 * (*_x0).Pose.Rot[2]);
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, Pos[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.Pos[1])/sizeof(FLT), 1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, Pos[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.Pos[2])/sizeof(FLT), 1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), (-1 * x45 * x28) + (x33 * x25) + (x41 * x43));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), (-1 * x54 * x28) + (x49 * x33) + (x53 * x43));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), (-1 * x63 * x28) + (x58 * x33) + (x62 * x28));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), (-1 * x45 * x29) + (x64 * x41) + (x33 * x35));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), (x50 * x33) + (-1 * x54 * x29) + (x64 * x53));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), (x59 * x33) + (-1 * x63 * x29) + (x62 * x29));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), (-1 * x45 * x27) + (x33 * x38) + (x65 * x41));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), (-1 * x54 * x27) + (x52 * x33) + (x65 * x53));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), (-1 * x63 * x27) + (x60 * x33) + (x62 * x27));
}
...
static inline void SurviveObsErrorStateErrorModelFlip_jac_Z(CnMat* Hx, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* err, const SurviveAxisAnglePose* Z) {
	...
	const FLT x4 = (*_x0).Pose.Rot[1] + (x1 * (*_x0).Pose.Rot[0]) + (-1 * x2 * (*_x0).Pose.Rot[3]) + (x0 * (*_x0).Pose.Rot[2]);
	...
	const FLT x7 = 2 * (1. / x6) * atan2(x6, (-1 * x1 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[0] + (-1 * x0 * (*_x0).Pose.Rot[3]) + (-1 * x2 * (*_x0).Pose.Rot[2]));
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, Pos[1])/sizeof(FLT), offsetof(SurviveAxisAnglePose, Pos[1])/sizeof(FLT), -1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, Pos[2])/sizeof(FLT), offsetof(SurviveAxisAnglePose, Pos[2])/sizeof(FLT), -1);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), (x11 * x19) + x17 + (-1 * x11 * x18));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), x21);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), x24);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), x21);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), (x13 * x19) + x17 + (-1 * x13 * x18));
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), x25);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveAxisAnglePose, AxisAngleRot[0])/sizeof(FLT), x24);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveAxisAnglePose, AxisAngleRot[1])/sizeof(FLT), x25);
	cnMatrixOptionalSet(Hx, offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveAxisAnglePose, AxisAngleRot[2])/sizeof(FLT), (x9 * x19) + x17 + (-1 * x9 * x18));
}
...
// Jacobian of SurviveKalmanModel_LightMeas_x_gen1 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec5670>]
...
// Jacobian of SurviveKalmanModel_LightMeas_x_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0eba580>, <cnkalman.codegen.WrapMember object at 0x7f2ed0eba130>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ebad00>, <cnkalman.codegen.WrapMember object at 0x7f2ed0eba5b0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0eba0d0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec0f10>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f4ed60>]
...
// Jacobian of SurviveKalmanModel_LightMeas_y_gen1 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ede5b0>]
...
// Full version Jacobian of SurviveKalmanModel_LightMeas_y_gen1 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ede5b0>]
...
// Jacobian of SurviveKalmanModel_LightMeas_y_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0ede160>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ede490>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ede8e0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e60f10>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e60eb0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ede220>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ede1f0>]
...
// Full version Jacobian of SurviveKalmanModel_LightMeas_y_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0ede160>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ede490>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ede8e0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e60f10>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e60eb0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ede220>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ede1f0>]
...
// Jacobian of SurviveKalmanModel_LightMeas_x_gen2 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0e63820>]
...
// Full version Jacobian of SurviveKalmanModel_LightMeas_x_gen2 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0e63820>]
...
// Jacobian of SurviveKalmanModel_LightMeas_x_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0e649d0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e64a90>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e64a30>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e64b50>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e64af0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e647c0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e64970>]
...
// Full version Jacobian of SurviveKalmanModel_LightMeas_x_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0e649d0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e64a90>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e64a30>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e64b50>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e64af0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e647c0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e64970>]
...
// Jacobian of SurviveKalmanModel_LightMeas_y_gen2 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0e71460>]
...
// Jacobian of SurviveKalmanModel_LightMeas_y_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0e6d250>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e6d310>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e6d2b0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e6d3d0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e6d370>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e6d040>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e6d1f0>]
...
static inline FLT SurviveKalmanErrorModel_LightMeas_x_gen1(const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x4 = (-1 * x3 * (*_x0).Pose.Rot[1]) + (x2 * (*error_model).Pose.AxisAngleRot[1]) + (x1 * (*error_model).Pose.AxisAngleRot[0]) + (*_x0).Pose.Rot[2];
	const FLT x5 = dt * dt;
	...
	const FLT x22 = (x21 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x20 * (*_x0).Pose.Rot[2]) + (x2 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x23 = x22 * x18;
	const FLT x24 = (*_x0).Pose.Rot[1] + (x2 * (*error_model).Pose.AxisAngleRot[0]) + (-1 * x1 * (*error_model).Pose.AxisAngleRot[1]) + (x3 * (*_x0).Pose.Rot[2]);
	const FLT x25 = x17 * x16;
	const FLT x26 = (-1 * x20 * (*_x0).Pose.Rot[1]) + (-1 * x21 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x1 * (*error_model).Pose.AxisAngleRot[2]);
	...
	const FLT x36 = (*_x0).Pose.Pos[1] + (2 * ((x34 * x33) + (-1 * x32 * x28))) + (*error_model).Pose.Pos[1] + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + (x35 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	const FLT x37 = (x30 * sensor_pt[1]) + (-1 * x28 * sensor_pt[2]) + (x33 * sensor_pt[0]);
	const FLT x38 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (x35 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (2 * ((x37 * x28) + (-1 * x31 * x34))) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2])) + (*error_model).Pose.Pos[2];
	const FLT x39 = (x35 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (*error_model).Pose.Pos[0] + (2 * ((x32 * x31) + (-1 * x33 * x37))) + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (*_x0).Pose.Pos[0];
	...
	const FLT x47 = (-1 * (*bsc0).phase) + (-1 * asin((1. / sqrt((x46 * x46) + (x44 * x44))) * x42 * (*bsc0).tilt)) + (-1 * atan2(x46, x45));
	return x47 + ((atan2(x42, x45) * atan2(x42, x45)) * (*bsc0).curve) + (-1 * cos(1.5707963267949 + x47 + (*bsc0).gibpha) * (*bsc0).gibmag);
}

// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen1 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0e817c0>]
static inline void SurviveKalmanErrorModel_LightMeas_x_gen1_jac_x0(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x4 = (*_x0).Pose.Rot[1] + (x3 * (*_x0).Pose.Rot[0]) + (-1 * x1 * (*_x0).Pose.Rot[3]) + (x2 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x5 = dt * dt;
	...
	const FLT x30 = (-1 * x2 * (*error_model).Pose.AxisAngleRot[1]) + (*_x0).Pose.Rot[0] + (-1 * x3 * (*_x0).Pose.Rot[1]) + (-1 * x29 * (*_x0).Pose.Rot[3]);
	const FLT x31 = x24 * x27;
	const FLT x32 = x30 * x31;
	const FLT x33 = (x1 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x2 * (*error_model).Pose.AxisAngleRot[0]) + (x29 * (*_x0).Pose.Rot[0]);
	const FLT x34 = x23 * x21;
	const FLT x35 = x34 * x33;
	const FLT x36 = (x3 * (*_x0).Pose.Rot[3]) + (-1 * x29 * (*_x0).Pose.Rot[1]) + (x1 * (*_x0).Pose.Rot[0]) + (*_x0).Pose.Rot[2];
	...
	const FLT x51 = (*_x0).Pose.Pos[0] + (*error_model).Pose.Pos[0] + (2 * ((x47 * x48) + (-1 * x45 * x38))) + sensor_pt[0] + (x50 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0]));
	const FLT x52 = (-1 * x38 * sensor_pt[1]) + (x47 * sensor_pt[2]) + (x42 * sensor_pt[0]);
	const FLT x53 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (*error_model).Pose.Pos[2] + (2 * ((x44 * x45) + (-1 * x52 * x47))) + (x50 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2]));
	const FLT x54 = (*_x0).Pose.Pos[1] + (2 * ((x52 * x38) + (-1 * x44 * x48))) + (*error_model).Pose.Pos[1] + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + (x50 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	...
	const FLT x87 = (-1 * x79 * ((x85 * x86) + (-1 * ((x81 * x68) + (x80 * x63)) * x82))) + (-1 * ((x73 * x68) + (-1 * x63 * x58)) * x76);
	const FLT x88 = -1 * x57;
	const FLT x89 = (*bsc0).gibmag * sin(1.5707963267949 + (-1 * asin(x86 * x77)) + (-1 * (*bsc0).phase) + (*bsc0).gibpha + (-1 * atan2(x72, x88)));
	...
	const FLT x99 = (-1 * x79 * ((x86 * x98) + (-1 * ((x81 * x95) + (x80 * x92)) * x82))) + (-1 * ((x73 * x95) + (-1 * x58 * x92)) * x76);
	const FLT x100 = x65 + x67;
	const FLT x101 = x62 + x97;
	const FLT x102 = x93 + (-1 * x94);
	const FLT x103 = (-1 * x79 * ((x86 * x102) + (-1 * ((x81 * x101) + (x80 * x100)) * x82))) + (-1 * ((x73 * x101) + (-1 * x58 * x100)) * x76);
	...
	const FLT x118 = (-1 * x79 * ((x86 * x117) + (-1 * ((x81 * x113) + (x80 * x108)) * x82))) + (-1 * ((x73 * x113) + (-1 * x58 * x108)) * x76);
	...
	const FLT x126 = (-1 * x79 * ((x86 * x125) + (-1 * ((x81 * x122) + (x80 * x119)) * x82))) + (-1 * ((x73 * x122) + (-1 * x58 * x119)) * x76);
	const FLT x127 = x110 + x112;
	const FLT x128 = 1 + x124 + x105;
	const FLT x129 = x120 + (-1 * x121);
	const FLT x130 = (-1 * x79 * ((x86 * x129) + (-1 * ((x81 * x128) + (x80 * x127)) * x82))) + (-1 * ((x73 * x128) + (-1 * x58 * x127)) * x76);
	...
	const FLT x171 = (-1 * x79 * ((x86 * x170) + (-1 * ((x81 * x169) + (x80 * x167)) * x82))) + (-1 * ((x73 * x169) + (-1 * x58 * x167)) * x76);
	...
	const FLT x196 = (-1 * x79 * ((x86 * x195) + (-1 * ((x81 * x194) + (x80 * x191)) * x82))) + (-1 * ((x73 * x194) + (-1 * x58 * x191)) * x76);
	...
	const FLT x216 = (-1 * x79 * ((x86 * x215) + (-1 * ((x81 * x214) + (x80 * x212)) * x82))) + (-1 * ((x73 * x214) + (-1 * x58 * x212)) * x76);
	...
	const FLT x233 = (-1 * x79 * ((x86 * x232) + (-1 * ((x81 * x231) + (x80 * x229)) * x82))) + (-1 * ((x73 * x231) + (-1 * x58 * x229)) * x76);
	...
	const FLT x252 = (-1 * x251 * x245) + (x12 * x250) + (x245 * x246) + (x7 * x250) + (x239 * x244) + (-1 * x12 * x249) + (-1 * x239 * x248) + (-1 * x7 * x249);
	...
	const FLT x277 = x276 + (x271 * x270) + (-1 * x6 * x266) + x265 + (-1 * x35 * x238) + (-1 * x256 * x255) + x235 + (-1 * x269 * x245) + (-1 * x36 * x263) + (x255 * x257) + (-1 * x261);
	...
	const FLT x291 = (x40 * x238) + (-1 * x278 * x255) + x281 + (x283 * x252) + (-1 * x279 * x245) + (-1 * x9 * x290) + (-1 * x289) + x287 + (-1 * x274 * x270) + (-1 * x4 * x263) + (-1 * x285) + x32;
	...
	const FLT x298 = x297 + (x25 * x270) + (x6 * x33 * x255) + (-1 * x43 * x238) + (x9 * x266) + (-1 * x295) + (-1 * x30 * x263) + x293 + x292 + (-1 * x296 * x245) + (x294 * x252);
	...
	const FLT x304 = x302 + (-1 * x6 * x290) + x303 + (-1 * x270 * x267) + (-1 * x252 * x301) + x299 + (-1 * x245 * x300) + (x0 * x266) + (x46 * x238) + (-1 * x33 * x263);
	...
	const FLT x317 = (-1 * x79 * ((x86 * x316) + (-1 * ((x81 * x315) + (x80 * x313)) * x82))) + (-1 * ((x73 * x315) + (-1 * x58 * x313)) * x76);
	...
	const FLT x325 = (x0 * x324) + (x244 * x323) + (-1 * x0 * x320) + (x0 * x319) + (-1 * x248 * x323) + (-1 * x0 * x321) + (-1 * x248 * x322) + (x244 * x322);
	...
	const FLT x332 = (-1 * x327 * x329) + x276 + (-1 * x0 * x328) + (x283 * x325) + x331 + (-1 * x4 * x326) + x234 + (-1 * x271 * x318) + (-1 * x278 * x327) + (x12 * x286);
	const FLT x333 = x6 * x327;
	const FLT x334 = x264 * x330;
	const FLT x335 = x259 * x330;
	const FLT x336 = x0 * x5;
	const FLT x337 = (-1 * x4 * x333) + (-1 * x274 * x318) + (-1 * x256 * x327) + (-1 * x36 * x326) + (-1 * x269 * x336) + (-1 * x287) + (-1 * x335) + (x12 * x273) + (x257 * x327) + x32 + x334 + x285;
	const FLT x338 = x284 * x330;
	const FLT x339 = x286 * x330;
	const FLT x340 = -1 * x299;
	const FLT x341 = x4 * x327;
	const FLT x342 = x302 + (x9 * x341) + (-1 * x30 * x326) + (-1 * x296 * x336) + (x267 * x318) + x338 + (x33 * x333) + (-1 * x12 * x288) + (x294 * x325) + x340 + (-1 * x339);
	...
	const FLT x346 = (-1 * x293) + (-1 * x301 * x325) + (-1 * x0 * x344) + (-1 * x33 * x326) + (-1 * x12 * x264) + x295 + x345 + (-1 * x30 * x333) + x292 + (x0 * x341) + (x12 * x259);
	...
	const FLT x358 = (-1 * x79 * ((x86 * x357) + (-1 * ((x81 * x356) + (x80 * x354)) * x82))) + (-1 * ((x73 * x356) + (-1 * x58 * x354)) * x76);
	const FLT x359 = (x6 * x6 * x6) * x240;
	const FLT x360 = x6 * x12;
	const FLT x361 = (-1 * x247 * x359) + (x243 * x359) + (-1 * x6 * x321) + (x6 * x324) + (x6 * x319) + (-1 * x248 * x360) + (x244 * x360) + (-1 * x6 * x320);
	const FLT x362 = x254 * x361;
	const FLT x363 = x33 * x362;
	const FLT x364 = x7 * x258;
	const FLT x365 = x262 * x361;
	const FLT x366 = x303 + (-1 * x4 * x365) + (x267 * x364) + (-1 * x0 * x363) + x339 + x340 + (-1 * x362 * x329) + (-1 * x7 * x288) + (-1 * x338) + (-1 * x6 * x328) + (x283 * x361);
	const FLT x367 = x4 * x362;
	const FLT x368 = x6 * x362;
	const FLT x369 = (-1 * x6 * x344) + (-1 * x33 * x365) + (x7 * x273) + (-1 * x274 * x364) + x289 + (-1 * x30 * x368) + (x0 * x367) + (-1 * x281) + x32 + (-1 * x334) + (-1 * x361 * x301) + x335;
	const FLT x370 = x6 * x5;
	const FLT x371 = (x257 * x362) + (-1 * x36 * x365) + (-1 * x269 * x370) + (-1 * x4 * x368) + x345 + (-1 * x256 * x362) + x28 + x297 + (x7 * x264) + (-1 * x7 * x259);
	const FLT x372 = (x9 * x367) + x261 + (x271 * x364) + (-1 * x7 * x286) + x331 + x235 + (-1 * x296 * x370) + (x294 * x361) + (x6 * x363) + (-1 * x265) + (-1 * x30 * x365);
	...
	const FLT x385 = (-1 * x79 * ((x86 * x383) + (-1 * ((x81 * x381) + (x80 * x384)) * x82))) + (-1 * ((x73 * x381) + (-1 * x58 * x384)) * x76);
	...
	const FLT x395 = (-1 * x79 * ((x86 * x391) + (-1 * ((x81 * x388) + (x80 * x394)) * x82))) + (-1 * ((x73 * x388) + (-1 * x58 * x394)) * x76);
	...
	const FLT x403 = (-1 * x79 * ((x86 * x402) + (-1 * ((x81 * x399) + (x80 * x396)) * x82))) + (-1 * ((x72 * x400) + (-1 * x58 * x396)) * x76);
	const FLT x404 = x386 + x387;
	const FLT x405 = dt + x392 + x401;
	const FLT x406 = x70 * x405;
	const FLT x407 = x397 + (-1 * x398);
	const FLT x408 = (-1 * x79 * ((x86 * x407) + (-1 * ((x81 * x405) + (x80 * x404)) * x82))) + (-1 * ((x72 * x406) + (-1 * x58 * x404)) * x76);
	cnSetZero(Hx);
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Acc[0])/sizeof(FLT), x87 + (x89 * x87) + (((-1 * x85 * x58) + (x68 * x90)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Acc[1])/sizeof(FLT), x99 + (x89 * x99) + (((-1 * x58 * x98) + (x90 * x95)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Acc[2])/sizeof(FLT), x103 + (x89 * x103) + (((-1 * x58 * x102) + (x90 * x101)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Pos[0])/sizeof(FLT), (x89 * x118) + x118 + (((-1 * x58 * x117) + (x90 * x113)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Pos[1])/sizeof(FLT), x126 + (x89 * x126) + (((-1 * x58 * x125) + (x90 * x122)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Pos[2])/sizeof(FLT), x130 + (x89 * x130) + (((-1 * x58 * x129) + (x90 * x128)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x171 + (x89 * x171) + (((-1 * x58 * x170) + (x90 * x169)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), x196 + (x89 * x196) + (((-1 * x58 * x195) + (x90 * x194)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), x216 + (x89 * x216) + (((-1 * x58 * x215) + (x90 * x214)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x233 + (x89 * x233) + (((-1 * x58 * x232) + (x90 * x231)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x317 + (x89 * x317) + (((-1 * x58 * x316) + (x90 * x315)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x358 + (x89 * x358) + (((-1 * x58 * x357) + (x90 * x356)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x385 + (((-1 * x58 * x383) + (x90 * x381)) * x91) + (x89 * x385));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.Pos[0])/sizeof(FLT), x395 + (((-1 * x58 * x391) + (x90 * x388)) * x91) + (x89 * x395));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.Pos[1])/sizeof(FLT), (x89 * x403) + x403 + (((-1 * x58 * x402) + (x77 * x400)) * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.Pos[2])/sizeof(FLT), x408 + (x89 * x408) + (((-1 * x58 * x407) + (x77 * x406)) * x91));
}

// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen1 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0e817c0>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen1 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0e7e550>]
static inline void SurviveKalmanErrorModel_LightMeas_x_gen1_jac_error_model(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x2 = 0.5 * (*error_model).Pose.AxisAngleRot[2];
	const FLT x3 = 0.5 * (*error_model).Pose.AxisAngleRot[0];
	const FLT x4 = (*_x0).Pose.Rot[1] + (x3 * (*_x0).Pose.Rot[0]) + (-1 * x1 * (*_x0).Pose.Rot[3]) + (x2 * (*_x0).Pose.Rot[2]);
	const FLT x5 = dt * dt;
	const FLT x6 = (*_x0).Velocity.AxisAngleRot[2] + (*error_model).Velocity.AxisAngleRot[2];
	const FLT x7 = x6 * x6;
	const FLT x8 = x5 * x7;
	...
	const FLT x28 = (-1 * x3 * (*_x0).Pose.Rot[1]) + (-1 * x1 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x2 * (*_x0).Pose.Rot[3]);
	const FLT x29 = x28 * x26;
	const FLT x30 = (*_x0).Pose.Rot[3] + (x1 * (*_x0).Pose.Rot[1]) + (-1 * x3 * (*_x0).Pose.Rot[2]) + (x2 * (*_x0).Pose.Rot[0]);
	const FLT x31 = x23 * x21;
	const FLT x32 = x30 * x31;
	const FLT x33 = (-1 * x2 * (*_x0).Pose.Rot[1]) + (x3 * (*_x0).Pose.Rot[3]) + (x1 * (*_x0).Pose.Rot[0]) + (*_x0).Pose.Rot[2];
	...
	const FLT x48 = (x47 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (2 * ((x44 * x45) + (-1 * x42 * x36))) + (*error_model).Pose.Pos[0] + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (*_x0).Pose.Pos[0];
	const FLT x49 = (-1 * x36 * sensor_pt[1]) + (x44 * sensor_pt[2]) + (x39 * sensor_pt[0]);
	const FLT x50 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (*error_model).Pose.Pos[2] + (x47 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (2 * ((x41 * x42) + (-1 * x44 * x49))) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2]));
	const FLT x51 = (*_x0).Pose.Pos[1] + (*error_model).Pose.Pos[1] + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + (2 * ((x49 * x36) + (-1 * x41 * x45))) + (x47 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	...
	const FLT x84 = (-1 * x75 * ((x82 * x83) + (-1 * ((x77 * x64) + (x76 * x60)) * x78))) + (-1 * ((x64 * x69) + (-1 * x60 * x55)) * x72);
	const FLT x85 = -1 * x54;
	const FLT x86 = (*bsc0).gibmag * sin(1.5707963267949 + (-1 * (*bsc0).phase) + (*bsc0).gibpha + (-1 * asin(x83 * x73)) + (-1 * atan2(x68, x85)));
	...
	const FLT x96 = (-1 * x75 * ((x83 * x95) + (-1 * ((x77 * x92) + (x89 * x76)) * x78))) + (-1 * ((x69 * x92) + (-1 * x89 * x55)) * x72);
	const FLT x97 = x61 + x63;
	const FLT x98 = x57 + x47 + x94;
	const FLT x99 = x90 + (-1 * x91);
	const FLT x100 = (-1 * x75 * ((x83 * x99) + (-1 * ((x77 * x98) + (x76 * x97)) * x78))) + (-1 * ((x69 * x98) + (-1 * x55 * x97)) * x72);
	const FLT x101 = 0.5 * x26;
	const FLT x102 = x9 * x101;
	const FLT x103 = 0.5 * x31;
	const FLT x104 = x6 * x101;
	const FLT x105 = x0 * x101;
	const FLT x106 = (-1 * x105 * (*_x0).Pose.Rot[2]) + (-1 * x104 * (*_x0).Pose.Rot[3]) + (-1 * x102 * (*_x0).Pose.Rot[1]) + (x103 * (*_x0).Pose.Rot[0]);
	...
	const FLT x151 = (-1 * x75 * ((x83 * x150) + (-1 * ((x77 * x149) + (x76 * x146)) * x78))) + (-1 * ((x69 * x149) + (-1 * x55 * x146)) * x72);
	...
	const FLT x170 = (-1 * x75 * ((x83 * x168) + (-1 * ((x77 * x166) + (x76 * x169)) * x78))) + (-1 * ((x69 * x166) + (-1 * x55 * x169)) * x72);
	...
	const FLT x184 = (-1 * x75 * ((x83 * x183) + (-1 * ((x77 * x182) + (x76 * x180)) * x78))) + (-1 * ((x69 * x182) + (-1 * x55 * x180)) * x72);
	...
	const FLT x195 = x194 + x193;
	const FLT x196 = (-1 * x75 * ((x83 * x195) + (-1 * ((x77 * x192) + (x76 * x189)) * x78))) + (-1 * ((x69 * x192) + (-1 * x55 * x189)) * x72);
	...
	const FLT x204 = (-1 * x75 * ((x83 * x203) + (-1 * ((x77 * x200) + (x76 * x197)) * x78))) + (-1 * ((x69 * x200) + (-1 * x55 * x197)) * x72);
	const FLT x205 = x190 + x191;
	const FLT x206 = x188 + x202;
	const FLT x207 = x198 + (-1 * x199);
	const FLT x208 = (-1 * x75 * ((x83 * x207) + (-1 * ((x77 * x206) + (x76 * x205)) * x78))) + (-1 * ((x69 * x206) + (-1 * x55 * x205)) * x72);
	...
	const FLT x227 = (x12 * x225) + (x9 * x220) + (x218 * x215) + (-1 * x12 * x223) + (-1 * x215 * x221) + (-1 * x7 * x223) + (-1 * x224 * x226) + (x7 * x225);
	...
	const FLT x253 = (-1 * x244 * x245) + (-1 * x6 * x243) + (-1 * x33 * x239) + x241 + (-1 * x10 * x213) + x252 + (x10 * x247) + x209 + (-1 * x230 * x231) + (x230 * x232) + (-1 * x237);
	...
	const FLT x266 = (-1 * x230 * x265) + x257 + (x10 * x248) + (-1 * x264) + (-1 * x0 * x254) + (-1 * x255 * x244) + (-1 * x260) + (x230 * x258) + x29 + x262 + (-1 * x10 * x250) + (-1 * x4 * x239);
	...
	const FLT x275 = x274 + (x9 * x243) + (x10 * x235) + (-1 * x273 * x265) + (x6 * x254) + (-1 * x271) + (-1 * x10 * x240) + x267 + (-1 * x28 * x239) + x269 + (x230 * x270);
	...
	const FLT x282 = x281 + x280 + (-1 * x10 * x256) + x35 + (x0 * x243) + (x10 * x263) + (-1 * x230 * x277) + (-1 * x230 * x276) + (-1 * x232 * x273) + (-1 * x30 * x239);
	...
	const FLT x295 = (-1 * x75 * ((x83 * x294) + (-1 * ((x77 * x293) + (x76 * x291)) * x78))) + (-1 * ((x69 * x293) + (-1 * x55 * x291)) * x72);
	...
	const FLT x302 = (-1 * x10 * x298) + (x296 * x301) + (x10 * x297) + (-1 * x216 * x300) + (x219 * x299) + (-1 * x7 * x298) + (-1 * x222 * x301) + (x7 * x297);
	...
	const FLT x308 = x252 + x38 + (x258 * x303) + (-1 * x12 * x247) + (-1 * x255 * x300) + (x12 * x213) + x307 + (-1 * x4 * x304) + (-1 * x265 * x303) + (-1 * x0 * x305);
	const FLT x309 = x242 * x302;
	const FLT x310 = x6 * x278;
	const FLT x311 = x6 * x279;
	const FLT x312 = (-1 * x245 * x300) + x260 + (-1 * x12 * x250) + (-1 * x262) + (x12 * x248) + (-1 * x33 * x304) + x310 + (-1 * x231 * x303) + (-1 * x311) + x29 + (-1 * x6 * x309) + (x232 * x303);
	const FLT x313 = x6 * x259;
	const FLT x314 = x6 * x261;
	const FLT x315 = x28 * x272;
	const FLT x316 = -1 * x35;
	const FLT x317 = (x9 * x309) + (x12 * x256) + x316 + (-1 * x300 * x315) + x313 + (x270 * x303) + (-1 * x28 * x304) + (-1 * x12 * x263) + (x6 * x305) + x280 + (-1 * x314);
	...
	const FLT x321 = (-1 * x300 * x319) + x320 + (-1 * x269) + (-1 * x30 * x304) + (-1 * x277 * x303) + x267 + (-1 * x12 * x240) + (x0 * x309) + x271 + (-1 * x276 * x303) + (x12 * x235);
	...
	const FLT x333 = (-1 * x75 * ((x83 * x332) + (-1 * ((x77 * x331) + (x76 * x329)) * x78))) + (-1 * ((x69 * x331) + (-1 * x55 * x329)) * x72);
	const FLT x334 = x6 * x296;
	const FLT x335 = x6 * x6 * x6;
	const FLT x336 = x6 * x222;
	const FLT x337 = x6 * x226;
	const FLT x338 = (x12 * x334) + (-1 * x216 * x337) + (x296 * x335) + (x10 * x334) + (-1 * x222 * x335) + (x6 * x220) + (-1 * x12 * x336) + (-1 * x10 * x336);
	...
	const FLT x345 = x281 + x314 + (-1 * x313) + (x34 * x343) + (-1 * x0 * x342) + (-1 * x43 * x341) + (x258 * x339) + (-1 * x265 * x339) + (-1 * x4 * x344) + x316 + (-1 * x255 * x337);
	const FLT x346 = x242 * x338;
	const FLT x347 = x23 * x343;
	const FLT x348 = (-1 * x277 * x339) + (-1 * x310) + (x0 * x346) + (-1 * x257) + (-1 * x337 * x319) + (x37 * x341) + x311 + x29 + x264 + (-1 * x30 * x344) + (-1 * x276 * x339) + (-1 * x28 * x347);
	const FLT x349 = x320 + (x232 * x339) + x274 + (-1 * x33 * x344) + (-1 * x245 * x337) + (x40 * x341) + (-1 * x231 * x339) + (-1 * x6 * x346) + x27 + (-1 * x233 * x343);
	const FLT x350 = (x9 * x346) + x307 + (x30 * x347) + (x6 * x342) + (-1 * x241) + (-1 * x32 * x341) + (-1 * x337 * x315) + x209 + (-1 * x28 * x344) + x237 + (x270 * x339);
	...
	const FLT x363 = (-1 * x75 * ((x83 * x361) + (-1 * ((x77 * x359) + (x76 * x362)) * x78))) + (-1 * ((x69 * x359) + (-1 * x55 * x362)) * x72);
	...
	const FLT x373 = (-1 * x75 * ((x83 * x369) + (-1 * ((x77 * x366) + (x76 * x372)) * x78))) + (-1 * ((x69 * x366) + (-1 * x55 * x372)) * x72);
	...
	const FLT x380 = (-1 * x75 * ((x83 * x379) + (-1 * ((x77 * x377) + (x76 * x374)) * x78))) + (-1 * ((x69 * x377) + (-1 * x55 * x374)) * x72);
	const FLT x381 = x364 + x365;
	const FLT x382 = x378 + x371;
	const FLT x383 = x375 + (-1 * x376);
	const FLT x384 = (-1 * x75 * ((x83 * x383) + (-1 * ((x77 * x382) + (x76 * x381)) * x78))) + (-1 * ((x69 * x382) + (-1 * x55 * x381)) * x72);
	cnSetZero(Hx);
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Acc[0])/sizeof(FLT), x84 + (x84 * x86) + (((-1 * x82 * x55) + (x87 * x64)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Acc[1])/sizeof(FLT), x96 + (x86 * x96) + (((-1 * x55 * x95) + (x87 * x92)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Acc[2])/sizeof(FLT), x100 + (x86 * x100) + (((-1 * x55 * x99) + (x87 * x98)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x151 + (x86 * x151) + (((-1 * x55 * x150) + (x87 * x149)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x170 + (((-1 * x55 * x168) + (x87 * x166)) * x88) + (x86 * x170));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x184 + (x86 * x184) + (((-1 * x55 * x183) + (x87 * x182)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.Pos[0])/sizeof(FLT), x196 + (x86 * x196) + (((-1 * x55 * x195) + (x87 * x192)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.Pos[1])/sizeof(FLT), x204 + (x86 * x204) + (((-1 * x55 * x203) + (x87 * x200)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.Pos[2])/sizeof(FLT), x208 + (x86 * x208) + (((-1 * x55 * x207) + (x87 * x206)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x295 + (x86 * x295) + (((-1 * x55 * x294) + (x87 * x293)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x333 + (x86 * x333) + (((-1 * x55 * x332) + (x87 * x331)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x363 + (((-1 * x55 * x361) + (x87 * x359)) * x88) + (x86 * x363));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.Pos[0])/sizeof(FLT), x373 + (((-1 * x55 * x369) + (x87 * x366)) * x88) + (x86 * x373));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.Pos[1])/sizeof(FLT), x380 + (x86 * x380) + (((-1 * x55 * x379) + (x87 * x377)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.Pos[2])/sizeof(FLT), x384 + (x86 * x384) + (((-1 * x55 * x383) + (x87 * x382)) * x88));
}

// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen1 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0e7e550>]
...
static inline void SurviveKalmanErrorModel_LightMeas_x_gen1_jac_sensor_pt(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x3 = 0.5 * (*error_model).Pose.AxisAngleRot[2];
	const FLT x4 = (-1 * x3 * (*_x0).Pose.Rot[1]) + (x2 * (*_x0).Pose.Rot[0]) + (x1 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x5 = dt * dt;
	const FLT x6 = (*_x0).Velocity.AxisAngleRot[2] + (*error_model).Velocity.AxisAngleRot[2];
	...
	const FLT x18 = dt * x14 * (1. / x12) * x17;
	const FLT x19 = x4 * x18;
	const FLT x20 = (-1 * x1 * (*_x0).Pose.Rot[1]) + (-1 * x2 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x3 * (*_x0).Pose.Rot[3]);
	const FLT x21 = x17 * x16;
	const FLT x22 = (x2 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x1 * (*_x0).Pose.Rot[2]) + (x3 * (*_x0).Pose.Rot[0]);
	const FLT x23 = x22 * x18;
	const FLT x24 = (*_x0).Pose.Rot[1] + (x1 * (*_x0).Pose.Rot[0]) + (-1 * x2 * (*_x0).Pose.Rot[3]) + (x3 * (*_x0).Pose.Rot[2]);
	const FLT x25 = x24 * x18;
	...
	const FLT x58 = (x57 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (2 * ((x56 * x32) + (-1 * x55 * x39))) + (*error_model).Pose.Pos[0] + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (*_x0).Pose.Pos[0];
	const FLT x59 = (-1 * x39 * sensor_pt[1]) + (x32 * sensor_pt[2]) + (x26 * sensor_pt[0]);
	const FLT x60 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (*error_model).Pose.Pos[2] + (x57 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (2 * ((x55 * x44) + (-1 * x59 * x32))) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2]));
	const FLT x61 = (*_x0).Pose.Pos[1] + (*error_model).Pose.Pos[1] + (2 * ((x59 * x39) + (-1 * x56 * x44))) + (x57 * ((*_x0).Acc[1] + (*error_model).Acc[1])) + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1]));
	...
	const FLT x89 = (-1 * x84 * ((x88 * x73) + (-1 * ((x86 * x54) + (x85 * x78)) * x87))) + (-1 * ((x80 * x54) + (-1 * x70 * x78)) * x83);
	const FLT x90 = (*bsc0).gibmag * sin(1.5707963267949 + (-1 * (*bsc0).phase) + (*bsc0).gibpha + (-1 * asin(x88 * x68)) + (-1 * atan2(x79, x74)));
	...
	const FLT x103 = (-1 * x84 * ((x88 * x102) + (-1 * x87 * ((x86 * x101) + (x85 * x99))))) + (-1 * x83 * ((x80 * x101) + (-1 * x70 * x99)));
	...
	const FLT x114 = (-1 * x84 * ((x88 * x113) + (-1 * ((x86 * x112) + (x85 * x110)) * x87))) + (-1 * ((x80 * x112) + (-1 * x70 * x110)) * x83);
...
static inline void SurviveKalmanErrorModel_LightMeas_x_gen1_jac_lh_p(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x18 = dt * x14 * (1. / x12) * x17;
	const FLT x19 = x4 * x18;
	const FLT x20 = (-1 * x3 * (*_x0).Pose.Rot[1]) + (-1 * x1 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x2 * (*_x0).Pose.Rot[3]);
	const FLT x21 = x20 * x18;
	const FLT x22 = (*_x0).Pose.Rot[3] + (x1 * (*_x0).Pose.Rot[1]) + (-1 * x3 * (*_x0).Pose.Rot[2]) + (x2 * (*_x0).Pose.Rot[0]);
	const FLT x23 = x17 * x16;
	const FLT x24 = (-1 * x2 * (*_x0).Pose.Rot[1]) + (x3 * (*_x0).Pose.Rot[3]) + (x1 * (*_x0).Pose.Rot[0]) + (*_x0).Pose.Rot[2];
	const FLT x25 = x24 * x18;
	...
	const FLT x71 = -1 * x55;
	const FLT x72 = (*bsc0).gibmag * sin(1.5707963267949 + (-1 * (*bsc0).phase) + (*bsc0).gibpha + (-1 * asin(x70 * x64)) + (-1 * atan2(x61, x71)));
	...
	const FLT x90 = (-1 * x66 * ((x89 * x70) + (-1 * ((x82 * x74) + (x80 * x86)) * x87))) + (-1 * ((x82 * x84) + (-1 * x80 * x78)) * x85);
	const FLT x91 = x83 * x64;
	const FLT x92 = x77 * x56;
	const FLT x93 = (-1 * sensor_pt[2]) + (-1 * x42) + (-1 * x41) + (-1 * (*_x0).Pose.Pos[2]) + (-1 * x40) + (-1 * (*error_model).Pose.Pos[2]);
	...
	const FLT x102 = (-1 * x66 * ((x70 * x101) + (-1 * ((x74 * x99) + (x86 * x96)) * x87))) + (-1 * ((x84 * x99) + (-1 * x78 * x96)) * x85);
	const FLT x103 = (-1 * (*error_model).Pose.Pos[0]) + (-1 * x33) + (-1 * (*_x0).Pose.Pos[0]) + (-1 * x34) + (-1 * sensor_pt[0]) + (-1 * x36);
	const FLT x104 = x82 + (x95 * x103) + x100;
	const FLT x105 = 2 * x38;
	const FLT x106 = (-4 * x44) + (-1 * x105) + x79;
	const FLT x107 = (x94 * x43) + (-1 * x97 * x103);
	const FLT x108 = (-1 * x66 * ((x70 * x107) + (-1 * ((x74 * x106) + (x86 * x104)) * x87))) + (-1 * ((x84 * x106) + (-1 * x78 * x104)) * x85);
	const FLT x109 = (-1 * sensor_pt[1]) + (-1 * x45) + (-1 * (*error_model).Pose.Pos[1]) + (-1 * x47) + (-1 * (*_x0).Pose.Pos[1]) + (-1 * x46);
	const FLT x110 = (x97 * x37) + (-1 * x95 * x109);
	const FLT x111 = x80 + x105 + (x94 * x109);
	const FLT x112 = x88 + (-1 * x98) + (-4 * x52);
	const FLT x113 = (-1 * x66 * ((x70 * x111) + (-1 * ((x74 * x110) + (x86 * x112)) * x87))) + (-1 * ((x84 * x110) + (-1 * x78 * x112)) * x85);
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[0])/sizeof(FLT), x69 + (x72 * x69));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[1])/sizeof(FLT), (-1 * x73) + (-1 * x73 * x72) + (-1 * x75 * x74));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[2])/sizeof(FLT), x76 + (x72 * x76) + (x77 * x64));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[0])/sizeof(FLT), x90 + (x72 * x90) + (((-1 * x89 * x78) + (x82 * x91)) * x92));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[1])/sizeof(FLT), x102 + (x72 * x102) + (x92 * ((-1 * x78 * x101) + (x91 * x99))));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[2])/sizeof(FLT), x108 + (x72 * x108) + (((-1 * x78 * x107) + (x91 * x106)) * x92));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[3])/sizeof(FLT), (((-1 * x78 * x111) + (x91 * x110)) * x92) + x113 + (x72 * x113));
}
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0e75340>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e75400>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e753a0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e754c0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e75460>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e75130>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e752e0>]
static inline void SurviveKalmanErrorModel_LightMeas_x_gen1_jac_bsc0(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x2 = 0.5 * (*_x0).Pose.Rot[0];
	const FLT x3 = 0.5 * (*error_model).Pose.AxisAngleRot[2];
	const FLT x4 = (-1 * x3 * (*_x0).Pose.Rot[1]) + (x2 * (*error_model).Pose.AxisAngleRot[1]) + (x1 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x5 = dt * dt;
	const FLT x6 = (x0 * x0) * x5;
	const FLT x7 = (*_x0).Velocity.AxisAngleRot[0] + (*error_model).Velocity.AxisAngleRot[0];
	const FLT x8 = x5 * (x7 * x7);
	...
	const FLT x21 = 0.5 * (*error_model).Pose.AxisAngleRot[1];
	const FLT x22 = (x21 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x20 * (*error_model).Pose.AxisAngleRot[0]) + (x2 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x23 = x22 * x18;
	const FLT x24 = (*_x0).Pose.Rot[1] + (x2 * (*error_model).Pose.AxisAngleRot[0]) + (-1 * x21 * (*_x0).Pose.Rot[3]) + (x20 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x25 = x17 * x16;
	const FLT x26 = (-1 * x1 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[0] + (-1 * x20 * (*error_model).Pose.AxisAngleRot[1]) + (-1 * x3 * (*_x0).Pose.Rot[3]);
	const FLT x27 = x26 * x18;
	const FLT x28 = (x7 * x27) + (-1 * x0 * x19) + (x24 * x25) + (x9 * x23);
	const FLT x29 = x24 * x18;
	const FLT x30 = (-1 * x7 * x29) + (-1 * x9 * x19) + (-1 * x0 * x23) + (x25 * x26);
	...
	const FLT x49 = 1.5707963267949 + (-1 * (*bsc0).phase) + (*bsc0).gibpha + (-1 * asin(x48 * (*bsc0).tilt)) + (-1 * atan2(x46, x45));
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0e75340>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e75400>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e753a0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e754c0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e75460>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e75130>, <cnkalman.codegen.WrapMember object at 0x7f2ed0e752e0>]
...
static inline FLT SurviveKalmanErrorModel_LightMeas_y_gen1(const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x21 = (x20 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x1 * (*_x0).Pose.Rot[2]) + (x2 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x22 = x21 * x18;
	const FLT x23 = (*_x0).Pose.Rot[1] + (x2 * (*error_model).Pose.AxisAngleRot[0]) + (-1 * x20 * (*_x0).Pose.Rot[3]) + (x3 * (*_x0).Pose.Rot[2]);
	const FLT x24 = x17 * x16;
	const FLT x25 = (-1 * x1 * (*_x0).Pose.Rot[1]) + (-1 * x20 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x3 * (*_x0).Pose.Rot[3]);
	...
	const FLT x35 = (*_x0).Pose.Pos[1] + (2 * ((x32 * x33) + (-1 * x31 * x27))) + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + (*error_model).Pose.Pos[1] + (x34 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	const FLT x36 = (-1 * x27 * sensor_pt[2]) + (x29 * sensor_pt[1]) + (x32 * sensor_pt[0]);
	const FLT x37 = (x34 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (*error_model).Pose.Pos[0] + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (2 * ((x30 * x31) + (-1 * x32 * x36))) + (*_x0).Pose.Pos[0];
	const FLT x38 = sensor_pt[2] + (*_x0).Pose.Pos[2] + (2 * ((x36 * x27) + (-1 * x30 * x33))) + (*error_model).Pose.Pos[2] + (x34 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2]));
	...
	const FLT x46 = (-1 * (*bsc0).phase) + (-1 * asin((1. / sqrt((x45 * x45) + (x43 * x43))) * x41 * (*bsc0).tilt)) + (-1 * atan2(-1 * x45, x44));
	return x46 + ((atan2(x41, x44) * atan2(x41, x44)) * (*bsc0).curve) + (-1 * cos(1.5707963267949 + x46 + (*bsc0).gibpha) * (*bsc0).gibmag);
}

// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen1 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec9580>]
static inline void SurviveKalmanErrorModel_LightMeas_y_gen1_jac_x0(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x8 = (x6 * (*_x0).Pose.Rot[0]) + (x5 * (*_x0).Pose.Rot[3]) + (-1 * x7 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[2];
	...
	const FLT x34 = (x6 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x5 * (*_x0).Pose.Rot[2]) + (x7 * (*_x0).Pose.Rot[0]);
	const FLT x35 = x32 * x16;
	const FLT x36 = (*_x0).Pose.Rot[1] + (x5 * (*_x0).Pose.Rot[0]) + (-1 * x6 * (*_x0).Pose.Rot[3]) + (x7 * (*_x0).Pose.Rot[2]);
	const FLT x37 = x29 * x27;
	const FLT x38 = x36 * x37;
	const FLT x39 = (-1 * x6 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x5 * (*_x0).Pose.Rot[1]) + (-1 * x7 * (*_x0).Pose.Rot[3]);
	...
	const FLT x52 = (*_x0).Pose.Pos[1] + (2 * ((x50 * x49) + (-1 * x42 * x47))) + (*error_model).Pose.Pos[1] + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + (x51 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	const FLT x53 = (-1 * x42 * sensor_pt[2]) + (x44 * sensor_pt[1]) + (x49 * sensor_pt[0]);
	const FLT x54 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (*error_model).Pose.Pos[2] + (x51 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (2 * ((x53 * x42) + (-1 * x50 * x46))) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2]));
	const FLT x55 = (2 * ((x46 * x47) + (-1 * x53 * x49))) + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (x51 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (*error_model).Pose.Pos[0] + (*_x0).Pose.Pos[0];
	...
	const FLT x84 = (-1 * x83 * ((x80 * x81) + (-1 * x75 * ((x4 * x73) + (x72 * x67))))) + (-1 * x71 * ((x67 * x68) + (-1 * x4 * x63)));
	const FLT x85 = -1 * x60;
	const FLT x86 = (*bsc0).gibmag * sin(1.5707963267949 + (-1 * (*bsc0).phase) + (*bsc0).gibpha + (-1 * asin(x81 * x74)) + (-1 * atan2(-1 * x58, x85)));
	...
	const FLT x96 = (-1 * x83 * ((x81 * x95) + (-1 * ((x73 * x91) + (x72 * x94)) * x75))) + (-1 * ((x68 * x94) + (-1 * x63 * x91)) * x71);
	const FLT x97 = x79 + x93;
	const FLT x98 = x89 + (-1 * x90);
	const FLT x99 = x1 + x3;
	const FLT x100 = (-1 * x83 * ((x81 * x99) + (-1 * ((x73 * x97) + (x72 * x98)) * x75))) + (-1 * ((x68 * x98) + (-1 * x63 * x97)) * x71);
	...
	const FLT x115 = (-1 * x83 * ((x81 * x114) + (-1 * ((x73 * x105) + (x72 * x109)) * x75))) + (-1 * ((x68 * x109) + (-1 * x63 * x105)) * x71);
	...
	const FLT x123 = (-1 * x83 * ((x81 * x122) + (-1 * ((x73 * x118) + (x72 * x121)) * x75))) + (-1 * ((x68 * x121) + (-1 * x63 * x118)) * x71);
	const FLT x124 = x120 + x113;
	const FLT x125 = x116 + (-1 * x117);
	const FLT x126 = x102 + x104;
	const FLT x127 = (-1 * x83 * ((x81 * x126) + (-1 * ((x73 * x124) + (x72 * x125)) * x75))) + (-1 * ((x68 * x125) + (-1 * x63 * x124)) * x71);
	...
	const FLT x168 = (-1 * x83 * ((x81 * x167) + (-1 * ((x73 * x164) + (x72 * x166)) * x75))) + (-1 * ((x68 * x166) + (-1 * x63 * x164)) * x71);
	...
	const FLT x191 = (-1 * x83 * ((x81 * x190) + (-1 * ((x73 * x187) + (x72 * x189)) * x75))) + (-1 * ((x68 * x189) + (-1 * x63 * x187)) * x71);
	...
	const FLT x212 = (-1 * x83 * ((x81 * x211) + (-1 * ((x73 * x208) + (x72 * x210)) * x75))) + (-1 * ((x68 * x210) + (-1 * x63 * x208)) * x71);
	...
	const FLT x229 = (-1 * x83 * ((x81 * x228) + (-1 * ((x73 * x225) + (x72 * x227)) * x75))) + (-1 * ((x68 * x227) + (-1 * x63 * x225)) * x71);
	...
	const FLT x244 = (x13 * x241) + (-1 * x40 * x242) + (x13 * x236) + (-1 * x13 * x243) + (x234 * x231) + (-1 * x231 * x237) + (x239 * x240) + (-1 * x238 * x239);
	...
	const FLT x282 = (-1 * x281 * x244) + (x264 * x263) + x261 + (-1 * x268) + (-1 * x36 * x275) + (x254 * x256) + (-1 * x245 * x249) + (-1 * x40 * x252) + x272 + (-1 * x273 * x254) + (-1 * x278) + x279;
	...
	const FLT x300 = (-1 * x289 * x244) + x299 + (-1 * x263 * x288) + x296 + (-1 * x254 * x259) + x283 + (x287 * x249) + (x276 * x254) + (-1 * x34 * x286) + (-1 * x34 * x275);
	...
	const FLT x309 = x308 + (x265 * x254) + x305 + (-1 * x8 * x286) + x303 + (-1 * x288 * x244 * x248) + (-1 * x269 * x254) + (-1 * x302) + (x245 * x301) + (-1 * x36 * x263 * x247) + (-1 * x8 * x275);
	...
	const FLT x320 = x318 + (-1 * x285 * x280) + (x14 * x294) + (x263 * x316) + x319 + (x244 * x313) + (x287 * x301) + (-1 * x290 * x254) + (-1 * x244 * x310) + x312 + (-1 * x315);
	...
	const FLT x333 = (-1 * x83 * ((x81 * x332) + (-1 * ((x73 * x329) + (x72 * x331)) * x75))) + (-1 * ((x68 * x331) + (-1 * x63 * x329)) * x71);
	...
	const FLT x340 = (x240 * x339) + (x14 * x335) + (-1 * x233 * x338) + (-1 * x14 * x336) + (-1 * x11 * x336) + (-1 * x238 * x339) + (x235 * x337) + (x11 * x335);
	const FLT x341 = x264 * x340;
	const FLT x342 = x36 * x274;
	const FLT x343 = x34 * x340;
	const FLT x344 = (-1 * x9 * x314) + (x9 * x311);
	const FLT x345 = x344 + (-1 * x251 * x338) + x304 + (-1 * x281 * x340) + (x262 * x341) + x308 + (-1 * x265 * x334) + (-1 * x249 * x343) + (-1 * x342 * x340) + (x269 * x334);
	...
	const FLT x352 = (-1 * x8 * x351) + x279 + (-1 * x262 * x247 * x347) + (-1 * x273 * x334) + (-1 * x272) + (-1 * x248 * x346) + (x256 * x334) + x349 + (-1 * x350) + (x301 * x343) + (-1 * x348 * x340) + x268;
	const FLT x353 = x9 * x267;
	const FLT x354 = x9 * x271;
	const FLT x355 = -1 * x283;
	const FLT x356 = x355 + x296 + (x259 * x334) + x353 + (-1 * x310 * x340) + (x248 * x341) + (-1 * x276 * x334) + (x301 * x347) + (-1 * x39 * x351) + (x262 * x316 * x340) + (-1 * x354);
	...
	const FLT x360 = x359 + (-1 * x34 * x351) + (-1 * x40 * x341) + (-1 * x358 * x340) + x315 + (x249 * x347) + x318 + (-1 * x290 * x334) + (-1 * x312) + (x17 * x294) + (-1 * x262 * x346);
	...
	const FLT x372 = (-1 * x83 * ((x81 * x371) + (-1 * ((x73 * x368) + (x72 * x370)) * x75))) + (-1 * ((x68 * x370) + (-1 * x63 * x368)) * x71);
	const FLT x373 = x9 * x14;
	const FLT x374 = x9 * x9 * x9;
	const FLT x375 = (-1 * x262 * x242) + (-1 * x238 * x374) + (x240 * x373) + (x9 * x236) + (x9 * x241) + (x240 * x374) + (-1 * x238 * x373) + (-1 * x9 * x243);
	const FLT x376 = x262 * x375;
	const FLT x377 = x11 * x253;
	const FLT x378 = x34 * x375;
	const FLT x379 = (-1 * x375 * x342) + (-1 * x249 * x378) + (-1 * x353) + (x264 * x376) + x299 + x355 + x354 + (x259 * x377) + (-1 * x276 * x377) + (-1 * x281 * x375) + (-1 * x262 * x252);
	const FLT x380 = x262 * x285;
	const FLT x381 = x36 * x375;
	const FLT x382 = x247 * x381;
	const FLT x383 = x288 * x375;
	const FLT x384 = (-1 * x289 * x375) + (x256 * x377) + (-1 * x375 * x358) + (x248 * x382) + (-1 * x349) + x350 + (-1 * x34 * x380) + x279 + x278 + (-1 * x262 * x383) + (-1 * x261) + (-1 * x273 * x377);
	const FLT x385 = x359 + x319 + (-1 * x375 * x348) + (-1 * x8 * x380) + (-1 * x262 * x382) + (-1 * x248 * x383) + x317 + (x378 * x301) + (-1 * x293 * x377) + (x290 * x377);
	const FLT x386 = x344 + (x381 * x301) + x302 + (-1 * x269 * x377) + (x376 * x316) + (x265 * x377) + (-1 * x303) + (-1 * x375 * x310) + x305 + (-1 * x39 * x380) + (x375 * x313);
	...
	const FLT x399 = (-1 * x83 * ((x81 * x398) + (-1 * ((x73 * x395) + (x72 * x397)) * x75))) + (-1 * ((x68 * x397) + (-1 * x63 * x395)) * x71);
	...
	const FLT x409 = (-1 * x83 * ((x81 * x408) + (-1 * ((x73 * x402) + (x72 * x405)) * x75))) + (-1 * ((x68 * x405) + (-1 * x63 * x402)) * x71);
	...
	const FLT x416 = (-1 * x83 * ((x81 * x415) + (-1 * ((x73 * x412) + (x72 * x414)) * x75))) + (-1 * ((x68 * x414) + (-1 * x63 * x412)) * x71);
	const FLT x417 = x407 + x413;
	const FLT x418 = x410 + (-1 * x411);
	const FLT x419 = x400 + x401;
	const FLT x420 = (-1 * x83 * ((x81 * x419) + (-1 * ((x73 * x417) + (x72 * x418)) * x75))) + (-1 * ((x68 * x418) + (-1 * x63 * x417)) * x71);
	cnSetZero(Hx);
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Acc[0])/sizeof(FLT), x84 + (x84 * x86) + (x88 * ((x4 * x87) + (-1 * x80 * x68))));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Acc[1])/sizeof(FLT), x96 + (x86 * x96) + (((x87 * x91) + (-1 * x68 * x95)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Acc[2])/sizeof(FLT), (x86 * x100) + x100 + (((x87 * x97) + (-1 * x68 * x99)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Pos[0])/sizeof(FLT), (x86 * x115) + x115 + (((x87 * x105) + (-1 * x68 * x114)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Pos[1])/sizeof(FLT), (x86 * x123) + x123 + (((x87 * x118) + (-1 * x68 * x122)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Pos[2])/sizeof(FLT), x127 + (x86 * x127) + (((x87 * x124) + (-1 * x68 * x126)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x168 + (x86 * x168) + (((x87 * x164) + (-1 * x68 * x167)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), (x86 * x191) + x191 + (((x87 * x187) + (-1 * x68 * x190)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), x212 + (x86 * x212) + (((x87 * x208) + (-1 * x68 * x211)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x229 + (x86 * x229) + (((x87 * x225) + (-1 * x68 * x228)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x333 + (x86 * x333) + (((x87 * x329) + (-1 * x68 * x332)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x372 + (x86 * x372) + (((x87 * x368) + (-1 * x68 * x371)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x399 + (x86 * x399) + (((x87 * x395) + (-1 * x68 * x398)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.Pos[0])/sizeof(FLT), x409 + (x86 * x409) + (((x87 * x402) + (-1 * x68 * x408)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.Pos[1])/sizeof(FLT), (x86 * x416) + x416 + (((x87 * x412) + (-1 * x68 * x415)) * x88));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.Pos[2])/sizeof(FLT), x420 + (x86 * x420) + (((x87 * x417) + (-1 * x68 * x419)) * x88));
}

// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen1 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec9580>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen1 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0eca970>]
static inline void SurviveKalmanErrorModel_LightMeas_y_gen1_jac_error_model(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x10 = (-1 * x9 * (*_x0).Pose.Rot[1]) + (x8 * (*error_model).Pose.AxisAngleRot[1]) + (x7 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x11 = dt * dt;
	const FLT x12 = x6 * x6;
	...
	const FLT x35 = (x34 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x7 * (*_x0).Pose.Rot[2]) + (x8 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x36 = x32 * x35;
	const FLT x37 = (x8 * (*error_model).Pose.AxisAngleRot[0]) + (-1 * x34 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[1] + (x9 * (*_x0).Pose.Rot[2]);
	const FLT x38 = x29 * x27;
	const FLT x39 = x38 * x37;
	const FLT x40 = (-1 * x7 * (*_x0).Pose.Rot[1]) + (-1 * x34 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x9 * (*_x0).Pose.Rot[3]);
	...
	const FLT x54 = (*_x0).Pose.Pos[1] + (*error_model).Pose.Pos[1] + (2 * ((x52 * x51) + (-1 * x42 * x49))) + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + (x53 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	const FLT x55 = (-1 * x42 * sensor_pt[2]) + (x46 * sensor_pt[1]) + (x51 * sensor_pt[0]);
	const FLT x56 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (2 * ((x55 * x42) + (-1 * x52 * x48))) + (x53 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (*error_model).Pose.Pos[2] + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2]));
	const FLT x57 = (x53 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (2 * ((x48 * x49) + (-1 * x51 * x55))) + (*error_model).Pose.Pos[0] + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (*_x0).Pose.Pos[0];
	...
	const FLT x85 = (-1 * x84 * ((x81 * x82) + (-1 * x76 * ((x5 * x74) + (x73 * x68))))) + (-1 * x72 * ((x68 * x69) + (-1 * x5 * x65)));
	const FLT x86 = -1 * x62;
	const FLT x87 = (*bsc0).gibmag * sin(1.5707963267949 + (-1 * asin(x82 * x75)) + (-1 * (*bsc0).phase) + (*bsc0).gibpha + (-1 * atan2(-1 * x60, x86)));
	...
	const FLT x97 = (-1 * x84 * ((x82 * x96) + (-1 * ((x74 * x92) + (x73 * x95)) * x76))) + (-1 * ((x69 * x95) + (-1 * x65 * x92)) * x72);
	const FLT x98 = x80 + x94;
	const FLT x99 = x90 + (-1 * x91);
	const FLT x100 = x2 + x4;
	const FLT x101 = (-1 * x84 * ((x82 * x100) + (-1 * ((x74 * x98) + (x73 * x99)) * x76))) + (-1 * ((x69 * x99) + (-1 * x65 * x98)) * x72);
	...
	const FLT x108 = (-1 * x105 * (*_x0).Pose.Rot[3]) + (-1 * x103 * (*_x0).Pose.Rot[1]) + (-1 * x107 * (*_x0).Pose.Rot[2]) + (x8 * x38);
	...
	const FLT x154 = (-1 * x84 * ((x82 * x153) + (-1 * ((x74 * x149) + (x73 * x152)) * x76))) + (-1 * ((x69 * x152) + (-1 * x65 * x149)) * x72);
	...
	const FLT x173 = (-1 * x84 * ((x82 * x172) + (-1 * ((x74 * x169) + (x73 * x171)) * x76))) + (-1 * ((x69 * x171) + (-1 * x65 * x169)) * x72);
	...
	const FLT x187 = (-1 * x84 * ((x82 * x186) + (-1 * ((x74 * x183) + (x73 * x185)) * x76))) + (-1 * ((x69 * x185) + (-1 * x65 * x183)) * x72);
	...
	const FLT x199 = (-1 * x84 * ((x82 * x198) + (-1 * ((x74 * x190) + (x73 * x193)) * x76))) + (-1 * ((x69 * x193) + (-1 * x65 * x190)) * x72);
	...
	const FLT x207 = (-1 * x84 * ((x82 * x206) + (-1 * ((x74 * x202) + (x73 * x205)) * x76))) + (-1 * ((x69 * x205) + (-1 * x65 * x202)) * x72);
	const FLT x208 = 1 + x204 + x195;
	const FLT x209 = x200 + (-1 * x201);
	const FLT x210 = x188 + x189;
	const FLT x211 = (-1 * x84 * ((x82 * x210) + (-1 * ((x74 * x208) + (x73 * x209)) * x76))) + (-1 * ((x69 * x209) + (-1 * x65 * x208)) * x72);
	...
	const FLT x228 = (-1 * x14 * x226) + (x14 * x224) + (x14 * x219) + (-1 * x14 * x227) + (x212 * x217) + (-1 * x212 * x221) + (-1 * x14 * x222) + (x14 * x223);
	...
	const FLT x264 = (x244 * x245) + (-1 * x14 * x234) + x253 + x243 + (-1 * x262 * x263) + (-1 * x249) + (-1 * x232 * x229) + (-1 * x257 * x228) + (-1 * x254 * x255) + x41 + (x238 * x236) + (-1 * x261);
	...
	const FLT x278 = x277 + x274 + (-1 * x263 * x244) + x33 + (-1 * x14 * x266) + (-1 * x262 * x245) + (x236 * x259) + (x268 * x228) + (-1 * x239 * x255) + (-1 * x269 * x228);
	...
	const FLT x289 = (-1 * x281 * x228) + (-1 * x236 * x250) + (-1 * x14 * x285) + x279 + x288 + (x255 * x247) + (-1 * x283 * x228) + (-1 * x232 * x263) + (x262 * x229) + x282 + (-1 * x280);
	...
	const FLT x300 = x299 + (x298 * x228) + (x44 * x255) + x297 + (-1 * x14 * x296) + (x229 * x244) + (-1 * x290 * x228) + (-1 * x236 * x270) + (x232 * x245) + x292 + (-1 * x294);
	...
	const FLT x313 = (-1 * x84 * ((x82 * x312) + (-1 * ((x74 * x309) + (x73 * x311)) * x76))) + (-1 * ((x69 * x311) + (-1 * x65 * x309)) * x72);
	const FLT x314 = x18 * x240;
	const FLT x315 = x15 * x217;
	const FLT x316 = x15 * x221;
	const FLT x317 = (x17 * x17 * x17) * x213;
	const FLT x318 = (x17 * x219) + (-1 * x220 * x317) + (x216 * x317) + (-1 * x17 * x316) + (-1 * x17 * x222) + (x17 * x223) + (x17 * x315) + (-1 * x17 * x226);
	...
	const FLT x324 = x288 + (-1 * x262 * x322) + x323 + x36 + (x10 * x319) + (-1 * x247 * x314) + (-1 * x232 * x320) + (-1 * x17 * x234) + (x250 * x321) + (-1 * x257 * x318);
	const FLT x325 = x6 * x272;
	const FLT x326 = x273 * x241;
	const FLT x327 = (-1 * x17 * x285) + (-1 * x253) + (-1 * x232 * x322) + x41 + (-1 * x326) + (-1 * x18 * x275) + (-1 * x281 * x318) + (x262 * x320) + (-1 * x37 * x319) + x249 + x325 + (x238 * x321);
	const FLT x328 = x241 * x248;
	const FLT x329 = x10 * x318;
	const FLT x330 = x6 * x252;
	const FLT x331 = -1 * x33;
	const FLT x332 = x274 + (x298 * x318) + x331 + (-1 * x290 * x318) + (-1 * x17 * x296) + x328 + (x35 * x319) + (x239 * x314) + (-1 * x259 * x321) + (x232 * x329) + (-1 * x330);
	const FLT x333 = (x332 * sensor_pt[2]) + (-1 * x327 * sensor_pt[0]) + (x324 * sensor_pt[1]);
	const FLT x334 = (x6 * x286) + (-1 * x6 * x287);
	const FLT x335 = x334 + (-1 * x17 * x266) + (-1 * x269 * x318) + (x44 * x314) + x294 + x297 + (-1 * x262 * x329) + (-1 * x270 * x321) + (-1 * x292) + (-1 * x40 * x319) + (x268 * x318);
	...
	const FLT x347 = (-1 * x84 * ((x82 * x346) + (-1 * ((x74 * x343) + (x73 * x345)) * x76))) + (-1 * ((x69 * x345) + (-1 * x65 * x343)) * x72);
	const FLT x348 = x6 * x6 * x6;
	const FLT x349 = x6 * x11;
	const FLT x350 = x30 * x349;
	const FLT x351 = (-1 * x214 * x350) + (-1 * x221 * x348) + (x6 * x224) + (x218 * x349) + (x217 * x348) + (x6 * x315) + (-1 * x6 * x227) + (-1 * x6 * x316);
	const FLT x352 = x10 * x351;
	const FLT x353 = x12 * x235;
	const FLT x354 = x35 * x351;
	const FLT x355 = x12 * x240;
	const FLT x356 = x40 * x351;
	const FLT x357 = (-1 * x262 * x356) + (x239 * x355) + (-1 * x328) + x277 + (-1 * x257 * x351) + (-1 * x232 * x354) + x331 + (x244 * x352) + x330 + (-1 * x259 * x353) + (-1 * x233 * x350);
	const FLT x358 = (-1 * x262 * x352) + (x268 * x351) + (-1 * x265 * x350) + x326 + (-1 * x243) + (x238 * x353) + x41 + x261 + (-1 * x244 * x356) + (-1 * x325) + (-1 * x12 * x275) + (-1 * x269 * x351);
	const FLT x359 = x334 + x299 + (x262 * x354) + (-1 * x281 * x351) + (-1 * x284 * x350) + (-1 * x283 * x351) + (-1 * x44 * x355) + x45 + (x270 * x353) + (-1 * x232 * x356);
	const FLT x360 = x323 + (x298 * x351) + (-1 * x250 * x353) + (x244 * x354) + x280 + (-1 * x282) + (x247 * x355) + (x232 * x352) + (-1 * x295 * x350) + x279 + (-1 * x290 * x351);
	...
	const FLT x373 = (-1 * x84 * ((x82 * x372) + (-1 * ((x74 * x369) + (x73 * x371)) * x76))) + (-1 * ((x69 * x371) + (-1 * x65 * x369)) * x72);
	...
	const FLT x383 = (-1 * x84 * ((x82 * x382) + (-1 * ((x74 * x376) + (x73 * x379)) * x76))) + (-1 * ((x69 * x379) + (-1 * x65 * x376)) * x72);
	...
	const FLT x390 = (-1 * x84 * ((x82 * x389) + (-1 * ((x74 * x386) + (x73 * x388)) * x76))) + (-1 * ((x69 * x388) + (-1 * x65 * x386)) * x72);
	const FLT x391 = x380 + dt + x387;
	const FLT x392 = x384 + (-1 * x385);
	const FLT x393 = x374 + x375;
	const FLT x394 = (-1 * x84 * ((x82 * x393) + (-1 * ((x74 * x391) + (x73 * x392)) * x76))) + (-1 * ((x69 * x392) + (-1 * x65 * x391)) * x72);
	cnSetZero(Hx);
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Acc[0])/sizeof(FLT), x85 + (x85 * x87) + (x89 * ((x5 * x88) + (-1 * x81 * x69))));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Acc[1])/sizeof(FLT), x97 + (x87 * x97) + (((x88 * x92) + (-1 * x69 * x96)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Acc[2])/sizeof(FLT), x101 + (x87 * x101) + (x89 * ((x88 * x98) + (-1 * x69 * x100))));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x154 + (x87 * x154) + (((x88 * x149) + (-1 * x69 * x153)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x173 + (x87 * x173) + (((x88 * x169) + (-1 * x69 * x172)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x187 + (x87 * x187) + (((x88 * x183) + (-1 * x69 * x186)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.Pos[0])/sizeof(FLT), x199 + (x87 * x199) + (((x88 * x190) + (-1 * x69 * x198)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.Pos[1])/sizeof(FLT), x207 + (x87 * x207) + (((x88 * x202) + (-1 * x69 * x206)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.Pos[2])/sizeof(FLT), x211 + (x87 * x211) + (((x88 * x208) + (-1 * x69 * x210)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x313 + (x87 * x313) + (((x88 * x309) + (-1 * x69 * x312)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x347 + (x87 * x347) + (((x88 * x343) + (-1 * x69 * x346)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[2])/sizeof(FLT), (x87 * x373) + x373 + (((x88 * x369) + (-1 * x69 * x372)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.Pos[0])/sizeof(FLT), x383 + (x87 * x383) + (((x88 * x376) + (-1 * x69 * x382)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.Pos[1])/sizeof(FLT), x390 + (x87 * x390) + (((x88 * x386) + (-1 * x69 * x389)) * x89));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.Pos[2])/sizeof(FLT), x394 + (x87 * x394) + (((x88 * x391) + (-1 * x69 * x393)) * x89));
}

// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen1 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0eca970>]
...
static inline void SurviveKalmanErrorModel_LightMeas_y_gen1_jac_sensor_pt(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x2 = 0.5 * (*error_model).Pose.AxisAngleRot[1];
	const FLT x3 = 0.5 * (*error_model).Pose.AxisAngleRot[2];
	const FLT x4 = (-1 * x3 * (*_x0).Pose.Rot[1]) + (x1 * (*error_model).Pose.AxisAngleRot[0]) + (x2 * (*_x0).Pose.Rot[0]) + (*_x0).Pose.Rot[2];
	const FLT x5 = dt * dt;
	const FLT x6 = (x0 * x0) * x5;
	const FLT x7 = (*_x0).Velocity.AxisAngleRot[0] + (*error_model).Velocity.AxisAngleRot[0];
	const FLT x8 = x5 * (x7 * x7);
	...
	const FLT x22 = (x2 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x21 * (*_x0).Pose.Rot[2]) + (x3 * (*_x0).Pose.Rot[0]);
	const FLT x23 = x22 * x18;
	const FLT x24 = x9 * x23;
	const FLT x25 = (*_x0).Pose.Rot[1] + (-1 * x1 * (*error_model).Pose.AxisAngleRot[1]) + (x21 * (*_x0).Pose.Rot[0]) + (x3 * (*_x0).Pose.Rot[2]);
	const FLT x26 = x17 * x16;
	const FLT x27 = x25 * x26;
	const FLT x28 = (-1 * x21 * (*_x0).Pose.Rot[1]) + (-1 * x2 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x1 * (*error_model).Pose.AxisAngleRot[2]);
	...
	const FLT x46 = 1.0/2.0 * dt * fabs(dt);
	const FLT x47 = (*_x0).Pose.Pos[1] + (2 * ((x44 * x45) + (-1 * x31 * x39))) + (*error_model).Pose.Pos[1] + (x46 * ((*_x0).Acc[1] + (*error_model).Acc[1])) + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1]));
	const FLT x48 = (-1 * x31 * sensor_pt[2]) + (x33 * sensor_pt[1]) + (x44 * sensor_pt[0]);
	const FLT x49 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (2 * ((x48 * x31) + (-1 * x45 * x38))) + (*error_model).Pose.Pos[2] + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2])) + (x46 * ((*_x0).Acc[2] + (*error_model).Acc[2]));
	const FLT x50 = (x46 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (2 * ((x38 * x39) + (-1 * x44 * x48))) + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (*error_model).Pose.Pos[0] + (*_x0).Pose.Pos[0];
	...
	const FLT x88 = (-1 * x80 * ((x86 * x87) + (-1 * ((x82 * x66) + (x81 * x74)) * x83))) + (-1 * ((x72 * x74) + (-1 * x71 * x53)) * x77);
	const FLT x89 = -1 * x68;
	const FLT x90 = (*bsc0).gibmag * sin(1.5707963267949 + (-1 * (*bsc0).phase) + (*bsc0).gibpha + (-1 * asin(x87 * x78)) + (-1 * atan2(-1 * x53, x89)));
	...
	const FLT x105 = (-1 * x80 * ((x87 * x104) + (-1 * ((x82 * x100) + (x81 * x103)) * x83))) + (-1 * ((x72 * x103) + (-1 * x53 * x101)) * x77);
	...
	const FLT x117 = (-1 * x80 * ((x87 * x116) + (-1 * ((x82 * x112) + (x81 * x115)) * x83))) + (-1 * ((x72 * x115) + (-1 * x53 * x113)) * x77);
...
static inline void SurviveKalmanErrorModel_LightMeas_y_gen1_jac_lh_p(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x66 = -1 * x61;
	const FLT x67 = (*bsc0).gibmag * sin(1.5707963267949 + (-1 * asin(x65 * x56)) + (-1 * (*bsc0).phase) + (*bsc0).gibpha + (-1 * atan2(-1 * x63, x66)));
	...
	const FLT x91 = (-1 * x70 * ((x65 * x90) + (-1 * ((x80 * x72) + (x85 * x87)) * x88))) + (-1 * ((x83 * x85) + (-1 * x80 * x82)) * x86);
	const FLT x92 = x81 * x56;
	const FLT x93 = x78 * x62;
	const FLT x94 = (-1 * sensor_pt[2]) + (-1 * x48) + (-1 * x46) + (-1 * x47) + (-1 * (*_x0).Pose.Pos[2]) + (-1 * (*error_model).Pose.Pos[2]);
	const FLT x95 = 2 * (*lh_p).Rot[1];
	const FLT x96 = 2 * x39;
	...
	const FLT x103 = (-1 * x70 * ((x65 * x102) + (-1 * ((x72 * x97) + (x87 * x99)) * x88))) + (-1 * ((x83 * x99) + (-1 * x82 * x97)) * x86);
	const FLT x104 = 2 * x57;
	const FLT x105 = (-4 * x58) + (-1 * x104) + x89;
	const FLT x106 = (-1 * (*error_model).Pose.Pos[0]) + (-1 * x41) + (-1 * (*_x0).Pose.Pos[0]) + (-1 * x42) + (-1 * sensor_pt[0]) + (-1 * x43);
	const FLT x107 = (x49 * x100) + (-1 * x95 * x106);
	const FLT x108 = (x101 * x106) + x80 + x98;
	const FLT x109 = (-1 * x70 * ((x65 * x108) + (-1 * ((x72 * x105) + (x87 * x107)) * x88))) + (-1 * ((x83 * x107) + (-1 * x82 * x105)) * x86);
	const FLT x110 = (-1 * sensor_pt[1]) + (-1 * x34) + (-1 * x37) + (-1 * (*error_model).Pose.Pos[1]) + (-1 * (*_x0).Pose.Pos[1]) + (-1 * x35);
	const FLT x111 = (x95 * x44) + (-1 * x101 * x110);
	const FLT x112 = x90 + x104 + (x100 * x110);
	const FLT x113 = x84 + (-1 * x96) + (-4 * x45);
	const FLT x114 = (-1 * x70 * ((x65 * x113) + (-1 * ((x72 * x111) + (x87 * x112)) * x88))) + (-1 * ((x83 * x112) + (-1 * x82 * x111)) * x86);
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Pos[0])/sizeof(FLT), (-1 * x73 * x72) + (-1 * x71 * x67) + (-1 * x71));
	...
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[0])/sizeof(FLT), x91 + (x67 * x91) + (((x80 * x92) + (-1 * x83 * x90)) * x93));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[1])/sizeof(FLT), x103 + (x67 * x103) + (x93 * ((x92 * x97) + (-1 * x83 * x102))));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[2])/sizeof(FLT), x109 + (x67 * x109) + (((x92 * x105) + (-1 * x83 * x108)) * x93));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurvivePose, Rot[3])/sizeof(FLT), x114 + (x67 * x114) + (((x92 * x111) + (-1 * x83 * x113)) * x93));
}
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0ec7fd0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec7df0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec7d60>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec7eb0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec7e50>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec0880>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec7f40>]
static inline void SurviveKalmanErrorModel_LightMeas_y_gen1_jac_bsc0(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x36 = (*_x0).Pose.Pos[1] + (2 * ((x34 * x33) + (-1 * x32 * x28))) + (*error_model).Pose.Pos[1] + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + (x35 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	const FLT x37 = (x30 * sensor_pt[1]) + (-1 * x28 * sensor_pt[2]) + (x33 * sensor_pt[0]);
	const FLT x38 = (x35 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (*error_model).Pose.Pos[0] + (2 * ((x32 * x31) + (-1 * x33 * x37))) + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (*_x0).Pose.Pos[0];
	const FLT x39 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (x35 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (2 * ((x37 * x28) + (-1 * x31 * x34))) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2])) + (*error_model).Pose.Pos[2];
	...
	const FLT x47 = (x46 * x46) + (x44 * x44);
	const FLT x48 = x42 * (1. / sqrt(x47));
	const FLT x49 = 1.5707963267949 + (-1 * (*bsc0).phase) + (*bsc0).gibpha + (-1 * asin(x48 * (*bsc0).tilt)) + (-1 * atan2(-1 * x46, x45));
	const FLT x50 = sin(x49) * (*bsc0).gibmag;
	const FLT x51 = x48 * (1. / sqrt(1 + (-1 * (x42 * x42) * (1. / x47) * ((*bsc0).tilt * (*bsc0).tilt))));
	cnSetZero(Hx);
	cnMatrixOptionalSet(Hx, 0, offsetof(BaseStationCal, curve)/sizeof(FLT), atan2(x42, x45) * atan2(x42, x45));
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0ec7fd0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec7df0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec7d60>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec7eb0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec7e50>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec0880>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec7f40>]
...
static inline FLT SurviveKalmanErrorModel_LightMeas_x_gen2(const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x34 = (x33 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (2 * ((x32 * x31) + (-1 * x30 * x26))) + (*error_model).Pose.Pos[0] + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (*_x0).Pose.Pos[0];
	const FLT x35 = (-1 * x26 * sensor_pt[1]) + (x31 * sensor_pt[2]) + (x28 * sensor_pt[0]);
	const FLT x36 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (2 * ((x30 * x29) + (-1 * x31 * x35))) + (*error_model).Pose.Pos[2] + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2])) + (x33 * ((*_x0).Acc[2] + (*error_model).Acc[2]));
	const FLT x37 = (*_x0).Pose.Pos[1] + (2 * ((x35 * x26) + (-1 * x32 * x29))) + (*error_model).Pose.Pos[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + sensor_pt[1] + (x33 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	...
	const FLT x54 = (-1 * asin(x47 + ((x50 * x50) * x53 * x48 * (1. / (x49 + (-1 * x48 * sin(x45) * ((x50 * (x53 + (x50 * (x52 + (x50 * (x51 + (x50 * (-8.0108022e-06 + (-1.60216044e-05 * x50))))))))) + (x50 * x53)))))))) + x43;
	return -1.5707963267949 + x54 + (-1 * (*bsc0).phase) + (sin(x54 + (*bsc0).gibpha) * (*bsc0).gibmag);
}

// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen2 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec5d90>]
static inline void SurviveKalmanErrorModel_LightMeas_x_gen2_jac_x0(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x30 = (x1 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x29 * (*error_model).Pose.AxisAngleRot[0]) + (x2 * (*_x0).Pose.Rot[0]);
	const FLT x31 = x27 * x16;
	const FLT x32 = x31 * x11;
	const FLT x33 = (*_x0).Pose.Rot[1] + (x0 * (*_x0).Pose.Rot[0]) + (-1 * x1 * (*_x0).Pose.Rot[3]) + (x2 * (*_x0).Pose.Rot[2]);
	const FLT x34 = x25 * x23;
	const FLT x35 = x34 * x33;
	const FLT x36 = (-1 * x0 * (*_x0).Pose.Rot[1]) + (-1 * x29 * (*error_model).Pose.AxisAngleRot[1]) + (*_x0).Pose.Rot[0] + (-1 * x2 * (*_x0).Pose.Rot[3]);
	...
	const FLT x49 = (2 * ((x45 * x46) + (-1 * x43 * x38))) + (*error_model).Pose.Pos[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + sensor_pt[1] + (*_x0).Pose.Pos[1] + (x48 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	const FLT x50 = (-1 * x38 * sensor_pt[2]) + (x40 * sensor_pt[1]) + (x45 * sensor_pt[0]);
	const FLT x51 = sensor_pt[2] + (*_x0).Pose.Pos[2] + (2 * ((x50 * x38) + (-1 * x42 * x46))) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2])) + (*error_model).Pose.Pos[2] + (x48 * ((*_x0).Acc[2] + (*error_model).Acc[2]));
	const FLT x52 = (x48 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + sensor_pt[0] + (2 * ((x42 * x43) + (-1 * x50 * x45))) + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (*error_model).Pose.Pos[0] + (*_x0).Pose.Pos[0];
	...
	const FLT x146 = x136 + (-1 * x93 * (x130 + (x113 * x145) + (-1 * x137 * x143) + (-1 * x141 * ((x137 * x140) + (-1 * x86 * ((x67 * x126) + (x67 * ((x113 * x115) + x126 + (x67 * (x124 + (x67 * ((x113 * x120) + x117 + (-1 * x113 * x119))) + (x113 * x121))))) + (x113 * x128) + (x113 * x127))))) + (x91 * x126)));
	...
	const FLT x164 = x162 + (-1 * x93 * (x161 + (-1 * x141 * ((x163 * x140) + (-1 * x86 * ((x72 * x158) + (x67 * x160) + (x67 * ((x115 * x156) + x160 + (x67 * (x159 + (x67 * (x157 + (x120 * x156) + (-1 * x118 * x158))) + (x75 * x158))))) + (x77 * x158))))) + (x91 * x160) + (x144 * x158) + (-1 * x163 * x143)));
	...
	const FLT x177 = x170 + (-1 * x93 * ((-1 * x141 * ((x171 * x140) + (-1 * x86 * ((x77 * x174) + (x67 * x176) + (x72 * x174) + (x67 * (x176 + (x115 * x172) + (x67 * (x175 + (x67 * ((x120 * x172) + (-1 * x118 * x174) + x173)) + (x75 * x174))))))))) + (x174 * x144) + (-1 * x171 * x143) + x169 + (x91 * x176)));
	...
	const FLT x200 = x198 + (-1 * x93 * ((x193 * x145) + (-1 * x141 * ((x199 * x140) + (-1 * x86 * ((x128 * x193) + (x67 * x196) + (x67 * (x196 + (x115 * x193) + (x67 * (x195 + (x67 * ((x120 * x193) + x194 + (-1 * x119 * x193))) + (x121 * x193))))) + (x127 * x193))))) + (x91 * x196) + x197 + (-1 * x199 * x143)));
	...
	const FLT x216 = x210 + (-1 * x93 * ((x212 * x145) + (-1 * x141 * ((x211 * x140) + (-1 * x86 * ((x212 * x128) + (x67 * x215) + (x67 * ((x212 * x115) + x215 + (x67 * (x214 + (x67 * ((x212 * x120) + x213 + (-1 * x212 * x119))) + (x212 * x121))))) + (x212 * x127))))) + x209 + (-1 * x211 * x143) + (x91 * x215)));
	...
	const FLT x228 = x226 + (-1 * x93 * ((-1 * x141 * ((x227 * x140) + (-1 * x86 * ((x67 * x224) + (x221 * x128) + (x67 * (x224 + (x221 * x115) + (x67 * (x223 + (x67 * ((x221 * x120) + x222 + (-1 * x221 * x119))) + (x221 * x121))))) + (x221 * x127))))) + x225 + (x221 * x145) + (x91 * x224) + (-1 * x227 * x143)));
	...
	const FLT x278 = x276 + (-1 * x93 * (x275 + (-1 * x277 * x143) + (-1 * x141 * ((x277 * x140) + (-1 * x86 * ((x67 * (x274 + (x271 * x115) + (x67 * ((x67 * (x272 + (x271 * x120) + (-1 * x271 * x119))) + x273 + (x271 * x121))))) + (x271 * x128) + (x67 * x274) + (x271 * x127))))) + (x271 * x145) + (x91 * x274)));
	...
	const FLT x310 = x304 + (-1 * x93 * (x303 + (x91 * x309) + (-1 * x305 * x143) + (x306 * x145) + (-1 * x141 * ((x305 * x140) + (-1 * x86 * ((x306 * x128) + (x67 * x309) + (x67 * (x309 + (x306 * x115) + (x67 * (x308 + (x67 * ((x306 * x120) + (-1 * x306 * x119) + x307)) + (x306 * x121))))) + (x306 * x127)))))));
	...
	const FLT x338 = x336 + (-1 * x93 * ((x331 * x145) + (-1 * x337 * x143) + x335 + (-1 * x141 * ((x337 * x140) + (-1 * x86 * ((x331 * x128) + (x67 * x334) + (x331 * x127) + (x67 * (x334 + (x331 * x115) + (x67 * (x333 + (x67 * ((x331 * x120) + (-1 * x331 * x119) + x332)) + (x331 * x121))))))))) + (x91 * x334)));
	...
	const FLT x363 = x361 + (-1 * x93 * (x360 + (-1 * x141 * ((x362 * x139) + (-1 * x86 * ((x356 * x128) + (x67 * x359) + (x67 * (x359 + (x356 * x115) + (x67 * ((x67 * ((x356 * x120) + x357 + (-1 * x356 * x119))) + x358 + (x356 * x121))))) + (x356 * x127))))) + (x356 * x145) + (x91 * x359) + (-1 * x362 * x142)));
	...
	const FLT x388 = (-1 * x369 * x386) + (x6 * x385) + (x12 * x385) + (x378 * x375) + (-1 * x8 * x387) + (-1 * x375 * x381) + (x8 * x380) + (-1 * x8 * x383);
	...
	const FLT x414 = (-1 * x401 * x399) + x413 + (-1 * x17 * x398) + x408 + (x365 * x367) + (-1 * x396 * x365) + (-1 * x372 * x370) + x368 + (-1 * x394 * x388) + (x373 * x392);
	...
	const FLT x427 = (-1 * x424 * x369) + (-1 * x17 * x392) + x422 + (x425 * x365) + (-1 * x417 * x365) + x416 + x426 + (-1 * x421 * x388) + (x419 * x399) + (-1 * x373 * x398) + (-1 * x420);
	...
	const FLT x437 = (-1 * x399 * x398) + x430 + (-1 * x419 * x373) + (x411 * x365) + (-1 * x428 * x370) + (-1 * x432) + (x17 * x401) + (-1 * x409 * x365) + x433 + (-1 * x434 * x388) + x436 + (-1 * x435);
	...
	const FLT x446 = (-1 * x444 * x369) + x445 + (x17 * x419) + (x399 * x392) + (x406 * x365) + (-1 * x402 * x365) + x439 + x441 + (-1 * x442) + (-1 * x440 * x388) + (x401 * x373);
	...
	const FLT x468 = x466 + (-1 * x93 * ((x462 * x144) + x465 + (-1 * x141 * ((x467 * x140) + (-1 * x86 * ((x67 * x464) + (x460 * x128) + (x67 * (x464 + (x460 * x115) + (x67 * (x463 + (x67 * ((x460 * x120) + x461 + (-1 * x462 * x118))) + (x460 * x121))))) + (x460 * x127))))) + (x91 * x464) + (-1 * x467 * x143)));
	const FLT x469 = x12 * x364;
	const FLT x470 = x9 * x384;
	const FLT x471 = x9 * x382;
	const FLT x472 = x4 * x11;
	const FLT x473 = x11 * x11 * x11;
	const FLT x474 = (-1 * x473 * x382) + (x472 * x379) + (-1 * x11 * x471) + (x11 * x470) + (x473 * x384) + (-1 * x472 * x386) + (-1 * x11 * x383) + (x6 * x11 * x384);
	...
	const FLT x481 = x426 + x480 + (-1 * x477 * x428) + (x474 * x475) + (-1 * x469 * x425) + (-1 * x478 * x399) + x415 + (-1 * x474 * x434) + (-1 * x476 * x418) + (x469 * x417);
	const FLT x482 = x474 * x391;
	const FLT x483 = x479 * x402;
	const FLT x484 = x479 * x406;
	const FLT x485 = x418 * x399;
	const FLT x486 = (-1 * x472 * x424) + x436 + (-1 * x469 * x409) + (-1 * x17 * x482) + (-1 * x478 * x373) + (-1 * x433) + (-1 * x484) + (x469 * x411) + (-1 * x474 * x421) + x483 + (x474 * x485) + x432;
	const FLT x487 = x479 * x425;
	const FLT x488 = x17 * x418;
	const FLT x489 = x479 * x417;
	const FLT x490 = -1 * x368;
	const FLT x491 = (x482 * x399) + (-1 * x474 * x440) + (x469 * x396) + (-1 * x472 * x444) + x490 + (-1 * x489) + x408 + x487 + (-1 * x469 * x367) + (x474 * x488) + (x476 * x400);
	...
	const FLT x495 = (-1 * x493 * x474) + (-1 * x477 * x372) + x494 + (-1 * x474 * x394) + (-1 * x441) + x439 + x442 + (-1 * x17 * x478) + (x476 * x391) + (-1 * x469 * x402) + (x469 * x406);
	...
	const FLT x515 = x513 + (-1 * x93 * (x512 + (x508 * x145) + (-1 * x514 * x143) + (x91 * x511) + (-1 * x141 * ((x514 * x140) + (-1 * x86 * ((x508 * x128) + (x67 * x511) + (x508 * x127) + (x67 * (x511 + (x508 * x115) + (x67 * (x510 + (x67 * ((x508 * x120) + x509 + (-1 * x508 * x119))) + (x508 * x121)))))))))));
	const FLT x516 = x5 * x5 * x5;
	const FLT x517 = x4 * x17;
	const FLT x518 = (-1 * x517 * x377) + (x5 * x470) + (x5 * x12 * x384) + (x5 * x380) + (-1 * x516 * x382) + (-1 * x5 * x387) + (x516 * x384) + (-1 * x5 * x471);
	const FLT x519 = x6 * x364;
	const FLT x520 = x518 * x373;
	const FLT x521 = x518 * x397;
	const FLT x522 = (-1 * x521 * x399) + (-1 * x434 * x518) + x413 + (x519 * x396) + (-1 * x487) + x489 + (-1 * x418 * x520) + x490 + (x475 * x518) + (-1 * x519 * x367) + (-1 * x428 * x517);
	const FLT x523 = x518 * x391;
	const FLT x524 = (-1 * x493 * x518) + (x523 * x373) + (-1 * x517 * x372) + x435 + x436 + (-1 * x409 * x519) + (-1 * x17 * x521) + (x411 * x519) + x484 + (-1 * x483) + (-1 * x430) + (-1 * x518 * x394);
	const FLT x525 = x445 + (-1 * x421 * x518) + x494 + (x485 * x518) + (-1 * x423 * x517) + (-1 * x17 * x523) + (x402 * x519) + (-1 * x521 * x373) + (-1 * x406 * x519) + x438;
	const FLT x526 = x480 + (x425 * x519) + x420 + (-1 * x417 * x519) + (-1 * x443 * x517) + (x488 * x518) + x416 + (x523 * x399) + (-1 * x422) + (x400 * x520) + (-1 * x440 * x518);
	...
	const FLT x547 = x541 + (-1 * x93 * (x540 + (x543 * x145) + (x91 * x546) + (-1 * x542 * x143) + (-1 * x141 * ((x542 * x140) + (-1 * x86 * ((x543 * x127) + (x67 * x546) + (x543 * x128) + (x67 * (x546 + (x543 * x115) + (x67 * (x545 + (x67 * ((x543 * x120) + x544 + (-1 * x543 * x119))) + (x543 * x121)))))))))));
	...
	const FLT x565 = x563 + (-1 * x93 * (x562 + (x91 * x561) + (-1 * x141 * ((x564 * x140) + (-1 * x86 * ((x558 * x128) + (x67 * (x561 + (x558 * x115) + (x67 * (x560 + (x67 * ((x558 * x120) + (-1 * x558 * x119) + x559)) + (x558 * x121))))) + (x558 * x127) + (x67 * x561))))) + (x558 * x145) + (-1 * x564 * x143)));
	...
	const FLT x581 = x579 + (-1 * x93 * ((x574 * x144) + (x91 * x577) + x578 + (-1 * x141 * ((x580 * x140) + (-1 * x86 * ((x573 * x128) + (x67 * x577) + (x67 * (x577 + (x573 * x115) + (x67 * (x576 + (x67 * ((-1 * x574 * x118) + (x573 * x120) + x575)) + (x573 * x121))))) + (x77 * x574))))) + (-1 * x580 * x143)));
	...
	const FLT x593 = x591 + (-1 * x93 * (x590 + (x586 * x145) + (-1 * x141 * ((x592 * x140) + (-1 * x86 * ((x67 * x589) + (x586 * x128) + (x67 * (x589 + (x586 * x115) + (x67 * (x588 + (x67 * ((x586 * x120) + x587 + (-1 * x586 * x119))) + (x586 * x121))))) + (x586 * x127))))) + (x91 * x589) + (-1 * x592 * x143)));
	cnSetZero(Hx);
	...
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x468 + (x468 * x147));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x515 + (x515 * x147));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x547 + (x547 * x147));
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen2 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec5d90>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen2 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec4880>]
static inline void SurviveKalmanErrorModel_LightMeas_x_gen2_jac_error_model(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x30 = (*_x0).Pose.Rot[3] + (-1 * x1 * (*_x0).Pose.Rot[2]) + (x29 * (*_x0).Pose.Rot[1]) + (x2 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x31 = x30 * x27;
	const FLT x32 = (*_x0).Pose.Rot[1] + (x2 * (*error_model).Pose.AxisAngleRot[0]) + (-1 * x29 * (*_x0).Pose.Rot[3]) + (x3 * (*_x0).Pose.Rot[2]);
	const FLT x33 = x23 * x21;
	const FLT x34 = x32 * x33;
	const FLT x35 = (-1 * x1 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[0] + (-1 * x29 * (*_x0).Pose.Rot[2]) + (-1 * x3 * (*_x0).Pose.Rot[3]);
	...
	const FLT x50 = (*_x0).Pose.Pos[1] + (2 * ((x46 * x47) + (-1 * x44 * x38))) + (*error_model).Pose.Pos[1] + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + (x49 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	const FLT x51 = (-1 * x38 * sensor_pt[2]) + (x41 * sensor_pt[1]) + (x46 * sensor_pt[0]);
	const FLT x52 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (2 * ((x51 * x38) + (-1 * x43 * x47))) + (*error_model).Pose.Pos[2] + (x49 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2]));
	const FLT x53 = (x49 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (2 * ((x43 * x44) + (-1 * x51 * x46))) + (*_x0).Pose.Pos[0] + (*error_model).Pose.Pos[0] + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0]));
	...
	const FLT x148 = x137 + (-1 * x94 * (x131 + (x114 * x147) + (-1 * x138 * x145) + (-1 * x143 * ((x138 * x141) + (-1 * x88 * ((x68 * x127) + (x68 * (x127 + (x114 * x116) + (x68 * (x125 + (x68 * (x118 + (x114 * x121) + (-1 * x114 * x120))) + (x114 * x122))))) + (x114 * x129) + (x114 * x128))))) + (x92 * x127)));
	...
	const FLT x165 = x163 + (-1 * x94 * ((x147 * x158) + (-1 * x143 * ((x164 * x141) + (-1 * x88 * ((x129 * x158) + (x68 * x161) + (x68 * (x161 + (x116 * x158) + (x68 * (x160 + (x68 * ((x121 * x158) + x159 + (-1 * x120 * x158))) + (x122 * x158))))) + (x128 * x158))))) + x162 + (x92 * x161) + (-1 * x164 * x145)));
	...
	const FLT x178 = x171 + (-1 * x94 * ((x175 * x146) + (-1 * x143 * ((x172 * x141) + (-1 * x88 * ((x129 * x173) + (x85 * x175) + (x68 * x177) + (x68 * ((x84 * x175) + x177 + (x68 * (x176 + (x68 * ((x121 * x173) + (-1 * x119 * x175) + x174)) + (x122 * x173))))))))) + (-1 * x172 * x145) + x170 + (x92 * x177)));
	...
	const FLT x191 = (-1 * x186 * (*_x0).Pose.Rot[3]) + (-1 * x184 * (*_x0).Pose.Rot[1]) + (-1 * x190 * (*_x0).Pose.Rot[2]) + (x2 * x33);
	...
	const FLT x235 = x233 + (-1 * x94 * ((x228 * x147) + x232 + (-1 * x234 * x145) + (-1 * x143 * ((x234 * x141) + (-1 * x88 * ((x228 * x129) + (x68 * x231) + (x68 * (x231 + (x228 * x116) + (x68 * (x230 + (x68 * ((x228 * x121) + x229 + (-1 * x228 * x120))) + (x228 * x122))))) + (x228 * x128))))) + (x92 * x231)));
	...
	const FLT x265 = x263 + (-1 * x94 * ((-1 * x264 * x145) + x262 + (x92 * x261) + (x258 * x147) + (-1 * x143 * ((x264 * x141) + (-1 * x88 * ((x258 * x129) + (x68 * x261) + (x68 * (x261 + (x258 * x116) + (x68 * ((x68 * ((x258 * x121) + (-1 * x258 * x120) + x259)) + x260 + (x258 * x122))))) + (x258 * x128)))))));
	...
	const FLT x287 = x285 + (-1 * x94 * (x284 + (-1 * x286 * x145) + (x280 * x147) + (-1 * x143 * ((x286 * x141) + (-1 * x88 * ((x280 * x129) + (x68 * x283) + (x68 * (x283 + (x280 * x116) + (x68 * (x282 + (x68 * ((x280 * x121) + x281 + (-1 * x280 * x120))) + (x280 * x122))))) + (x280 * x128))))) + (x92 * x283)));
	...
	const FLT x307 = x305 + (-1 * x94 * ((-1 * x143 * ((x306 * x141) + (-1 * x88 * ((x68 * x303) + (x300 * x129) + (x68 * (x303 + (x300 * x116) + (x68 * (x302 + (x68 * (x301 + (x300 * x121) + (-1 * x300 * x120))) + (x300 * x122))))) + (x300 * x128))))) + x304 + (x300 * x147) + (x92 * x303) + (-1 * x306 * x145)));
	...
	const FLT x323 = x317 + (-1 * x94 * ((x319 * x147) + x316 + (-1 * x143 * ((x318 * x141) + (-1 * x88 * ((x319 * x129) + (x68 * (x322 + (x319 * x116) + (x68 * (x321 + (x68 * ((x319 * x121) + x320 + (-1 * x319 * x120))) + (x319 * x122))))) + (x68 * x322) + (x319 * x128))))) + (-1 * x318 * x145) + (x92 * x322)));
	...
	const FLT x335 = x333 + (-1 * x94 * (x332 + (-1 * x143 * ((x334 * x141) + (-1 * x88 * ((x328 * x129) + (x68 * x331) + (x68 * (x331 + (x328 * x116) + (x68 * (x330 + (x68 * ((x328 * x121) + x329 + (-1 * x328 * x120))) + (x328 * x122))))) + (x328 * x128))))) + (x328 * x147) + (x92 * x331) + (-1 * x334 * x145)));
	...
	const FLT x358 = (-1 * x8 * x357) + (x12 * x356) + (-1 * x12 * x355) + (x350 * x345) + (-1 * x354 * x345) + (x8 * x352) + (x6 * x356) + (-1 * x6 * x355);
	...
	const FLT x380 = x373 + (-1 * x369 * x358) + (-1 * x0 * x367) + (-1 * x363 * x365) + x28 + (-1 * x8 * x342) + (x42 * x338) + x379 + (x11 * x360) + (-1 * x30 * x362);
	...
	const FLT x390 = (x365 * x340) + x384 + (-1 * x4 * x362) + x381 + (x382 * x358) + x389 + (-1 * x363 * x386) + (-1 * x0 * x360) + (-1 * x11 * x367) + (-1 * x45 * x338) + (-1 * x383);
	...
	const FLT x405 = (-1 * x8 * x367) + (x395 * x396) + (-1 * x404) + (x39 * x338) + x394 + (-1 * x376 * x386) + (-1 * x32 * x362) + (-1 * x392 * x358) + (-1 * x399) + x402 + (-1 * x36 * x365) + x37;
	...
	const FLT x413 = (-1 * x36 * x386) + (x368 * x359) + (x376 * x365) + (x396 * x391) + (-1 * x411) + (-1 * x34 * x338) + x412 + x406 + (-1 * x35 * x362) + x408 + (x409 * x358);
	...
	const FLT x434 = x432 + (-1 * x94 * ((x427 * x147) + x431 + (-1 * x143 * ((x433 * x141) + (-1 * x88 * ((x427 * x129) + (x68 * x430) + (x68 * (x430 + (x427 * x116) + (x68 * (x429 + (x68 * ((x427 * x121) + x428 + (-1 * x427 * x120))) + (x427 * x122))))) + (x427 * x128))))) + (x92 * x430) + (-1 * x433 * x145)));
	const FLT x435 = x9 * x350;
	const FLT x436 = x9 * x354;
	const FLT x437 = x6 * x11;
	const FLT x438 = (x11 * x11 * x11) * x346;
	const FLT x439 = (-1 * x438 * x353) + (x11 * x352) + (x438 * x349) + (x11 * x435) + (-1 * x11 * x436) + (-1 * x11 * x357) + (-1 * x437 * x354) + (x437 * x350);
	...
	const FLT x445 = x389 + (-1 * x439 * x443) + x444 + (-1 * x442 * x376) + x31 + (x0 * x440) + (-1 * x12 * x397) + (x12 * x400) + (-1 * x439 * x392) + (-1 * x32 * x441);
	const FLT x446 = x11 * x366;
	const FLT x447 = x0 * x439;
	const FLT x448 = x32 * x344;
	const FLT x449 = x0 * x375;
	const FLT x450 = x0 * x378;
	const FLT x451 = (-1 * x442 * x363) + x449 + x37 + (-1 * x4 * x441) + (x439 * x382) + (-1 * x402) + (-1 * x12 * x370) + (x12 * x372) + (-1 * x448 * x447) + (-1 * x439 * x446) + (-1 * x450) + x399;
	const FLT x452 = -1 * x28;
	const FLT x453 = x0 * x398;
	const FLT x454 = x0 * x401;
	const FLT x455 = (x12 * x393) + (-1 * x36 * x442) + (-1 * x454) + (-1 * x35 * x441) + (-1 * x12 * x403) + x452 + (x447 * x391) + x453 + x379 + (x32 * x439 * x368) + (x11 * x440);
	...
	const FLT x459 = (-1 * x408) + (-1 * x439 * x369) + x406 + (-1 * x12 * x374) + (-1 * x30 * x441) + (x12 * x377) + (-1 * x11 * x342) + x411 + (-1 * x447 * x366) + x458 + (x457 * x439);
	...
	const FLT x479 = x477 + (-1 * x94 * (x476 + (x472 * x147) + (-1 * x478 * x145) + (x92 * x475) + (-1 * x143 * ((x478 * x141) + (-1 * x88 * ((x68 * x475) + (x472 * x128) + (x472 * x129) + (x68 * (x475 + (x472 * x116) + (x68 * (x474 + (x68 * (x473 + (x472 * x121) + (-1 * x472 * x120))) + (x472 * x122)))))))))));
	const FLT x480 = x0 * x0 * x0;
	const FLT x481 = x0 * x5;
	const FLT x482 = x0 * x12;
	const FLT x483 = x25 * x481;
	const FLT x484 = (x482 * x350) + (-1 * x483 * x348) + (-1 * x480 * x354) + (x480 * x350) + (x0 * x435) + (-1 * x0 * x436) + (x481 * x351) + (-1 * x482 * x354);
	const FLT x485 = x0 * x484;
	const FLT x486 = 0.5 * x483;
	const FLT x487 = x484 * x361;
	const FLT x488 = (-1 * x32 * x487) + x454 + (x485 * x395) + (-1 * x484 * x392) + (-1 * x453) + (-1 * x484 * x443) + (x6 * x393) + x452 + (-1 * x6 * x403) + x373 + (-1 * x486 * x376);
	const FLT x489 = x484 * x368;
	const FLT x490 = (-1 * x4 * x489) + x450 + (-1 * x483 * x341) + (x6 * x372) + x404 + (-1 * x394) + x37 + (-1 * x485 * x366) + (-1 * x449) + (x457 * x484) + (-1 * x6 * x370) + (-1 * x30 * x487);
	const FLT x491 = x412 + (-1 * x486 * x363) + (-1 * x485 * x448) + (-1 * x6 * x377) + x458 + (x6 * x374) + (x30 * x489) + (-1 * x4 * x487) + (-1 * x484 * x446) + x40;
	const FLT x492 = x444 + (x32 * x489) + x383 + (x485 * x391) + (-1 * x6 * x400) + (-1 * x36 * x486) + (-1 * x384) + (-1 * x35 * x487) + (x6 * x397) + x381 + (x484 * x409);
	...
	const FLT x513 = x507 + (-1 * x94 * (x506 + (-1 * x508 * x144) + (x509 * x147) + (x92 * x512) + (-1 * x143 * ((x508 * x140) + (-1 * x88 * ((x509 * x128) + (x509 * x129) + (x68 * x512) + (x68 * (x512 + (x509 * x116) + (x68 * (x511 + (x68 * ((x509 * x121) + x510 + (-1 * x509 * x120))) + (x509 * x122)))))))))));
	...
	const FLT x532 = x530 + (-1 * x94 * ((x528 * x146) + (x92 * x527) + x529 + (-1 * x143 * ((x531 * x141) + (-1 * x88 * ((x68 * (x527 + (x524 * x116) + (x68 * (x526 + (x68 * ((-1 * x528 * x119) + (x524 * x121) + x525)) + (x524 * x122))))) + (x524 * x129) + (x524 * x128) + (x68 * x527))))) + (-1 * x531 * x145)));
	...
	const FLT x548 = x546 + (-1 * x94 * (x545 + (x541 * x146) + (x92 * x544) + (-1 * x143 * ((x547 * x141) + (-1 * x88 * ((x73 * x541) + (x68 * x544) + (x68 * (x544 + (x84 * x541) + (x68 * ((x68 * ((x540 * x121) + (-1 * x541 * x119) + x542)) + x543 + (x83 * x541))))) + (x85 * x541))))) + (-1 * x547 * x145)));
	...
	const FLT x560 = x558 + (-1 * x94 * ((x553 * x147) + (-1 * x143 * ((x559 * x141) + (-1 * x88 * ((x553 * x129) + (x68 * x556) + (x68 * (x556 + (x553 * x116) + (x68 * (x555 + (x68 * ((x553 * x121) + x554 + (-1 * x553 * x120))) + (x553 * x122))))) + (x553 * x128))))) + x557 + (x92 * x556) + (-1 * x559 * x145)));
	cnSetZero(Hx);
	...
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x235 + (x235 * x149));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x265 + (x265 * x149));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x287 + (x287 * x149));
	...
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x434 + (x434 * x149));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x479 + (x479 * x149));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x513 + (x513 * x149));
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen2 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ec4880>]
...
static inline void SurviveKalmanErrorModel_LightMeas_x_gen2_jac_sensor_pt(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x21 = (*_x0).Pose.Rot[3] + (x1 * (*_x0).Pose.Rot[1]) + (-1 * x0 * (*_x0).Pose.Rot[2]) + (x2 * (*_x0).Pose.Rot[0]);
	const FLT x22 = x21 * x18;
	const FLT x23 = x9 * x22;
	const FLT x24 = (*_x0).Pose.Rot[1] + (x0 * (*_x0).Pose.Rot[0]) + (-1 * x1 * (*_x0).Pose.Rot[3]) + (x2 * (*_x0).Pose.Rot[2]);
	const FLT x25 = x17 * x16;
	const FLT x26 = x24 * x25;
	const FLT x27 = (-1 * x0 * (*_x0).Pose.Rot[1]) + (-1 * x1 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x2 * (*_x0).Pose.Rot[3]);
	...
	const FLT x45 = (-1 * x44 * sensor_pt[1]) + (x38 * sensor_pt[2]) + (x33 * sensor_pt[0]);
	const FLT x46 = 1.0/2.0 * dt * fabs(dt);
	const FLT x47 = (*_x0).Pose.Pos[1] + (2 * ((x44 * x45) + (-1 * x30 * x39))) + (*error_model).Pose.Pos[1] + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + (x46 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	const FLT x48 = (-1 * x30 * sensor_pt[2]) + (x33 * sensor_pt[1]) + (x44 * sensor_pt[0]);
	const FLT x49 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (2 * ((x48 * x30) + (-1 * x45 * x38))) + (*error_model).Pose.Pos[2] + (x46 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2]));
	const FLT x50 = (x46 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (2 * ((x38 * x39) + (-1 * x44 * x48))) + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (*error_model).Pose.Pos[0] + (*_x0).Pose.Pos[0];
	const FLT x51 = (-1 * x50 * (*lh_p).Rot[2]) + (x47 * (*lh_p).Rot[1]) + (x49 * (*lh_p).Rot[0]);
	const FLT x52 = (-1 * x47 * (*lh_p).Rot[3]) + (x50 * (*lh_p).Rot[0]) + (x49 * (*lh_p).Rot[2]);
	const FLT x53 = x47 + (*lh_p).Pos[1] + (2 * ((x52 * (*lh_p).Rot[3]) + (-1 * x51 * (*lh_p).Rot[1])));
	...
	const FLT x142 = x124 + (-1 * x141 * (x118 + (x102 * x139) + (-1 * x125 * x138) + (-1 * x134 * ((x125 * x130) + (-1 * x116 * ((x101 * x108) + (x65 * ((x72 * x102) + x105 + (x65 * (x104 + (x65 * ((x66 * x102) + x103 + (-1 * x102 * x106))) + (x101 * x107))))) + (x74 * x102) + (x65 * x105))))) + (x105 * x136)));
	...
	const FLT x164 = x157 + (-1 * x141 * (x156 + (x163 * x136) + (x160 * x139) + (-1 * x137 * x158) + (-1 * x134 * ((x129 * x158) + (-1 * x116 * ((x108 * x159) + (x65 * ((x72 * x160) + x163 + (x65 * ((x65 * ((x66 * x160) + x161 + (-1 * x106 * x160))) + x162 + (x107 * x159))))) + (x74 * x160) + (x65 * x163)))))));
	...
	const FLT x184 = x182 + (-1 * x141 * (x181 + (-1 * x183 * x138) + (-1 * x134 * ((x183 * x130) + (-1 * x116 * ((x108 * x176) + (x65 * x180) + (x65 * (x180 + (x72 * x177) + (x65 * (x179 + (x65 * ((x66 * x177) + (-1 * x106 * x177) + x178)) + (x107 * x176))))) + (x74 * x177))))) + (x177 * x139) + (x180 * x136)));
...
static inline void SurviveKalmanErrorModel_LightMeas_x_gen2_jac_lh_p(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x21 = (x2 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x1 * (*_x0).Pose.Rot[2]) + (x20 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x22 = x21 * x18;
	const FLT x23 = (*_x0).Pose.Rot[1] + (x20 * (*error_model).Pose.AxisAngleRot[0]) + (-1 * x2 * (*_x0).Pose.Rot[3]) + (x3 * (*_x0).Pose.Rot[2]);
	const FLT x24 = x17 * x16;
	const FLT x25 = (-1 * x1 * (*_x0).Pose.Rot[1]) + (-1 * x2 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x3 * (*_x0).Pose.Rot[3]);
	const FLT x26 = x25 * x18;
	const FLT x27 = (x7 * x26) + (x24 * x23) + (-1 * x0 * x19) + (x9 * x22);
	const FLT x28 = x23 * x18;
	const FLT x29 = (-1 * x7 * x28) + (-1 * x0 * x22) + (-1 * x9 * x19) + (x24 * x25);
	...
	const FLT x126 = x109 + (-1 * x97 * ((-1 * x125 * ((x110 * x124) + (-1 * x90 * ((-1 * x76 * x115) + (-1 * x114 * x122) + (x71 * ((-1 * x80 * x115) + x118 + (x71 * (x117 + (x71 * (x116 + (-1 * x114 * x120) + (x119 * x115))) + (-1 * x114 * x121))))) + (x71 * x118))))) + (-1 * x110 * x113) + (x95 * x118) + (-1 * x100) + (-1 * x101 * x106)));
	...
	const FLT x135 = x97 * ((-1 * x125 * ((x124 * x131) + (-1 * x90 * ((x76 * x129) + (x71 * (x134 + (x80 * x129) + (x71 * (x133 + (x71 * ((x78 * x129) + x132 + (-1 * x119 * x129))) + (x121 * x128))))) + (x122 * x128) + (x71 * x134))))) + (-1 * x113 * x131) + x86 + (x95 * x134) + (x129 * x130));
	...
	const FLT x146 = (-1 * x139) + (-1 * x97 * ((-1 * x125 * ((x124 * x140) + (-1 * x90 * ((x71 * x145) + (-1 * x76 * x142) + (x71 * ((-1 * x80 * x142) + x145 + (x71 * ((x71 * ((-1 * x120 * x141) + x143 + (x119 * x142))) + x144 + (-1 * x121 * x141))))) + (-1 * x122 * x141))))) + (x95 * x145) + (-1 * x113 * x140) + (-1 * x137) + (-1 * x106 * x138)));
	...
	const FLT x168 = x166 + (-1 * x97 * (x162 + (x95 * x160) + (x130 * x157) + (-1 * x125 * ((x124 * x167) + (-1 * x90 * ((x76 * x157) + (x71 * x160) + (x71 * (x160 + (x80 * x157) + (x71 * (x159 + (x71 * (x158 + (x78 * x157) + (-1 * x119 * x157))) + (x121 * x156))))) + (x122 * x156))))) + (-1 * x113 * x167)));
	const FLT x169 = 2 * x45;
	const FLT x170 = (-1 * x169) + (-4 * x39) + x152;
	const FLT x171 = 2 * ((-1 * x42) + (-1 * sensor_pt[2]) + (-1 * x41) + (-1 * (*_x0).Pose.Pos[2]) + (-1 * x43) + (-1 * (*error_model).Pose.Pos[2]));
	const FLT x172 = 2 * (*lh_p).Rot[2];
	...
	const FLT x185 = x183 + (-1 * x97 * ((x178 * x130) + (-1 * x113 * x184) + (-1 * x125 * ((x124 * x184) + (-1 * x90 * ((x76 * x178) + (x71 * x181) + (x71 * (x181 + (x80 * x178) + (x71 * ((x71 * ((x78 * x178) + (-1 * x119 * x178) + x179)) + x180 + (x121 * x177))))) + (x122 * x177))))) + x182 + (x95 * x181)));
	const FLT x186 = (-1 * (*error_model).Pose.Pos[0]) + (-1 * x46) + (-1 * (*_x0).Pose.Pos[0]) + (-1 * sensor_pt[0]) + (-1 * x47) + (-1 * x48);
	...
	const FLT x202 = x200 + (-1 * x97 * (x199 + (x95 * x198) + (-1 * x201 * x112) + (x195 * x130) + (-1 * x125 * ((x201 * x123) + (-1 * x90 * ((x76 * x195) + (x71 * x198) + (x71 * (x198 + (x80 * x195) + (x71 * (x197 + (x71 * ((x78 * x195) + (-1 * x119 * x195) + x196)) + (x121 * x194))))) + (x122 * x194)))))));
	const FLT x203 = (-1 * sensor_pt[1]) + (-1 * x34) + (-1 * x37) + (-1 * (*error_model).Pose.Pos[1]) + (-1 * (*_x0).Pose.Pos[1]) + (-1 * x35);
	...
	const FLT x216 = x214 + (-1 * x97 * (x213 + (x209 * x130) + (x95 * x212) + (-1 * x125 * ((x215 * x124) + (-1 * x90 * ((x76 * x209) + (x71 * (x212 + (x80 * x209) + (x71 * (x211 + (x71 * ((x78 * x209) + x210 + (-1 * x209 * x119))) + (x208 * x121))))) + (x208 * x122) + (x71 * x212))))) + (-1 * x215 * x113)));
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0eba1f0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ebaf10>, <cnkalman.codegen.WrapMember object at 0x7f2ed0eba700>, <cnkalman.codegen.WrapMember object at 0x7f2ed0eba340>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ebac10>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec40a0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ebabe0>]
static inline void SurviveKalmanErrorModel_LightMeas_x_gen2_jac_bsc0(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x3 = (*_x0).Pose.Rot[1] + (x2 * (*_x0).Pose.Rot[0]) + (-1 * x0 * (*error_model).Pose.AxisAngleRot[1]) + (x1 * (*_x0).Pose.Rot[2]);
	const FLT x4 = (*_x0).Velocity.AxisAngleRot[1] + (*error_model).Velocity.AxisAngleRot[1];
	const FLT x5 = dt * dt;
	const FLT x6 = (*_x0).Velocity.AxisAngleRot[2] + (*error_model).Velocity.AxisAngleRot[2];
	const FLT x7 = (x6 * x6) * x5;
	...
	const FLT x19 = x4 * x18;
	const FLT x20 = 0.5 * (*error_model).Pose.AxisAngleRot[1];
	const FLT x21 = (-1 * x2 * (*_x0).Pose.Rot[1]) + (-1 * x20 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x0 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x22 = x6 * x18;
	const FLT x23 = (x20 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x2 * (*_x0).Pose.Rot[2]) + (x1 * (*_x0).Pose.Rot[0]);
	const FLT x24 = x17 * x16;
	const FLT x25 = (-1 * x1 * (*_x0).Pose.Rot[1]) + (x20 * (*_x0).Pose.Rot[0]) + (x0 * (*error_model).Pose.AxisAngleRot[0]) + (*_x0).Pose.Rot[2];
	...
	const FLT x32 = (-1 * x31 * sensor_pt[0]) + (x29 * sensor_pt[1]) + (x28 * sensor_pt[2]);
	const FLT x33 = 1.0/2.0 * dt * fabs(dt);
	const FLT x34 = (x33 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (2 * ((x32 * x31) + (-1 * x30 * x27))) + (*error_model).Pose.Pos[0] + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (*_x0).Pose.Pos[0];
	const FLT x35 = (x31 * sensor_pt[2]) + (-1 * x27 * sensor_pt[1]) + (x28 * sensor_pt[0]);
	const FLT x36 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (2 * ((x30 * x29) + (-1 * x31 * x35))) + (*error_model).Pose.Pos[2] + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2])) + (x33 * ((*_x0).Acc[2] + (*error_model).Acc[2]));
	const FLT x37 = (*_x0).Pose.Pos[1] + (2 * ((x35 * x27) + (-1 * x32 * x29))) + (*error_model).Pose.Pos[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + sensor_pt[1] + (x33 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	const FLT x38 = (-1 * x37 * (*lh_p).Rot[3]) + (x34 * (*lh_p).Rot[0]) + (x36 * (*lh_p).Rot[2]);
	const FLT x39 = (-1 * x36 * (*lh_p).Rot[1]) + (x37 * (*lh_p).Rot[0]) + (x34 * (*lh_p).Rot[3]);
	const FLT x40 = x36 + (2 * ((x39 * (*lh_p).Rot[1]) + (-1 * x38 * (*lh_p).Rot[2]))) + (*lh_p).Pos[2];
	const FLT x41 = (-1 * x34 * (*lh_p).Rot[2]) + (x37 * (*lh_p).Rot[1]) + (x36 * (*lh_p).Rot[0]);
	...
	const FLT x98 = x78 * ((-1 * x79 * x52 * ((-1 * x88 * ((x57 * (x97 + (x68 * x94) + (x57 * (x96 + (x57 * ((x66 * x94) + x95 + (-2.40324066e-05 * x57 * x94))) + (x67 * x94))))) + (x62 * x94) + (x57 * x97) + (x69 * x94))) + (-1 * x64) + (x85 * x70 * x64 * x93) + (-1 * x71 * x53))) + x92 + (2 * x88 * x74 * x65 * x90) + (x75 * x52 * x97) + (-1 * x86 * x93));
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0eba1f0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ebaf10>, <cnkalman.codegen.WrapMember object at 0x7f2ed0eba700>, <cnkalman.codegen.WrapMember object at 0x7f2ed0eba340>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ebac10>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ec40a0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0ebabe0>]
...
static inline FLT SurviveKalmanErrorModel_LightMeas_y_gen2(const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x4 = (*_x0).Pose.Rot[1] + (x3 * (*error_model).Pose.AxisAngleRot[0]) + (-1 * x1 * (*_x0).Pose.Rot[3]) + (x2 * (*_x0).Pose.Rot[2]);
	const FLT x5 = dt * dt;
	const FLT x6 = (*_x0).Velocity.AxisAngleRot[2] + (*error_model).Velocity.AxisAngleRot[2];
	const FLT x7 = (x6 * x6) * x5;
	const FLT x8 = (*_x0).Velocity.AxisAngleRot[0] + (*error_model).Velocity.AxisAngleRot[0];
	...
	const FLT x19 = x4 * x18;
	const FLT x20 = 0.5 * (*error_model).Pose.AxisAngleRot[0];
	const FLT x21 = (-1 * x20 * (*_x0).Pose.Rot[1]) + (-1 * x1 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x2 * (*_x0).Pose.Rot[3]);
	const FLT x22 = x21 * x18;
	const FLT x23 = (x1 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x20 * (*_x0).Pose.Rot[2]) + (x3 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x24 = x17 * x16;
	const FLT x25 = (-1 * x2 * (*_x0).Pose.Rot[1]) + (x3 * (*error_model).Pose.AxisAngleRot[1]) + (x20 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x26 = x25 * x18;
	...
	const FLT x35 = 1.0/2.0 * dt * fabs(dt);
	const FLT x36 = (x35 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + (*error_model).Pose.Pos[0] + sensor_pt[0] + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (2 * ((x34 * x33) + (-1 * x32 * x27))) + (*_x0).Pose.Pos[0];
	const FLT x37 = (x33 * sensor_pt[2]) + (-1 * x27 * sensor_pt[1]) + (x30 * sensor_pt[0]);
	const FLT x38 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (x35 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (*error_model).Pose.Pos[2] + (2 * ((x32 * x31) + (-1 * x33 * x37))) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2]));
	const FLT x39 = (*_x0).Pose.Pos[1] + (2 * ((x37 * x27) + (-1 * x31 * x34))) + (*error_model).Pose.Pos[1] + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1])) + (x35 * ((*_x0).Acc[1] + (*error_model).Acc[1]));
	...
	const FLT x56 = (-1 * asin(x49 + (x50 * (x52 * x52) * x55 * (1. / (x51 + (x50 * sin(x46) * ((x52 * (x55 + (x52 * (x54 + (x52 * (x53 + (x52 * (-8.0108022e-06 + (-1.60216044e-05 * x52))))))))) + (x52 * x55)))))))) + x45;
	return -1.5707963267949 + x56 + (-1 * (*bsc0).phase) + (sin(x56 + (*bsc0).gibpha) * (*bsc0).gibmag);
}

// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen2 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ea1ca0>]
static inline void SurviveKalmanErrorModel_LightMeas_y_gen2_jac_x0(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x7 = 0.5 * (*error_model).Pose.AxisAngleRot[1];
	const FLT x8 = 0.5 * (*error_model).Pose.AxisAngleRot[2];
	const FLT x9 = (-1 * x8 * (*_x0).Pose.Rot[1]) + (x7 * (*_x0).Pose.Rot[0]) + (x6 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x10 = dt * dt;
	const FLT x11 = x5 * x5;
	const FLT x12 = x11 * x10;
	const FLT x13 = (*_x0).Velocity.AxisAngleRot[0] + (*error_model).Velocity.AxisAngleRot[0];
	...
	const FLT x34 = (*_x0).Pose.Rot[3] + (x7 * (*_x0).Pose.Rot[1]) + (-1 * x6 * (*_x0).Pose.Rot[2]) + (x8 * (*_x0).Pose.Rot[0]);
	const FLT x35 = x32 * x29;
	const FLT x36 = x34 * x35;
	const FLT x37 = (x6 * (*_x0).Pose.Rot[0]) + (-1 * x7 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[1] + (x8 * (*_x0).Pose.Rot[2]);
	const FLT x38 = x28 * x26;
	const FLT x39 = x38 * x37;
	const FLT x40 = (-1 * x6 * (*_x0).Pose.Rot[1]) + (-1 * x7 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x8 * (*_x0).Pose.Rot[3]);
	...
	const FLT x147 = x120 + (-1 * x146 * (x114 + (-1 * x143 * ((x108 * ((x95 * x140) + (x87 * x128) + (x87 * x141) + (x95 * (x140 + (x87 * x129) + (x95 * ((x95 * ((x87 * x134) + (-1 * x87 * x131) + x133)) + x138 + (x87 * x135))))))) + (-1 * x121 * x127))) + (x87 * x112) + (x140 * x144) + (-1 * x121 * x125)));
	...
	const FLT x164 = x159 + (-1 * x146 * ((x163 * x144) + x158 + (-1 * x125 * x160) + (x112 * x157) + (-1 * x143 * ((x108 * ((x95 * x163) + (x95 * (x163 + (x129 * x157) + (x95 * ((x95 * ((x134 * x157) + (-1 * x131 * x157) + x161)) + x162 + (x135 * x157))))) + (x141 * x157) + (x128 * x157))) + (-1 * x127 * x160)))));
	...
	const FLT x176 = x171 + (-1 * x146 * ((-1 * x125 * x172) + x170 + (x112 * x169) + (x175 * x144) + (-1 * x143 * ((x108 * ((x95 * (x175 + (x129 * x169) + (x95 * (x174 + (x95 * ((x169 * x134) + x173 + (-1 * x169 * x131))) + (x169 * x135))))) + (x95 * x175) + (x128 * x169) + (x169 * x141))) + (-1 * x127 * x172)))));
	...
	const FLT x199 = x193 + (-1 * x146 * (x192 + (-1 * x143 * ((x108 * ((x95 * x198) + (x195 * x141) + (x128 * x195) + (x95 * (x198 + (x129 * x195) + (x95 * (x197 + (x95 * ((x195 * x134) + x196 + (-1 * x195 * x131))) + (x195 * x135))))))) + (-1 * x127 * x194))) + (x198 * x144) + (-1 * x125 * x194) + (x112 * x195)));
	...
	const FLT x215 = x209 + (-1 * x146 * ((x211 * x112) + x208 + (x214 * x144) + (-1 * x210 * x124) + (-1 * x143 * ((x108 * ((x211 * x141) + (x95 * x214) + (x211 * x128) + (x95 * (x214 + (x211 * x129) + (x95 * (x213 + (x95 * ((x211 * x134) + x212 + (-1 * x211 * x131))) + (x211 * x135))))))) + (-1 * x210 * x126)))));
	...
	const FLT x227 = x221 + (-1 * x146 * (x220 + (x226 * x144) + (x223 * x112) + (-1 * x143 * ((x108 * ((x95 * x226) + (x223 * x141) + (x223 * x128) + (x95 * (x226 + (x223 * x129) + (x95 * (x225 + (x95 * ((x223 * x134) + x224 + (-1 * x223 * x131))) + (x223 * x135))))))) + (-1 * x222 * x127))) + (-1 * x222 * x125)));
	...
	const FLT x278 = x272 + (-1 * x146 * (x271 + (x277 * x144) + (-1 * x143 * ((x108 * ((x95 * x277) + (x274 * x141) + (x274 * x128) + (x95 * (x277 + (x274 * x129) + (x95 * (x276 + (x95 * ((x274 * x134) + (-1 * x274 * x131) + x275)) + (x274 * x135))))))) + (-1 * x273 * x127))) + (-1 * x273 * x125) + (x274 * x112)));
	...
	const FLT x312 = x307 + (-1 * x146 * (x306 + (-1 * x143 * ((x108 * ((x95 * x311) + (x304 * x141) + (x304 * x128) + (x95 * ((x305 * x104) + x311 + (x95 * ((x95 * ((x304 * x134) + x309 + (-1 * x305 * x130))) + x310 + (x304 * x135))))))) + (-1 * x308 * x127))) + (x311 * x144) + (x305 * x111) + (-1 * x308 * x125)));
	...
	const FLT x341 = x334 + (-1 * x146 * (x333 + (-1 * x335 * x125) + (-1 * x143 * ((x108 * ((x95 * x340) + (x336 * x141) + (x337 * x105) + (x95 * (x340 + (x337 * x104) + (x95 * (x339 + (x95 * (x338 + (x336 * x134) + (-1 * x337 * x130))) + (x336 * x135))))))) + (-1 * x335 * x127))) + (x340 * x144) + (x337 * x111)));
	...
	const FLT x367 = x360 + (-1 * x146 * (x359 + (x363 * x111) + (x366 * x144) + (-1 * x143 * ((x108 * ((x95 * x366) + (x95 * ((x362 * x129) + x366 + (x95 * (x365 + (x95 * ((x362 * x134) + (-1 * x363 * x130) + x364)) + (x362 * x135))))) + (x362 * x128) + (x362 * x141))) + (-1 * x361 * x127))) + (-1 * x361 * x125)));
	...
	const FLT x386 = (x379 * x378) + (-1 * x371 * x381) + (x371 * x377) + (-1 * x373 * x385) + (-1 * x13 * x382) + (-1 * x384 * x381) + (x377 * x384) + (x13 * x383);
	...
	const FLT x417 = x416 + (x409 * x410) + x408 + (-1 * x30 * x407) + (-1 * x406 * x405) + x403 + (-1 * x14 * x370) + (-1 * x40 * x391) + (-1 * x398) + (x393 * x392) + (-1 * x9 * x400);
	...
	const FLT x427 = (-1 * x426 * x392) + (x14 * x414) + (-1 * x390 * x393) + (-1 * x421) + (x405 * x420) + (-1 * x409 * x411) + x419 + (-1 * x407 * x396) + x423 + (-1 * x37 * x400) + (-1 * x425) + x41;
	...
	const FLT x434 = x433 + (x406 * x392) + (-1 * x430) + (x405 * x393) + (-1 * x14 * x401) + (x409 * x396) + x428 + (-1 * x40 * x400) + (-1 * x407 * x411) + x429 + (x420 * x390);
	...
	const FLT x440 = x439 + x437 + (-1 * x30 * x409) + (x37 * x391) + (-1 * x420 * x392) + (-1 * x405 * x426) + (x14 * x424) + (-1 * x435 * x385) + x33 + (-1 * x34 * x400);
	...
	const FLT x461 = x455 + (-1 * x146 * ((x460 * x144) + x454 + (x457 * x112) + (-1 * x143 * ((x108 * ((x95 * x460) + (x457 * x141) + (x457 * x128) + (x95 * (x460 + (x457 * x129) + (x95 * (x459 + (x95 * ((x457 * x134) + (-1 * x457 * x131) + x458)) + (x457 * x135))))))) + (-1 * x456 * x127))) + (-1 * x456 * x125)));
	...
	const FLT x468 = (-1 * x466 * x380) + (x16 * x467) + (-1 * x463 * x381) + (x16 * x383) + (x466 * x373 * x375) + (x463 * x377) + (-1 * x465 * x373) + (-1 * x16 * x382);
	...
	const FLT x476 = x416 + (-1 * x473 * x396) + x36 + (-1 * x462 * x410) + (x469 * x468) + (-1 * x471 * x390) + x475 + (x50 * x472) + (-1 * x468 * x474) + (-1 * x468 * x470);
	const FLT x477 = x40 * x390;
	const FLT x478 = x37 * x468;
	const FLT x479 = x9 * x399;
	const FLT x480 = x5 * x438;
	const FLT x481 = x412 * x397;
	const FLT x482 = (-1 * x30 * x473) + x41 + (x43 * x472) + (-1 * x462 * x411) + (-1 * x423) + (x471 * x392) + (-1 * x481) + x421 + (-1 * x478 * x405) + (-1 * x468 * x479) + (-1 * x468 * x477) + x480;
	const FLT x483 = -1 * x33;
	const FLT x484 = x412 * x432;
	const FLT x485 = x9 * x390;
	const FLT x486 = x16 * x431;
	const FLT x487 = x40 * x399;
	const FLT x488 = (x478 * x392) + x439 + (-1 * x468 * x487) + (-1 * x473 * x411) + (-1 * x486) + (-1 * x47 * x472) + (x471 * x405) + x483 + (x468 * x485) + (x30 * x462) + x484;
	...
	const FLT x494 = (-1 * x492 * x468) + (-1 * x465 * x435) + x493 + (-1 * x491 * x468) + x428 + (-1 * x39 * x472) + x430 + (x462 * x396) + (-1 * x429) + (-1 * x490 * x468) + (x478 * x390);
	...
	const FLT x514 = x508 + (-1 * x146 * (x507 + (x513 * x144) + (-1 * x509 * x125) + (-1 * x143 * ((x108 * ((x95 * x513) + (x510 * x141) + (x510 * x128) + (x95 * (x513 + (x510 * x129) + (x95 * (x512 + (x95 * ((x510 * x134) + x511 + (-1 * x510 * x131))) + (x510 * x135))))))) + (-1 * x509 * x127))) + (x510 * x112)));
	const FLT x515 = x5 * x464;
	const FLT x516 = x404 * x372;
	const FLT x517 = x516 * x376;
	const FLT x518 = x5 * x5 * x5;
	const FLT x519 = x5 * x381;
	const FLT x520 = (x17 * x517) + (x518 * x377) + (x5 * x467) + (x14 * x517) + (-1 * x17 * x519) + (-1 * x464 * x516) + (-1 * x518 * x381) + (-1 * x14 * x519);
	const FLT x521 = x37 * x520;
	const FLT x522 = x11 * x394;
	const FLT x523 = (-1 * x492 * x520) + (-1 * x435 * x515) + (x521 * x390) + (-1 * x480) + (-1 * x490 * x520) + x425 + x41 + (x11 * x414) + (-1 * x411 * x522) + x481 + (-1 * x419) + (-1 * x491 * x520);
	const FLT x524 = x34 * x520;
	const FLT x525 = x433 + x493 + (x524 * x392) + (-1 * x479 * x520) + (x11 * x401) + (-0.5 * x30 * x515) + (-1 * x405 * x521) + (-1 * x522 * x396) + (-1 * x477 * x520) + x45;
	const FLT x526 = 0.5 * x464;
	const FLT x527 = x437 + (-1 * x474 * x520) + (-1 * x470 * x520) + x486 + (-1 * x524 * x390) + (x469 * x520) + (x30 * x522) + (-1 * x484) + x483 + (-1 * x11 * x424) + (-1 * x526 * x397);
	const FLT x528 = (x521 * x392) + x475 + x398 + (x405 * x524) + (-1 * x403) + (x485 * x520) + (-1 * x436 * x526) + (x410 * x522) + (-1 * x11 * x370) + x408 + (-1 * x487 * x520);
	...
	const FLT x549 = x544 + (-1 * x146 * (x543 + (x548 * x144) + (-1 * x143 * ((x108 * ((x95 * x548) + (x95 * (x548 + (x542 * x129) + (x95 * (x547 + (x95 * ((x542 * x134) + (-1 * x542 * x131) + x546)) + (x542 * x135))))) + (x542 * x141) + (x542 * x128))) + (-1 * x545 * x127))) + (x542 * x112) + (-1 * x545 * x125)));
	...
	const FLT x567 = x561 + (-1 * x146 * ((x566 * x144) + (-1 * x562 * x125) + x560 + (x563 * x112) + (-1 * x143 * ((x108 * ((x95 * x566) + (x563 * x141) + (x95 * ((x563 * x129) + x566 + (x95 * ((x95 * ((x563 * x134) + (-1 * x563 * x131) + x564)) + x565 + (x563 * x135))))) + (x563 * x128))) + (-1 * x562 * x127)))));
	...
	const FLT x582 = x577 + (-1 * x146 * (x576 + (-1 * x143 * ((x108 * ((x95 * x581) + (x575 * x141) + (x575 * x128) + (x95 * (x581 + (x575 * x129) + (x95 * (x580 + (x95 * ((x575 * x134) + x579 + (-1 * x575 * x131))) + (x575 * x135))))))) + (-1 * x578 * x127))) + (x581 * x144) + (x575 * x112) + (-1 * x578 * x125)));
	...
	const FLT x594 = x588 + (-1 * x146 * (x587 + (x593 * x144) + (x590 * x112) + (-1 * x589 * x125) + (-1 * x143 * ((x108 * ((x95 * x593) + (x590 * x141) + (x590 * x128) + (x95 * (x593 + (x590 * x129) + (x95 * (x592 + (x95 * ((x590 * x134) + x591 + (-1 * x590 * x131))) + (x590 * x135))))))) + (-1 * x589 * x127)))));
	cnSetZero(Hx);
	...
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x461 + (x461 * x148));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x514 + (x514 * x148));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x549 + (x549 * x148));
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen2 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0ea1ca0>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen2 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0f1cd60>]
static inline void SurviveKalmanErrorModel_LightMeas_y_gen2_jac_error_model(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x27 = x24 * x26;
	const FLT x28 = x4 * x27;
	const FLT x29 = (x2 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x1 * (*_x0).Pose.Rot[2]) + (x3 * (*_x0).Pose.Rot[0]);
	const FLT x30 = x29 * x27;
	const FLT x31 = (*_x0).Pose.Rot[1] + (x1 * (*_x0).Pose.Rot[0]) + (-1 * x2 * (*_x0).Pose.Rot[3]) + (x3 * (*_x0).Pose.Rot[2]);
	const FLT x32 = x23 * x21;
	const FLT x33 = x32 * x31;
	const FLT x34 = (-1 * x1 * (*_x0).Pose.Rot[1]) + (-1 * x2 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x3 * (*_x0).Pose.Rot[3]);
	...
	const FLT x47 = dt * fabs(dt);
	const FLT x48 = 1.0/2.0 * x47;
	const FLT x49 = (2 * ((x45 * x46) + (-1 * x43 * x37))) + (*error_model).Pose.Pos[1] + (*_x0).Pose.Pos[1] + (x48 * ((*_x0).Acc[1] + (*error_model).Acc[1])) + sensor_pt[1] + (dt * ((*_x0).Velocity.Pos[1] + (*error_model).Velocity.Pos[1]));
	const FLT x50 = (-1 * x37 * sensor_pt[2]) + (x40 * sensor_pt[1]) + (x45 * sensor_pt[0]);
	const FLT x51 = (*_x0).Pose.Pos[2] + sensor_pt[2] + (*error_model).Pose.Pos[2] + (x48 * ((*_x0).Acc[2] + (*error_model).Acc[2])) + (2 * ((x50 * x37) + (-1 * x42 * x46))) + (dt * ((*_x0).Velocity.Pos[2] + (*error_model).Velocity.Pos[2]));
	const FLT x52 = (x48 * ((*_x0).Acc[0] + (*error_model).Acc[0])) + sensor_pt[0] + (2 * ((x42 * x43) + (-1 * x50 * x45))) + (dt * ((*_x0).Velocity.Pos[0] + (*error_model).Velocity.Pos[0])) + (*error_model).Pose.Pos[0] + (*_x0).Pose.Pos[0];
	const FLT x53 = (-1 * x52 * (*lh_p).Rot[2]) + (x49 * (*lh_p).Rot[1]) + (x51 * (*lh_p).Rot[0]);
	const FLT x54 = (-1 * x49 * (*lh_p).Rot[3]) + (x52 * (*lh_p).Rot[0]) + (x51 * (*lh_p).Rot[2]);
	const FLT x55 = x49 + (*lh_p).Pos[1] + (2 * ((x54 * (*lh_p).Rot[3]) + (-1 * x53 * (*lh_p).Rot[1])));
	...
	const FLT x141 = x119 + (-1 * x140 * ((x138 * x135) + (-1 * x137 * ((x108 * ((x88 * x100) + (x87 * x127) + (x95 * x135) + (x95 * ((x88 * x104) + x135 + (x95 * ((x95 * ((x88 * x102) + (-1 * x88 * x128) + x130)) + x133 + (x87 * x131))))))) + (-1 * x120 * x126))) + (x88 * x111) + x113 + (-1 * x120 * x124)));
	...
	const FLT x159 = x154 + (-1 * x140 * (x153 + (-1 * x124 * x155) + (x138 * x158) + (x111 * x152) + (-1 * x137 * ((x108 * ((x95 * x158) + (x95 * (x158 + (x104 * x152) + (x95 * (x157 + (x95 * ((x102 * x152) + (-1 * x128 * x152) + x156)) + (x131 * x151))))) + (x100 * x152) + (x127 * x151))) + (-1 * x126 * x155)))));
	...
	const FLT x177 = x167 + (-1 * x140 * (x166 + (x176 * x138) + (-1 * x124 * x168) + (x165 * x164) + (-1 * x137 * ((x108 * ((x95 * x176) + (x127 * x164) + (x95 * (x176 + (x164 * x170) + (x95 * (x175 + (x95 * ((x164 * x173) + x171 + (-1 * x164 * x172))) + (x164 * x131))))) + (x169 * x164))) + (-1 * x126 * x168)))));
	...
	const FLT x189 = (-1 * x181 * (*_x0).Pose.Rot[2]) + (-1 * x183 * (*_x0).Pose.Rot[1]) + (-1 * x185 * (*_x0).Pose.Rot[3]) + (x178 * (*_x0).Pose.Rot[0]);
	...
	const FLT x235 = x230 + (-1 * x140 * (x229 + (x234 * x138) + (-1 * x231 * x124) + (x228 * x165) + (-1 * x137 * ((x108 * ((x228 * x169) + (x95 * x234) + (x228 * x127) + (x95 * (x234 + (x228 * x170) + (x95 * (x233 + (x95 * (x232 + (x228 * x173) + (-1 * x228 * x172))) + (x228 * x131))))))) + (-1 * x231 * x126)))));
	...
	const FLT x263 = x257 + (-1 * x140 * (x256 + (-1 * x258 * x124) + (x262 * x138) + (-1 * x137 * ((x108 * ((x259 * x169) + (x95 * x262) + (x259 * x127) + (x95 * (x262 + (x259 * x170) + (x95 * (x261 + (x95 * ((x259 * x173) + x260 + (-1 * x259 * x172))) + (x259 * x131))))))) + (-1 * x258 * x126))) + (x259 * x165)));
	...
	const FLT x285 = x279 + (-1 * x140 * ((-1 * x280 * x124) + x278 + (x284 * x138) + (-1 * x137 * ((x108 * ((x95 * x284) + (x281 * x169) + (x95 * (x284 + (x281 * x170) + (x95 * (x283 + (x95 * ((x281 * x173) + (-1 * x281 * x172) + x282)) + (x281 * x131))))) + (x281 * x127))) + (-1 * x280 * x126))) + (x281 * x165)));
	...
	const FLT x305 = x299 + (-1 * x140 * ((x304 * x138) + (-1 * x137 * ((x108 * ((x95 * x304) + (x301 * x169) + (x301 * x127) + (x95 * (x304 + (x301 * x170) + (x95 * ((x95 * ((x301 * x173) + x302 + (-1 * x301 * x172))) + x303 + (x301 * x131))))))) + (-1 * x300 * x126))) + x298 + (-1 * x300 * x124) + (x301 * x165)));
	...
	const FLT x321 = x315 + (-1 * x140 * (x314 + (x320 * x138) + (x317 * x165) + (-1 * x316 * x124) + (-1 * x137 * ((x108 * ((x95 * x320) + (x317 * x169) + (x317 * x127) + (x95 * (x320 + (x317 * x170) + (x95 * (x319 + (x95 * ((x317 * x173) + x318 + (-1 * x317 * x172))) + (x317 * x131))))))) + (-1 * x316 * x126)))));
	...
	const FLT x334 = x327 + (-1 * x140 * (x326 + (x330 * x111) + (x333 * x138) + (-1 * x137 * ((x108 * ((x95 * x333) + (x330 * x100) + (x329 * x127) + (x95 * (x333 + (x330 * x104) + (x95 * (x332 + (x95 * (x331 + (x330 * x102) + (-1 * x330 * x128))) + (x329 * x131))))))) + (-1 * x328 * x126))) + (-1 * x328 * x124)));
	...
	const FLT x352 = (-1 * x12 * x348) + (x12 * x350) + (x344 * x345) + (-1 * x351 * x344) + (-1 * x346 * x340) + (x6 * x350) + (x343 * x340) + (-1 * x6 * x348);
	...
	const FLT x378 = (x372 * x371) + (-1 * x368 * x370) + (-1 * x31 * x367) + x366 + (-1 * x4 * x364) + (-1 * x9 * x338) + (-1 * x34 * x356) + x377 + x335 + (x8 * x357) + (-1 * x362);
	...
	const FLT x387 = (x9 * x375) + (-1 * x370 * x359) + (x4 * x367) + (-1 * x386 * x355) + (-1 * x29 * x356) + x381 + (-1 * x382) + x383 + (-1 * x31 * x364) + (-1 * x35 * x372) + (-1 * x385) + x36;
	...
	const FLT x395 = x394 + x391 + (x0 * x357) + (x392 * x355) + (-1 * x34 * x364) + (x4 * x356) + (x9 * x360) + (-1 * x35 * x370) + (-1 * x9 * x365) + x389 + (-1 * x390);
	const FLT x396 = x11 * x360;
	const FLT x397 = (x8 * x396) + (-1 * x376 * x365);
	const FLT x398 = x0 * x35;
	const FLT x399 = (x375 * x361) + (-1 * x379 * x398);
	const FLT x400 = x399 + x397 + (-1 * x4 * x8 * x355) + (-1 * x34 * x367) + (x9 * x384) + x28 + (-1 * x371 * x370) + (x31 * x356) + (-1 * x372 * x368) + (-1 * x29 * x364);
	...
	const FLT x421 = x415 + (-1 * x140 * ((x417 * x165) + (-1 * x137 * ((x108 * ((x417 * x127) + (x95 * x420) + (x417 * x169) + (x95 * (x420 + (x417 * x170) + (x95 * (x419 + (x95 * ((-1 * x417 * x172) + (x417 * x173) + x418)) + (x417 * x131))))))) + (-1 * x416 * x126))) + x414 + (x420 * x138) + (-1 * x416 * x124)));
	...
	const FLT x429 = (x11 * x428) + (-1 * x427 * x347) + (x427 * x349) + (-1 * x11 * x424) + (x11 * x423) + (-1 * x11 * x425) + (x426 * x349) + (-1 * x426 * x347);
	...
	const FLT x439 = x438 + x377 + (-1 * x436 * x359) + (x0 * x431) + x30 + (-1 * x422 * x371) + (-1 * x31 * x432) + (-1 * x430 * x386) + (-1 * x11 * x434) + (x12 * x338);
	const FLT x440 = x31 * x430;
	const FLT x441 = x437 * x365;
	const FLT x442 = x0 * x396;
	const FLT x443 = (-1 * x383) + (-1 * x34 * x11 * x430) + (-1 * x35 * x422) + (-1 * x4 * x432) + x36 + x441 + (x8 * x434) + (-1 * x436 * x368) + (-1 * x442) + (x12 * x375) + (-1 * x0 * x440) + x382;
	const FLT x444 = x373 * x393;
	const FLT x445 = x437 * x338;
	const FLT x446 = -1 * x28;
	const FLT x447 = x397 + x446 + (-1 * x34 * x432) + (-1 * x35 * x436) + x444 + (x430 * x392) + (x422 * x368) + (x11 * x431) + (-1 * x12 * x384) + (x0 * x434) + (-1 * x445);
	...
	const FLT x451 = (-1 * x389) + (-1 * x8 * x431) + (-1 * x29 * x432) + (x422 * x359) + x390 + x391 + (-1 * x12 * x365) + x450 + (-1 * x436 * x371) + (x11 * x440) + (-1 * x430 * x449);
	...
	const FLT x471 = x465 + (-1 * x140 * (x464 + (x470 * x138) + (-1 * x137 * ((x108 * ((x467 * x169) + (x467 * x127) + (x95 * x470) + (x95 * (x470 + (x467 * x170) + (x95 * ((x95 * ((x467 * x173) + x468 + (-1 * x467 * x172))) + x469 + (x467 * x131))))))) + (-1 * x466 * x126))) + (-1 * x466 * x124) + (x467 * x165)));
	const FLT x472 = x0 * x0 * x0;
	const FLT x473 = x0 * x12;
	const FLT x474 = (-1 * x472 * x347) + (x472 * x349) + (x0 * x423) + (x473 * x349) + (-1 * x0 * x424) + (-1 * x0 * x425) + (x0 * x428) + (-1 * x473 * x347);
	const FLT x475 = x474 * x354;
	const FLT x476 = x11 * x475;
	const FLT x477 = x6 * x358;
	const FLT x478 = x474 * x363;
	const FLT x479 = x4 * x475;
	const FLT x480 = (-1 * x8 * x479) + (-1 * x435 * x393) + (x6 * x375) + (x31 * x476) + x385 + (-1 * x475 * x449) + x36 + (-1 * x441) + (-1 * x381) + x442 + (-1 * x29 * x478) + (-1 * x35 * x477);
	const FLT x481 = x31 * x475;
	const FLT x482 = x474 * x433;
	const FLT x483 = x450 + x394 + (-1 * x435 * x380) + (-1 * x6 * x360) + (x8 * x482) + (-1 * x4 * x478) + (x6 * x365) + (-1 * x0 * x481) + x39 + (-1 * x34 * x476);
	const FLT x484 = x399 + (-1 * x31 * x478) + x445 + (x477 * x368) + (-1 * x11 * x482) + x446 + (x0 * x479) + (-1 * x475 * x386) + (-1 * x6 * x384) + (-1 * x444) + (-1 * x0 * x435 * x359);
	const FLT x485 = x362 + (x477 * x371) + x438 + (x8 * x481) + (x0 * x482) + (-1 * x366) + x335 + (-1 * x6 * x338) + (x4 * x476) + (-1 * x435 * x398) + (-1 * x34 * x478);
	...
	const FLT x506 = x501 + (-1 * x140 * (x500 + (-1 * x137 * ((x108 * ((x499 * x169) + (x95 * (x505 + (x499 * x170) + (x95 * (x504 + (x95 * ((-1 * x499 * x172) + (x499 * x173) + x503)) + (x499 * x131))))) + (x95 * x505) + (x499 * x127))) + (-1 * x502 * x125))) + (x499 * x165) + (x505 * x138) + (-1 * x502 * x123)));
	...
	const FLT x525 = x518 + (-1 * x140 * (x517 + (x524 * x138) + (x521 * x111) + (-1 * x519 * x124) + (-1 * x137 * ((x108 * ((x95 * (x524 + (x520 * x170) + (x95 * (x523 + (x95 * ((x520 * x173) + (-1 * x521 * x128) + x522)) + (x520 * x131))))) + (x95 * x524) + (x520 * x169) + (x520 * x127))) + (-1 * x519 * x126)))));
	...
	const FLT x540 = x535 + (-1 * x140 * ((x539 * x138) + (-1 * x137 * ((x108 * ((x95 * x539) + (x533 * x169) + (x533 * x127) + (x95 * (x539 + (x533 * x170) + (x95 * (x538 + (x95 * ((x533 * x173) + x537 + (-1 * x533 * x172))) + (x533 * x131))))))) + (-1 * x536 * x126))) + (x533 * x165) + x534 + (-1 * x536 * x124)));
	...
	const FLT x553 = x546 + (-1 * x140 * (x545 + (x552 * x138) + (x549 * x111) + (-1 * x547 * x124) + (-1 * x137 * ((x108 * ((x95 * x552) + (x549 * x100) + (x548 * x127) + (x95 * ((x549 * x104) + x552 + (x95 * ((x95 * ((x549 * x102) + x550 + (-1 * x549 * x128))) + x551 + (x548 * x131))))))) + (-1 * x547 * x126)))));
	cnSetZero(Hx);
	...
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x235 + (x235 * x142));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x263 + (x263 * x142));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x285 + (x285 * x142));
	...
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x421 + (x421 * x142));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x471 + (x471 * x142));
	cnMatrixOptionalSet(Hx, 0, offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x506 + (x506 * x142));
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen2 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7f2ed0f1cd60>]
...
static inline void SurviveKalmanErrorModel_LightMeas_y_gen2_jac_sensor_pt(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x137 = x122 + (-1 * x136 * (x116 + (-1 * x124 * x133) + (x91 * x114) + (x129 * x134) + (-1 * x132 * ((x111 * ((x91 * x103) + (x98 * x129) + (x91 * x108) + (x98 * ((x91 * x107) + x129 + (x98 * (x128 + (x98 * ((x91 * x105) + x126 + (-1 * x91 * x127))) + (x91 * x106))))))) + (-1 * x124 * x125)))));
	...
	const FLT x160 = x153 + (-1 * x136 * ((x134 * x159) + x152 + (-1 * x132 * ((x111 * ((x98 * x159) + (x98 * (x159 + (x107 * x151) + (x98 * (x158 + (x98 * ((x105 * x151) + x157 + (-1 * x127 * x151))) + (x106 * x151))))) + (x108 * x151) + (x103 * x151))) + (-1 * x154 * x156))) + (x114 * x151) + (-1 * x154 * x155)));
	...
	const FLT x179 = x174 + (-1 * x136 * ((x178 * x134) + (-1 * x175 * x155) + (x114 * x172) + x173 + (-1 * x132 * ((x111 * ((x98 * x178) + (x103 * x172) + (x108 * x172) + (x98 * (x178 + (x107 * x172) + (x98 * (x177 + (x98 * ((x105 * x172) + x176 + (-1 * x127 * x172))) + (x106 * x172))))))) + (-1 * x175 * x156)))));
...
static inline void SurviveKalmanErrorModel_LightMeas_y_gen2_jac_lh_p(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x18 = dt * x14 * (1. / x12) * x17;
	const FLT x19 = x4 * x18;
	const FLT x20 = (x2 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x1 * (*_x0).Pose.Rot[2]) + (x3 * (*_x0).Pose.Rot[0]);
	const FLT x21 = x9 * x18;
	const FLT x22 = (*_x0).Pose.Rot[1] + (x1 * (*_x0).Pose.Rot[0]) + (-1 * x2 * (*_x0).Pose.Rot[3]) + (x3 * (*_x0).Pose.Rot[2]);
	const FLT x23 = x17 * x16;
	const FLT x24 = (-1 * x1 * (*_x0).Pose.Rot[1]) + (-1 * x2 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x3 * (*_x0).Pose.Rot[3]);
	const FLT x25 = x24 * x18;
	...
	const FLT x125 = x110 + (-1 * x124 * ((-1 * x112 * x119) + (-1 * x118 * ((x103 * ((x88 * x75) + (-1 * x81 * x116) + (x75 * (x88 + (-1 * x81 * x114) + (x75 * (x85 + (x75 * (x83 + (-1 * x82 * x97) + (x82 * x115))) + (-1 * x82 * x98))))) + (-1 * x82 * x100))) + (-1 * x112 * x113))) + x69 + (-1 * x120 * x122) + (x88 * x107)));
	...
	const FLT x136 = x124 * ((-1 * x118 * ((x103 * ((x75 * x131) + (x116 * x127) + (x100 * x128) + (x75 * (x131 + (x99 * x128) + (x75 * (x130 + (x75 * ((x97 * x128) + (-1 * x115 * x128) + x129)) + (x98 * x128))))))) + (x134 * x135))) + (x133 * x134) + (x128 * x132) + (-1 * x91) + (x107 * x131));
	...
	const FLT x147 = (-1 * x145) + (-1 * x124 * ((-1 * x118 * ((x103 * ((x75 * x143) + (x75 * (x143 + (-1 * x114 * x139) + (x75 * (x142 + (x75 * ((-1 * x97 * x140) + x141 + (x115 * x140))) + (-1 * x98 * x140))))) + (-1 * x100 * x140) + (-1 * x116 * x139))) + (-1 * x135 * x146))) + (-1 * x122 * x144) + (-1 * x133 * x146) + x138 + (x107 * x143)));
	...
	const FLT x169 = x164 + (-1 * x124 * (x160 + (x107 * x168) + (-1 * x118 * ((x103 * ((x75 * x168) + (x116 * x157) + (x100 * x158) + (x75 * (x168 + (x99 * x158) + (x75 * (x167 + (x75 * ((x97 * x158) + x166 + (-1 * x115 * x158))) + (x98 * x158))))))) + (-1 * x165 * x135))) + (x132 * x158) + (-1 * x165 * x133)));
	const FLT x170 = (-1 * sensor_pt[2]) + (-1 * x48) + (-1 * x46) + (-1 * x47) + (-1 * (*_x0).Pose.Pos[2]) + (-1 * (*error_model).Pose.Pos[2]);
	...
	const FLT x188 = x181 + (-1 * x124 * ((-1 * x182 * x133) + x180 + (x107 * x187) + (x184 * x132) + (-1 * x118 * ((x103 * ((x75 * x187) + (x116 * x183) + (x100 * x184) + (x75 * ((x99 * x184) + x187 + (x75 * (x186 + (x75 * ((x97 * x184) + x185 + (-1 * x115 * x184))) + (x98 * x184))))))) + (-1 * x182 * x135)))));
	const FLT x189 = (-1 * (*error_model).Pose.Pos[0]) + (-1 * x41) + (-1 * (*_x0).Pose.Pos[0]) + (-1 * x42) + (-1 * sensor_pt[0]) + (-1 * x43);
	...
	const FLT x203 = x196 + (-1 * x124 * (x195 + (-1 * x197 * x133) + (x199 * x132) + (-1 * x118 * ((x103 * ((x75 * x202) + (x116 * x198) + (x100 * x199) + (x75 * ((x99 * x199) + x202 + (x75 * (x201 + (x75 * ((x97 * x199) + x200 + (-1 * x115 * x199))) + (x98 * x199))))))) + (-1 * x197 * x135))) + (x202 * x107)));
	const FLT x204 = x148 + (-1 * x175) + (-4 * x45);
	const FLT x205 = (-1 * sensor_pt[1]) + (-1 * x34) + (-1 * x37) + (-1 * (*error_model).Pose.Pos[1]) + (-1 * (*_x0).Pose.Pos[1]) + (-1 * x35);
	...
	const FLT x217 = x210 + (-1 * x124 * (x209 + (x213 * x132) + (x216 * x107) + (-1 * x118 * ((x103 * ((x75 * x216) + (x212 * x116) + (x213 * x100) + (x75 * (x216 + (x99 * x213) + (x75 * (x215 + (x75 * ((x97 * x213) + x214 + (-1 * x213 * x115))) + (x98 * x213))))))) + (-1 * x211 * x135))) + (-1 * x211 * x133)));
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0f02e20>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f02940>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f02220>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f02fa0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f02730>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f0dd30>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f02f70>]
static inline void SurviveKalmanErrorModel_LightMeas_y_gen2_jac_bsc0(CnMat* Hx, const FLT dt, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model, const FLT* sensor_pt, const SurvivePose* lh_p, const BaseStationCal* bsc0) {
	...
	const FLT x6 = (-1 * x5 * (*_x0).Pose.Rot[1]) + (x4 * (*_x0).Pose.Rot[0]) + (x3 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x7 = dt * dt;
	...
	const FLT x22 = (x4 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x3 * (*_x0).Pose.Rot[2]) + (x5 * (*_x0).Pose.Rot[0]);
	const FLT x23 = x22 * x20;
	const FLT x24 = (*_x0).Pose.Rot[1] + (x3 * (*_x0).Pose.Rot[0]) + (-1 * x4 * (*_x0).Pose.Rot[3]) + (x5 * (*_x0).Pose.Rot[2]);
	const FLT x25 = x19 * x18;
	const FLT x26 = (-1 * x3 * (*_x0).Pose.Rot[1]) + (-1 * x4 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x5 * (*_x0).Pose.Rot[3]);
	...
	const FLT x97 = x80 * ((-1 * x74 * x69 * ((-1 * x1 * x61 * x69) + (x70 * ((x50 * x95) + (-1 * x60 * x92) + (-1 * x55 * x92) + (x50 * (x95 + (-1 * x59 * x92) + (x50 * (x94 + (x50 * (x93 + (-1 * x57 * x92) + (2.40324066e-05 * x50 * x92))) + (-1 * x58 * x92))))))) + x62 + (-1 * x85 * x61 * x62 * x96))) + (x77 * x69 * x95) + x89 + (-1 * x86 * x96) + (-2 * x70 * x76 * x56 * x91));
	cnMatrixOptionalSet(Hx, 0, offsetof(BaseStationCal, curve)/sizeof(FLT), (-1 * x81 * x83) + (-1 * x81));
	cnMatrixOptionalSet(Hx, 0, offsetof(BaseStationCal, gibmag)/sizeof(FLT), sin(x82));
	cnMatrixOptionalSet(Hx, 0, offsetof(BaseStationCal, gibpha)/sizeof(FLT), x83);
	cnMatrixOptionalSet(Hx, 0, offsetof(BaseStationCal, ogeemag)/sizeof(FLT), (-1 * x83 * x84) + (-1 * x84));
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7f2ed0f02e20>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f02940>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f02220>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f02fa0>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f02730>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f0dd30>, <cnkalman.codegen.WrapMember object at 0x7f2ed0f02f70>]

...
// Jacobian of kalman_model_predict wrt [obj_px, obj_py, obj_pz, obj_qw, obj_qi, obj_qj, obj_qk, vx, vy, vz, avx, avy, avz, acc_x, acc_y, acc_z, acc_biasx, acc_biasy, acc_biasz, gbx, gby, gbz, imu_w, imu_x, imu_y, imu_z]
static inline void gen_kalman_model_predict_jac_kalman_model(FLT* out, const FLT t, const SurviveKalmanModel* kalman_model) {
	...
	out[86] = 0;
	out[87] = 0;
	out[88] = (x68 * x66) + (x67 * obj_qk) + (-1 * x59 * obj_qw) + x29 + (-1 * x60 * x61) + (x30 * x34) + (-1 * x57) + (x52 * obj_qj) + x73 + x65 + (-1 * x54 * obj_qi);
	out[89] = x92 + (-1 * x90 * obj_qj) + x89 + (x81 * x68) + (x86 * obj_qj) + x75 + (-1 * x82 * x60) + (x87 * obj_qk) + (-1 * x84) + (-1 * x91 * obj_qw) + (x85 * x62);
	out[90] = x112 + x110 + (x70 * x103) + (-1 * x107) + (x99 * obj_qj) + (-1 * x98 * obj_qw) + (-1 * x101 * obj_qk) + x109 + (x102 * obj_qk) + (-1 * x60 * x104) + (x68 * x100);
	out[91] = 0;
	out[92] = 0;
	out[93] = 0;
	out[94] = 0;
	...
	out[112] = 0;
	out[113] = 0;
	out[114] = x119 + (-1 * x115) + (-1 * x61 * x30) + (-1 * x116) + (-1 * x59 * obj_qi) + (-1 * x60 * x34) + x117 + (x54 * obj_qw) + (x66 * x113) + x114 + (-1 * x52 * obj_qk) + (-1 * x118 * obj_qw);
	out[115] = x122 + (x81 * x113) + (-1 * x91 * obj_qi) + x112 + (-1 * x121 * obj_qk) + (-1 * x120 * obj_qw) + (-1 * x82 * x30) + x108 + (x90 * obj_qk) + (-1 * x86 * obj_qk);
	out[116] = x124 + (-1 * x123 * obj_qw) + (-1 * x98 * obj_qi) + (-1 * x101 * obj_qj) + x75 + (-1 * x99 * obj_qk) + (-1 * x89) + x84 + (x62 * x103) + (-1 * x30 * x104) + (x100 * x113);
	out[117] = 0;
	out[118] = 0;
	out[119] = 0;
	out[120] = 0;
	...
	out[138] = 0;
	out[139] = 0;
	out[140] = (-1 * x110) + (x66 * x69) + x107 + (x70 * x34) + x122 + (-1 * x59 * obj_qj) + (-1 * x67 * obj_qi) + x109 + (-1 * x52 * obj_qw) + (-1 * x61 * x62) + (-1 * x54 * obj_qk);
	out[141] = (-1 * x114) + x125 + (x81 * x69) + x119 + (x90 * obj_qw) + (-1 * x85 * x60) + (-1 * x82 * x62) + (-1 * x91 * obj_qj) + (-1 * x86 * obj_qw) + (-1 * x126) + x116 + (-1 * x87 * obj_qi);
	out[142] = x73 + x127 + (-1 * x62 * x104) + (-1 * x99 * obj_qw) + (x101 * obj_qi) + (x69 * x100) + (-1 * x102 * obj_qi) + (-1 * x98 * obj_qj) + x28 + (-1 * x30 * x103);
	out[143] = 0;
	out[144] = 0;
	out[145] = 0;
	out[146] = 0;
	...
	out[164] = 0;
	out[165] = 0;
	out[166] = x124 + x74 + x92 + (-1 * x118 * obj_qj) + (x52 * obj_qi) + (-1 * x62 * x34) + (-1 * x70 * x61) + (-1 * x59 * obj_qk) + (x54 * obj_qj) + (-1 * x67 * obj_qw);
	out[167] = (-1 * x65) + x57 + (-1 * x82 * x70) + (x121 * obj_qi) + (-1 * x87 * obj_qw) + x127 + (x86 * obj_qi) + (-1 * x90 * obj_qi) + x29 + (-1 * x91 * obj_qk) + (-1 * x120 * obj_qj);
	out[168] = (-1 * x117) + x119 + (-1 * x125) + (x101 * obj_qw) + (-1 * x102 * obj_qw) + (x99 * obj_qi) + (-1 * x70 * x104) + x115 + (-1 * x60 * x103) + (-1 * x98 * obj_qk) + x126 + (-1 * x123 * obj_qj);
	out[169] = 0;
	out[170] = 0;
	out[171] = 0;
	out[172] = 0;
...
static inline void gen_imu_predict_up(FLT* out, const SurviveKalmanModel* kalman_model) {
	...
	const GEN_FLT imu_y = (*kalman_model).IMUCorrection[2];
	const GEN_FLT imu_z = (*kalman_model).IMUCorrection[3];
	const GEN_FLT x0 = sqrt(1e-11 + (imu_x * imu_x) + (imu_z * imu_z) + (imu_w * imu_w) + (imu_y * imu_y));
	const GEN_FLT x1 = (1. / x0) * (1. / sqrt(1e-11 + (obj_qw * obj_qw) + (obj_qi * obj_qi) + (obj_qj * obj_qj) + (obj_qk * obj_qk)));
	const GEN_FLT x2 = x1 * obj_qj;
	const GEN_FLT x3 = x1 * obj_qk;
	const GEN_FLT x4 = x1 * obj_qw;
	const GEN_FLT x5 = x1 * obj_qi;
	const GEN_FLT x6 = (x4 * imu_z) + (-1 * x5 * imu_y) + (x2 * imu_x) + (-1 * x3 * imu_w);
	const GEN_FLT x7 = x1 * imu_y;
	const GEN_FLT x8 = (x5 * imu_x) + (x4 * imu_w) + (x3 * imu_z) + (x7 * obj_qj);
	const GEN_FLT x9 = 0.101971621297793 * acc_y;
	const GEN_FLT x10 = 0.101971621297793 * acc_x;
	const GEN_FLT x11 = (-1 * x5 * imu_w) + (x3 * imu_y) + (x4 * imu_x) + (-1 * x2 * imu_z);
	const GEN_FLT x12 = 1 + (0.101971621297793 * acc_z);
	const GEN_FLT x13 = (-1 * x12 * x11) + (x8 * x9) + (x6 * x10);
	const GEN_FLT x14 = (x5 * imu_z) + (-1 * x2 * imu_w) + (x7 * obj_qw) + (-1 * x3 * imu_x);
	const GEN_FLT x15 = (-1 * x14 * x10) + (x8 * x12) + (x9 * x11);
	const GEN_FLT x16 = (-1 * x6 * x9) + (x8 * x10) + (x14 * x12);
	out[0] = (x0 * (x10 + (2 * ((x15 * x14) + (-1 * x6 * x13))))) + acc_biasx;
	out[1] = (x0 * (x9 + (2 * ((x6 * x16) + (-1 * x15 * x11))))) + acc_biasy;
	out[2] = (x0 * (x12 + (2 * ((x13 * x11) + (-1 * x14 * x16))))) + acc_biasz;
}

// Jacobian of imu_predict_up wrt [obj_px, obj_py, obj_pz, obj_qw, obj_qi, obj_qj, obj_qk, vx, vy, vz, avx, avy, avz, acc_x, acc_y, acc_z, acc_biasx, acc_biasy, acc_biasz, gbx, gby, gbz, imu_w, imu_x, imu_y, imu_z]
static inline void gen_imu_predict_up_jac_kalman_model(FLT* out, const SurviveKalmanModel* kalman_model) {
	...
	const GEN_FLT imu_y = (*kalman_model).IMUCorrection[2];
	const GEN_FLT imu_z = (*kalman_model).IMUCorrection[3];
	const GEN_FLT x0 = imu_z * imu_z;
	const GEN_FLT x1 = imu_y * imu_y;
	const GEN_FLT x2 = imu_w * imu_w;
	const GEN_FLT x3 = imu_x * imu_x;
	const GEN_FLT x4 = 1e-11 + x2 + x3 + x0 + x1;
	const GEN_FLT x5 = sqrt(x4);
	const GEN_FLT x6 = 1. / x5;
	const GEN_FLT x7 = obj_qw * obj_qw;
	const GEN_FLT x8 = obj_qk * obj_qk;
	const GEN_FLT x9 = obj_qj * obj_qj;
	const GEN_FLT x10 = obj_qi * obj_qi;
	const GEN_FLT x11 = 1e-11 + x10 + x9 + x7 + x8;
	const GEN_FLT x12 = 1. / sqrt(x11);
	const GEN_FLT x13 = x6 * x12;
	const GEN_FLT x14 = x13 * imu_z;
	const GEN_FLT x15 = x6 * (1. / (x11 * sqrt(x11)));
	const GEN_FLT x16 = x15 * imu_z;
	const GEN_FLT x17 = x15 * imu_y;
	const GEN_FLT x18 = obj_qw * obj_qi;
	const GEN_FLT x19 = x18 * x17;
	const GEN_FLT x20 = x15 * imu_x;
	const GEN_FLT x21 = x20 * obj_qw;
	const GEN_FLT x22 = -1 * x21 * obj_qj;
	const GEN_FLT x23 = x15 * imu_w;
	const GEN_FLT x24 = x23 * obj_qw;
	const GEN_FLT x25 = x24 * obj_qk;
	const GEN_FLT x26 = x25 + x19 + x14 + x22 + (-1 * x7 * x16);
	const GEN_FLT x27 = x14 * obj_qk;
	const GEN_FLT x28 = x13 * imu_y;
	const GEN_FLT x29 = x28 * obj_qj;
	const GEN_FLT x30 = x13 * imu_w;
	const GEN_FLT x31 = x30 * obj_qw;
	const GEN_FLT x32 = x13 * imu_x;
	const GEN_FLT x33 = x32 * obj_qi;
	const GEN_FLT x34 = x33 + x27 + x31 + x29;
	const GEN_FLT x35 = 0.101971621297793 * acc_y;
	const GEN_FLT x36 = x32 * obj_qj;
	const GEN_FLT x37 = x30 * obj_qk;
	const GEN_FLT x38 = x14 * obj_qw;
	const GEN_FLT x39 = x28 * obj_qi;
	const GEN_FLT x40 = x38 + (-1 * x39) + x36 + (-1 * x37);
	const GEN_FLT x41 = 0.101971621297793 * acc_x;
	const GEN_FLT x42 = x28 * obj_qk;
	const GEN_FLT x43 = x14 * obj_qj;
	const GEN_FLT x44 = x32 * obj_qw;
	const GEN_FLT x45 = x30 * obj_qi;
	const GEN_FLT x46 = (-1 * x45) + x44 + x42 + (-1 * x43);
	const GEN_FLT x47 = 1 + (0.101971621297793 * acc_z);
	const GEN_FLT x48 = (-1 * x46 * x47) + (x34 * x35) + (x40 * x41);
	const GEN_FLT x49 = 2 * x48;
	const GEN_FLT x50 = x24 * obj_qi;
	const GEN_FLT x51 = x17 * obj_qk;
	const GEN_FLT x52 = -1 * x51 * obj_qw;
	const GEN_FLT x53 = x16 * obj_qw;
	const GEN_FLT x54 = x53 * obj_qj;
	const GEN_FLT x55 = x52 + (-1 * x7 * x20) + x50 + x54 + x32;
	const GEN_FLT x56 = -1 * x20 * x18;
	const GEN_FLT x57 = -1 * x53 * obj_qk;
	const GEN_FLT x58 = x17 * obj_qj;
	const GEN_FLT x59 = -1 * x58 * obj_qw;
	const GEN_FLT x60 = x57 + x59 + x56 + x30 + (-1 * x7 * x23);
	const GEN_FLT x61 = (x41 * x26) + (-1 * x55 * x47) + (x60 * x35);
	const GEN_FLT x62 = 2 * x40;
	const GEN_FLT x63 = x24 * obj_qj;
	const GEN_FLT x64 = x21 * obj_qk;
	const GEN_FLT x65 = -1 * x18 * x16;
	const GEN_FLT x66 = x28 + (-1 * x7 * x17) + x65 + x63 + x64;
	const GEN_FLT x67 = x28 * obj_qw;
	const GEN_FLT x68 = x32 * obj_qk;
	const GEN_FLT x69 = x30 * obj_qj;
	const GEN_FLT x70 = x14 * obj_qi;
	const GEN_FLT x71 = x70 + x67 + (-1 * x69) + (-1 * x68);
	const GEN_FLT x72 = (x47 * x34) + (-1 * x71 * x41) + (x46 * x35);
	const GEN_FLT x73 = 2 * x72;
	const GEN_FLT x74 = (x55 * x35) + (-1 * x66 * x41) + (x60 * x47);
	const GEN_FLT x75 = 2 * x71;
	const GEN_FLT x76 = x20 * obj_qj;
	const GEN_FLT x77 = -1 * x76 * obj_qi;
	const GEN_FLT x78 = obj_qk * obj_qi;
	const GEN_FLT x79 = x78 * x23;
	const GEN_FLT x80 = x77 + x65 + (-1 * x28) + x79 + (x10 * x17);
	const GEN_FLT x81 = -1 * x78 * x16;
	const GEN_FLT x82 = x58 * obj_qi;
	const GEN_FLT x83 = (-1 * x82) + (-1 * x50) + x81 + x32 + (-1 * x20 * x10);
	const GEN_FLT x84 = x23 * obj_qj;
	const GEN_FLT x85 = x84 * obj_qi;
	const GEN_FLT x86 = x78 * x20;
	const GEN_FLT x87 = x86 + (-1 * x19) + x85 + x14 + (-1 * x10 * x16);
	const GEN_FLT x88 = -1 * x30;
	const GEN_FLT x89 = x51 * obj_qi;
	const GEN_FLT x90 = x16 * obj_qj;
	const GEN_FLT x91 = x90 * obj_qi;
	const GEN_FLT x92 = x91 + (-1 * x89) + x56 + x88 + (x23 * x10);
	const GEN_FLT x93 = (x92 * x35) + (x83 * x47) + (-1 * x87 * x41);
	const GEN_FLT x94 = (x80 * x41) + (x83 * x35) + (-1 * x92 * x47);
	const GEN_FLT x95 = x84 * obj_qk;
	const GEN_FLT x96 = x95 + (-1 * x9 * x20) + x82 + x32 + (-1 * x54);
	const GEN_FLT x97 = -1 * x58 * obj_qk;
	const GEN_FLT x98 = (x9 * x16) + x97 + x22 + x85 + (-1 * x14);
	const GEN_FLT x99 = x90 * obj_qk;
	const GEN_FLT x100 = (-1 * x9 * x17) + x77 + (-1 * x99) + (-1 * x63) + x28;
	const GEN_FLT x101 = (x96 * x41) + (-1 * x98 * x47) + (x35 * x100);
	const GEN_FLT x102 = x76 * obj_qk;
	const GEN_FLT x103 = x102 + x59 + (-1 * x91) + (x9 * x23) + x88;
	const GEN_FLT x104 = (x98 * x35) + (-1 * x41 * x103) + (x47 * x100);
	const GEN_FLT x105 = (x8 * x23) + (-1 * x102) + x57 + x89 + x88;
	const GEN_FLT x106 = (x8 * x20) + (-1 * x32) + x81 + x52 + x95;
	const GEN_FLT x107 = x14 + (-1 * x8 * x16) + (-1 * x25) + (-1 * x86) + x97;
	const GEN_FLT x108 = x28 + x99 + (-1 * x8 * x17) + (-1 * x64) + x79;
	const GEN_FLT x109 = (x35 * x108) + (x47 * x107) + (-1 * x41 * x106);
	const GEN_FLT x110 = (x41 * x105) + (-1 * x47 * x108) + (x35 * x107);
	const GEN_FLT x111 = 0.101971621297793 * x37;
	const GEN_FLT x112 = 0.101971621297793 * x38;
	const GEN_FLT x113 = 0.101971621297793 * x39;
	const GEN_FLT x114 = 0.101971621297793 * x36;
	const GEN_FLT x115 = x114 + (-1 * x113) + (-1 * x111) + x112;
	const GEN_FLT x116 = (-0.101971621297793 * x70) + (-0.101971621297793 * x67) + (0.101971621297793 * x69) + (0.101971621297793 * x68);
	const GEN_FLT x117 = (0.101971621297793 * x31) + (0.101971621297793 * x29) + (0.101971621297793 * x33) + (0.101971621297793 * x27);
	const GEN_FLT x118 = x62 * x117;
	const GEN_FLT x119 = (0.101971621297793 * x44) + (-0.101971621297793 * x45) + (-0.101971621297793 * x43) + (0.101971621297793 * x42);
	const GEN_FLT x120 = 0.203943242595586 * x46;
	const GEN_FLT x121 = 0.203943242595586 * x71;
	const GEN_FLT x122 = x6 * (x41 + (2 * ((x71 * x72) + (-1 * x40 * x48))));
	const GEN_FLT x123 = (1. / (x4 * sqrt(x4))) * x12;
	const GEN_FLT x124 = x123 * imu_w;
	const GEN_FLT x125 = x124 * imu_z;
	const GEN_FLT x126 = -1 * x125 * obj_qw;
	const GEN_FLT x127 = x13 * obj_qk;
	const GEN_FLT x128 = -1 * x127;
	const GEN_FLT x129 = x124 * imu_x;
	const GEN_FLT x130 = x129 * obj_qj;
	const GEN_FLT x131 = x124 * imu_y;
	const GEN_FLT x132 = x131 * obj_qi;
	const GEN_FLT x133 = x2 * x123;
	const GEN_FLT x134 = x132 + (x133 * obj_qk) + x126 + (-1 * x130) + x128;
	const GEN_FLT x135 = x125 * obj_qi;
	const GEN_FLT x136 = x13 * obj_qj;
	const GEN_FLT x137 = -1 * x136;
	const GEN_FLT x138 = -1 * x131 * obj_qw;
	const GEN_FLT x139 = x124 * obj_qk;
	const GEN_FLT x140 = x139 * imu_x;
	const GEN_FLT x141 = x138 + (x133 * obj_qj) + x140 + (-1 * x135) + x137;
	const GEN_FLT x142 = x13 * obj_qw;
	const GEN_FLT x143 = x129 * obj_qi;
	const GEN_FLT x144 = x139 * imu_z;
	const GEN_FLT x145 = x131 * obj_qj;
	const GEN_FLT x146 = (-1 * x145) + (-1 * x143) + x142 + (-1 * x144) + (-1 * x133 * obj_qw);
	const GEN_FLT x147 = x13 * obj_qi;
	const GEN_FLT x148 = -1 * x147;
	const GEN_FLT x149 = -1 * x129 * obj_qw;
	const GEN_FLT x150 = x131 * obj_qk;
	const GEN_FLT x151 = imu_z * obj_qj;
	const GEN_FLT x152 = x124 * x151;
	const GEN_FLT x153 = x152 + x149 + x148 + (-1 * x150) + (x133 * obj_qi);
	const GEN_FLT x154 = (x35 * x153) + (x47 * x146) + (-1 * x41 * x141);
	const GEN_FLT x155 = (x41 * x134) + (x35 * x146) + (-1 * x47 * x153);
	const GEN_FLT x156 = x123 * imu_y;
	const GEN_FLT x157 = x156 * imu_x;
	const GEN_FLT x158 = x157 * obj_qi;
	const GEN_FLT x159 = x3 * x123;
	const GEN_FLT x160 = x123 * imu_x;
	const GEN_FLT x161 = x160 * imu_z;
	const GEN_FLT x162 = -1 * x161 * obj_qw;
	const GEN_FLT x163 = x136 + x162 + x158 + (-1 * x159 * obj_qj) + x140;
	const GEN_FLT x164 = x161 * obj_qk;
	const GEN_FLT x165 = -1 * x157 * obj_qj;
	const GEN_FLT x166 = x147 + (-1 * x164) + x165 + (-1 * x159 * obj_qi) + x149;
	const GEN_FLT x167 = x157 * obj_qk;
	const GEN_FLT x168 = x160 * x151;
	const GEN_FLT x169 = (-1 * x167) + x168 + x143 + x142 + (-1 * x159 * obj_qw);
	const GEN_FLT x170 = (x41 * x163) + (x35 * x166) + (-1 * x47 * x169);
	const GEN_FLT x171 = -1 * x161 * obj_qi;
	const GEN_FLT x172 = -1 * x157 * obj_qw;
	const GEN_FLT x173 = (x159 * obj_qk) + x172 + x171 + x128 + x130;
	const GEN_FLT x174 = (x35 * x169) + (-1 * x41 * x173) + (x47 * x166);
	const GEN_FLT x175 = x1 * x123;
	const GEN_FLT x176 = x156 * imu_z;
	const GEN_FLT x177 = -1 * x176 * obj_qw;
	const GEN_FLT x178 = x165 + x148 + x150 + (x175 * obj_qi) + x177;
	const GEN_FLT x179 = x151 * x156;
	const GEN_FLT x180 = (-1 * x175 * obj_qk) + x127 + x132 + x179 + x172;
	const GEN_FLT x181 = -1 * x176 * obj_qk;
	const GEN_FLT x182 = (-1 * x175 * obj_qj) + x181 + (-1 * x158) + x138 + x136;
	const GEN_FLT x183 = (x41 * x178) + (-1 * x47 * x180) + (x35 * x182);
	const GEN_FLT x184 = x176 * obj_qi;
	const GEN_FLT x185 = x142 + (-1 * x184) + (-1 * x175 * obj_qw) + x145 + x167;
	const GEN_FLT x186 = (x35 * x180) + (-1 * x41 * x185) + (x47 * x182);
	const GEN_FLT x187 = x0 * x123;
	const GEN_FLT x188 = (-1 * x168) + (-1 * x187 * obj_qw) + x142 + x144 + x184;
	const GEN_FLT x189 = (x187 * obj_qj) + x181 + x137 + x135 + x162;
	const GEN_FLT x190 = x127 + (-1 * x179) + x171 + (-1 * x187 * obj_qk) + x126;
	const GEN_FLT x191 = (x41 * x188) + (-1 * x47 * x189) + (x35 * x190);
	const GEN_FLT x192 = x164 + x177 + x147 + (-1 * x187 * obj_qi) + x152;
	const GEN_FLT x193 = (x35 * x189) + (-1 * x41 * x192) + (x47 * x190);
	const GEN_FLT x194 = 2 * x46;
	const GEN_FLT x195 = (x41 * x34) + (-1 * x40 * x35) + (x71 * x47);
	const GEN_FLT x196 = 2 * x195;
	const GEN_FLT x197 = (x66 * x47) + (-1 * x35 * x26) + (x60 * x41);
	const GEN_FLT x198 = (x87 * x47) + (-1 * x80 * x35) + (x83 * x41);
	const GEN_FLT x199 = (x47 * x103) + (-1 * x96 * x35) + (x41 * x100);
	const GEN_FLT x200 = (x47 * x106) + (-1 * x35 * x105) + (x41 * x107);
	const GEN_FLT x201 = (-1 * x114) + x113 + x111 + (-1 * x112);
	const GEN_FLT x202 = x6 * (x35 + (2 * ((x40 * x195) + (-1 * x72 * x46))));
	const GEN_FLT x203 = (x47 * x141) + (-1 * x35 * x134) + (x41 * x146);
	const GEN_FLT x204 = (x47 * x173) + (-1 * x35 * x163) + (x41 * x166);
	const GEN_FLT x205 = (x47 * x185) + (-1 * x35 * x178) + (x41 * x182);
	const GEN_FLT x206 = (x47 * x192) + (x41 * x190) + (-1 * x35 * x188);
	const GEN_FLT x207 = x6 * (x47 + (2 * ((x46 * x48) + (-1 * x71 * x195))));
	out[0] = 0;
	out[1] = 0;
	out[2] = 0;
	out[3] = x5 * ((x73 * x66) + (x75 * x74) + (-1 * x49 * x26) + (-1 * x61 * x62));
	out[4] = x5 * ((x87 * x73) + (-1 * x62 * x94) + (-1 * x80 * x49) + (x75 * x93));
	out[5] = x5 * ((x75 * x104) + (x73 * x103) + (-1 * x96 * x49) + (-1 * x62 * x101));
	out[6] = x5 * ((x75 * x109) + (-1 * x62 * x110) + (-1 * x49 * x105) + (x73 * x106));
	out[7] = 0;
	out[8] = 0;
	out[9] = 0;
	out[10] = 0;
	out[11] = 0;
	out[12] = 0;
	out[13] = x5 * (0.101971621297793 + (x75 * x116) + (-1 * x62 * x115));
	out[14] = x5 * ((x75 * x119) + (-1 * x118));
	out[15] = ((x34 * x121) + (x40 * x120)) * x5;
	out[16] = 1;
	out[17] = 0;
	out[18] = 0;
	out[19] = 0;
	out[20] = 0;
	out[21] = 0;
	out[22] = (x5 * ((-1 * x62 * x155) + (x75 * x154) + (-1 * x49 * x134) + (x73 * x141))) + (x122 * imu_w);
	out[23] = (x5 * ((x75 * x174) + (-1 * x49 * x163) + (x73 * x173) + (-1 * x62 * x170))) + (x122 * imu_x);
	out[24] = (x5 * ((x73 * x185) + (-1 * x49 * x178) + (x75 * x186) + (-1 * x62 * x183))) + (x122 * imu_y);
	out[25] = (x5 * ((x75 * x193) + (-1 * x49 * x188) + (x73 * x192) + (-1 * x62 * x191))) + (x122 * imu_z);
	out[26] = 0;
	out[27] = 0;
	out[28] = 0;
	out[29] = x5 * ((x62 * x197) + (x26 * x196) + (-1 * x73 * x55) + (-1 * x74 * x194));
	out[30] = x5 * ((x62 * x198) + (-1 * x73 * x92) + (-1 * x93 * x194) + (x80 * x196));
	out[31] = x5 * ((x96 * x196) + (-1 * x73 * x98) + (x62 * x199) + (-1 * x104 * x194));
	out[32] = x5 * ((x62 * x200) + (-1 * x109 * x194) + (-1 * x73 * x108) + (x105 * x196));
	out[33] = 0;
	out[34] = 0;
	out[35] = 0;
	out[36] = 0;
	out[37] = 0;
	out[38] = 0;
	out[39] = x5 * (x118 + (-1 * x116 * x194));
	out[40] = x5 * (0.101971621297793 + (x62 * x201) + (-1 * x119 * x194));
	out[41] = ((x40 * x121) + (-1 * x34 * x120)) * x5;
	out[42] = 0;
	out[43] = 1;
	out[44] = 0;
	out[45] = 0;
	out[46] = 0;
	out[47] = 0;
	out[48] = (x5 * ((x62 * x203) + (x196 * x134) + (-1 * x73 * x153) + (-1 * x194 * x154))) + (x202 * imu_w);
	out[49] = (x5 * ((x163 * x196) + (-1 * x73 * x169) + (-1 * x174 * x194) + (x62 * x204))) + (x202 * imu_x);
	out[50] = (x5 * ((x178 * x196) + (x62 * x205) + (-1 * x186 * x194) + (-1 * x73 * x180))) + (x202 * imu_y);
	out[51] = (x5 * ((x62 * x206) + (x188 * x196) + (-1 * x73 * x189) + (-1 * x193 * x194))) + (x202 * imu_z);
	out[52] = 0;
	out[53] = 0;
	out[54] = 0;
	out[55] = x5 * ((x61 * x194) + (x55 * x49) + (-1 * x66 * x196) + (-1 * x75 * x197));
	out[56] = x5 * ((x94 * x194) + (-1 * x75 * x198) + (x92 * x49) + (-1 * x87 * x196));
	out[57] = x5 * ((x98 * x49) + (-1 * x103 * x196) + (-1 * x75 * x199) + (x101 * x194));
	out[58] = ((x110 * x194) + (x49 * x108) + (-1 * x106 * x196) + (-1 * x75 * x200)) * x5;
	out[59] = 0;
	out[60] = 0;
	out[61] = 0;
	out[62] = 0;
	out[63] = 0;
	out[64] = 0;
	out[65] = x5 * ((x115 * x194) + (-1 * x75 * x117));
	out[66] = x5 * ((x117 * x194) + (-1 * x75 * x201));
	out[67] = x5 * (0.101971621297793 + (-0.203943242595586 * (x46 * x46)) + (-0.203943242595586 * (x71 * x71)));
	out[68] = 0;
	out[69] = 0;
	out[70] = 1;
	out[71] = 0;
	out[72] = 0;
	out[73] = 0;
	out[74] = (x207 * imu_w) + (((x49 * x153) + (x194 * x155) + (-1 * x196 * x141) + (-1 * x75 * x203)) * x5);
	out[75] = (x207 * imu_x) + (((x49 * x169) + (-1 * x173 * x196) + (x170 * x194) + (-1 * x75 * x204)) * x5);
	out[76] = (x207 * imu_y) + (((x49 * x180) + (-1 * x185 * x196) + (x183 * x194) + (-1 * x75 * x205)) * x5);
	out[77] = (x207 * imu_z) + (((x191 * x194) + (x49 * x189) + (-1 * x196 * x192) + (-1 * x75 * x206)) * x5);
}
...
static inline void gen_imu_predict(FLT* out, const SurviveKalmanModel* kalman_model) {
	...
	const GEN_FLT x2 = x1 * obj_qj;
	const GEN_FLT x3 = x1 * obj_qk;
	const GEN_FLT x4 = x1 * imu_z;
	const GEN_FLT x5 = x1 * imu_y;
	const GEN_FLT x6 = (-1 * x5 * obj_qi) + (x4 * obj_qw) + (x2 * imu_x) + (-1 * x3 * imu_w);
	const GEN_FLT x7 = x1 * imu_w;
	const GEN_FLT x8 = x1 * imu_x;
	const GEN_FLT x9 = (x7 * obj_qw) + (x3 * imu_z) + (x8 * obj_qi) + (x2 * imu_y);
	const GEN_FLT x10 = 0.101971621297793 * acc_y;
	const GEN_FLT x11 = 0.101971621297793 * acc_x;
	const GEN_FLT x12 = (-1 * x7 * obj_qi) + (x5 * obj_qk) + (x8 * obj_qw) + (-1 * x2 * imu_z);
	const GEN_FLT x13 = 1 + (0.101971621297793 * acc_z);
	const GEN_FLT x14 = (-1 * x13 * x12) + (x9 * x10) + (x6 * x11);
	const GEN_FLT x15 = (x4 * obj_qi) + (-1 * x2 * imu_w) + (x5 * obj_qw) + (-1 * x3 * imu_x);
	const GEN_FLT x16 = (-1 * x15 * x11) + (x9 * x13) + (x12 * x10);
	const GEN_FLT x17 = (x9 * x11) + (-1 * x6 * x10) + (x15 * x13);
	const GEN_FLT x18 = (-1 * x12 * avz) + (x6 * avx) + (x9 * avy);
	const GEN_FLT x19 = (-1 * x15 * avx) + (x9 * avz) + (x12 * avy);
	const GEN_FLT x20 = (-1 * x6 * avy) + (x9 * avx) + (x15 * avz);
	out[0] = (x0 * (x11 + (2 * ((x15 * x16) + (-1 * x6 * x14))))) + acc_biasx;
	out[1] = (x0 * (x10 + (2 * ((x6 * x17) + (-1 * x12 * x16))))) + acc_biasy;
	out[2] = (x0 * (x13 + (2 * ((x14 * x12) + (-1 * x15 * x17))))) + acc_biasz;
	out[3] = (2 * ((x15 * x19) + (-1 * x6 * x18))) + gbx + avx;
	out[4] = (2 * ((x6 * x20) + (-1 * x12 * x19))) + gby + avy;
	out[5] = (2 * ((x12 * x18) + (-1 * x20 * x15))) + gbz + avz;
}

// Jacobian of imu_predict wrt [obj_px, obj_py, obj_pz, obj_qw, obj_qi, obj_qj, obj_qk, vx, vy, vz, avx, avy, avz, acc_x, acc_y, acc_z, acc_biasx, acc_biasy, acc_biasz, gbx, gby, gbz, imu_w, imu_x, imu_y, imu_z]
static inline void gen_imu_predict_jac_kalman_model(FLT* out, const SurviveKalmanModel* kalman_model) {
	...
	const GEN_FLT x4 = 1e-11 + x2 + x3 + x0 + x1;
	const GEN_FLT x5 = sqrt(x4);
	const GEN_FLT x6 = obj_qw * obj_qw;
	...
	const GEN_FLT x13 = x12 * x11;
	const GEN_FLT x14 = x13 * imu_z;
	const GEN_FLT x15 = x12 * (1. / (x10 * sqrt(x10)));
	const GEN_FLT x16 = x15 * imu_z;
	const GEN_FLT x17 = x15 * imu_y;
	const GEN_FLT x18 = obj_qw * obj_qi;
	const GEN_FLT x19 = x18 * x17;
	...
	const GEN_FLT x22 = -1 * x21 * obj_qw;
	const GEN_FLT x23 = x15 * imu_w;
	const GEN_FLT x24 = obj_qw * obj_qk;
	const GEN_FLT x25 = x24 * x23;
	const GEN_FLT x26 = x22 + x25 + x19 + x14 + (-1 * x6 * x16);
	const GEN_FLT x27 = x14 * obj_qk;
	const GEN_FLT x28 = x13 * imu_y;
	const GEN_FLT x29 = x28 * obj_qj;
	const GEN_FLT x30 = x13 * imu_w;
	...
	const GEN_FLT x48 = (-1 * x46 * x47) + (x34 * x35) + (x40 * x41);
	const GEN_FLT x49 = 2 * x48;
	const GEN_FLT x50 = x23 * x18;
	const GEN_FLT x51 = x17 * obj_qk;
	const GEN_FLT x52 = -1 * x51 * obj_qw;
	const GEN_FLT x53 = x16 * obj_qj;
	const GEN_FLT x54 = x53 * obj_qw;
	const GEN_FLT x55 = x52 + (-1 * x6 * x20) + x50 + x54 + x32;
	const GEN_FLT x56 = x20 * obj_qw;
	const GEN_FLT x57 = -1 * x56 * obj_qi;
	const GEN_FLT x58 = -1 * x24 * x16;
	const GEN_FLT x59 = x17 * obj_qj;
	const GEN_FLT x60 = -1 * x59 * obj_qw;
	const GEN_FLT x61 = x58 + x60 + x30 + x57 + (-1 * x6 * x23);
	const GEN_FLT x62 = (x41 * x26) + (-1 * x55 * x47) + (x61 * x35);
	const GEN_FLT x63 = 2 * x40;
	const GEN_FLT x64 = x23 * obj_qj;
	const GEN_FLT x65 = x64 * obj_qw;
	const GEN_FLT x66 = x56 * obj_qk;
	const GEN_FLT x67 = -1 * x18 * x16;
	const GEN_FLT x68 = x28 + x67 + x65 + (-1 * x6 * x17) + x66;
	const GEN_FLT x69 = x28 * obj_qw;
	const GEN_FLT x70 = x32 * obj_qk;
	const GEN_FLT x71 = x30 * obj_qj;
	const GEN_FLT x72 = x14 * obj_qi;
	const GEN_FLT x73 = x72 + (-1 * x71) + x69 + (-1 * x70);
	const GEN_FLT x74 = (-1 * x73 * x41) + (x47 * x34) + (x46 * x35);
	const GEN_FLT x75 = 2 * x74;
	const GEN_FLT x76 = (x55 * x35) + (-1 * x68 * x41) + (x61 * x47);
	const GEN_FLT x77 = 2 * x73;
	const GEN_FLT x78 = -1 * x21 * obj_qi;
	const GEN_FLT x79 = obj_qk * obj_qi;
	const GEN_FLT x80 = x79 * x23;
	const GEN_FLT x81 = x80 + x78 + x67 + (-1 * x28) + (x9 * x17);
	const GEN_FLT x82 = -1 * x79 * x16;
	const GEN_FLT x83 = x59 * obj_qi;
	const GEN_FLT x84 = (-1 * x83) + x32 + x82 + (-1 * x50) + (-1 * x9 * x20);
	const GEN_FLT x85 = x64 * obj_qi;
	const GEN_FLT x86 = x79 * x20;
	const GEN_FLT x87 = x86 + (-1 * x19) + x85 + x14 + (-1 * x9 * x16);
	const GEN_FLT x88 = -1 * x30;
	const GEN_FLT x89 = x51 * obj_qi;
	const GEN_FLT x90 = x53 * obj_qi;
	const GEN_FLT x91 = x90 + (-1 * x89) + x57 + x88 + (x9 * x23);
	const GEN_FLT x92 = (x91 * x35) + (x84 * x47) + (-1 * x87 * x41);
	const GEN_FLT x93 = (x81 * x41) + (x84 * x35) + (-1 * x91 * x47);
	const GEN_FLT x94 = x64 * obj_qk;
	const GEN_FLT x95 = x94 + (-1 * x8 * x20) + x83 + x32 + (-1 * x54);
	const GEN_FLT x96 = -1 * x51 * obj_qj;
	const GEN_FLT x97 = (x8 * x16) + x96 + x22 + x85 + (-1 * x14);
	const GEN_FLT x98 = x53 * obj_qk;
	const GEN_FLT x99 = (-1 * x98) + (-1 * x8 * x17) + x78 + (-1 * x65) + x28;
	const GEN_FLT x100 = (x95 * x41) + (-1 * x97 * x47) + (x99 * x35);
	const GEN_FLT x101 = x21 * obj_qk;
	const GEN_FLT x102 = (x8 * x23) + (-1 * x90) + x101 + x60 + x88;
	const GEN_FLT x103 = (x97 * x35) + (-1 * x41 * x102) + (x99 * x47);
	const GEN_FLT x104 = (x7 * x23) + x58 + x89 + (-1 * x101) + x88;
	const GEN_FLT x105 = (x7 * x20) + x52 + (-1 * x32) + x82 + x94;
	const GEN_FLT x106 = x14 + (-1 * x7 * x16) + (-1 * x25) + (-1 * x86) + x96;
	const GEN_FLT x107 = x28 + (-1 * x7 * x17) + x98 + (-1 * x66) + x80;
	const GEN_FLT x108 = (x35 * x107) + (x47 * x106) + (-1 * x41 * x105);
	const GEN_FLT x109 = (x41 * x104) + (-1 * x47 * x107) + (x35 * x106);
	const GEN_FLT x110 = 0.101971621297793 * x37;
	const GEN_FLT x111 = 0.101971621297793 * x38;
	const GEN_FLT x112 = 0.101971621297793 * x39;
	const GEN_FLT x113 = 0.101971621297793 * x36;
	const GEN_FLT x114 = x113 + (-1 * x112) + (-1 * x110) + x111;
	const GEN_FLT x115 = (-0.101971621297793 * x72) + (0.101971621297793 * x71) + (-0.101971621297793 * x69) + (0.101971621297793 * x70);
	const GEN_FLT x116 = (0.101971621297793 * x31) + (0.101971621297793 * x29) + (0.101971621297793 * x33) + (0.101971621297793 * x27);
	const GEN_FLT x117 = x63 * x116;
	const GEN_FLT x118 = (0.101971621297793 * x44) + (-0.101971621297793 * x45) + (-0.101971621297793 * x43) + (0.101971621297793 * x42);
	const GEN_FLT x119 = 0.203943242595586 * x46;
	const GEN_FLT x120 = 0.203943242595586 * x73;
	const GEN_FLT x121 = x12 * (x41 + (2 * ((x73 * x74) + (-1 * x40 * x48))));
	const GEN_FLT x122 = (1. / (x4 * sqrt(x4))) * x11;
	const GEN_FLT x123 = x122 * obj_qw;
	const GEN_FLT x124 = x123 * imu_w;
	const GEN_FLT x125 = -1 * x124 * imu_z;
	const GEN_FLT x126 = x13 * obj_qk;
	const GEN_FLT x127 = -1 * x126;
	const GEN_FLT x128 = x122 * obj_qj;
	const GEN_FLT x129 = imu_w * imu_x;
	const GEN_FLT x130 = x128 * x129;
	const GEN_FLT x131 = x122 * obj_qi;
	const GEN_FLT x132 = x131 * imu_w;
	const GEN_FLT x133 = x132 * imu_y;
	const GEN_FLT x134 = x122 * obj_qk;
	const GEN_FLT x135 = (x2 * x134) + (-1 * x130) + x133 + x125 + x127;
	const GEN_FLT x136 = x132 * imu_z;
	const GEN_FLT x137 = x13 * obj_qj;
	const GEN_FLT x138 = -1 * x137;
	const GEN_FLT x139 = -1 * x124 * imu_y;
	const GEN_FLT x140 = x129 * x134;
	const GEN_FLT x141 = x140 + (x2 * x128) + (-1 * x136) + x139 + x138;
	const GEN_FLT x142 = x13 * obj_qw;
	const GEN_FLT x143 = x132 * imu_x;
	const GEN_FLT x144 = imu_w * imu_z;
	const GEN_FLT x145 = x134 * x144;
	const GEN_FLT x146 = imu_w * imu_y;
	const GEN_FLT x147 = x128 * x146;
	const GEN_FLT x148 = (-1 * x147) + (-1 * x143) + x142 + (-1 * x145) + (-1 * x2 * x123);
	const GEN_FLT x149 = x13 * obj_qi;
	const GEN_FLT x150 = -1 * x149;
	const GEN_FLT x151 = -1 * x124 * imu_x;
	const GEN_FLT x152 = x134 * x146;
	const GEN_FLT x153 = x128 * x144;
	const GEN_FLT x154 = x153 + (-1 * x152) + x150 + x151 + (x2 * x131);
	const GEN_FLT x155 = (x35 * x154) + (x47 * x148) + (-1 * x41 * x141);
	const GEN_FLT x156 = (x41 * x135) + (x35 * x148) + (-1 * x47 * x154);
	const GEN_FLT x157 = imu_x * imu_y;
	const GEN_FLT x158 = x131 * x157;
	const GEN_FLT x159 = imu_x * imu_z;
	const GEN_FLT x160 = -1 * x123 * x159;
	const GEN_FLT x161 = x137 + x158 + x160 + (-1 * x3 * x128) + x140;
	const GEN_FLT x162 = x134 * x159;
	const GEN_FLT x163 = -1 * x128 * x157;
	const GEN_FLT x164 = x163 + x149 + (-1 * x162) + (-1 * x3 * x131) + x151;
	const GEN_FLT x165 = x134 * x157;
	const GEN_FLT x166 = x128 * x159;
	const GEN_FLT x167 = (-1 * x165) + x143 + x166 + x142 + (-1 * x3 * x123);
	const GEN_FLT x168 = (x41 * x161) + (x35 * x164) + (-1 * x47 * x167);
	const GEN_FLT x169 = -1 * x131 * x159;
	const GEN_FLT x170 = -1 * x123 * x157;
	const GEN_FLT x171 = x170 + (x3 * x134) + x127 + x169 + x130;
	const GEN_FLT x172 = (x35 * x167) + (-1 * x41 * x171) + (x47 * x164);
	const GEN_FLT x173 = imu_y * imu_z;
	const GEN_FLT x174 = -1 * x123 * x173;
	const GEN_FLT x175 = x163 + x150 + x152 + (x1 * x131) + x174;
	const GEN_FLT x176 = x128 * x173;
	const GEN_FLT x177 = x126 + (-1 * x1 * x134) + x176 + x133 + x170;
	const GEN_FLT x178 = -1 * x173 * x134;
	const GEN_FLT x179 = (-1 * x1 * x128) + (-1 * x158) + x139 + x178 + x137;
	const GEN_FLT x180 = (x41 * x175) + (-1 * x47 * x177) + (x35 * x179);
	const GEN_FLT x181 = x173 * x131;
	const GEN_FLT x182 = x142 + (-1 * x181) + x147 + (-1 * x1 * x123) + x165;
	const GEN_FLT x183 = (x35 * x177) + (-1 * x41 * x182) + (x47 * x179);
	const GEN_FLT x184 = x145 + (-1 * x0 * x123) + (-1 * x166) + x142 + x181;
	const GEN_FLT x185 = (x0 * x128) + x178 + x138 + x136 + x160;
	const GEN_FLT x186 = x126 + (-1 * x0 * x134) + (-1 * x176) + x169 + x125;
	const GEN_FLT x187 = (x41 * x184) + (-1 * x47 * x185) + (x35 * x186);
	const GEN_FLT x188 = x162 + (-1 * x0 * x131) + x174 + x149 + x153;
	const GEN_FLT x189 = (x35 * x185) + (-1 * x41 * x188) + (x47 * x186);
	const GEN_FLT x190 = 2 * x46;
	const GEN_FLT x191 = (x41 * x34) + (-1 * x40 * x35) + (x73 * x47);
	const GEN_FLT x192 = 2 * x191;
	const GEN_FLT x193 = (x68 * x47) + (-1 * x35 * x26) + (x61 * x41);
	const GEN_FLT x194 = (x87 * x47) + (-1 * x81 * x35) + (x84 * x41);
	const GEN_FLT x195 = (x47 * x102) + (-1 * x95 * x35) + (x99 * x41);
	const GEN_FLT x196 = (x47 * x105) + (-1 * x35 * x104) + (x41 * x106);
	const GEN_FLT x197 = (-1 * x113) + x112 + x110 + (-1 * x111);
	const GEN_FLT x198 = x12 * (x35 + (2 * ((x40 * x191) + (-1 * x74 * x46))));
	const GEN_FLT x199 = (x47 * x141) + (-1 * x35 * x135) + (x41 * x148);
	const GEN_FLT x200 = (-1 * x35 * x161) + (x47 * x171) + (x41 * x164);
	const GEN_FLT x201 = (x47 * x182) + (-1 * x35 * x175) + (x41 * x179);
	const GEN_FLT x202 = (x47 * x188) + (x41 * x186) + (-1 * x35 * x184);
	const GEN_FLT x203 = x73 * x73;
	const GEN_FLT x204 = x46 * x46;
	const GEN_FLT x205 = x12 * (x47 + (2 * ((x46 * x48) + (-1 * x73 * x191))));
	const GEN_FLT x206 = 2 * ((-1 * x46 * avz) + (x40 * avx) + (x34 * avy));
	const GEN_FLT x207 = (x61 * avy) + (-1 * x55 * avz) + (x26 * avx);
	const GEN_FLT x208 = 2 * ((-1 * x73 * avx) + (x34 * avz) + (x46 * avy));
	const GEN_FLT x209 = (x55 * avy) + (-1 * x68 * avx) + (x61 * avz);
	const GEN_FLT x210 = (x84 * avy) + (-1 * x91 * avz) + (x81 * avx);
	const GEN_FLT x211 = (-1 * x87 * avx) + (x91 * avy) + (x84 * avz);
	const GEN_FLT x212 = (x99 * avy) + (-1 * x97 * avz) + (x95 * avx);
	const GEN_FLT x213 = (x97 * avy) + (x99 * avz) + (-1 * avx * x102);
	const GEN_FLT x214 = (avy * x106) + (-1 * avz * x107) + (avx * x104);
	const GEN_FLT x215 = (avy * x107) + (-1 * avx * x105) + (avz * x106);
	const GEN_FLT x216 = (-1 * x72) + x71 + (-1 * x69) + x70;
	const GEN_FLT x217 = x63 * x34;
	const GEN_FLT x218 = (-1 * x44) + x45 + x43 + (-1 * x42);
	const GEN_FLT x219 = x77 * x34;
	const GEN_FLT x220 = (avy * x148) + (-1 * avz * x154) + (avx * x135);
	const GEN_FLT x221 = (avy * x154) + (-1 * avx * x141) + (avz * x148);
	const GEN_FLT x222 = (avy * x167) + (-1 * avx * x171) + (avz * x164);
	const GEN_FLT x223 = (-1 * avz * x167) + (avy * x164) + (avx * x161);
	const GEN_FLT x224 = (avy * x177) + (-1 * avx * x182) + (avz * x179);
	const GEN_FLT x225 = (-1 * avz * x177) + (avy * x179) + (avx * x175);
	const GEN_FLT x226 = (avy * x186) + (avx * x184) + (-1 * avz * x185);
	const GEN_FLT x227 = (avy * x185) + (avz * x186) + (-1 * avx * x188);
	const GEN_FLT x228 = 2 * ((-1 * x40 * avy) + (x34 * avx) + (x73 * avz));
	const GEN_FLT x229 = (-1 * x26 * avy) + (x68 * avz) + (x61 * avx);
	const GEN_FLT x230 = (x87 * avz) + (-1 * x81 * avy) + (x84 * avx);
	const GEN_FLT x231 = (avz * x102) + (-1 * x95 * avy) + (x99 * avx);
	const GEN_FLT x232 = (-1 * avy * x104) + (avz * x105) + (avx * x106);
	const GEN_FLT x233 = (-1 * x36) + x39 + x37 + (-1 * x38);
	const GEN_FLT x234 = x34 * x190;
	const GEN_FLT x235 = (avz * x141) + (-1 * avy * x135) + (avx * x148);
	const GEN_FLT x236 = (avz * x171) + (-1 * avy * x161) + (avx * x164);
	const GEN_FLT x237 = (-1 * avy * x175) + (avz * x182) + (avx * x179);
	const GEN_FLT x238 = (-1 * avy * x184) + (avz * x188) + (avx * x186);
	out[0] = 0;
	out[1] = 0;
	out[2] = 0;
	out[3] = x5 * ((x77 * x76) + (x75 * x68) + (-1 * x49 * x26) + (-1 * x63 * x62));
	out[4] = x5 * ((x87 * x75) + (-1 * x63 * x93) + (-1 * x81 * x49) + (x77 * x92));
	out[5] = x5 * ((x77 * x103) + (x75 * x102) + (-1 * x95 * x49) + (-1 * x63 * x100));
	out[6] = x5 * ((-1 * x63 * x109) + (x77 * x108) + (-1 * x49 * x104) + (x75 * x105));
	out[7] = 0;
	out[8] = 0;
	out[9] = 0;
	out[10] = 0;
	out[11] = 0;
	out[12] = 0;
	out[13] = x5 * (0.101971621297793 + (x77 * x115) + (-1 * x63 * x114));
	out[14] = x5 * ((x77 * x118) + (-1 * x117));
	out[15] = ((x34 * x120) + (x40 * x119)) * x5;
	out[16] = 1;
	out[17] = 0;
	out[18] = 0;
	out[19] = 0;
	out[20] = 0;
	out[21] = 0;
	out[22] = (x5 * ((-1 * x63 * x156) + (x77 * x155) + (-1 * x49 * x135) + (x75 * x141))) + (x121 * imu_w);
	out[23] = (x5 * ((x77 * x172) + (x75 * x171) + (-1 * x49 * x161) + (-1 * x63 * x168))) + (x121 * imu_x);
	out[24] = (x5 * ((x75 * x182) + (-1 * x49 * x175) + (x77 * x183) + (-1 * x63 * x180))) + (x121 * imu_y);
	out[25] = (x5 * ((x77 * x189) + (x75 * x188) + (-1 * x49 * x184) + (-1 * x63 * x187))) + (x121 * imu_z);
	out[26] = 0;
	out[27] = 0;
	out[28] = 0;
	out[29] = x5 * ((x63 * x193) + (x26 * x192) + (-1 * x75 * x55) + (-1 * x76 * x190));
	out[30] = x5 * ((-1 * x92 * x190) + (-1 * x75 * x91) + (x63 * x194) + (x81 * x192));
	out[31] = x5 * ((x95 * x192) + (x63 * x195) + (-1 * x75 * x97) + (-1 * x103 * x190));
	out[32] = x5 * ((x63 * x196) + (-1 * x75 * x107) + (-1 * x108 * x190) + (x104 * x192));
	out[33] = 0;
	out[34] = 0;
	out[35] = 0;
	out[36] = 0;
	out[37] = 0;
	out[38] = 0;
	out[39] = x5 * (x117 + (-1 * x115 * x190));
	out[40] = x5 * (0.101971621297793 + (x63 * x197) + (-1 * x118 * x190));
	out[41] = ((x40 * x120) + (-1 * x34 * x119)) * x5;
	out[42] = 0;
	out[43] = 1;
	out[44] = 0;
	out[45] = 0;
	out[46] = 0;
	out[47] = 0;
	out[48] = (x5 * ((x63 * x199) + (x192 * x135) + (-1 * x75 * x154) + (-1 * x190 * x155))) + (x198 * imu_w);
	out[49] = (x5 * ((-1 * x172 * x190) + (x161 * x192) + (-1 * x75 * x167) + (x63 * x200))) + (x198 * imu_x);
	out[50] = (x5 * ((-1 * x183 * x190) + (x175 * x192) + (x63 * x201) + (-1 * x75 * x177))) + (x198 * imu_y);
	out[51] = (x5 * ((x63 * x202) + (-1 * x75 * x185) + (x184 * x192) + (-1 * x189 * x190))) + (x198 * imu_z);
	out[52] = 0;
	out[53] = 0;
	out[54] = 0;
	out[55] = x5 * ((x62 * x190) + (x55 * x49) + (-1 * x68 * x192) + (-1 * x77 * x193));
	out[56] = x5 * ((x93 * x190) + (-1 * x77 * x194) + (x91 * x49) + (-1 * x87 * x192));
	out[57] = x5 * ((-1 * x77 * x195) + (x97 * x49) + (-1 * x102 * x192) + (x100 * x190));
	out[58] = ((x109 * x190) + (-1 * x105 * x192) + (x49 * x107) + (-1 * x77 * x196)) * x5;
	out[59] = 0;
	out[60] = 0;
	out[61] = 0;
	out[62] = 0;
	out[63] = 0;
	out[64] = 0;
	out[65] = x5 * ((x114 * x190) + (-1 * x77 * x116));
	out[66] = x5 * ((x116 * x190) + (-1 * x77 * x197));
	out[67] = x5 * (0.101971621297793 + (-0.203943242595586 * x204) + (-0.203943242595586 * x203));
	out[68] = 0;
	out[69] = 0;
	out[70] = 1;
	out[71] = 0;
	out[72] = 0;
	out[73] = 0;
	out[74] = (x205 * imu_w) + (((x190 * x156) + (-1 * x192 * x141) + (x49 * x154) + (-1 * x77 * x199)) * x5);
	out[75] = (x205 * imu_x) + (((x168 * x190) + (x49 * x167) + (-1 * x171 * x192) + (-1 * x77 * x200)) * x5);
	out[76] = (x205 * imu_y) + (((-1 * x182 * x192) + (x180 * x190) + (x49 * x177) + (-1 * x77 * x201)) * x5);
	out[77] = (x205 * imu_z) + (((x187 * x190) + (x49 * x185) + (-1 * x188 * x192) + (-1 * x77 * x202)) * x5);
	out[78] = 0;
	out[79] = 0;
	out[80] = 0;
	out[81] = (x77 * x209) + (x68 * x208) + (-1 * x26 * x206) + (-1 * x63 * x207);
	out[82] = (x87 * x208) + (x77 * x211) + (-1 * x81 * x206) + (-1 * x63 * x210);
	out[83] = (x77 * x213) + (x208 * x102) + (-1 * x95 * x206) + (-1 * x63 * x212);
	out[84] = (x77 * x215) + (x208 * x105) + (-1 * x206 * x104) + (-1 * x63 * x214);
	out[85] = 0;
	out[86] = 0;
	out[87] = 0;
	out[88] = 1 + (x77 * x216) + (-2 * (x40 * x40));
	out[89] = (x73 * x190) + (-1 * x217);
	out[90] = x219 + (-1 * x63 * x218);
	out[91] = 0;
	out[92] = 0;
	out[93] = 0;
	out[94] = 0;
	...
	out[98] = 0;
	out[99] = 0;
	out[100] = (x208 * x141) + (x77 * x221) + (-1 * x206 * x135) + (-1 * x63 * x220);
	out[101] = (-1 * x63 * x223) + (x77 * x222) + (-1 * x206 * x161) + (x208 * x171);
	out[102] = (-1 * x63 * x225) + (x208 * x182) + (-1 * x206 * x175) + (x77 * x224);
	out[103] = (x208 * x188) + (x77 * x227) + (-1 * x63 * x226) + (-1 * x206 * x184);
	out[104] = 0;
	out[105] = 0;
	out[106] = 0;
	out[107] = (x26 * x228) + (-1 * x55 * x208) + (x63 * x229) + (-1 * x209 * x190);
	out[108] = (-1 * x211 * x190) + (x81 * x228) + (-1 * x91 * x208) + (x63 * x230);
	out[109] = (-1 * x213 * x190) + (x63 * x231) + (-1 * x97 * x208) + (x95 * x228);
	out[110] = (x63 * x232) + (x228 * x104) + (-1 * x208 * x107) + (-1 * x215 * x190);
	out[111] = 0;
	out[112] = 0;
	out[113] = 0;
	out[114] = x217 + (-1 * x216 * x190);
	out[115] = 1 + (x63 * x233) + (-2 * x204);
	out[116] = (x77 * x40) + (-1 * x234);
	out[117] = 0;
	out[118] = 0;
	out[119] = 0;
	out[120] = 0;
	...
	out[124] = 1;
	out[125] = 0;
	out[126] = (-1 * x221 * x190) + (-1 * x208 * x154) + (x228 * x135) + (x63 * x235);
	out[127] = (x228 * x161) + (-1 * x208 * x167) + (x63 * x236) + (-1 * x222 * x190);
	out[128] = (x228 * x175) + (-1 * x208 * x177) + (x63 * x237) + (-1 * x224 * x190);
	out[129] = (x63 * x238) + (-1 * x227 * x190) + (-1 * x208 * x185) + (x228 * x184);
	out[130] = 0;
	out[131] = 0;
	out[132] = 0;
	out[133] = (x55 * x206) + (-1 * x77 * x229) + (x207 * x190) + (-1 * x68 * x228);
	out[134] = (-1 * x77 * x230) + (x91 * x206) + (-1 * x87 * x228) + (x210 * x190);
	out[135] = (x97 * x206) + (x212 * x190) + (-1 * x228 * x102) + (-1 * x77 * x231);
	out[136] = (-1 * x77 * x232) + (x206 * x107) + (-1 * x228 * x105) + (x214 * x190);
	out[137] = 0;
	out[138] = 0;
	out[139] = 0;
	out[140] = (x40 * x190) + (-1 * x219);
	out[141] = x234 + (-1 * x77 * x233);
	out[142] = 1 + (x218 * x190) + (-2 * x203);
	out[143] = 0;
	out[144] = 0;
	out[145] = 0;
	out[146] = 0;
	...
	out[150] = 0;
	out[151] = 1;
	out[152] = (x220 * x190) + (x206 * x154) + (-1 * x228 * x141) + (-1 * x77 * x235);
	out[153] = (x223 * x190) + (x206 * x167) + (-1 * x228 * x171) + (-1 * x77 * x236);
	out[154] = (x225 * x190) + (x206 * x177) + (-1 * x228 * x182) + (-1 * x77 * x237);
	out[155] = (x226 * x190) + (x206 * x185) + (-1 * x228 * x188) + (-1 * x77 * x238);
}
...
// Jacobian of imu_predict_gyro wrt [obj_px, obj_py, obj_pz, obj_qw, obj_qi, obj_qj, obj_qk, vx, vy, vz, avx, avy, avz, acc_x, acc_y, acc_z, acc_biasx, acc_biasy, acc_biasz, gbx, gby, gbz, imu_w, imu_x, imu_y, imu_z]
static inline void gen_imu_predict_gyro_jac_kalman_model(FLT* out, const SurviveKalmanModel* kalman_model) {
	...
	out[20] = 0;
	out[21] = 0;
	out[22] = (x66 * x138) + (x64 * x137) + (-1 * x40 * x118) + (-1 * x52 * x131);
	out[23] = (-1 * x52 * x155) + (-1 * x40 * x143) + (x66 * x154) + (x64 * x147);
	out[24] = (-1 * x52 * x167) + (-1 * x40 * x159) + (x64 * x161) + (x66 * x166);
	out[25] = (x64 * x173) + (-1 * x52 * x172) + (x66 * x174) + (-1 * x40 * x169);
	out[26] = 0;
	out[27] = 0;
	out[28] = 0;
	out[29] = (x52 * x176) + (x25 * x175) + (-1 * x64 * x45) + (-1 * x65 * x102);
	out[30] = (x70 * x175) + (-1 * x83 * x102) + (-1 * x75 * x64) + (x52 * x177);
	out[31] = (-1 * x93 * x102) + (-1 * x87 * x64) + (x52 * x178) + (x85 * x175);
	out[32] = (x52 * x179) + (x94 * x175) + (-1 * x64 * x95) + (-1 * x99 * x102);
	out[33] = 0;
	out[34] = 0;
	out[35] = 0;
	out[36] = x101 + (-1 * x100 * x102);
	out[37] = 1 + (x52 * x180) + (-2 * (x39 * x39));
	out[38] = (x63 * x52) + (-1 * x181);
	out[39] = 0;
	out[40] = 0;
	out[41] = 0;
	out[42] = 0;
	...
	out[46] = 1;
	out[47] = 0;
	out[48] = (-1 * x102 * x138) + (x118 * x175) + (-1 * x64 * x125) + (x52 * x182);
	out[49] = (x52 * x183) + (x175 * x143) + (-1 * x64 * x153) + (-1 * x102 * x154);
	out[50] = (x175 * x159) + (-1 * x64 * x165) + (x52 * x184) + (-1 * x102 * x166);
	out[51] = (x52 * x185) + (-1 * x102 * x174) + (-1 * x64 * x170) + (x169 * x175);
	out[52] = 0;
	out[53] = 0;
	out[54] = 0;
	out[55] = (x40 * x45) + (x51 * x102) + (-1 * x66 * x176) + (-1 * x58 * x175);
	out[56] = (-1 * x66 * x177) + (x75 * x40) + (-1 * x82 * x175) + (x79 * x102);
	out[57] = (x87 * x40) + (-1 * x92 * x175) + (x90 * x102) + (-1 * x66 * x178);
	out[58] = (-1 * x98 * x175) + (-1 * x66 * x179) + (x95 * x40) + (x97 * x102);
	out[59] = 0;
	out[60] = 0;
	out[61] = 0;
	out[62] = (x33 * x102) + (-1 * x104);
	out[63] = x181 + (-1 * x66 * x180);
	out[64] = 1 + (x103 * x102) + (-2 * (x63 * x63));
	out[65] = 0;
	out[66] = 0;
	out[67] = 0;
	out[68] = 0;
	...
	out[72] = 0;
	out[73] = 1;
	out[74] = (x102 * x131) + (x40 * x125) + (-1 * x175 * x137) + (-1 * x66 * x182);
	out[75] = (x102 * x155) + (x40 * x153) + (-1 * x175 * x147) + (-1 * x66 * x183);
	out[76] = (x102 * x167) + (x40 * x165) + (-1 * x161 * x175) + (-1 * x66 * x184);
	out[77] = (x102 * x172) + (x40 * x170) + (-1 * x175 * x173) + (-1 * x66 * x185);
}

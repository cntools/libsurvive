...
// Jacobian of SurviveKalmanModelAddErrorModel wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd62076f940>]
static inline void SurviveKalmanModelAddErrorModel_jac_x0(CnMat* Hx, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_state) {
	...
	const FLT x9 = 1.0 * x6;
	const FLT x10 = 1.0 * x5;
	const FLT x11 = 1.0 * x3;
	const FLT x12 = 1.0/2.0 * (1. / (x7 * sqrt(x7)));
	const FLT x13 = x12 * ((2 * x4) + (x11 * (*error_state).Pose.AxisAngleRot[1]) + (x9 * (*error_state).Pose.AxisAngleRot[0]) + (x10 * (*error_state).Pose.AxisAngleRot[2]));
	const FLT x14 = 0.5 * x8;
	const FLT x15 = x14 * (*error_state).Pose.AxisAngleRot[0];
	const FLT x16 = -1 * x15;
	const FLT x17 = 1.0 * x4;
	const FLT x18 = x12 * ((-1 * x17 * (*error_state).Pose.AxisAngleRot[0]) + (-1 * x11 * (*error_state).Pose.AxisAngleRot[2]) + (x10 * (*error_state).Pose.AxisAngleRot[1]) + (2 * x6));
	const FLT x19 = x14 * (*error_state).Pose.AxisAngleRot[1];
	const FLT x20 = -1 * x19;
	const FLT x21 = x12 * ((-1 * x17 * (*error_state).Pose.AxisAngleRot[1]) + (-1 * x10 * (*error_state).Pose.AxisAngleRot[0]) + (x9 * (*error_state).Pose.AxisAngleRot[2]) + (2 * x3));
	const FLT x22 = x2 * x8;
	const FLT x23 = -1 * x22;
	const FLT x24 = x12 * ((2 * x5) + (-1 * x17 * (*error_state).Pose.AxisAngleRot[2]) + (-1 * x9 * (*error_state).Pose.AxisAngleRot[1]) + (x11 * (*error_state).Pose.AxisAngleRot[0]));
	cnSetZero(Hx);
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), (-1 * x4 * x13) + x8);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), (-1 * x4 * x18) + x16);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), (-1 * x4 * x21) + x20);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), (-1 * x4 * x24) + x23);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), (-1 * x6 * x13) + x15);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), (-1 * x6 * x18) + x8);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), (-1 * x6 * x21) + x22);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), (-1 * x6 * x24) + x20);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), (-1 * x3 * x13) + x19);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), (-1 * x3 * x18) + x23);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), (-1 * x3 * x21) + x8);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), (-1 * x3 * x24) + x15);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), (-1 * x5 * x13) + x22);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), (-1 * x5 * x18) + x19);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), (-1 * x5 * x21) + x16);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), (-1 * x5 * x24) + x8);
...
// Jacobian of SurviveKalmanModelAddErrorModel wrt [(*error_state).AccBias[0], (*error_state).AccBias[1], (*error_state).AccBias[2], (*error_state).Acc[0], (*error_state).Acc[1], (*error_state).Acc[2], (*error_state).GyroBias[0], (*error_state).GyroBias[1], (*error_state).GyroBias[2], (*error_state).IMUCorrection[0], (*error_state).IMUCorrection[1], (*error_state).IMUCorrection[2], (*error_state).IMUCorrection[3], (*error_state).Pose.AxisAngleRot[0], (*error_state).Pose.AxisAngleRot[1], (*error_state).Pose.AxisAngleRot[2], (*error_state).Pose.Pos[0], (*error_state).Pose.Pos[1], (*error_state).Pose.Pos[2], (*error_state).Velocity.AxisAngleRot[0], (*error_state).Velocity.AxisAngleRot[1], (*error_state).Velocity.AxisAngleRot[2], (*error_state).Velocity.Pos[0], (*error_state).Velocity.Pos[1], (*error_state).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd62070f430>]
static inline void SurviveKalmanModelAddErrorModel_jac_error_state(CnMat* Hx, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_state) {
	...
	const FLT x12 = 1.0 * (*_x0).Pose.Rot[0];
	const FLT x13 = 1.0 * x3;
	const FLT x14 = 1.0 * x4;
	const FLT x15 = 1.0/2.0 * (1. / (x7 * sqrt(x7)));
	const FLT x16 = x15 * ((-1 * x14 * (*_x0).Pose.Rot[1]) + (x13 * (*_x0).Pose.Rot[3]) + (-1 * x11 * (*_x0).Pose.Rot[2]) + (x6 * x12));
	const FLT x17 = x8 * (*_x0).Pose.Rot[2];
	const FLT x18 = -1 * x17;
	const FLT x19 = 1.0 * x6;
	const FLT x20 = x15 * ((-1 * x14 * (*_x0).Pose.Rot[2]) + (x3 * x12) + (-1 * x19 * (*_x0).Pose.Rot[3]) + (x11 * (*_x0).Pose.Rot[1]));
	const FLT x21 = x8 * (*_x0).Pose.Rot[3];
	const FLT x22 = -1 * x21;
	const FLT x23 = x15 * ((-1 * x14 * (*_x0).Pose.Rot[3]) + (-1 * x13 * (*_x0).Pose.Rot[1]) + (x19 * (*_x0).Pose.Rot[2]) + (x5 * x12));
	const FLT x24 = x8 * (*_x0).Pose.Rot[0];
	cnSetZero(Hx);
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), (-1 * x4 * x16) + x10);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), (-1 * x4 * x20) + x18);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), (-1 * x4 * x23) + x22);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), (-1 * x6 * x16) + x24);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), (-1 * x6 * x20) + x22);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), (-1 * x6 * x23) + x17);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), (-1 * x3 * x16) + x21);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), (-1 * x3 * x20) + x24);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), (-1 * x3 * x23) + x10);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), (-1 * x5 * x16) + x18);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), (-1 * x5 * x20) + x9);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), (-1 * x5 * x23) + x24);
...
static inline void SurviveKalmanModelErrorPredict(SurviveKalmanErrorModel* out, const FLT t, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model) {
	...
	const FLT x8 = (*_x0).Velocity.AxisAngleRot[1] + (*error_model).Velocity.AxisAngleRot[1];
	const FLT x9 = t * t;
	...
	const FLT x14 = (x8 * x8) * x9;
	const FLT x15 = 1e-10 + x14 + x11 + x13;
	const FLT x16 = sqrt(x15);
	const FLT x17 = 0.5 * x16;
	const FLT x18 = sin(x17);
	const FLT x19 = (-1 * x5 * (*_x0).Pose.Rot[1]) + (x6 * (*_x0).Pose.Rot[0]) + (x4 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x20 = (-1 * x4 * (*_x0).Pose.Rot[1]) + (-1 * x6 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x5 * (*_x0).Pose.Rot[3]);
	const FLT x21 = (*_x0).Pose.Rot[1] + (-1 * x6 * (*_x0).Pose.Rot[3]) + (x4 * (*_x0).Pose.Rot[0]) + (x5 * (*_x0).Pose.Rot[2]);
	const FLT x22 = (1. / x15) * (x18 * x18);
	const FLT x23 = cos(x17);
	const FLT x24 = (1. / sqrt((x21 * x21) + (x20 * x20) + (x7 * x7) + (x19 * x19))) * (1. / sqrt((x23 * x23) + (x22 * x11) + (x22 * x13) + (x22 * x14)));
	const FLT x25 = t * x24 * x18 * (1. / x16);
	const FLT x26 = x8 * x25;
	const FLT x27 = x24 * x23;
	const FLT x28 = x25 * x10;
	const FLT x29 = x25 * x12;
	const FLT x30 = (x20 * x29) + (-1 * x28 * x19) + (x7 * x26) + (x21 * x27);
	const FLT x31 = (-1 * x21 * x29) + (x20 * x27) + (-1 * x7 * x28) + (-1 * x26 * x19);
	const FLT x32 = (x29 * x19) + (x20 * x28) + (-1 * x21 * x26) + (x7 * x27);
	const FLT x33 = (-1 * x7 * x29) + (x21 * x28) + (x20 * x26) + (x27 * x19);
	const FLT x34 = (-1 * x33 * (*_x0).Pose.Rot[1]) + (x32 * (*_x0).Pose.Rot[0]) + (x30 * (*_x0).Pose.Rot[2]) + (-1 * x31 * (*_x0).Pose.Rot[3]);
	const FLT x35 = (x32 * (*_x0).Pose.Rot[1]) + (x33 * (*_x0).Pose.Rot[0]) + (-1 * x30 * (*_x0).Pose.Rot[3]) + (-1 * x31 * (*_x0).Pose.Rot[2]);
	const FLT x36 = (-1 * x31 * (*_x0).Pose.Rot[1]) + (x33 * (*_x0).Pose.Rot[3]) + (-1 * x32 * (*_x0).Pose.Rot[2]) + (x30 * (*_x0).Pose.Rot[0]);
	const FLT x37 = (x30 * (*_x0).Pose.Rot[1]) + (x31 * (*_x0).Pose.Rot[0]) + (x33 * (*_x0).Pose.Rot[2]) + (x32 * (*_x0).Pose.Rot[3]);
	const FLT x38 = x35 * x35;
	...
	out->Pose.AxisAngleRot[0]=atan2(2 * ((x36 * x37) + (x34 * x35)), 1 + (-2 * ((x36 * x36) + x38)));
	out->Pose.AxisAngleRot[1]=asin(2 * ((x35 * x37) + (-1 * x34 * x36)));
	out->Pose.AxisAngleRot[2]=atan2(2 * ((x34 * x37) + (x36 * x35)), 1 + (-2 * (x38 + (x34 * x34))));
...
// Jacobian of SurviveKalmanModelErrorPredict wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd620736cd0>]
static inline void SurviveKalmanModelErrorPredict_jac_x0(CnMat* Hx, const FLT t, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model) {
	const FLT x0 = 1.0/2.0 * t;
	const FLT x1 = fabs(t) * x0;
	const FLT x2 = 0.5 * (*_x0).Pose.Rot[3];
	const FLT x3 = 0.5 * (*error_model).Pose.AxisAngleRot[2];
	const FLT x4 = 0.5 * (*error_model).Pose.AxisAngleRot[0];
	const FLT x5 = (*_x0).Pose.Rot[1] + (x4 * (*_x0).Pose.Rot[0]) + (-1 * x2 * (*error_model).Pose.AxisAngleRot[1]) + (x3 * (*_x0).Pose.Rot[2]);
	...
	const FLT x22 = (x21 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x4 * (*_x0).Pose.Rot[2]) + (x3 * (*_x0).Pose.Rot[0]);
	const FLT x23 = (x21 * (*_x0).Pose.Rot[0]) + (-1 * x3 * (*_x0).Pose.Rot[1]) + (x2 * (*error_model).Pose.AxisAngleRot[0]) + (*_x0).Pose.Rot[2];
	const FLT x24 = (-1 * x4 * (*_x0).Pose.Rot[1]) + (-1 * x21 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x2 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x25 = (x24 * x24) + (x5 * x5) + (x22 * x22) + (x23 * x23);
	const FLT x26 = 1. / sqrt(x25);
	const FLT x27 = x19 * x19;
	const FLT x28 = 1. / x16;
	const FLT x29 = x28 * x27;
	const FLT x30 = cos(x18);
	const FLT x31 = (x30 * x30) + (x29 * x10) + (x29 * x13) + (x29 * x15);
	const FLT x32 = 1. / sqrt(x31);
	const FLT x33 = x32 * x26;
	const FLT x34 = t * x33;
	const FLT x35 = x34 * x20;
	const FLT x36 = x6 * x35;
	const FLT x37 = x5 * x36;
	const FLT x38 = x30 * x26;
	const FLT x39 = x32 * x38;
	const FLT x40 = x39 * x22;
	const FLT x41 = x24 * x20;
	const FLT x42 = x41 * x34;
	const FLT x43 = x8 * x42;
	const FLT x44 = x35 * x11;
	const FLT x45 = x44 * x23;
	const FLT x46 = x45 + x43 + (-1 * x37) + x40;
	const FLT x47 = x35 * x22;
	const FLT x48 = x6 * x47;
	const FLT x49 = x5 * x39;
	const FLT x50 = x8 * x35;
	const FLT x51 = x50 * x23;
	const FLT x52 = x42 * x11;
	const FLT x53 = x52 + (-1 * x51) + x48 + x49;
	const FLT x54 = x5 * x50;
	const FLT x55 = x39 * x23;
	const FLT x56 = x6 * x42;
	const FLT x57 = x47 * x11;
	const FLT x58 = (-1 * x57) + x56 + x54 + x55;
	const FLT x59 = x8 * x47;
	const FLT x60 = x36 * x23;
	const FLT x61 = x39 * x24;
	const FLT x62 = x5 * x35;
	const FLT x63 = x62 * x11;
	const FLT x64 = (-1 * x63) + (-1 * x59) + x61 + (-1 * x60);
	const FLT x65 = (x58 * (*_x0).Pose.Rot[3]) + (-1 * x64 * (*_x0).Pose.Rot[1]) + (-1 * x46 * (*_x0).Pose.Rot[2]) + (x53 * (*_x0).Pose.Rot[0]);
	const FLT x66 = x44 * x21;
	const FLT x67 = x0 * x11;
	const FLT x68 = x23 * x20;
	const FLT x69 = 1.0 * x22;
	const FLT x70 = 1.0 * x5;
	const FLT x71 = 1.0 * (*error_model).Pose.AxisAngleRot[1];
	const FLT x72 = (x70 * (*error_model).Pose.AxisAngleRot[0]) + (2 * x24) + (x71 * x23) + (x69 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x73 = x32 * (1. / (x25 * sqrt(x25)));
	const FLT x74 = x73 * x72;
	const FLT x75 = x74 * x68;
	const FLT x76 = x0 * x6;
	const FLT x77 = x5 * x20;
	const FLT x78 = x77 * x76;
	const FLT x79 = x73 * x30;
	const FLT x80 = 1.0/2.0 * x22;
	const FLT x81 = x80 * x79;
	const FLT x82 = x0 * x8;
	const FLT x83 = x74 * x41;
	const FLT x84 = -1 * x4 * x36;
	const FLT x85 = x3 * x39;
	const FLT x86 = x85 + x84;
	const FLT x87 = x66 + (-1 * x82 * x83) + (-1 * x81 * x72) + x50 + (-1 * x75 * x67) + x86 + (x78 * x74);
	const FLT x88 = x82 * x77;
	const FLT x89 = x22 * x20;
	const FLT x90 = x89 * x74;
	const FLT x91 = 1.0/2.0 * x23;
	const FLT x92 = x72 * x79;
	const FLT x93 = x39 * x21;
	const FLT x94 = -1 * x3 * x44;
	const FLT x95 = x4 * x50;
	const FLT x96 = x95 + x94;
	const FLT x97 = x36 + x96 + (x67 * x90) + (-1 * x83 * x76) + (-1 * x88 * x74) + (-1 * x92 * x91) + x93;
	const FLT x98 = x3 * x36;
	const FLT x99 = 1.0/2.0 * x5;
	const FLT x100 = x4 * x39;
	const FLT x101 = -1 * x50 * x21;
	const FLT x102 = x101 + x100;
	const FLT x103 = (x82 * x75) + x102 + (-1 * x92 * x99) + x44 + (-1 * x83 * x67) + x98 + (-1 * x76 * x90);
	const FLT x104 = x4 * x44;
	const FLT x105 = -1 * x104;
	const FLT x106 = x82 * x89;
	const FLT x107 = x77 * x67;
	const FLT x108 = x73 * x107;
	const FLT x109 = 1.0/2.0 * x24;
	const FLT x110 = x79 * x109;
	const FLT x111 = x3 * x50;
	const FLT x112 = -1 * x111;
	const FLT x113 = x36 * x21;
	const FLT x114 = x39 + (-1 * x113);
	const FLT x115 = x114 + x112 + (x74 * x106) + (x75 * x76) + x105 + (-1 * x72 * x110) + (x72 * x108);
	const FLT x116 = x64 + (x115 * (*_x0).Pose.Rot[0]) + (x103 * (*_x0).Pose.Rot[1]) + (x87 * (*_x0).Pose.Rot[3]) + (x97 * (*_x0).Pose.Rot[2]);
	const FLT x117 = x58 + (x87 * (*_x0).Pose.Rot[1]) + (-1 * x115 * (*_x0).Pose.Rot[2]) + (-1 * x103 * (*_x0).Pose.Rot[3]) + (x97 * (*_x0).Pose.Rot[0]);
	const FLT x118 = (-1 * x58 * (*_x0).Pose.Rot[1]) + (x46 * (*_x0).Pose.Rot[0]) + (x53 * (*_x0).Pose.Rot[2]) + (-1 * x64 * (*_x0).Pose.Rot[3]);
	const FLT x119 = (x103 * (*_x0).Pose.Rot[0]) + x53 + (-1 * x87 * (*_x0).Pose.Rot[2]) + (-1 * x115 * (*_x0).Pose.Rot[1]) + (x97 * (*_x0).Pose.Rot[3]);
	const FLT x120 = (x53 * (*_x0).Pose.Rot[1]) + (x64 * (*_x0).Pose.Rot[0]) + (x58 * (*_x0).Pose.Rot[2]) + (x46 * (*_x0).Pose.Rot[3]);
	const FLT x121 = (x58 * (*_x0).Pose.Rot[0]) + (-1 * x53 * (*_x0).Pose.Rot[3]) + (x46 * (*_x0).Pose.Rot[1]) + (-1 * x64 * (*_x0).Pose.Rot[2]);
	const FLT x122 = x46 + (x87 * (*_x0).Pose.Rot[0]) + (-1 * x115 * (*_x0).Pose.Rot[3]) + (-1 * x97 * (*_x0).Pose.Rot[1]) + (x103 * (*_x0).Pose.Rot[2]);
	const FLT x123 = x121 * x121;
	const FLT x124 = 1 + (-2 * ((x65 * x65) + x123));
	const FLT x125 = 2 * (1. / x124);
	const FLT x126 = 4 * x121;
	const FLT x127 = -1 * x117 * x126;
	const FLT x128 = 4 * x65;
	const FLT x129 = x124 * x124;
	const FLT x130 = (x65 * x120) + (x118 * x121);
	const FLT x131 = 2 * (1. / x129) * x130;
	const FLT x132 = x129 * (1. / (x129 + (4 * (x130 * x130))));
	const FLT x133 = -1 * x44;
	const FLT x134 = 1.0 * x24;
	const FLT x135 = 1.0 * x23;
	const FLT x136 = (-1 * x135 * (*error_model).Pose.AxisAngleRot[2]) + (x71 * x22) + (2 * x5) + (-1 * x134 * (*error_model).Pose.AxisAngleRot[0]);
	const FLT x137 = x73 * x136;
	const FLT x138 = x68 * x137;
	const FLT x139 = (-1 * x100) + x101;
	const FLT x140 = x139 + (x76 * x138) + x133 + (x108 * x136) + (x106 * x137) + x98 + (-1 * x110 * x136);
	const FLT x141 = x41 * x137;
	const FLT x142 = x79 * x136;
	const FLT x143 = x82 * x68;
	const FLT x144 = x89 * x137;
	const FLT x145 = x113 + x39;
	const FLT x146 = x145 + (-1 * x76 * x144) + x111 + x105 + (-1 * x99 * x142) + (x137 * x143) + (-1 * x67 * x141);
	const FLT x147 = -1 * x36;
	const FLT x148 = (-1 * x95) + x94;
	const FLT x149 = x148 + (-1 * x81 * x136) + x93 + x147 + (-1 * x67 * x138) + (-1 * x82 * x141) + (x78 * x137);
	const FLT x150 = -1 * x66;
	const FLT x151 = (-1 * x85) + x84;
	const FLT x152 = x150 + x151 + (-1 * x91 * x142) + (-1 * x76 * x141) + (-1 * x88 * x137) + (x67 * x144) + x50;
	const FLT x153 = x60 + (-1 * x61) + x59 + x63;
	const FLT x154 = (x152 * (*_x0).Pose.Rot[3]) + x153 + (-1 * x149 * (*_x0).Pose.Rot[2]) + (-1 * x140 * (*_x0).Pose.Rot[1]) + (x146 * (*_x0).Pose.Rot[0]);
	const FLT x155 = x53 + (x152 * (*_x0).Pose.Rot[2]) + (x149 * (*_x0).Pose.Rot[3]) + (x146 * (*_x0).Pose.Rot[1]) + (x140 * (*_x0).Pose.Rot[0]);
	const FLT x156 = x46 + (-1 * x140 * (*_x0).Pose.Rot[2]) + (x152 * (*_x0).Pose.Rot[0]) + (-1 * x146 * (*_x0).Pose.Rot[3]) + (x149 * (*_x0).Pose.Rot[1]);
	const FLT x157 = x57 + (-1 * x56) + (-1 * x54) + (-1 * x152 * (*_x0).Pose.Rot[1]) + (-1 * x55) + (x149 * (*_x0).Pose.Rot[0]) + (x146 * (*_x0).Pose.Rot[2]) + (-1 * x140 * (*_x0).Pose.Rot[3]);
	const FLT x158 = -1 * x126 * x156;
	const FLT x159 = -1 * x50;
	const FLT x160 = (2 * x23) + (-1 * x69 * (*error_model).Pose.AxisAngleRot[0]) + (x70 * (*error_model).Pose.AxisAngleRot[2]) + (-1 * x71 * x24);
	const FLT x161 = x73 * x160;
	const FLT x162 = x41 * x161;
	const FLT x163 = x89 * x161;
	const FLT x164 = x79 * x99;
	const FLT x165 = (-1 * x160 * x164) + x159 + x150 + x86 + (-1 * x67 * x162) + (x161 * x143) + (-1 * x76 * x163);
	const FLT x166 = -1 * x98;
	const FLT x167 = x68 * x161;
	const FLT x168 = (-1 * x81 * x160) + x166 + x139 + x44 + (-1 * x82 * x162) + (-1 * x67 * x167) + (x78 * x161);
	const FLT x169 = x79 * x91;
	const FLT x170 = x114 + (-1 * x160 * x169) + x104 + (x67 * x163) + (-1 * x76 * x162) + (-1 * x88 * x161) + x111;
	const FLT x171 = -1 * x93;
	const FLT x172 = x96 + (x76 * x167) + (-1 * x110 * x160) + (x107 * x161) + (x82 * x163) + x171 + x147;
	const FLT x173 = (x172 * (*_x0).Pose.Rot[0]) + (x170 * (*_x0).Pose.Rot[2]) + (x165 * (*_x0).Pose.Rot[1]) + x58 + (x168 * (*_x0).Pose.Rot[3]);
	const FLT x174 = (-1 * x165 * (*_x0).Pose.Rot[3]) + x153 + (-1 * x172 * (*_x0).Pose.Rot[2]) + (x168 * (*_x0).Pose.Rot[1]) + (x170 * (*_x0).Pose.Rot[0]);
	const FLT x175 = (-1 * x45) + x37 + (-1 * x40) + (x165 * (*_x0).Pose.Rot[0]) + (x170 * (*_x0).Pose.Rot[3]) + (-1 * x172 * (*_x0).Pose.Rot[1]) + (-1 * x43) + (-1 * x168 * (*_x0).Pose.Rot[2]);
	const FLT x176 = x53 + (x168 * (*_x0).Pose.Rot[0]) + (-1 * x170 * (*_x0).Pose.Rot[1]) + (x165 * (*_x0).Pose.Rot[2]) + (-1 * x172 * (*_x0).Pose.Rot[3]);
	const FLT x177 = -1 * x126 * x174;
	const FLT x178 = (x135 * (*error_model).Pose.AxisAngleRot[0]) + (-1 * x5 * x71) + (2 * x22) + (-1 * x134 * (*error_model).Pose.AxisAngleRot[2]);
	const FLT x179 = x73 * x178;
	const FLT x180 = x68 * x179;
	const FLT x181 = x151 + (x76 * x180) + (x107 * x179) + x66 + (-1 * x110 * x178) + x159 + (x106 * x179);
	const FLT x182 = x41 * x179;
	const FLT x183 = x89 * x179;
	const FLT x184 = x148 + (-1 * x164 * x178) + x36 + (-1 * x76 * x183) + x171 + (-1 * x67 * x182) + (x82 * x180);
	const FLT x185 = (-1 * x81 * x178) + x145 + x104 + x112 + (-1 * x67 * x180) + (-1 * x82 * x182) + (x78 * x179);
	const FLT x186 = x102 + (-1 * x88 * x179) + x133 + x166 + (-1 * x169 * x178) + (x67 * x183) + (-1 * x76 * x182);
	const FLT x187 = x58 + (x186 * (*_x0).Pose.Rot[3]) + (-1 * x185 * (*_x0).Pose.Rot[2]) + (-1 * x181 * (*_x0).Pose.Rot[1]) + (x184 * (*_x0).Pose.Rot[0]);
	const FLT x188 = (x186 * (*_x0).Pose.Rot[2]) + x46 + (x184 * (*_x0).Pose.Rot[1]) + (x185 * (*_x0).Pose.Rot[3]) + (x181 * (*_x0).Pose.Rot[0]);
	const FLT x189 = (-1 * x49) + (-1 * x48) + (-1 * x181 * (*_x0).Pose.Rot[2]) + (x186 * (*_x0).Pose.Rot[0]) + (x185 * (*_x0).Pose.Rot[1]) + x51 + (-1 * x52) + (-1 * x184 * (*_x0).Pose.Rot[3]);
	const FLT x190 = x153 + (-1 * x181 * (*_x0).Pose.Rot[3]) + (x184 * (*_x0).Pose.Rot[2]) + (-1 * x186 * (*_x0).Pose.Rot[1]) + (x185 * (*_x0).Pose.Rot[0]);
	const FLT x191 = -1 * x126 * x189;
	const FLT x192 = -1 * x47;
	const FLT x193 = x5 * x33;
	const FLT x194 = t * t * t;
	const FLT x195 = x19 * (1. / (x16 * sqrt(x16)));
	const FLT x196 = x194 * x195;
	const FLT x197 = x11 * x196;
	const FLT x198 = x197 * x193;
	const FLT x199 = x8 * x198;
	const FLT x200 = t * t * t * t;
	const FLT x201 = (x11 * x11 * x11) * x200;
	const FLT x202 = 1.0 * x30;
	const FLT x203 = x202 * x195;
	const FLT x204 = 2 * x27 * (1. / (x16 * x16));
	const FLT x205 = x200 * x203;
	const FLT x206 = x11 * x205;
	const FLT x207 = 2 * x29;
	const FLT x208 = x7 * x207;
	const FLT x209 = x200 * x204;
	const FLT x210 = x11 * x209;
	const FLT x211 = x20 * x202;
	const FLT x212 = x7 * x211;
	const FLT x213 = (-1 * x14 * x210) + (-1 * x11 * x212) + (-1 * x201 * x204) + (x9 * x206) + (x201 * x203) + (-1 * x9 * x210) + (x11 * x208) + (x14 * x206);
	const FLT x214 = 1. / (x31 * sqrt(x31));
	const FLT x215 = x38 * x214;
	const FLT x216 = x213 * x215;
	const FLT x217 = x33 * x23;
	const FLT x218 = 0.5 * x20;
	const FLT x219 = x218 * x217;
	const FLT x220 = x7 * x219;
	const FLT x221 = x213 * x214;
	const FLT x222 = x26 * x221;
	const FLT x223 = 0.5 * x28;
	const FLT x224 = x223 * x194;
	const FLT x225 = x11 * x224;
	const FLT x226 = x8 * x225;
	const FLT x227 = x49 * x226;
	const FLT x228 = x12 * x196;
	const FLT x229 = x33 * x22;
	const FLT x230 = x76 * x26;
	const FLT x231 = x230 * x221;
	const FLT x232 = x67 * x26;
	const FLT x233 = x232 * x221;
	const FLT x234 = x12 * x224;
	const FLT x235 = x6 * x225;
	const FLT x236 = x33 * x24;
	const FLT x237 = x236 * x197;
	const FLT x238 = (-1 * x6 * x237) + (x61 * x235);
	const FLT x239 = x238 + (x89 * x233) + (-1 * x41 * x231) + (x228 * x229) + (-1 * x40 * x234) + x227 + x192 + (-1 * x11 * x220) + (-1 * x91 * x216) + (-1 * x199) + (-1 * x88 * x222);
	const FLT x240 = -1 * x62;
	const FLT x241 = x217 * x197;
	const FLT x242 = x6 * x241;
	const FLT x243 = x55 * x235;
	const FLT x244 = x82 * x26;
	const FLT x245 = x221 * x244;
	const FLT x246 = x7 * x11;
	const FLT x247 = 0.5 * x41 * x33;
	const FLT x248 = x229 * x197;
	const FLT x249 = (x8 * x248) + (-1 * x40 * x226);
	const FLT x250 = (-1 * x49 * x234) + (x68 * x231) + (x222 * x107) + (-1 * x216 * x109) + (-1 * x246 * x247) + x242 + x249 + (-1 * x243) + x240 + (x228 * x193) + (x89 * x245);
	const FLT x251 = x35 * x23;
	const FLT x252 = x77 * x230;
	const FLT x253 = x218 * x229;
	const FLT x254 = (-1 * x49 * x235) + (x6 * x198);
	const FLT x255 = (-1 * x8 * x237) + (x61 * x226);
	const FLT x256 = x254 + x255 + (-1 * x68 * x233) + (-1 * x217 * x228) + (x55 * x234) + (x252 * x221) + x251 + (-1 * x80 * x216) + (-1 * x41 * x245) + (-1 * x253 * x246);
	const FLT x257 = x6 * x248;
	const FLT x258 = x218 * x193;
	const FLT x259 = x55 * x226;
	const FLT x260 = x40 * x235;
	const FLT x261 = x8 * x241;
	const FLT x262 = (-1 * x258 * x246) + (x68 * x245) + (-1 * x257) + (-1 * x236 * x228) + x42 + (-1 * x99 * x216) + x261 + (x61 * x234) + (-1 * x89 * x231) + (-1 * x259) + x260 + (-1 * x41 * x233);
	const FLT x263 = (-1 * x256 * (*_x0).Pose.Rot[2]) + (x239 * (*_x0).Pose.Rot[3]) + (x262 * (*_x0).Pose.Rot[0]) + (-1 * x250 * (*_x0).Pose.Rot[1]);
	const FLT x264 = (-1 * x250 * (*_x0).Pose.Rot[2]) + (-1 * x262 * (*_x0).Pose.Rot[3]) + (x239 * (*_x0).Pose.Rot[0]) + (x256 * (*_x0).Pose.Rot[1]);
	const FLT x265 = (x250 * (*_x0).Pose.Rot[0]) + (x256 * (*_x0).Pose.Rot[3]) + (x239 * (*_x0).Pose.Rot[2]) + (x262 * (*_x0).Pose.Rot[1]);
	const FLT x266 = (-1 * x250 * (*_x0).Pose.Rot[3]) + (-1 * x239 * (*_x0).Pose.Rot[1]) + (x262 * (*_x0).Pose.Rot[2]) + (x256 * (*_x0).Pose.Rot[0]);
	const FLT x267 = -1 * x264 * x126;
	const FLT x268 = x12 * x205;
	const FLT x269 = x6 * x9;
	const FLT x270 = x12 * x209;
	const FLT x271 = x6 * x6 * x6;
	const FLT x272 = ((-1 * x209 * x271) + (-1 * x6 * x212) + (x6 * x268) + (x205 * x269) + (-1 * x209 * x269) + (x205 * x271) + (-1 * x6 * x270) + (x6 * x208)) * x214;
	const FLT x273 = x14 * x196;
	const FLT x274 = x38 * x272;
	const FLT x275 = x68 * x272;
	const FLT x276 = x14 * x224;
	const FLT x277 = x6 * x7;
	const FLT x278 = x41 * x272;
	const FLT x279 = x6 * x8;
	const FLT x280 = x279 * x196;
	const FLT x281 = x279 * x224;
	const FLT x282 = (x61 * x281) + (-1 * x236 * x280);
	const FLT x283 = (-1 * x278 * x244) + x240 + (-1 * x277 * x253) + (-1 * x232 * x275) + x282 + x243 + (x273 * x193) + (x272 * x252) + (-1 * x49 * x276) + (-1 * x242) + (-1 * x80 * x274);
	const FLT x284 = x26 * x272;
	const FLT x285 = x89 * x272;
	const FLT x286 = x280 * x229;
	const FLT x287 = x40 * x281;
	const FLT x288 = -1 * x251;
	const FLT x289 = (-1 * x274 * x109) + (-1 * x55 * x276) + x288 + x254 + (-1 * x277 * x247) + (x230 * x275) + x286 + (x284 * x107) + (x217 * x273) + (-1 * x287) + (x285 * x244);
	const FLT x290 = x280 * x193;
	const FLT x291 = x49 * x281;
	const FLT x292 = (-1 * x260) + (-1 * x88 * x284) + (-1 * x236 * x273) + (-1 * x6 * x220) + (-1 * x91 * x274) + x291 + (x232 * x285) + (-1 * x290) + (-1 * x230 * x278) + (x61 * x276) + x42 + x257;
	const FLT x293 = (x217 * x280) + (-1 * x55 * x281);
	const FLT x294 = x238 + x293 + (-1 * x230 * x285) + (-1 * x277 * x258) + (-1 * x273 * x229) + (-1 * x99 * x274) + (x275 * x244) + (-1 * x232 * x278) + (x40 * x276) + x47;
	const FLT x295 = (x294 * (*_x0).Pose.Rot[0]) + (x292 * (*_x0).Pose.Rot[3]) + (-1 * x283 * (*_x0).Pose.Rot[2]) + (-1 * x289 * (*_x0).Pose.Rot[1]);
	const FLT x296 = (-1 * x289 * (*_x0).Pose.Rot[2]) + (x283 * (*_x0).Pose.Rot[1]) + (x292 * (*_x0).Pose.Rot[0]) + (-1 * x294 * (*_x0).Pose.Rot[3]);
	const FLT x297 = (x283 * (*_x0).Pose.Rot[3]) + (x292 * (*_x0).Pose.Rot[2]) + (x294 * (*_x0).Pose.Rot[1]) + (x289 * (*_x0).Pose.Rot[0]);
	const FLT x298 = (-1 * x289 * (*_x0).Pose.Rot[3]) + (x294 * (*_x0).Pose.Rot[2]) + (-1 * x292 * (*_x0).Pose.Rot[1]) + (x283 * (*_x0).Pose.Rot[0]);
	const FLT x299 = -1 * x296 * x126;
	const FLT x300 = x8 * x7;
	const FLT x301 = x8 * x8 * x8;
	const FLT x302 = x8 * x14;
	const FLT x303 = (-1 * x209 * x302) + (x205 * x302) + (-1 * x211 * x300) + (x207 * x300) + (x8 * x268) + (x205 * x301) + (-1 * x8 * x270) + (-1 * x209 * x301);
	const FLT x304 = x215 * x303;
	const FLT x305 = x9 * x194;
	const FLT x306 = x223 * x305;
	const FLT x307 = x214 * x303;
	const FLT x308 = x26 * x307;
	const FLT x309 = x67 * x308;
	const FLT x310 = x305 * x195;
	const FLT x311 = x230 * x307;
	const FLT x312 = x249 + x282 + x62 + (-1 * x219 * x300) + (x89 * x309) + (-1 * x41 * x311) + (x49 * x306) + (-1 * x91 * x304) + (-1 * x310 * x193) + (-1 * x88 * x308);
	const FLT x313 = (-1 * x247 * x300) + (x308 * x106) + x293 + x199 + (-1 * x304 * x109) + (x308 * x107) + (x229 * x310) + x192 + (x68 * x311) + (-1 * x227) + (-1 * x40 * x306);
	const FLT x314 = x259 + x290 + (-1 * x261) + (x252 * x307) + x42 + (-1 * x68 * x309) + (-1 * x291) + (-1 * x82 * x41 * x308) + (-1 * x253 * x300) + (-1 * x80 * x304) + (x61 * x306) + (-1 * x236 * x310);
	const FLT x315 = x255 + (x308 * x143) + (x217 * x310) + (-1 * x286) + (-1 * x55 * x306) + (-1 * x258 * x300) + (-1 * x41 * x309) + x288 + (-1 * x89 * x311) + x287 + (-1 * x99 * x304);
	const FLT x316 = (x315 * (*_x0).Pose.Rot[0]) + (-1 * x314 * (*_x0).Pose.Rot[2]) + (x312 * (*_x0).Pose.Rot[3]) + (-1 * x313 * (*_x0).Pose.Rot[1]);
	const FLT x317 = (x314 * (*_x0).Pose.Rot[3]) + (x312 * (*_x0).Pose.Rot[2]) + (x313 * (*_x0).Pose.Rot[0]) + (x315 * (*_x0).Pose.Rot[1]);
	const FLT x318 = (-1 * x313 * (*_x0).Pose.Rot[2]) + (-1 * x315 * (*_x0).Pose.Rot[3]) + (x314 * (*_x0).Pose.Rot[1]) + (x312 * (*_x0).Pose.Rot[0]);
	const FLT x319 = (x314 * (*_x0).Pose.Rot[0]) + (-1 * x313 * (*_x0).Pose.Rot[3]) + (-1 * x312 * (*_x0).Pose.Rot[1]) + (x315 * (*_x0).Pose.Rot[2]);
	const FLT x320 = -1 * x318 * x126;
	const FLT x321 = 2 * (1. / sqrt(1 + (-4 * (((x120 * x121) + (-1 * x65 * x118)) * ((x120 * x121) + (-1 * x65 * x118))))));
	const FLT x322 = 1 + (-2 * (x123 + (x118 * x118)));
	const FLT x323 = 2 * (1. / x322);
	const FLT x324 = 4 * x118;
	const FLT x325 = x322 * x322;
	const FLT x326 = (x118 * x120) + (x65 * x121);
	const FLT x327 = 2 * x326 * (1. / x325);
	const FLT x328 = x325 * (1. / (x325 + (4 * (x326 * x326))));
	cnSetZero(Hx);
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x132 * ((-1 * x131 * ((-1 * x119 * x128) + x127)) + (x125 * ((x122 * x121) + (x65 * x116) + (x119 * x120) + (x118 * x117)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), x132 * ((-1 * x131 * ((-1 * x128 * x154) + x158)) + (x125 * ((x121 * x157) + (x120 * x154) + (x118 * x156) + (x65 * x155)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), x132 * ((-1 * x131 * ((-1 * x128 * x175) + x177)) + (x125 * ((x120 * x175) + (x121 * x176) + (x65 * x173) + (x118 * x174)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x132 * ((-1 * x131 * ((-1 * x128 * x187) + x191)) + (x125 * ((x118 * x189) + (x120 * x187) + (x121 * x190) + (x65 * x188)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x132 * ((-1 * x131 * ((-1 * x263 * x128) + x267)) + (x125 * ((x266 * x121) + (x65 * x265) + (x263 * x120) + (x264 * x118)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x132 * ((-1 * x131 * ((-1 * x295 * x128) + x299)) + (x125 * ((x65 * x297) + (x295 * x120) + (x298 * x121) + (x296 * x118)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x132 * ((-1 * x131 * ((-1 * x316 * x128) + x320)) + (x125 * ((x319 * x121) + (x318 * x118) + (x316 * x120) + (x65 * x317)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x321 * ((-1 * x118 * x119) + (-1 * x65 * x122) + (x116 * x121) + (x117 * x120)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), x321 * ((-1 * x118 * x154) + (-1 * x65 * x157) + (x120 * x156) + (x121 * x155)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), x321 * ((-1 * x118 * x175) + (-1 * x65 * x176) + (x120 * x174) + (x121 * x173)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x321 * ((-1 * x118 * x187) + (-1 * x65 * x190) + (x121 * x188) + (x120 * x189)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x321 * ((-1 * x65 * x266) + (-1 * x263 * x118) + (x265 * x121) + (x264 * x120)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x321 * ((-1 * x295 * x118) + (x296 * x120) + (-1 * x65 * x298) + (x297 * x121)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x321 * ((-1 * x65 * x319) + (-1 * x316 * x118) + (x317 * x121) + (x318 * x120)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[0])/sizeof(FLT), x328 * ((-1 * x327 * (x127 + (-1 * x324 * x122))) + (x323 * ((x118 * x116) + (x120 * x122) + (x119 * x121) + (x65 * x117)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[1])/sizeof(FLT), x328 * ((-1 * x327 * (x158 + (-1 * x324 * x157))) + (x323 * ((x121 * x154) + (x65 * x156) + (x120 * x157) + (x118 * x155)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[2])/sizeof(FLT), x328 * ((-1 * x327 * (x177 + (-1 * x324 * x176))) + (x323 * ((x121 * x175) + (x65 * x174) + (x120 * x176) + (x118 * x173)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Pose.Rot[3])/sizeof(FLT), x328 * ((-1 * x327 * (x191 + (-1 * x324 * x190))) + (x323 * ((x121 * x187) + (x120 * x190) + (x118 * x188) + (x65 * x189)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x328 * ((-1 * x327 * (x267 + (-1 * x266 * x324))) + (x323 * ((x263 * x121) + (x65 * x264) + (x265 * x118) + (x266 * x120)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x328 * ((-1 * x327 * (x299 + (-1 * x298 * x324))) + (x323 * ((x295 * x121) + (x65 * x296) + (x297 * x118) + (x298 * x120)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x328 * ((-1 * x327 * (x320 + (-1 * x324 * x319))) + (x323 * ((x316 * x121) + (x65 * x318) + (x319 * x120) + (x317 * x118)))));
...
// Jacobian of SurviveKalmanModelErrorPredict wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd620735a60>]
static inline void SurviveKalmanModelErrorPredict_jac_error_model(CnMat* Hx, const FLT t, const SurviveKalmanModel* _x0, const SurviveKalmanErrorModel* error_model) {
	...
	const FLT x4 = 0.5 * (*error_model).Pose.AxisAngleRot[0];
	const FLT x5 = (-1 * x4 * (*_x0).Pose.Rot[1]) + (-1 * x3 * (*_x0).Pose.Rot[2]) + (*_x0).Pose.Rot[0] + (-1 * x2 * (*_x0).Pose.Rot[3]);
	const FLT x6 = 1.0/2.0 * x5;
	const FLT x7 = 1.0 * x5;
	const FLT x8 = (x3 * (*_x0).Pose.Rot[1]) + (*_x0).Pose.Rot[3] + (-1 * x4 * (*_x0).Pose.Rot[2]) + (x2 * (*_x0).Pose.Rot[0]);
	const FLT x9 = 1.0 * x8;
	const FLT x10 = (*_x0).Pose.Rot[1] + (-1 * x3 * (*_x0).Pose.Rot[3]) + (x4 * (*_x0).Pose.Rot[0]) + (x2 * (*_x0).Pose.Rot[2]);
	const FLT x11 = 1.0 * x10;
	const FLT x12 = (-1 * x2 * (*_x0).Pose.Rot[1]) + (x3 * (*_x0).Pose.Rot[0]) + (x4 * (*_x0).Pose.Rot[3]) + (*_x0).Pose.Rot[2];
	const FLT x13 = 1.0 * x12;
	const FLT x14 = (x13 * (*_x0).Pose.Rot[3]) + (-1 * x7 * (*_x0).Pose.Rot[1]) + (x11 * (*_x0).Pose.Rot[0]) + (-1 * x9 * (*_x0).Pose.Rot[2]);
	const FLT x15 = (x10 * x10) + (x5 * x5) + (x8 * x8) + (x12 * x12);
	const FLT x16 = 1. / (x15 * sqrt(x15));
	const FLT x17 = t * t;
	const FLT x18 = (*_x0).Velocity.AxisAngleRot[2] + (*error_model).Velocity.AxisAngleRot[2];
	const FLT x19 = x18 * x18;
	const FLT x20 = x19 * x17;
	...
	const FLT x30 = cos(x29);
	const FLT x31 = sin(x29);
	const FLT x32 = x31 * x31;
	const FLT x33 = 1. / x27;
	const FLT x34 = x32 * x33;
	const FLT x35 = (x34 * x23) + (x30 * x30) + (x34 * x20) + (x34 * x26);
	const FLT x36 = 1. / sqrt(x35);
	const FLT x37 = x30 * x36;
	const FLT x38 = x37 * x16;
	const FLT x39 = x38 * x14;
	const FLT x40 = x31 * (1. / x28);
	const FLT x41 = x40 * x21;
	const FLT x42 = x0 * x41;
	const FLT x43 = x36 * x16;
	const FLT x44 = x43 * x14;
	const FLT x45 = x44 * x10;
	const FLT x46 = x8 * x44;
	const FLT x47 = x0 * x40;
	const FLT x48 = x47 * x18;
	const FLT x49 = x47 * x24;
	const FLT x50 = x44 * x12;
	const FLT x51 = 1. / sqrt(x15);
	const FLT x52 = x51 * x36;
	const FLT x53 = t * x40;
	const FLT x54 = x53 * x52;
	const FLT x55 = x54 * x18;
	const FLT x56 = 0.5 * x55;
	const FLT x57 = x56 * (*_x0).Pose.Rot[2];
	const FLT x58 = x54 * x24;
	const FLT x59 = 0.5 * x58;
	const FLT x60 = x59 * (*_x0).Pose.Rot[3];
	const FLT x61 = 0.5 * (*_x0).Pose.Rot[0];
	const FLT x62 = t * x41;
	const FLT x63 = x62 * x52;
	const FLT x64 = x63 * x61;
	const FLT x65 = x51 * x37;
	const FLT x66 = 0.5 * x65;
	const FLT x67 = x66 * (*_x0).Pose.Rot[1];
	const FLT x68 = (-1 * x64) + (-1 * x67) + x57 + (-1 * x60);
	const FLT x69 = (x50 * x49) + (-1 * x6 * x39) + x68 + (x46 * x48) + (x42 * x45);
	const FLT x70 = 0.5 * x63;
	const FLT x71 = x70 * (*_x0).Pose.Rot[2];
	const FLT x72 = x5 * x49;
	const FLT x73 = x61 * x55;
	const FLT x74 = 1.0/2.0 * x12;
	const FLT x75 = x66 * (*_x0).Pose.Rot[3];
	const FLT x76 = x59 * (*_x0).Pose.Rot[1];
	const FLT x77 = (-1 * x76) + (-1 * x74 * x39) + (-1 * x72 * x44) + x71 + (-1 * x45 * x48) + x75 + (x42 * x46) + x73;
	const FLT x78 = 1.0/2.0 * x8;
	const FLT x79 = x5 * x48;
	const FLT x80 = x70 * (*_x0).Pose.Rot[3];
	const FLT x81 = x56 * (*_x0).Pose.Rot[1];
	const FLT x82 = x66 * (*_x0).Pose.Rot[2];
	const FLT x83 = x61 * x58;
	const FLT x84 = (-1 * x83) + (-1 * x82) + x80 + (-1 * x81);
	const FLT x85 = x84 + (-1 * x78 * x39) + (x45 * x49) + (-1 * x79 * x44) + (-1 * x50 * x42);
	const FLT x86 = x5 * x42;
	const FLT x87 = 1.0/2.0 * x10;
	const FLT x88 = (x66 * (*_x0).Pose.Rot[0]) + (-1 * x59 * (*_x0).Pose.Rot[2]) + (-1 * x56 * (*_x0).Pose.Rot[3]) + (-1 * x70 * (*_x0).Pose.Rot[1]);
	const FLT x89 = x88 + (x50 * x48) + (-1 * x87 * x39) + (-1 * x46 * x49) + (-1 * x86 * x44);
	const FLT x90 = (x89 * (*_x0).Pose.Rot[0]) + (-1 * x69 * (*_x0).Pose.Rot[1]) + (-1 * x85 * (*_x0).Pose.Rot[2]) + (x77 * (*_x0).Pose.Rot[3]);
	const FLT x91 = x52 * x10;
	const FLT x92 = x53 * x91;
	const FLT x93 = x65 * x12;
	const FLT x94 = x5 * x54;
	const FLT x95 = x8 * x51;
	const FLT x96 = x95 * x36;
	const FLT x97 = (x94 * x24) + (x92 * x18) + (-1 * x62 * x96) + x93;
	const FLT x98 = x95 * x37;
	const FLT x99 = x52 * x12;
	const FLT x100 = (x62 * x99) + (x94 * x18) + (-1 * x92 * x24) + x98;
	const FLT x101 = x53 * x96;
	const FLT x102 = x54 * x12;
	const FLT x103 = x5 * x65;
	const FLT x104 = x103 + (-1 * x18 * x101) + (-1 * x62 * x91) + (-1 * x24 * x102);
	const FLT x105 = x65 * x10;
	const FLT x106 = x5 * x52;
	const FLT x107 = (x62 * x106) + (-1 * x18 * x102) + (x24 * x101) + x105;
	const FLT x108 = (x107 * (*_x0).Pose.Rot[1]) + (x104 * (*_x0).Pose.Rot[0]) + (x97 * (*_x0).Pose.Rot[2]) + (x100 * (*_x0).Pose.Rot[3]);
	const FLT x109 = (x77 * (*_x0).Pose.Rot[2]) + (x85 * (*_x0).Pose.Rot[3]) + (x89 * (*_x0).Pose.Rot[1]) + (x69 * (*_x0).Pose.Rot[0]);
	const FLT x110 = (-1 * x104 * (*_x0).Pose.Rot[1]) + (x97 * (*_x0).Pose.Rot[3]) + (-1 * x100 * (*_x0).Pose.Rot[2]) + (x107 * (*_x0).Pose.Rot[0]);
	const FLT x111 = (-1 * x69 * (*_x0).Pose.Rot[2]) + (-1 * x89 * (*_x0).Pose.Rot[3]) + (x85 * (*_x0).Pose.Rot[1]) + (x77 * (*_x0).Pose.Rot[0]);
	const FLT x112 = (-1 * x97 * (*_x0).Pose.Rot[1]) + (x100 * (*_x0).Pose.Rot[0]) + (x107 * (*_x0).Pose.Rot[2]) + (-1 * x104 * (*_x0).Pose.Rot[3]);
	const FLT x113 = (x89 * (*_x0).Pose.Rot[2]) + (-1 * x69 * (*_x0).Pose.Rot[3]) + (x85 * (*_x0).Pose.Rot[0]) + (-1 * x77 * (*_x0).Pose.Rot[1]);
	const FLT x114 = (x100 * (*_x0).Pose.Rot[1]) + (x97 * (*_x0).Pose.Rot[0]) + (-1 * x107 * (*_x0).Pose.Rot[3]) + (-1 * x104 * (*_x0).Pose.Rot[2]);
	const FLT x115 = x114 * x114;
	const FLT x116 = 1 + (-2 * ((x110 * x110) + x115));
	const FLT x117 = 2 * (1. / x116);
	const FLT x118 = 4 * x114;
	const FLT x119 = -1 * x111 * x118;
	const FLT x120 = 4 * x110;
	const FLT x121 = x116 * x116;
	const FLT x122 = (x108 * x110) + (x112 * x114);
	const FLT x123 = 2 * x122 * (1. / x121);
	const FLT x124 = x121 * (1. / (x121 + (4 * (x122 * x122))));
	const FLT x125 = ((x13 * (*_x0).Pose.Rot[0]) + (x9 * (*_x0).Pose.Rot[1]) + (-1 * x11 * (*_x0).Pose.Rot[3]) + (-1 * x7 * (*_x0).Pose.Rot[2])) * x16;
	const FLT x126 = x37 * x125;
	const FLT x127 = x36 * x125;
	const FLT x128 = x10 * x127;
	const FLT x129 = x8 * x127;
	const FLT x130 = x49 * x12;
	const FLT x131 = x84 + (x127 * x130) + (x48 * x129) + (-1 * x6 * x126) + (x42 * x128);
	const FLT x132 = x48 * x10;
	const FLT x133 = x88 + (-1 * x74 * x126) + (x42 * x129) + (-1 * x72 * x127) + (-1 * x127 * x132);
	const FLT x134 = x42 * x12;
	const FLT x135 = x67 + x64 + (x49 * x128) + (-1 * x78 * x126) + x60 + (-1 * x57) + (-1 * x79 * x127) + (-1 * x127 * x134);
	const FLT x136 = x48 * x12;
	const FLT x137 = (-1 * x75) + (-1 * x73) + (-1 * x71) + x76;
	const FLT x138 = (-1 * x86 * x127) + x137 + (-1 * x87 * x126) + (x127 * x136) + (-1 * x49 * x129);
	const FLT x139 = (x138 * (*_x0).Pose.Rot[0]) + (-1 * x135 * (*_x0).Pose.Rot[2]) + (-1 * x131 * (*_x0).Pose.Rot[1]) + (x133 * (*_x0).Pose.Rot[3]);
	const FLT x140 = (x135 * (*_x0).Pose.Rot[3]) + (x133 * (*_x0).Pose.Rot[2]) + (x138 * (*_x0).Pose.Rot[1]) + (x131 * (*_x0).Pose.Rot[0]);
	const FLT x141 = (x135 * (*_x0).Pose.Rot[1]) + (-1 * x131 * (*_x0).Pose.Rot[2]) + (-1 * x138 * (*_x0).Pose.Rot[3]) + (x133 * (*_x0).Pose.Rot[0]);
	const FLT x142 = (-1 * x133 * (*_x0).Pose.Rot[1]) + (-1 * x131 * (*_x0).Pose.Rot[3]) + (x138 * (*_x0).Pose.Rot[2]) + (x135 * (*_x0).Pose.Rot[0]);
	const FLT x143 = -1 * x118 * x141;
	const FLT x144 = (-1 * x13 * (*_x0).Pose.Rot[1]) + (x9 * (*_x0).Pose.Rot[0]) + (x11 * (*_x0).Pose.Rot[2]) + (-1 * x7 * (*_x0).Pose.Rot[3]);
	const FLT x145 = x38 * x144;
	const FLT x146 = x43 * x144;
	const FLT x147 = x8 * x146;
	const FLT x148 = x10 * x146;
	const FLT x149 = x137 + (x130 * x146) + (x42 * x148) + (-1 * x6 * x145) + (x48 * x147);
	const FLT x150 = x83 + x81 + (-1 * x80) + (-1 * x87 * x145) + (-1 * x49 * x147) + (-1 * x86 * x146) + (x136 * x146) + x82;
	const FLT x151 = (-1 * x132 * x146) + (x42 * x147) + x68 + (-1 * x72 * x146) + (-1 * x74 * x145);
	const FLT x152 = x88 + (x49 * x148) + (-1 * x78 * x145) + (-1 * x134 * x146) + (-1 * x79 * x146);
	const FLT x153 = (x152 * (*_x0).Pose.Rot[3]) + (x149 * (*_x0).Pose.Rot[0]) + (x151 * (*_x0).Pose.Rot[2]) + (x150 * (*_x0).Pose.Rot[1]);
	const FLT x154 = (x151 * (*_x0).Pose.Rot[3]) + (-1 * x152 * (*_x0).Pose.Rot[2]) + (x150 * (*_x0).Pose.Rot[0]) + (-1 * x149 * (*_x0).Pose.Rot[1]);
	const FLT x155 = (-1 * x149 * (*_x0).Pose.Rot[2]) + (-1 * x150 * (*_x0).Pose.Rot[3]) + (x151 * (*_x0).Pose.Rot[0]) + (x152 * (*_x0).Pose.Rot[1]);
	const FLT x156 = (-1 * x149 * (*_x0).Pose.Rot[3]) + (x150 * (*_x0).Pose.Rot[2]) + (-1 * x151 * (*_x0).Pose.Rot[1]) + (x152 * (*_x0).Pose.Rot[0]);
	const FLT x157 = -1 * x118 * x155;
	const FLT x158 = -1 * x101;
	const FLT x159 = t * t * t;
	const FLT x160 = x31 * (1. / (x27 * sqrt(x27)));
	const FLT x161 = x160 * x159;
	const FLT x162 = x18 * x161;
	const FLT x163 = x91 * x21 * x162;
	const FLT x164 = x21 * x21 * x21;
	const FLT x165 = t * t * t * t;
	const FLT x166 = 1.0 * x30;
	const FLT x167 = x160 * x166;
	const FLT x168 = x167 * x165;
	const FLT x169 = 2 * x32 * (1. / (x27 * x27));
	const FLT x170 = x169 * x165;
	const FLT x171 = x21 * x168;
	const FLT x172 = 2 * x34;
	const FLT x173 = x17 * x172;
	const FLT x174 = x21 * x170;
	const FLT x175 = x41 * x17;
	const FLT x176 = (-1 * x166 * x175) + (-1 * x25 * x174) + (-1 * x164 * x170) + (-1 * x19 * x174) + (x19 * x171) + (x168 * x164) + (x21 * x173) + (x25 * x171);
	const FLT x177 = 1. / (x35 * sqrt(x35));
	const FLT x178 = x30 * x177;
	const FLT x179 = x178 * x176;
	const FLT x180 = x51 * x179;
	const FLT x181 = 0.5 * x99;
	const FLT x182 = x51 * x177;
	const FLT x183 = x176 * x182;
	const FLT x184 = x10 * x183;
	const FLT x185 = 0.5 * x33 * x159;
	const FLT x186 = x105 * x185;
	const FLT x187 = x21 * x18;
	const FLT x188 = x187 * x186;
	const FLT x189 = x96 * x161;
	const FLT x190 = x95 * x177;
	const FLT x191 = x176 * x190;
	const FLT x192 = x98 * x185;
	const FLT x193 = x24 * x161;
	const FLT x194 = x21 * x193;
	const FLT x195 = x103 * x185;
	const FLT x196 = x21 * x195;
	const FLT x197 = (x24 * x196) + (-1 * x106 * x194);
	const FLT x198 = (x42 * x191) + (x22 * x189) + (-1 * x72 * x183) + x188 + x197 + (-1 * x163) + (-1 * x22 * x192) + (-1 * x175 * x181) + (-1 * x48 * x184) + x158 + (-1 * x74 * x180);
	const FLT x199 = -1 * x92;
	const FLT x200 = x99 * x21;
	const FLT x201 = x200 * x193;
	const FLT x202 = x93 * x185;
	const FLT x203 = x24 * x21;
	const FLT x204 = x202 * x203;
	const FLT x205 = x22 * x161;
	const FLT x206 = x6 * x51;
	const FLT x207 = 0.5 * x175;
	const FLT x208 = x21 * x189;
	const FLT x209 = (-1 * x187 * x192) + (x18 * x208);
	const FLT x210 = (x42 * x184) + x209 + (-1 * x206 * x179) + (x183 * x130) + x201 + x199 + (-1 * x207 * x106) + (-1 * x204) + (-1 * x22 * x186) + (x91 * x205) + (x48 * x191);
	const FLT x211 = 1.0/2.0 * x95;
	const FLT x212 = x18 * x106;
	const FLT x213 = (-1 * x21 * x212 * x161) + (x18 * x196);
	const FLT x214 = (-1 * x203 * x186) + (x91 * x194);
	const FLT x215 = x213 + (-1 * x99 * x205) + (x49 * x184) + x214 + x102 + (x22 * x202) + (-1 * x79 * x183) + (-1 * x211 * x179) + (-1 * x183 * x134) + (-1 * x96 * x207);
	const FLT x216 = x24 * x208;
	const FLT x217 = x202 * x187;
	const FLT x218 = x203 * x192;
	const FLT x219 = x200 * x162;
	const FLT x220 = (x22 * x195) + x94 + (-1 * x217) + (-1 * x216) + x219 + (-1 * x87 * x180) + (-1 * x49 * x191) + x218 + (-1 * x205 * x106) + (-1 * x91 * x207) + (x183 * x136) + (-1 * x86 * x183);
	const FLT x221 = (x220 * (*_x0).Pose.Rot[0]) + (-1 * x215 * (*_x0).Pose.Rot[2]) + (x198 * (*_x0).Pose.Rot[3]) + (-1 * x210 * (*_x0).Pose.Rot[1]);
	const FLT x222 = (-1 * x210 * (*_x0).Pose.Rot[2]) + (-1 * x220 * (*_x0).Pose.Rot[3]) + (x198 * (*_x0).Pose.Rot[0]) + (x215 * (*_x0).Pose.Rot[1]);
	const FLT x223 = (x215 * (*_x0).Pose.Rot[3]) + (x198 * (*_x0).Pose.Rot[2]) + (x210 * (*_x0).Pose.Rot[0]) + (x220 * (*_x0).Pose.Rot[1]);
	const FLT x224 = (-1 * x210 * (*_x0).Pose.Rot[3]) + (-1 * x198 * (*_x0).Pose.Rot[1]) + (x220 * (*_x0).Pose.Rot[2]) + (x215 * (*_x0).Pose.Rot[0]);
	const FLT x225 = -1 * x222 * x118;
	const FLT x226 = x22 * x168;
	const FLT x227 = x40 * x166;
	const FLT x228 = x24 * x17;
	const FLT x229 = x24 * x19;
	const FLT x230 = x22 * x170;
	const FLT x231 = (x24 * x24 * x24) * x165;
	const FLT x232 = (x231 * x167) + (-1 * x231 * x169) + (x24 * x226) + (-1 * x24 * x230) + (-1 * x227 * x228) + (x229 * x168) + (x24 * x173) + (-1 * x229 * x170);
	const FLT x233 = x232 * x182;
	const FLT x234 = x10 * x233;
	const FLT x235 = x25 * x161;
	const FLT x236 = x232 * x178;
	const FLT x237 = 0.5 * x40;
	const FLT x238 = x237 * x228;
	const FLT x239 = x5 * x233;
	const FLT x240 = x24 * x18;
	const FLT x241 = (-1 * x212 * x193) + (x240 * x195);
	const FLT x242 = (-1 * x25 * x186) + x241 + (-1 * x96 * x238) + (-1 * x233 * x134) + (x91 * x235) + (x49 * x234) + x204 + x199 + (-1 * x211 * x236) + (-1 * x48 * x239) + (-1 * x201);
	const FLT x243 = -1 * x102;
	const FLT x244 = x12 * x233;
	const FLT x245 = x232 * x190;
	const FLT x246 = x240 * x189;
	const FLT x247 = x240 * x192;
	const FLT x248 = x51 * x236;
	const FLT x249 = x214 + (-1 * x25 * x202) + (-1 * x6 * x248) + (-1 * x247) + x246 + (x42 * x234) + (-1 * x238 * x106) + (x49 * x244) + x243 + (x99 * x235) + (x48 * x245);
	const FLT x250 = x40 * x181;
	const FLT x251 = x18 * x193;
	const FLT x252 = x91 * x251;
	const FLT x253 = x240 * x186;
	const FLT x254 = (-1 * x218) + (-1 * x74 * x248) + x94 + (-1 * x49 * x239) + (x42 * x245) + x216 + (-1 * x250 * x228) + x253 + (-1 * x233 * x132) + (x25 * x195) + (-1 * x252) + (-1 * x235 * x106);
	const FLT x255 = (x99 * x251) + (-1 * x202 * x240);
	const FLT x256 = x255 + x197 + (-1 * x49 * x245) + (-1 * x91 * x238) + (-1 * x25 * x189) + (-1 * x86 * x233) + (x25 * x192) + (-1 * x87 * x248) + (x48 * x244) + x101;
	const FLT x257 = (x256 * (*_x0).Pose.Rot[0]) + (x254 * (*_x0).Pose.Rot[3]) + (-1 * x242 * (*_x0).Pose.Rot[2]) + (-1 * x249 * (*_x0).Pose.Rot[1]);
	const FLT x258 = (-1 * x249 * (*_x0).Pose.Rot[2]) + (x242 * (*_x0).Pose.Rot[1]) + (x254 * (*_x0).Pose.Rot[0]) + (-1 * x256 * (*_x0).Pose.Rot[3]);
	const FLT x259 = (x242 * (*_x0).Pose.Rot[3]) + (x256 * (*_x0).Pose.Rot[1]) + (x254 * (*_x0).Pose.Rot[2]) + (x249 * (*_x0).Pose.Rot[0]);
	const FLT x260 = (-1 * x249 * (*_x0).Pose.Rot[3]) + (-1 * x254 * (*_x0).Pose.Rot[1]) + (x256 * (*_x0).Pose.Rot[2]) + (x242 * (*_x0).Pose.Rot[0]);
	const FLT x261 = -1 * x258 * x118;
	const FLT x262 = x18 * x17;
	const FLT x263 = x18 * x18 * x18;
	const FLT x264 = x25 * x18;
	const FLT x265 = (-1 * x264 * x170) + (x264 * x168) + (-1 * x262 * x227) + (x18 * x226) + (x263 * x168) + (x262 * x172) + (-1 * x18 * x230) + (-1 * x263 * x170);
	const FLT x266 = x265 * x178;
	const FLT x267 = x51 * x266;
	const FLT x268 = x265 * x190;
	const FLT x269 = x19 * x161;
	const FLT x270 = x265 * x182;
	const FLT x271 = (-1 * x72 * x270) + x241 + (-1 * x262 * x250) + x209 + (x42 * x268) + x92 + (-1 * x91 * x269) + (x19 * x186) + (-1 * x74 * x267) + (-1 * x270 * x132);
	const FLT x272 = x10 * x270;
	const FLT x273 = x48 * x265;
	const FLT x274 = x237 * x262;
	const FLT x275 = (-1 * x188) + x255 + (-1 * x206 * x266) + (-1 * x274 * x106) + x158 + (x19 * x189) + (x273 * x190) + x163 + (x270 * x130) + (x42 * x272) + (-1 * x19 * x192);
	const FLT x276 = x217 + x252 + (-1 * x219) + x94 + (-1 * x269 * x106) + (-1 * x270 * x134) + (x19 * x195) + (-1 * x253) + (-1 * x96 * x274) + (-1 * x211 * x266) + (-1 * x79 * x270) + (x49 * x272);
	const FLT x277 = x243 + (-1 * x246) + (-1 * x49 * x268) + (-1 * x19 * x202) + (x12 * x273 * x182) + (-1 * x87 * x267) + (-1 * x86 * x270) + x213 + x247 + (x99 * x269) + (-1 * x91 * x274);
	const FLT x278 = (-1 * x276 * (*_x0).Pose.Rot[2]) + (x277 * (*_x0).Pose.Rot[0]) + (x271 * (*_x0).Pose.Rot[3]) + (-1 * x275 * (*_x0).Pose.Rot[1]);
	const FLT x279 = (x276 * (*_x0).Pose.Rot[3]) + (x271 * (*_x0).Pose.Rot[2]) + (x275 * (*_x0).Pose.Rot[0]) + (x277 * (*_x0).Pose.Rot[1]);
	const FLT x280 = (-1 * x277 * (*_x0).Pose.Rot[3]) + (x276 * (*_x0).Pose.Rot[1]) + (-1 * x275 * (*_x0).Pose.Rot[2]) + (x271 * (*_x0).Pose.Rot[0]);
	const FLT x281 = (-1 * x275 * (*_x0).Pose.Rot[3]) + (x276 * (*_x0).Pose.Rot[0]) + (-1 * x271 * (*_x0).Pose.Rot[1]) + (x277 * (*_x0).Pose.Rot[2]);
	const FLT x282 = -1 * x280 * x118;
	const FLT x283 = 2 * (1. / sqrt(1 + (-4 * (((x108 * x114) + (-1 * x110 * x112)) * ((x108 * x114) + (-1 * x110 * x112))))));
	const FLT x284 = 1 + (-2 * (x115 + (x112 * x112)));
	const FLT x285 = 2 * (1. / x284);
	const FLT x286 = 4 * x112;
	const FLT x287 = x284 * x284;
	const FLT x288 = (x108 * x112) + (x110 * x114);
	const FLT x289 = 2 * (1. / x287) * x288;
	const FLT x290 = x287 * (1. / (x287 + (4 * (x288 * x288))));
	cnSetZero(Hx);
	...
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x124 * ((-1 * x123 * ((-1 * x90 * x120) + x119)) + (x117 * ((x113 * x114) + (x111 * x112) + (x90 * x108) + (x109 * x110)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x124 * ((-1 * x123 * ((-1 * x120 * x139) + x143)) + (((x114 * x142) + (x108 * x139) + (x112 * x141) + (x110 * x140)) * x117)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x124 * ((-1 * x123 * ((-1 * x120 * x154) + x157)) + (((x114 * x156) + (x112 * x155) + (x110 * x153) + (x108 * x154)) * x117)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x124 * ((-1 * x123 * ((-1 * x221 * x120) + x225)) + (((x224 * x114) + (x223 * x110) + (x221 * x108) + (x222 * x112)) * x117)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x124 * ((-1 * x123 * ((-1 * x257 * x120) + x261)) + (((x260 * x114) + (x259 * x110) + (x257 * x108) + (x258 * x112)) * x117)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x124 * ((-1 * x123 * ((-1 * x278 * x120) + x282)) + (((x281 * x114) + (x280 * x112) + (x278 * x108) + (x279 * x110)) * x117)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x283 * ((-1 * x110 * x113) + (-1 * x90 * x112) + (x109 * x114) + (x108 * x111)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), ((-1 * x112 * x139) + (-1 * x110 * x142) + (x108 * x141) + (x114 * x140)) * x283);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), ((x114 * x153) + (-1 * x112 * x154) + (-1 * x110 * x156) + (x108 * x155)) * x283);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[0])/sizeof(FLT), ((-1 * x221 * x112) + (-1 * x224 * x110) + (x223 * x114) + (x222 * x108)) * x283);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[1])/sizeof(FLT), ((-1 * x260 * x110) + (-1 * x257 * x112) + (x258 * x108) + (x259 * x114)) * x283);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[2])/sizeof(FLT), ((-1 * x281 * x110) + (-1 * x278 * x112) + (x279 * x114) + (x280 * x108)) * x283);
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[0])/sizeof(FLT), x290 * ((-1 * x289 * (x119 + (-1 * x286 * x113))) + (x285 * ((x90 * x114) + (x110 * x111) + (x108 * x113) + (x109 * x112)))));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[1])/sizeof(FLT), x290 * ((-1 * x289 * (x143 + (-1 * x286 * x142))) + (((x114 * x139) + (x110 * x141) + (x112 * x140) + (x108 * x142)) * x285)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), x290 * ((-1 * x289 * (x157 + (-1 * x286 * x156))) + (((x110 * x155) + (x108 * x156) + (x114 * x154) + (x112 * x153)) * x285)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[0])/sizeof(FLT), x290 * ((-1 * x289 * (x225 + (-1 * x286 * x224))) + (((x222 * x110) + (x221 * x114) + (x223 * x112) + (x224 * x108)) * x285)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[1])/sizeof(FLT), x290 * ((-1 * x289 * (x261 + (-1 * x260 * x286))) + (((x258 * x110) + (x257 * x114) + (x259 * x112) + (x260 * x108)) * x285)));
	cnMatrixOptionalSet(Hx, offsetof(SurviveKalmanErrorModel, Pose.AxisAngleRot[2])/sizeof(FLT), offsetof(SurviveKalmanErrorModel, Velocity.AxisAngleRot[2])/sizeof(FLT), x290 * ((-1 * x289 * (x282 + (-1 * x286 * x281))) + (((x278 * x114) + (x280 * x110) + (x281 * x108) + (x279 * x112)) * x285)));
...
// Jacobian of SurviveObsErrorModelNoFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd62070fc70>]
...
// Jacobian of SurviveObsErrorModelFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd62073b4f0>]
...
// Jacobian of SurviveObsErrorStateErrorModelNoFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd62073c430>]
...
// Jacobian of SurviveObsErrorStateErrorModelNoFlip wrt [(*err).AccBias[0], (*err).AccBias[1], (*err).AccBias[2], (*err).Acc[0], (*err).Acc[1], (*err).Acc[2], (*err).GyroBias[0], (*err).GyroBias[1], (*err).GyroBias[2], (*err).IMUCorrection[0], (*err).IMUCorrection[1], (*err).IMUCorrection[2], (*err).IMUCorrection[3], (*err).Pose.AxisAngleRot[0], (*err).Pose.AxisAngleRot[1], (*err).Pose.AxisAngleRot[2], (*err).Pose.Pos[0], (*err).Pose.Pos[1], (*err).Pose.Pos[2], (*err).Velocity.AxisAngleRot[0], (*err).Velocity.AxisAngleRot[1], (*err).Velocity.AxisAngleRot[2], (*err).Velocity.Pos[0], (*err).Velocity.Pos[1], (*err).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd62073d1c0>]
...
// Jacobian of SurviveObsErrorStateErrorModelFlip wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd62073a310>]
...
// Jacobian of SurviveObsErrorStateErrorModelFlip wrt [(*err).AccBias[0], (*err).AccBias[1], (*err).AccBias[2], (*err).Acc[0], (*err).Acc[1], (*err).Acc[2], (*err).GyroBias[0], (*err).GyroBias[1], (*err).GyroBias[2], (*err).IMUCorrection[0], (*err).IMUCorrection[1], (*err).IMUCorrection[2], (*err).IMUCorrection[3], (*err).Pose.AxisAngleRot[0], (*err).Pose.AxisAngleRot[1], (*err).Pose.AxisAngleRot[2], (*err).Pose.Pos[0], (*err).Pose.Pos[1], (*err).Pose.Pos[2], (*err).Velocity.AxisAngleRot[0], (*err).Velocity.AxisAngleRot[1], (*err).Velocity.AxisAngleRot[2], (*err).Velocity.Pos[0], (*err).Velocity.Pos[1], (*err).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd62073bf10>]
...
// Jacobian of SurviveKalmanModel_LightMeas_x_gen1 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd6206c8d00>]
...
// Jacobian of SurviveKalmanModel_LightMeas_x_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6206c7c10>, <cnkalman.codegen.WrapMember object at 0x7fd6206c7df0>, <cnkalman.codegen.WrapMember object at 0x7fd6206c7d60>, <cnkalman.codegen.WrapMember object at 0x7fd6206c7eb0>, <cnkalman.codegen.WrapMember object at 0x7fd6206c7e50>, <cnkalman.codegen.WrapMember object at 0x7fd6206c7bb0>, <cnkalman.codegen.WrapMember object at 0x7fd6206c7880>]
...
// Jacobian of SurviveKalmanModel_LightMeas_y_gen1 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd6206cb850>]
...
// Jacobian of SurviveKalmanModel_LightMeas_y_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6206cc640>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc700>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc6a0>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc7c0>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc760>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc430>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc5e0>]
...
// Full version Jacobian of SurviveKalmanModel_LightMeas_y_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6206cc640>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc700>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc6a0>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc7c0>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc760>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc430>, <cnkalman.codegen.WrapMember object at 0x7fd6206cc5e0>]
...
// Jacobian of SurviveKalmanModel_LightMeas_x_gen2 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd6206d2130>]
...
// Jacobian of SurviveKalmanModel_LightMeas_x_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6206cf2e0>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf3a0>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf340>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf460>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf400>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf0d0>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf280>]
...
// Full version Jacobian of SurviveKalmanModel_LightMeas_x_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6206cf2e0>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf3a0>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf340>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf460>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf400>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf0d0>, <cnkalman.codegen.WrapMember object at 0x7fd6206cf280>]
...
// Jacobian of SurviveKalmanModel_LightMeas_y_gen2 wrt [(*_x0).AccBias[0], (*_x0).AccBias[1], (*_x0).AccBias[2], (*_x0).Acc[0], (*_x0).Acc[1], (*_x0).Acc[2], (*_x0).GyroBias[0], (*_x0).GyroBias[1], (*_x0).GyroBias[2], (*_x0).IMUCorrection[0], (*_x0).IMUCorrection[1], (*_x0).IMUCorrection[2], (*_x0).IMUCorrection[3], (*_x0).Pose.Pos[0], (*_x0).Pose.Pos[1], (*_x0).Pose.Pos[2], (*_x0).Pose.Rot[0], (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd6206cfd30>]
...
// Jacobian of SurviveKalmanModel_LightMeas_y_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6206d3b20>, <cnkalman.codegen.WrapMember object at 0x7fd6206d3be0>, <cnkalman.codegen.WrapMember object at 0x7fd6206d3b80>, <cnkalman.codegen.WrapMember object at 0x7fd6206d3ca0>, <cnkalman.codegen.WrapMember object at 0x7fd6206d3c40>, <cnkalman.codegen.WrapMember object at 0x7fd6206d3910>, <cnkalman.codegen.WrapMember object at 0x7fd6206d3ac0>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen1 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd620736b80>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6207262b0>, <cnkalman.codegen.WrapMember object at 0x7fd620726eb0>, <cnkalman.codegen.WrapMember object at 0x7fd620726fd0>, <cnkalman.codegen.WrapMember object at 0x7fd620726970>, <cnkalman.codegen.WrapMember object at 0x7fd620726d30>, <cnkalman.codegen.WrapMember object at 0x7fd62072af40>, <cnkalman.codegen.WrapMember object at 0x7fd620726fa0>]
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6207262b0>, <cnkalman.codegen.WrapMember object at 0x7fd620726eb0>, <cnkalman.codegen.WrapMember object at 0x7fd620726fd0>, <cnkalman.codegen.WrapMember object at 0x7fd620726970>, <cnkalman.codegen.WrapMember object at 0x7fd620726d30>, <cnkalman.codegen.WrapMember object at 0x7fd62072af40>, <cnkalman.codegen.WrapMember object at 0x7fd620726fa0>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen1 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd62071e6a0>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7fd62071c880>, <cnkalman.codegen.WrapMember object at 0x7fd62071c610>, <cnkalman.codegen.WrapMember object at 0x7fd62071c700>, <cnkalman.codegen.WrapMember object at 0x7fd62071c730>, <cnkalman.codegen.WrapMember object at 0x7fd62071c370>, <cnkalman.codegen.WrapMember object at 0x7fd62071c190>, <cnkalman.codegen.WrapMember object at 0x7fd62071c3a0>]
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7fd62071c880>, <cnkalman.codegen.WrapMember object at 0x7fd62071c610>, <cnkalman.codegen.WrapMember object at 0x7fd62071c700>, <cnkalman.codegen.WrapMember object at 0x7fd62071c730>, <cnkalman.codegen.WrapMember object at 0x7fd62071c370>, <cnkalman.codegen.WrapMember object at 0x7fd62071c190>, <cnkalman.codegen.WrapMember object at 0x7fd62071c3a0>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen2 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd62071a220>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6207719d0>, <cnkalman.codegen.WrapMember object at 0x7fd6207715b0>, <cnkalman.codegen.WrapMember object at 0x7fd620771340>, <cnkalman.codegen.WrapMember object at 0x7fd620772a30>, <cnkalman.codegen.WrapMember object at 0x7fd620772430>, <cnkalman.codegen.WrapMember object at 0x7fd620771250>, <cnkalman.codegen.WrapMember object at 0x7fd620771520>]
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6207719d0>, <cnkalman.codegen.WrapMember object at 0x7fd6207715b0>, <cnkalman.codegen.WrapMember object at 0x7fd620771340>, <cnkalman.codegen.WrapMember object at 0x7fd620772a30>, <cnkalman.codegen.WrapMember object at 0x7fd620772430>, <cnkalman.codegen.WrapMember object at 0x7fd620771250>, <cnkalman.codegen.WrapMember object at 0x7fd620771520>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen2 wrt [(*error_model).AccBias[0], (*error_model).AccBias[1], (*error_model).AccBias[2], (*error_model).Acc[0], (*error_model).Acc[1], (*error_model).Acc[2], (*error_model).GyroBias[0], (*error_model).GyroBias[1], (*error_model).GyroBias[2], (*error_model).IMUCorrection[0], (*error_model).IMUCorrection[1], (*error_model).IMUCorrection[2], (*error_model).IMUCorrection[3], (*error_model).Pose.AxisAngleRot[0], (*error_model).Pose.AxisAngleRot[1], (*error_model).Pose.AxisAngleRot[2], (*error_model).Pose.Pos[0], (*error_model).Pose.Pos[1], (*error_model).Pose.Pos[2], (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1], (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1], (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fd62077fa30>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6207287f0>, <cnkalman.codegen.WrapMember object at 0x7fd6207288b0>, <cnkalman.codegen.WrapMember object at 0x7fd620728850>, <cnkalman.codegen.WrapMember object at 0x7fd620728970>, <cnkalman.codegen.WrapMember object at 0x7fd620728910>, <cnkalman.codegen.WrapMember object at 0x7fd6207285e0>, <cnkalman.codegen.WrapMember object at 0x7fd620728790>]
...
// Full version Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7fd6207287f0>, <cnkalman.codegen.WrapMember object at 0x7fd6207288b0>, <cnkalman.codegen.WrapMember object at 0x7fd620728850>, <cnkalman.codegen.WrapMember object at 0x7fd620728970>, <cnkalman.codegen.WrapMember object at 0x7fd620728910>, <cnkalman.codegen.WrapMember object at 0x7fd6207285e0>, <cnkalman.codegen.WrapMember object at 0x7fd620728790>]

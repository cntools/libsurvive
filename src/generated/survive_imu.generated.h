...
static inline void gen_axisangle2quat_jac_axis_angle(FLT* out, const FLT* axis_angle) {
	...
	const GEN_FLT x21 = (-1 * x2 * x12) + (-1 * x13 * x11) + (-1 * x0 * x12) + (x10 * aa_x) + (x2 * x20) + (-1 * x19 * aa_x) + (x0 * x20) + (x13 * x17);
	...
	const GEN_FLT x33 = (x32 * x17) + (x30 * aa_y) + (x10 * aa_y) + (-1 * x29 * aa_y) + (-1 * x32 * x11) + (-1 * x19 * aa_y) + (x31 * x17) + (-1 * x31 * x11);
	const GEN_FLT x34 = aa_z * aa_z * aa_z;
	const GEN_FLT x35 = x2 * aa_z;
	const GEN_FLT x36 = (x35 * x17) + (-1 * x34 * x11) + (-1 * x29 * aa_z) + (-1 * x35 * x11) + (x10 * aa_z) + (-1 * x19 * aa_z) + (x30 * aa_z) + (x34 * x17);
...
static inline void gen_axisangle2pose_jac_obj_p_axisangle(FLT* out, const LinmathAxisAnglePose* obj_p_axisangle) {
	...
	const GEN_FLT x6 = 0.5 * x4;
	const GEN_FLT x7 = sin(x6);
	const GEN_FLT x8 = x7 * x7;
	const GEN_FLT x9 = 1. / x3;
	const GEN_FLT x10 = x8 * x9;
	const GEN_FLT x11 = cos(x6);
	const GEN_FLT x12 = 1e-11 + (x1 * x10) + (x2 * x10) + (x0 * x10) + (x11 * x11);
	const GEN_FLT x13 = 1. / sqrt(x12);
	const GEN_FLT x14 = x7 * x13;
	const GEN_FLT x15 = x5 * x14;
	const GEN_FLT x16 = 0.5 * x15;
	const GEN_FLT x17 = obj_qi * obj_qi * obj_qi;
	const GEN_FLT x18 = 1. / (x3 * sqrt(x3));
	const GEN_FLT x19 = 1.0 * x7;
	const GEN_FLT x20 = x11 * x19;
	const GEN_FLT x21 = x20 * x18;
	const GEN_FLT x22 = 2 * x10;
	const GEN_FLT x23 = 2 * (1. / (x3 * x3)) * x8;
	const GEN_FLT x24 = x0 * x23;
	const GEN_FLT x25 = x2 * x11;
	const GEN_FLT x26 = x25 * x19 * x18;
	const GEN_FLT x27 = x5 * x20;
	const GEN_FLT x28 = x0 * x21;
	const GEN_FLT x29 = (-1 * x2 * x23 * obj_qi) + (x28 * obj_qi) + (-1 * x27 * obj_qi) + (-1 * x24 * obj_qi) + (x22 * obj_qi) + (x21 * x17) + (x26 * obj_qi) + (-1 * x23 * x17);
	const GEN_FLT x30 = 1.0/2.0 * (1. / (x12 * sqrt(x12)));
	const GEN_FLT x31 = x30 * x11;
	const GEN_FLT x32 = x1 * obj_qj;
	const GEN_FLT x33 = obj_qj * obj_qj * obj_qj;
	const GEN_FLT x34 = x5 * obj_qj;
	const GEN_FLT x35 = (-1 * x34 * x20) + (x28 * obj_qj) + (x32 * x21) + (-1 * x32 * x23) + (x22 * obj_qj) + (-1 * x24 * obj_qj) + (-1 * x33 * x23) + (x33 * x21);
	const GEN_FLT x36 = x23 * obj_qk;
	const GEN_FLT x37 = obj_qk * obj_qk * obj_qk;
	const GEN_FLT x38 = (-1 * x2 * x36) + (-1 * x27 * obj_qk) + (-1 * x1 * x36) + (x1 * x21 * obj_qk) + (x22 * obj_qk) + (x37 * x21) + (x26 * obj_qk) + (-1 * x37 * x23);
	const GEN_FLT x39 = x7 * x30;
	const GEN_FLT x40 = x39 * x29;
	const GEN_FLT x41 = x5 * obj_qi;
	const GEN_FLT x42 = x14 * x18;
	const GEN_FLT x43 = 0.5 * x9 * x13;
	const GEN_FLT x44 = x43 * x11;
	const GEN_FLT x45 = x35 * x39;
	const GEN_FLT x46 = obj_qj * obj_qi;
	const GEN_FLT x47 = (x44 * x46) + (-1 * x42 * x46);
	const GEN_FLT x48 = x38 * x39;
	const GEN_FLT x49 = x42 * obj_qk;
	const GEN_FLT x50 = x44 * obj_qk;
	const GEN_FLT x51 = (x50 * obj_qi) + (-1 * x49 * obj_qi);
	const GEN_FLT x52 = (x50 * obj_qj) + (-1 * x49 * obj_qj);
	const GEN_FLT x53 = x5 * obj_qk;
	out[0] = 1;
	out[1] = 0;
	out[2] = 0;
	out[3] = 0;
	...
	out[19] = 0;
	out[20] = 0;
	out[21] = (-1 * x31 * x29) + (-1 * x16 * obj_qi);
	out[22] = (-1 * x31 * x35) + (-1 * x16 * obj_qj);
	out[23] = (-1 * x31 * x38) + (-1 * x16 * obj_qk);
	out[24] = 0;
	out[25] = 0;
	out[26] = 0;
	out[27] = (-1 * x40 * x41) + x15 + (x1 * x44) + (-1 * x1 * x42);
	out[28] = x47 + (-1 * x41 * x45);
	out[29] = x51 + (-1 * x41 * x48);
	out[30] = 0;
	out[31] = 0;
	out[32] = 0;
	out[33] = x47 + (-1 * x40 * x34);
	out[34] = x15 + (-1 * x45 * x34) + (x43 * x25) + (-1 * x2 * x42);
	out[35] = x52 + (-1 * x48 * x34);
	out[36] = 0;
	out[37] = 0;
	out[38] = 0;
	out[39] = x51 + (-1 * x53 * x40);
	out[40] = x52 + (-1 * x53 * x45);
	out[41] = x15 + (x0 * x44) + (-1 * x0 * x42) + (-1 * x53 * x48);
}

...
// <cnkalman.codegen.WrapMember object at 0x7fe728e6da30>]
...
// (*_x1).Pose.Rot[2], (*_x1).Pose.Rot[3], (*_x1).Velocity.AxisAngleRot[0], (*_x1).Velocity.AxisAngleRot[1],
// (*_x1).Velocity.AxisAngleRot[2], (*_x1).Velocity.Pos[0], (*_x1).Velocity.Pos[1], (*_x1).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e6da30>] Jacobian of SurviveKalmanModelToErrorModel wrt
...
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e70820>]
...
// <cnkalman.codegen.WrapMember object at 0x7fe728e70820>]
static inline void SurvivePoseAddErrorModel(SurvivePose *out, const SurvivePose *_x0,
	...
	const FLT x3 = (x2 * (*error_state).AxisAngleRot[1]) + (x1 * (*error_state).AxisAngleRot[2]) +
				   (-1 * x0 * (*error_state).AxisAngleRot[0]) + (*_x0).Rot[3];
	const FLT x4 = 0.5 * (*_x0).Rot[3];
	const FLT x5 = (-1 * x2 * (*error_state).AxisAngleRot[2]) + (x1 * (*error_state).AxisAngleRot[1]) +
				   (x4 * (*error_state).AxisAngleRot[0]) + (*_x0).Rot[2];
	const FLT x6 = (-1 * x0 * (*error_state).AxisAngleRot[1]) + (-1 * x2 * (*error_state).AxisAngleRot[0]) +
				   (-1 * x4 * (*error_state).AxisAngleRot[2]) + (*_x0).Rot[0];
	const FLT x7 = (*_x0).Rot[1] + (x0 * (*error_state).AxisAngleRot[2]) + (-1 * x4 * (*error_state).AxisAngleRot[1]) +
				   (x1 * (*error_state).AxisAngleRot[0]);
...
static inline void SurvivePoseAddErrorModel_jac_x0(CnMat *Hx, const SurvivePose *_x0,
	...
	const FLT x14 =
		x13 * ((x5 * x12) + (x11 * (*error_state).AxisAngleRot[2]) + (x10 * (*error_state).AxisAngleRot[0]) + (2 * x6));
	const FLT x15 = 0.5 * x9;
	const FLT x16 = x15 * (*error_state).AxisAngleRot[0];
	const FLT x17 = -1 * x16;
	const FLT x18 = 1.0 * x6;
	const FLT x19 = 1.0 * x5;
	const FLT x20 = x13 * ((-1 * x19 * (*error_state).AxisAngleRot[2]) + (x3 * x12) +
						   (-1 * x18 * (*error_state).AxisAngleRot[0]) + (2 * x7));
	const FLT x21 = x15 * (*error_state).AxisAngleRot[1];
	const FLT x22 = -1 * x21;
	const FLT x23 = x13 * ((2 * x5) + (-1 * x11 * (*error_state).AxisAngleRot[0]) +
						   (x10 * (*error_state).AxisAngleRot[2]) + (-1 * x6 * x12));
	const FLT x24 = x15 * (*error_state).AxisAngleRot[2];
	const FLT x25 = -1 * x24;
	const FLT x26 = x13 * ((x19 * (*error_state).AxisAngleRot[0]) + (2 * x3) + (-1 * x7 * x12) +
						   (-1 * x18 * (*error_state).AxisAngleRot[2]));
	cnSetZero(Hx);
...
static inline void SurvivePoseAddErrorModel_jac_error_state(CnMat *Hx, const SurvivePose *_x0,
	...
	const FLT x2 = 0.5 * (*_x0).Rot[1];
	const FLT x3 = (x2 * (*error_state).AxisAngleRot[1]) + (-1 * x0 * (*error_state).AxisAngleRot[0]) +
				   (x1 * (*_x0).Rot[0]) + (*_x0).Rot[3];
	const FLT x4 = 0.5 * (*_x0).Rot[3];
	const FLT x5 = 0.5 * (*_x0).Rot[0];
	const FLT x6 = (x5 * (*error_state).AxisAngleRot[1]) + (-1 * x2 * (*error_state).AxisAngleRot[2]) +
				   (x4 * (*error_state).AxisAngleRot[0]) + (*_x0).Rot[2];
	const FLT x7 = (-1 * x0 * (*error_state).AxisAngleRot[1]) + (-1 * x2 * (*error_state).AxisAngleRot[0]) +
				   (-1 * x4 * (*error_state).AxisAngleRot[2]) + (*_x0).Rot[0];
	const FLT x8 = (*_x0).Rot[1] + (x1 * (*_x0).Rot[2]) + (-1 * x4 * (*error_state).AxisAngleRot[1]) +
				   (x5 * (*error_state).AxisAngleRot[0]);
	...
	const FLT x18 =
		((x16 * (*_x0).Rot[3]) + (-1 * x15 * (*_x0).Rot[2]) + (x13 * (*_x0).Rot[0]) + (-1 * x14 * (*_x0).Rot[1])) * x17;
	const FLT x19 = x0 * x10;
	const FLT x20 = -1 * x19;
	const FLT x21 =
		((x16 * (*_x0).Rot[0]) + (x15 * (*_x0).Rot[1]) + (-1 * x13 * (*_x0).Rot[3]) + (-1 * x14 * (*_x0).Rot[2])) * x17;
	const FLT x22 = x4 * x10;
	const FLT x23 = -1 * x22;
	const FLT x24 =
		((-1 * x16 * (*_x0).Rot[1]) + (-1 * x14 * (*_x0).Rot[3]) + (x15 * (*_x0).Rot[0]) + (x13 * (*_x0).Rot[2])) * x17;
	...
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[0]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[0]) / sizeof(FLT), (-1 * x7 * x18) + x12);
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[0]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[1]) / sizeof(FLT), (-1 * x7 * x21) + x20);
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[0]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[2]) / sizeof(FLT), (-1 * x7 * x24) + x23);
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[1]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[0]) / sizeof(FLT), (-1 * x8 * x18) + x25);
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[1]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[1]) / sizeof(FLT), (-1 * x8 * x21) + x23);
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[1]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[2]) / sizeof(FLT), (-1 * x8 * x24) + x19);
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[2]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[0]) / sizeof(FLT), (-1 * x6 * x18) + x22);
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[2]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[1]) / sizeof(FLT), (-1 * x6 * x21) + x25);
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[2]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[2]) / sizeof(FLT), (-1 * x6 * x24) + x12);
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[3]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[0]) / sizeof(FLT), (-1 * x3 * x18) + x20);
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[3]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[1]) / sizeof(FLT), (-1 * x3 * x21) + x11);
	cnMatrixOptionalSet(Hx, offsetof(SurvivePose, Rot[3]) / sizeof(FLT),
						offsetof(SurviveAxisAnglePose, AxisAngleRot[2]) / sizeof(FLT), (-1 * x3 * x24) + x25);
}
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e77d60>]
...
// (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1],
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e77d60>] Jacobian of
...
// (*error_state).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e77550>]
...
// (*kalman_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728ec9700>]
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e82280>]
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e82280>] Jacobian of SurviveKalmanModelErrorPredict wrt
...
// (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e82fd0>]
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e71a00>] Jacobian of SurviveObsErrorModelNoFlip wrt
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e8e100>] Jacobian of SurviveObsErrorModelFlip wrt
// [(*Z).AxisAngleRot[0], (*Z).AxisAngleRot[1], (*Z).AxisAngleRot[2], (*Z).Pos[0], (*Z).Pos[1], (*Z).Pos[2]]
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e6d4c0>]
...
// (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0],
// (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1],
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e6d4c0>] Jacobian of
...
// (*err).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e8e5e0>] Jacobian of
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e85430>]
...
// (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0],
// (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1],
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e85430>] Jacobian of
...
// (*err).Pose.Pos[0], (*err).Pose.Pos[1], (*err).Pose.Pos[2], (*err).Velocity.AxisAngleRot[0],
// (*err).Velocity.AxisAngleRot[1], (*err).Velocity.AxisAngleRot[2], (*err).Velocity.Pos[0], (*err).Velocity.Pos[1],
// (*err).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e830d0>] Jacobian of
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e770a0>]
...
// (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0],
// (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1],
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e770a0>]
...
// Jacobian of SurviveKalmanModel_LightMeas_x_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7fe728e68c10>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e7e040>, <cnkalman.codegen.WrapMember object at 0x7fe728e68b20>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e7e100>, <cnkalman.codegen.WrapMember object at 0x7fe728e7e0a0>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e68580>, <cnkalman.codegen.WrapMember object at 0x7fe728e68a60>]
...
// 0x7fe728e68c10>, <cnkalman.codegen.WrapMember object at 0x7fe728e7e040>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e68b20>, <cnkalman.codegen.WrapMember object at 0x7fe728e7e100>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e7e0a0>, <cnkalman.codegen.WrapMember object at 0x7fe728e68580>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e68a60>]
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e7ea60>]
...
// (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0],
// (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1],
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e7ea60>]
...
// Jacobian of SurviveKalmanModel_LightMeas_y_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7fe728e1d850>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e1d910>, <cnkalman.codegen.WrapMember object at 0x7fe728e1d8b0>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e1d9d0>, <cnkalman.codegen.WrapMember object at 0x7fe728e1d970>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e1d640>, <cnkalman.codegen.WrapMember object at 0x7fe728e1d7f0>]
...
// 0x7fe728e1d850>, <cnkalman.codegen.WrapMember object at 0x7fe728e1d910>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e1d8b0>, <cnkalman.codegen.WrapMember object at 0x7fe728e1d9d0>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e1d970>, <cnkalman.codegen.WrapMember object at 0x7fe728e1d640>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e1d7f0>]
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e18340>]
...
// (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0],
// (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1],
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e18340>]
...
// Jacobian of SurviveKalmanModel_LightMeas_x_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7fe728e1a4f0>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e1a5b0>, <cnkalman.codegen.WrapMember object at 0x7fe728e1a550>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e1a670>, <cnkalman.codegen.WrapMember object at 0x7fe728e1a610>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e1a2e0>, <cnkalman.codegen.WrapMember object at 0x7fe728e1a490>]
...
// 0x7fe728e1a4f0>, <cnkalman.codegen.WrapMember object at 0x7fe728e1a5b0>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e1a550>, <cnkalman.codegen.WrapMember object at 0x7fe728e1a670>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e1a610>, <cnkalman.codegen.WrapMember object at 0x7fe728e1a2e0>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e1a490>]
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e8edc0>]
...
// (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0],
// (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1],
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e8edc0>]
...
// Jacobian of SurviveKalmanModel_LightMeas_y_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7fe728e8e100>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e84eb0>, <cnkalman.codegen.WrapMember object at 0x7fe728e84970>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e84ac0>, <cnkalman.codegen.WrapMember object at 0x7fe728e84d90>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e8e310>, <cnkalman.codegen.WrapMember object at 0x7fe728e8e1f0>]
...
// 0x7fe728e8e100>, <cnkalman.codegen.WrapMember object at 0x7fe728e84eb0>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e84970>, <cnkalman.codegen.WrapMember object at 0x7fe728e84ac0>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e84d90>, <cnkalman.codegen.WrapMember object at 0x7fe728e8e310>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e8e1f0>]
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728ecd280>]
...
// (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0],
// (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1],
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728ecd280>]
...
// (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1],
// (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1],
// (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728ec9e20>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7fe728e78c40>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e78c70>, <cnkalman.codegen.WrapMember object at 0x7fe728e785e0>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e78a90>, <cnkalman.codegen.WrapMember object at 0x7fe728e78430>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e78a30>, <cnkalman.codegen.WrapMember object at 0x7fe728e78640>]
...
// 0x7fe728e78c40>, <cnkalman.codegen.WrapMember object at 0x7fe728e78c70>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e785e0>, <cnkalman.codegen.WrapMember object at 0x7fe728e78a90>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e78430>, <cnkalman.codegen.WrapMember object at 0x7fe728e78a30>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e78640>]
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e71910>]
...
// (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0],
// (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1],
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e71910>]
...
// (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1],
// (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1],
// (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e70790>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen1 wrt [<cnkalman.codegen.WrapMember object at 0x7fe728e6d700>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e6d040>, <cnkalman.codegen.WrapMember object at 0x7fe728e6d430>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e6d490>, <cnkalman.codegen.WrapMember object at 0x7fe728e6d340>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e6d130>, <cnkalman.codegen.WrapMember object at 0x7fe728e6d2b0>]
...
// 0x7fe728e6d700>, <cnkalman.codegen.WrapMember object at 0x7fe728e6d040>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e6d430>, <cnkalman.codegen.WrapMember object at 0x7fe728e6d490>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e6d340>, <cnkalman.codegen.WrapMember object at 0x7fe728e6d130>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e6d2b0>]
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e6d940>]
...
// (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0],
// (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1],
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e6d940>]
...
// (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1],
// (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1],
// (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e57af0>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_x_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7fe728e605e0>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e60eb0>, <cnkalman.codegen.WrapMember object at 0x7fe728e60dc0>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e60f70>, <cnkalman.codegen.WrapMember object at 0x7fe728e60e80>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e60190>, <cnkalman.codegen.WrapMember object at 0x7fe728e607c0>]
...
// 0x7fe728e605e0>, <cnkalman.codegen.WrapMember object at 0x7fe728e60eb0>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e60dc0>, <cnkalman.codegen.WrapMember object at 0x7fe728e60f70>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e60e80>, <cnkalman.codegen.WrapMember object at 0x7fe728e60190>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e607c0>]
...
// (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0], (*_x0).Velocity.AxisAngleRot[1],
// (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1], (*_x0).Velocity.Pos[2],
// <cnkalman.codegen.WrapMember object at 0x7fe728e1af40>]
...
// (*_x0).Pose.Rot[1], (*_x0).Pose.Rot[2], (*_x0).Pose.Rot[3], (*_x0).Velocity.AxisAngleRot[0],
// (*_x0).Velocity.AxisAngleRot[1], (*_x0).Velocity.AxisAngleRot[2], (*_x0).Velocity.Pos[0], (*_x0).Velocity.Pos[1],
// (*_x0).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e1af40>]
...
// (*error_model).Velocity.AxisAngleRot[0], (*error_model).Velocity.AxisAngleRot[1],
// (*error_model).Velocity.AxisAngleRot[2], (*error_model).Velocity.Pos[0], (*error_model).Velocity.Pos[1],
// (*error_model).Velocity.Pos[2], <cnkalman.codegen.WrapMember object at 0x7fe728e1bdf0>]
...
// Jacobian of SurviveKalmanErrorModel_LightMeas_y_gen2 wrt [<cnkalman.codegen.WrapMember object at 0x7fe728e2dbe0>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e2dca0>, <cnkalman.codegen.WrapMember object at 0x7fe728e2dc40>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e2dd60>, <cnkalman.codegen.WrapMember object at 0x7fe728e2dd00>,
// <cnkalman.codegen.WrapMember object at 0x7fe728e2d9d0>, <cnkalman.codegen.WrapMember object at 0x7fe728e2db80>]
...
// 0x7fe728e2dbe0>, <cnkalman.codegen.WrapMember object at 0x7fe728e2dca0>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e2dc40>, <cnkalman.codegen.WrapMember object at 0x7fe728e2dd60>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e2dd00>, <cnkalman.codegen.WrapMember object at 0x7fe728e2d9d0>, <cnkalman.codegen.WrapMember object at
// 0x7fe728e2db80>]
